...
class form_clients_mob_apl
{
   ...
   var $main_contact_img_id_scfile_type;
   var $main_contact_img_id_ul_type;
   var $main_contact_img_id_limpa;
   var $main_contact_img_id_salva;
   var $out_main_contact_img_id;
   var $out1_main_contact_img_id;
   var $memb_status_id;
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['archive']))
          {
              $this->archive = $this->NM_ajax_info['param']['archive'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['pmts']))
          {
              $this->pmts = $this->NM_ajax_info['param']['pmts'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['type_company']))
          {
              $this->type_company = $this->NM_ajax_info['param']['type_company'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_clients_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_clients_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_clients_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_clients_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_clients_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_clients_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['upload_field_info']['main_contact_img_id'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['upload_field_info']['doc_sec_of_state'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['upload_field_info']['doc_city_bus_lic'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['upload_field_info']['doc_agric_lic'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_mob']['upload_field_info']['doc_last_year_tax'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_clients_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_mob']['label'] = "Clients";
      ...
      $_SESSION['scriptcase']['error_icon']['form_clients_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_clients_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->NM_ajax_info['param']['main_contact_img_id_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      elseif (isset($this->main_contact_img_id_ul_name) && '' != $this->main_contact_img_id_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->main_contact_img_id_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_clients_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_clients/form_clients_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_clients_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_clients_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_clients_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_clients/form_clients_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_clients_mob_erro.class.php"); 
      }
      $this->Erro      = new form_clients_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opcao']))
         { 
             if ($this->client_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_mob']['start']);
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_clients']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['members'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['botoes']['members'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['total']);
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['total']);
          $detailAppName = 'form_client_pmts_mob';
          $detailAppObject = "form_client_pmts_mob";
          $detailAppFolder = $this->Ini->root . $this->Ini->path_link  . SC_dir_app_name($detailAppName);
          if (!@is_dir($detailAppFolder)) {
              $detailAppName = substr($detailAppName, 0, -4);
              $detailAppObject = substr($detailAppObject, 0, -4);
          ...
          require_once($detailAppFolder . "/index.php");
          require_once($detailAppFolder . "/{$detailAppName}_apl.php");
          $this->form_client_pmts_mob = new $detailAppObject;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['total']);
          $detailAppName = 'form_client_notes_mob';
          $detailAppObject = "form_client_notes_mob";
          $detailAppFolder = $this->Ini->root . $this->Ini->path_link  . SC_dir_app_name($detailAppName);
          if (!@is_dir($detailAppFolder)) {
              $detailAppName = substr($detailAppName, 0, -4);
              $detailAppObject = substr($detailAppObject, 0, -4);
          ...
          require_once($detailAppFolder . "/index.php");
          require_once($detailAppFolder . "/{$detailAppName}_apl.php");
          $this->form_client_notes_mob = new $detailAppObject;
      }
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_clients_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_clients_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      if (isset($this->type_company)) { $this->nm_limpa_alfa($this->type_company); }
      if (isset($this->archive)) { $this->nm_limpa_alfa($this->archive); }
      ...
      if (isset($this->pmts)) { $this->nm_limpa_alfa($this->pmts); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['appn_date']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'] . ';' . $_SESSION['scriptcase']['reg_conf']['time_format'];
      $this->field_config['appn_date']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['appn_date']['time_sep']     = $_SESSION['scriptcase']['reg_conf']['time_sep'];
      $this->field_config['appn_date']['date_display'] = "ddmmaaaa;hhiiss";
      $this->new_date_format('DH', 'appn_date');
      //-- qb_id
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Gera_log_access'] = false;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_type_company' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'type_company');
          }
          ...
          if ('validate_archive' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'archive');
          }
          ...
          if ('validate_pmts' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'pmts');
          }
          if ('validate_notes' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'notes');
          }
          form_clients_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_clients_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_clients_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("Clients") ?></TITLE>
...
<form name="Fdown" method="get" action="form_clients_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_clients_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_clients_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_clients_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_clients_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_clients_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_clients_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_clients_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'type_company' == $filtro)) || (is_array($filtro) && in_array('type_company', $filtro)))
        $this->ValidateField_type_company($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'archive' == $filtro)) || (is_array($filtro) && in_array('archive', $filtro)))
        $this->ValidateField_archive($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'pmts' == $filtro)) || (is_array($filtro) && in_array('pmts', $filtro)))
        $this->ValidateField_pmts($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
//---
    ...
    function ValidateField_client_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Membership ID#: " . $this->Ini->Nm_lang['lang_errm_size']; 
   ...
   if (isset($this->Field_no_validate['pricing_level_id'])) {
       return;
               ...
               if (!empty($this->pricing_level_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_pricing_level_id']) && !in_array($this->pricing_level_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_pricing_level_id']))
               {
                   $hasError = true;
    ...
    function ValidateField_type_company(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['type_company'])) {
       return;
   }
               if (!empty($this->type_company) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_type_company']) && !in_array($this->type_company, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_type_company']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['type_company']))
                   {
                       $Campos_Erros['type_company'] = array();
                   }
                   $Campos_Erros['type_company'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['type_company']) || !is_array($this->NM_ajax_info['errList']['type_company']))
                   {
                       $this->NM_ajax_info['errList']['type_company'] = array();
                   }
                   $this->NM_ajax_info['errList']['type_company'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'type_company';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_type_company
   ...
   if (isset($this->Field_no_validate['bus_cat_id'])) {
       return;
               ...
               if (!empty($this->bus_cat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_cat_id']) && !in_array($this->bus_cat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_cat_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['bus_subcat_id'])) {
       return;
               ...
               if (!empty($this->bus_subcat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_subcat_id']) && !in_array($this->bus_subcat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_subcat_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_archive(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['archive'])) {
       return;
   }
      if ($this->archive == "" && $this->nmgp_opcao != "excluir")
      { 
          $this->archive = "0";
      } 
      else 
      { 
          if (is_array($this->archive))
          {
              ...
              foreach ($this->archive as $ind => $dados_archive_1 ) 
              {
                  if ($dados_archive_1 != "") 
                  {
                      $this->archive_1[] = $dados_archive_1;
                  } 
              } 
              $this->archive = ""; 
              foreach ($this->archive_1 as $dados_archive_1 ) 
   ...
   if (isset($this->Field_no_validate['memb_status_id'])) {
       return;
               ...
               if (!empty($this->memb_status_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_memb_status_id']) && !in_array($this->memb_status_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_memb_status_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_main_contact_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->main_contact_name) > 100) 
          { 
              $hasError = true;
              $Campos_Crit .= "Contact Name " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['main_contact_name']))
              {
                  $Campos_Erros['main_contact_name'] = array();
              }
              $Campos_Erros['main_contact_name'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['main_contact_name'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_main_contact_img_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (isset($this->Field_no_validate['main_contact_img_id'])) {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if ("" != $this->main_contact_img_id && "S" != $this->main_contact_img_id_limpa && !$teste_validade->ArqExtensao($this->main_contact_img_id, array()))
            {
                $hasError = true;
    ...
    function ValidateField_pmts(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['pmts'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_clients_mob_doc_name.php';
              }
              ...
              if ($nm_browser == "Opera")  
              { 
                  $this->main_contact_img_id_scfile_type = substr($this->main_contact_img_id_scfile_type, 0, strpos($this->main_contact_img_id_scfile_type, ";")) ; 
              } 
              if ($this->main_contact_img_id_scfile_type == "image/pjpeg" || $this->main_contact_img_id_scfile_type == "image/jpeg" || $this->main_contact_img_id_scfile_type == "image/gif" ||  
                  $this->main_contact_img_id_scfile_type == "image/png" || $this->main_contact_img_id_scfile_type == "image/x-png" || $this->main_contact_img_id_scfile_type == "image/bmp")  
              { 
              ...
              { 
                  ...
                  { 
                     $Campos_Crit .= "Contact Driver<br>License or ID " . $this->Ini->Nm_lang['lang_errm_ivtp'];  
                      if (!isset($Campos_Erros['main_contact_img_id']))
                      {
                          $Campos_Erros['main_contact_img_id'] = array();
                      }
                      $Campos_Erros['main_contact_img_id'][] = $this->Ini->Nm_lang['lang_errm_ivtp'];
                      if (!isset($this->NM_ajax_info['errList']['main_contact_img_id']) || !is_array($this->NM_ajax_info['errList']['main_contact_img_id']))
                      {
                          $this->NM_ajax_info['errList']['main_contact_img_id'] = array();
                      }
                      $this->NM_ajax_info['errList']['main_contact_img_id'][] = $this->Ini->Nm_lang['lang_errm_ivtp'];
                  } 
              } 
          } 
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dados_form']['main_contact_img_id']) && $this->main_contact_img_id_limpa != "S")
          {
              $this->main_contact_img_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dados_form']['main_contact_img_id'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['pmts'] = $this->pmts;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['appn_date_hora'] = $this->appn_date_hora;
      nm_limpa_data($this->appn_date, $this->field_config['appn_date']['date_sep']) ; 
      nm_limpa_hora($this->appn_date_hora, $this->field_config['appn_date']['time_sep']) ; 
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_type_company();
          ...
          $this->ajax_return_values_archive();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['client_id']['keyVal'] = form_clients_mob_pack_protect_string($this->nmgp_dados_form['client_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['foreign_key']['client_id'] = $this->nmgp_dados_form['client_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['where_filter'] = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['where_detal']  = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['foreign_key']['client_id'] = $this->nmgp_dados_form['client_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['where_filter'] = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['where_detal']  = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_notes_mob_script_case_init'] ]['form_client_notes_mob']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['foreign_key']['client_id'] = $this->nmgp_dados_form['client_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['where_filter'] = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['where_detal']  = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_pricing_level_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_pricing_level_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_pricing_level_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_pricing_level_id'] = array(); 
}
$aLookup[] = array(form_clients_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_pricing_level_id'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_clients_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_clients_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_pricing_level_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pricing_level_id']['valList'][$i] = form_clients_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_city($bForce = false)
   {
          ...
          //----- type_company
   function ajax_return_values_type_company($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("type_company", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->type_company);
              $aLookup = array();
              $this->_tmp_lookup_type_company = $this->type_company;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_type_company']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_type_company'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_type_company']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_type_company'] = array(); 
}
$aLookup[] = array(form_clients_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_type_company'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_type_company'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"type_company\"";
          if (isset($this->NM_ajax_info['select_html']['type_company']) && !empty($this->NM_ajax_info['select_html']['type_company']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['type_company']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->type_company == $sValue)
                  {
                      $this->_tmp_lookup_type_company = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['type_company'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['type_company']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['type_company']['valList'][$i] = form_clients_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['type_company']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['type_company']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['type_company']['labList'] = $aLabel;
          }
   }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_cat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_cat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_cat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_cat_id'] = array(); 
}
$aLookup[] = array(form_clients_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_mob_pack_protect_string('Chosse')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_cat_id'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_cat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_cat_id']['valList'][$i] = form_clients_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_subcat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_subcat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_subcat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_subcat_id'] = array(); 
}
$aLookup[] = array(form_clients_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_subcat_id'][] = '';
if ($this->bus_cat_id != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_bus_subcat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_subcat_id']['valList'][$i] = form_clients_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_acct_facebook($bForce = false)
   {
          ...
          //----- archive
   function ajax_return_values_archive($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("archive", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->archive);
              $aLookup = array();
              $this->_tmp_lookup_archive = $this->archive;

$aLookup[] = array(form_clients_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_clients_mob_pack_protect_string("Inactive Membership")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_archive'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['archive']) && !empty($this->NM_ajax_info['select_html']['archive']))
          {
              $sOptComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['archive']);
          }
          $this->NM_ajax_info['fldList']['archive'] = array(
                       'row'    => '',
               'type'    => 'checkbox',
               'switch'  => true,
               ...
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-archive',
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['archive']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['archive']['valList'][$i] = form_clients_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['archive']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['archive']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['archive']['labList'] = $aLabel;
          }
   }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_memb_status_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_memb_status_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_memb_status_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_memb_status_id'] = array(); 
}
$aLookup[] = array(form_clients_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_memb_status_id'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_memb_status_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['memb_status_id']['valList'][$i] = form_clients_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   if ('' != $this->main_contact_img_id_ul_name && @is_file($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->main_contact_img_id_ul_name))
   {
       $this->main_contact_img_id = @file_get_contents($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->main_contact_img_id_ul_name);
   }
   if ($this->main_contact_img_id != "" && $this->main_contact_img_id != "none")   
   { 
       $out_main_contact_img_id = $this->Ini->path_imag_temp . "/sc_main_contact_img_id_" . $_SESSION['scriptcase']['sc_num_img'] . session_id() . ".gif" ;  
       $out1_main_contact_img_id = $out_main_contact_img_id; 
       $arq_main_contact_img_id = fopen($this->Ini->root . $out_main_contact_img_id, "w") ;  
       if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) 
       { 
           $nm_tmp = nm_conv_img_access(substr($this->main_contact_img_id, 0, 12));
           if (is_string($this->main_contact_img_id) && substr($this->main_contact_img_id, 0, 4) != "*nm*" && is_string($nm_tmp) && substr($nm_tmp, 0, 4) == "*nm*") 
           { 
               $this->main_contact_img_id = nm_conv_img_access($this->main_contact_img_id);
           } 
       } 
       if (is_string($this->main_contact_img_id) && substr($this->main_contact_img_id, 0, 4) == "*nm*") 
       { 
           $this->main_contact_img_id = substr($this->main_contact_img_id, 4) ; 
           $this->main_contact_img_id = base64_decode($this->main_contact_img_id) ; 
       } 
       $img_pos_bm = (is_string($this->main_contact_img_id)) ? strpos($this->main_contact_img_id, "BM") : false; 
       if (!$img_pos_bm === FALSE && $img_pos_bm == 78) 
       { 
           $this->main_contact_img_id = substr($this->main_contact_img_id, $img_pos_bm) ; 
       } 
       fwrite($arq_main_contact_img_id, (string)$this->main_contact_img_id) ;  
       fclose($arq_main_contact_img_id) ;  
       $sc_obj_img = new nm_trata_img($this->Ini->root . $out_main_contact_img_id, true);
       $this->nmgp_return_img['main_contact_img_id'][0] = $sc_obj_img->getHeight();
       $this->nmgp_return_img['main_contact_img_id'][1] = $sc_obj_img->getWidth();
       $_SESSION['scriptcase']['sc_num_img']++ ; 
       $out_main_contact_img_id = $this->Ini->path_imag_temp . "/sc_" . "main_contact_img_id_" . $_SESSION['scriptcase']['sc_num_img'] . session_id() . ".gif" ; 
       $_SESSION['scriptcase']['sc_num_img']++ ; 
       if (!$this->Ini->Gd_missing)
       { 
           $sc_obj_img = new nm_trata_img($this->Ini->root . $out1_main_contact_img_id, true);
           $sc_obj_img->setWidth(50);
           $sc_obj_img->setHeight(50);
           $sc_obj_img->setManterAspecto(true);
           $sc_obj_img->createImg($this->Ini->root . $out_main_contact_img_id);
       } 
       else 
       { 
           $out_main_contact_img_id = $out1_main_contact_img_id;
       } 
       $_SESSION['scriptcase']['sc_num_img']++ ; 
   } 
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['main_contact_img_id'] = array(
               ...
               'imgFile' => $out_main_contact_img_id,
               'imgOrig' => $out1_main_contact_img_id,
               'imgLink' => "javascript:nm_mostra_img(var_ajax_img_main_contact_img_id, '" . $this->nmgp_return_img['main_contact_img_id'][0] . "', '" . $this->nmgp_return_img['main_contact_img_id'][1] . "')",
               'keepImg' => $sKeepImage,
              );
          }
   }
   ...
   function ajax_return_values_buyers($bForce = false)
   {
          ...
          //----- pmts
   function ajax_return_values_pmts($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("pmts", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->pmts);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['pmts'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_notes($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Field_no_validate'] = array();
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['form_clients_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_clients_mob']['contr_erro'] = 'off'; 
      ...
      if (empty($this->appn_date))
      {
          $this->appn_date_hora = $this->appn_date;
      }
      $this->nm_guardar_campos();
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          { 
              ...
              if (!empty($this->main_contact_img_id) && $this->main_contact_img_id != 'null' && substr($this->main_contact_img_id, 0, 4) != "*nm*") 
              { 
          ...
          { 
              if ($this->Ini->nm_tpbanco != "pdo_sqlsrv" && !empty($this->main_contact_img_id) && $this->main_contact_img_id != 'null' && substr($this->main_contact_img_id, 0, 4) != "*nm*") 
              { 
                  $this->main_contact_img_id = "*nm*" . base64_encode($this->main_contact_img_id) ; 
              } 
          } 
          ...
          $this->pmts_before_qstr = $this->pmts;
          $this->pmts = substr($this->Db->qstr($this->pmts), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->pmts = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->pmts);
          }
          if ($this->pmts == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->pmts = "null"; 
              $this->NM_val_null[] = "pmts";
          } 
      }
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_fields_update = array(); 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "co_name = '$this->co_name', mailing_address = '$this->mailing_address', city = '$this->city', state = '$this->state', zip_code = '$this->zip_code', phone_number = '$this->phone_number', email = '$this->email', renewal_date = #$this->renewal_date#, type_company = '$this->type_company', archive = $this->archive, pricing_level_id = $this->pricing_level_id, permanent_member_date = #$this->permanent_member_date#, acct_instagram = '$this->acct_instagram', acct_facebook = '$this->acct_facebook', website_url = '$this->website_url', bus_cat_id = $this->bus_cat_id, bus_subcat_id = $this->bus_subcat_id, bus_subcat_other = '$this->bus_subcat_other', main_contact_name = '$this->main_contact_name', main_contact_phone = '$this->main_contact_phone', main_contact_email = '$this->main_contact_email', main_contact_title = '$this->main_contact_title', memb_status_id = $this->memb_status_id"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "co_name = '$this->co_name', mailing_address = '$this->mailing_address', city = '$this->city', state = '$this->state', zip_code = '$this->zip_code', phone_number = '$this->phone_number', email = '$this->email', renewal_date = " . $this->Ini->date_delim . $this->renewal_date . $this->Ini->date_delim1 . ", type_company = '$this->type_company', archive = $this->archive, pricing_level_id = $this->pricing_level_id, permanent_member_date = " . $this->Ini->date_delim . $this->permanent_member_date . $this->Ini->date_delim1 . ", acct_instagram = '$this->acct_instagram', acct_facebook = '$this->acct_facebook', website_url = '$this->website_url', bus_cat_id = $this->bus_cat_id, bus_subcat_id = $this->bus_subcat_id, bus_subcat_other = '$this->bus_subcat_other', main_contact_name = '$this->main_contact_name', main_contact_phone = '$this->main_contact_phone', main_contact_email = '$this->main_contact_email', main_contact_title = '$this->main_contact_title', memb_status_id = $this->memb_status_id"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "co_name = '$this->co_name', mailing_address = '$this->mailing_address', city = '$this->city', state = '$this->state', zip_code = '$this->zip_code', phone_number = '$this->phone_number', email = '$this->email', renewal_date = EXTEND('$this->renewal_date', YEAR TO FRACTION), type_company = '$this->type_company', archive = $this->archive, pricing_level_id = $this->pricing_level_id, permanent_member_date = EXTEND('$this->permanent_member_date', YEAR TO FRACTION), acct_instagram = '$this->acct_instagram', acct_facebook = '$this->acct_facebook', website_url = '$this->website_url', bus_cat_id = $this->bus_cat_id, bus_subcat_id = $this->bus_subcat_id, bus_subcat_other = '$this->bus_subcat_other', main_contact_name = '$this->main_contact_name', main_contact_phone = '$this->main_contact_phone', main_contact_email = '$this->main_contact_email', main_contact_title = '$this->main_contact_title', memb_status_id = $this->memb_status_id"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['appn_date']) && $NM_val_form['appn_date'] != $this->nmgp_dados_select['appn_date']) 
              { 
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
                  { 
              ...
              if (isset($NM_val_form['appn_note']) && $NM_val_form['appn_note'] != $this->nmgp_dados_select['appn_note']) 
              { 
                  $SC_fields_update[] = "appn_note = '$this->appn_note'"; 
              } 
              if (isset($NM_val_form['qb_id']) && $NM_val_form['qb_id'] != $this->nmgp_dados_select['qb_id']) 
              { 
              ...
              $this->pmts = $this->pmts_before_qstr;
              if (in_array(strtolower($this->Ini->nm_tpbanco), $nm_bases_lob_geral))
              { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['main_contact_img_id_salva'] = array(
                      'row'     => '',
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['type_company'])) { $this->type_company = $NM_val_form['type_company']; }
              elseif (isset($this->type_company)) { $this->nm_limpa_alfa($this->type_company); }
              if     (isset($NM_val_form) && isset($NM_val_form['archive'])) { $this->archive = $NM_val_form['archive']; }
              elseif (isset($this->archive)) { $this->nm_limpa_alfa($this->archive); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['pmts'])) { $this->pmts = $NM_val_form['pmts']; }
              elseif (isset($this->pmts)) { $this->nm_limpa_alfa($this->pmts); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('co_name', 'client_id', 'mailing_address', 'pricing_level_id', 'city', 'type_company', 'state', 'bus_cat_id', 'zip_code', 'bus_subcat_id', 'phone_number', 'bus_subcat_other', 'email', 'website_url', 'permanent_member_date', 'acct_instagram', 'renewal_date', 'acct_facebook', 'archive', 'memb_status_id', 'main_contact_name', 'main_contact_phone', 'main_contact_email', 'main_contact_title', 'main_contact_img_id', 'buyers', 'pmts', 'notes'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "co_name, ofa_contact, street_address, mailing_address, city, state, zip_code, phone_number, home_phone, fax_number, email, business_type, fresh_cut_allowed, business_license, nursery_license, federal_tax_id, temporary_pass, ofa_member, starting_date, renewal_date, expiration_date, cancel_date, canceled_by, reason_canceled, retire_date, verified_receipts, date_last_updated, restricted, committee_approval_required, type_company, archive, archive_date, pricing_level_id, store_front_address, store_front_city, store_front_zip, home_base_address, home_base_city, home_base_zip, store_front_state, home_base_state, record_created, permanent_member_date, acct_instagram, acct_facebook, website_url, bus_cat_id, bus_subcat_id, bus_subcat_other, appn_date, appn_note, doc_sec_of_state, doc_city_bus_lic, doc_agric_lic, doc_last_year_tax, qb_id, main_contact_name, main_contact_phone, main_contact_email, main_contact_title, main_contact_img_id, memb_status_id $compl_insert) VALUES (" . $NM_seq_auto . "'$this->co_name', '$this->ofa_contact', '$this->street_address', '$this->mailing_address', '$this->city', '$this->state', '$this->zip_code', '$this->phone_number', '$this->home_phone', '$this->fax_number', '$this->email', '$this->business_type', $this->fresh_cut_allowed, '$this->business_license', '$this->nursery_license', '$this->federal_tax_id', $this->temporary_pass, $this->ofa_member, " . $this->Ini->date_delim . $this->starting_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->renewal_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->expiration_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->cancel_date . $this->Ini->date_delim1 . ", '$this->canceled_by', '$this->reason_canceled', " . $this->Ini->date_delim . $this->retire_date . $this->Ini->date_delim1 . ", '$this->verified_receipts', " . $this->Ini->date_delim . $this->date_last_updated . $this->Ini->date_delim1 . ", $this->restricted, $this->committee_approval_required, '$this->type_company', $this->archive, " . $this->Ini->date_delim . $this->archive_date . $this->Ini->date_delim1 . ", $this->pricing_level_id, '$this->store_front_address', '$this->store_front_city', '$this->store_front_zip', '$this->home_base_address', '$this->home_base_city', '$this->home_base_zip', '$this->store_front_state', '$this->home_base_state', " . $this->Ini->date_delim . $this->record_created . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->permanent_member_date . $this->Ini->date_delim1 . ", '$this->acct_instagram', '$this->acct_facebook', '$this->website_url', $this->bus_cat_id, $this->bus_subcat_id, '$this->bus_subcat_other', " . $this->Ini->date_delim . $this->appn_date . $this->Ini->date_delim1 . ", '$this->appn_note', EMPTY_BLOB(), EMPTY_BLOB(), EMPTY_BLOB(), EMPTY_BLOB(), $this->qb_id, '$this->main_contact_name', '$this->main_contact_phone', '$this->main_contact_email', '$this->main_contact_title', EMPTY_BLOB(), $this->memb_status_id $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
              {
                  $compl_insert     = ""; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          {
              $sDetailWhere = "client_id = " . $this->client_id . "";
              $this->form_client_notes_mob->ini_controle();
              if ($this->form_client_notes_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
                  $sMsgErro   = $this->Ini->Nm_lang['lang_errm_fkvi'];
              }
          ...
          {
              $sDetailWhere = "client_id = " . $this->client_id . "";
              $this->form_client_pmts_mob->ini_controle();
              if ($this->form_client_pmts_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
                  $sMsgErro   = $this->Ini->Nm_lang['lang_errm_fkvi'];
              }
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['parms'] = "client_id?#?$this->client_id?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_clients_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total'] = $qt_geral_reg_form_clients_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->client_id))
          {
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $Key_Where = "client_id < $this->client_id "; 
              }  
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              {
                  $Key_Where = "client_id < $this->client_id "; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_clients_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] > $qt_geral_reg_form_clients_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] = $qt_geral_reg_form_clients_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              { 
                  ...
                  { 
                     $this->main_contact_img_id = file_get_contents($rs->fields[62]);
                  }else 
                  { 
                     $this->main_contact_img_id = ''; 
                  } 
              ...
              { 
                  $this->main_contact_img_id = $rs->fields[62] ; 
              } 
              $this->nmgp_dados_select['main_contact_img_id'] = $this->main_contact_img_id;
              $this->memb_status_id = $rs->fields[63] ; 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['parms'] = "client_id?#?$this->client_id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['sub_dir'][0]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['sub_dir'][1]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['sub_dir'][2]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['sub_dir'][3]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['sub_dir'][4]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] < $qt_geral_reg_form_clients_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_notes_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
// 
//-- 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dados_select'];
           ...
           $this->SC_log_arr['fields']['pmts']['0'] =  $nmgp_dados_select['pmts'];
       }
   }
// 
   function NM_gera_log_new() 
   {
       ...
       $this->SC_log_arr['fields']['pmts']['1'] =  $this->pmts;
   }
// 
...
// 
   function NM_gera_log_output() 
   {
       ...
       $Log_labels['appn_date'] =  "Appn Date";
       ...
       $Log_labels['memb_status_id'] =  "Status";
       $Log_labels['buyers'] =  "buyers";
       $Log_labels['notes'] =  "notes";
       $Log_labels['pmts'] =  "pmts";
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       if ($this->Ini->Export_img_zip) {
           $this->Ini->Img_export_zip[] = $this->Ini->root . $out_main_contact_img_id;
           $out_main_contact_img_id = str_replace($this->Ini->path_imag_temp . "/", "", $out_main_contact_img_id);
       } 
       $_SESSION['scriptcase']['sc_num_img']++ ; 
   } 
   ...
   {
       global $temp_out_main_contact_img_id;
       if (isset($temp_out_main_contact_img_id))
       {
           $out_main_contact_img_id = $temp_out_main_contact_img_id;
       }
       global $temp_out1_main_contact_img_id;
       if (isset($temp_out1_main_contact_img_id))
       {
           $out1_main_contact_img_id = $temp_out1_main_contact_img_id;
       }
   }
        $this->initFormPages();
    include_once("form_clients_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    function form_highlight_search_quicksearch(&$result, $field, $value)
    {
        ...
        elseif ($field == $this->nmgp_fast_search && in_array($field, array("co_name", "client_id", "mailing_address", "pricing_level_id", "city", "type_company", "state", "bus_cat_id", "zip_code", "bus_subcat_id", "phone_number", "bus_subcat_other", "email", "website_url", "permanent_member_date", "acct_instagram", "renewal_date", "acct_facebook", "archive", "memb_status_id", "main_contact_name", "main_contact_phone", "main_contact_email", "main_contact_title", "main_contact_img_id", "buyers", "pmts", "notes"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_type_company()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['Lookup_type_company']))
{
...
{ 
   ...
   function Form_lookup_archive()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "Inactive Membership?#?1?#?N?@?";
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "type_company") 
          {
              $data_lookup = $this->SC_lookup_type_company($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "type_company", $arg_search, $data_lookup, "VARCHAR", false);
              }
          }
          if ($field == "state") 
          {
          ...
          if ($field == "archive") 
          {
              $data_lookup = $this->SC_lookup_archive($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "archive", $arg_search, $data_lookup, "BIT", false);
              }
          }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_clients_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total'] = $qt_geral_reg_form_clients_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_clients_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "client_id";$nm_numeric[] = "fresh_cut_allowed";$nm_numeric[] = "temporary_pass";$nm_numeric[] = "ofa_member";$nm_numeric[] = "restricted";$nm_numeric[] = "committee_approval_required";$nm_numeric[] = "archive";$nm_numeric[] = "pricing_level_id";$nm_numeric[] = "bus_cat_id";$nm_numeric[] = "bus_subcat_id";$nm_numeric[] = "qb_id";$nm_numeric[] = "memb_status_id";
      if (in_array($campo_join, $nm_numeric))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_pricing_level_id($condicao, $campo)
   {
       ...
       {
           $nm_comando = "SELECT pricing_level, memb_lev_id FROM members_level WHERE (CAST (memb_lev_id AS TEXT) LIKE '%$campo%') AND (active)" ; 
       }
       else
       {
           $nm_comando = "SELECT pricing_level, memb_lev_id FROM members_level WHERE (#cmp_ipricing_level#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos) AND (active)" ; 
       }
       if ($condicao == "ii")
       {
   ...
   function SC_lookup_type_company($condicao, $campo)
   {
       $result = array();
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT company_type, company_type FROM members_pass_type WHERE (#cmp_icompany_type#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos)" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%#arg_i" . $campo . "#arg_f%'", "LIKE '#arg_i" . $campo . "#arg_f%'", $nm_comando);
       }
   ...
   function SC_lookup_archive($condicao, $campo)
   {
       $data_look = array();
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $data_look['1'] = "Inactive Membership";
       $result = array();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_clients_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_clients_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "delete":
                ...
                break;
            case "members":
                return array("sc_members_top", "sc_members_top", "sc_members_top", "sc_members_top");
                break;
            case "breload":
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['ordem_ord'] == " desc") {
