  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clients_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate co_name
  function do_ajax_form_clients_mob_validate_co_name()
  {
    var nomeCampo_co_name = "co_name";
    var var_co_name = scAjaxGetFieldText(nomeCampo_co_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_co_name(var_co_name, var_script_case_init, do_ajax_form_clients_mob_validate_co_name_cb);
  } // do_ajax_form_clients_mob_validate_co_name

  function do_ajax_form_clients_mob_validate_co_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_co_name_cb

  // ---------- Validate client_id
  function do_ajax_form_clients_mob_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldHidden(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_clients_mob_validate_client_id_cb);
  } // do_ajax_form_clients_mob_validate_client_id

  function do_ajax_form_clients_mob_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_client_id_cb

  // ---------- Validate mailing_address
  function do_ajax_form_clients_mob_validate_mailing_address()
  {
    var nomeCampo_mailing_address = "mailing_address";
    var var_mailing_address = scAjaxGetFieldText(nomeCampo_mailing_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_mailing_address(var_mailing_address, var_script_case_init, do_ajax_form_clients_mob_validate_mailing_address_cb);
  } // do_ajax_form_clients_mob_validate_mailing_address

  function do_ajax_form_clients_mob_validate_mailing_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_mailing_address_cb

  // ---------- Validate pricing_level_id
  function do_ajax_form_clients_mob_validate_pricing_level_id()
  {
    var nomeCampo_pricing_level_id = "pricing_level_id";
    var var_pricing_level_id = scAjaxGetFieldSelect(nomeCampo_pricing_level_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_pricing_level_id(var_pricing_level_id, var_script_case_init, do_ajax_form_clients_mob_validate_pricing_level_id_cb);
  } // do_ajax_form_clients_mob_validate_pricing_level_id

  function do_ajax_form_clients_mob_validate_pricing_level_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_pricing_level_id_cb

  // ---------- Validate city
  function do_ajax_form_clients_mob_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_city(var_city, var_script_case_init, do_ajax_form_clients_mob_validate_city_cb);
  } // do_ajax_form_clients_mob_validate_city

  function do_ajax_form_clients_mob_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_city_cb

  // ---------- Validate type_company
  function do_ajax_form_clients_mob_validate_type_company()
  {
    var nomeCampo_type_company = "type_company";
    var var_type_company = scAjaxGetFieldSelect(nomeCampo_type_company);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_type_company(var_type_company, var_script_case_init, do_ajax_form_clients_mob_validate_type_company_cb);
  } // do_ajax_form_clients_mob_validate_type_company

  function do_ajax_form_clients_mob_validate_type_company_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_type_company_cb

  // ---------- Validate state
  function do_ajax_form_clients_mob_validate_state()
  {
    var nomeCampo_state = "state";
    var var_state = scAjaxGetFieldText(nomeCampo_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_state(var_state, var_script_case_init, do_ajax_form_clients_mob_validate_state_cb);
  } // do_ajax_form_clients_mob_validate_state

  function do_ajax_form_clients_mob_validate_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "state";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_state_cb

  // ---------- Validate bus_cat_id
  function do_ajax_form_clients_mob_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldSelect(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_clients_mob_validate_bus_cat_id_cb);
  } // do_ajax_form_clients_mob_validate_bus_cat_id

  function do_ajax_form_clients_mob_validate_bus_cat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_bus_cat_id_cb

  // ---------- Validate zip_code
  function do_ajax_form_clients_mob_validate_zip_code()
  {
    var nomeCampo_zip_code = "zip_code";
    var var_zip_code = scAjaxGetFieldText(nomeCampo_zip_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_zip_code(var_zip_code, var_script_case_init, do_ajax_form_clients_mob_validate_zip_code_cb);
  } // do_ajax_form_clients_mob_validate_zip_code

  function do_ajax_form_clients_mob_validate_zip_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_zip_code_cb

  // ---------- Validate bus_subcat_id
  function do_ajax_form_clients_mob_validate_bus_subcat_id()
  {
    var nomeCampo_bus_subcat_id = "bus_subcat_id";
    var var_bus_subcat_id = scAjaxGetFieldSelect(nomeCampo_bus_subcat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_bus_subcat_id(var_bus_subcat_id, var_script_case_init, do_ajax_form_clients_mob_validate_bus_subcat_id_cb);
  } // do_ajax_form_clients_mob_validate_bus_subcat_id

  function do_ajax_form_clients_mob_validate_bus_subcat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_bus_subcat_id_cb

  // ---------- Validate phone_number
  function do_ajax_form_clients_mob_validate_phone_number()
  {
    var nomeCampo_phone_number = "phone_number";
    var var_phone_number = scAjaxGetFieldText(nomeCampo_phone_number);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_phone_number(var_phone_number, var_script_case_init, do_ajax_form_clients_mob_validate_phone_number_cb);
  } // do_ajax_form_clients_mob_validate_phone_number

  function do_ajax_form_clients_mob_validate_phone_number_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_phone_number_cb

  // ---------- Validate bus_subcat_other
  function do_ajax_form_clients_mob_validate_bus_subcat_other()
  {
    var nomeCampo_bus_subcat_other = "bus_subcat_other";
    var var_bus_subcat_other = scAjaxGetFieldText(nomeCampo_bus_subcat_other);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_bus_subcat_other(var_bus_subcat_other, var_script_case_init, do_ajax_form_clients_mob_validate_bus_subcat_other_cb);
  } // do_ajax_form_clients_mob_validate_bus_subcat_other

  function do_ajax_form_clients_mob_validate_bus_subcat_other_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_bus_subcat_other_cb

  // ---------- Validate email
  function do_ajax_form_clients_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_email(var_email, var_script_case_init, do_ajax_form_clients_mob_validate_email_cb);
  } // do_ajax_form_clients_mob_validate_email

  function do_ajax_form_clients_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_email_cb

  // ---------- Validate website_url
  function do_ajax_form_clients_mob_validate_website_url()
  {
    var nomeCampo_website_url = "website_url";
    var var_website_url = scAjaxGetFieldText(nomeCampo_website_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_website_url(var_website_url, var_script_case_init, do_ajax_form_clients_mob_validate_website_url_cb);
  } // do_ajax_form_clients_mob_validate_website_url

  function do_ajax_form_clients_mob_validate_website_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_website_url_cb

  // ---------- Validate permanent_member_date
  function do_ajax_form_clients_mob_validate_permanent_member_date()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_permanent_member_date(var_permanent_member_date, var_script_case_init, do_ajax_form_clients_mob_validate_permanent_member_date_cb);
  } // do_ajax_form_clients_mob_validate_permanent_member_date

  function do_ajax_form_clients_mob_validate_permanent_member_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_permanent_member_date_cb

  // ---------- Validate acct_instagram
  function do_ajax_form_clients_mob_validate_acct_instagram()
  {
    var nomeCampo_acct_instagram = "acct_instagram";
    var var_acct_instagram = scAjaxGetFieldText(nomeCampo_acct_instagram);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_acct_instagram(var_acct_instagram, var_script_case_init, do_ajax_form_clients_mob_validate_acct_instagram_cb);
  } // do_ajax_form_clients_mob_validate_acct_instagram

  function do_ajax_form_clients_mob_validate_acct_instagram_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_acct_instagram_cb

  // ---------- Validate renewal_date
  function do_ajax_form_clients_mob_validate_renewal_date()
  {
    var nomeCampo_renewal_date = "renewal_date";
    var var_renewal_date = scAjaxGetFieldText(nomeCampo_renewal_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_renewal_date(var_renewal_date, var_script_case_init, do_ajax_form_clients_mob_validate_renewal_date_cb);
  } // do_ajax_form_clients_mob_validate_renewal_date

  function do_ajax_form_clients_mob_validate_renewal_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_renewal_date_cb

  // ---------- Validate acct_facebook
  function do_ajax_form_clients_mob_validate_acct_facebook()
  {
    var nomeCampo_acct_facebook = "acct_facebook";
    var var_acct_facebook = scAjaxGetFieldText(nomeCampo_acct_facebook);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_acct_facebook(var_acct_facebook, var_script_case_init, do_ajax_form_clients_mob_validate_acct_facebook_cb);
  } // do_ajax_form_clients_mob_validate_acct_facebook

  function do_ajax_form_clients_mob_validate_acct_facebook_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_acct_facebook_cb

  // ---------- Validate archive
  function do_ajax_form_clients_mob_validate_archive()
  {
    var nomeCampo_archive = "archive";
    var var_archive = scAjaxGetFieldCheckbox(nomeCampo_archive, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_archive(var_archive, var_script_case_init, do_ajax_form_clients_mob_validate_archive_cb);
  } // do_ajax_form_clients_mob_validate_archive

  function do_ajax_form_clients_mob_validate_archive_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "archive";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_archive_cb

  // ---------- Validate memb_status_id
  function do_ajax_form_clients_mob_validate_memb_status_id()
  {
    var nomeCampo_memb_status_id = "memb_status_id";
    var var_memb_status_id = scAjaxGetFieldSelect(nomeCampo_memb_status_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_memb_status_id(var_memb_status_id, var_script_case_init, do_ajax_form_clients_mob_validate_memb_status_id_cb);
  } // do_ajax_form_clients_mob_validate_memb_status_id

  function do_ajax_form_clients_mob_validate_memb_status_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_memb_status_id_cb

  // ---------- Validate main_contact_name
  function do_ajax_form_clients_mob_validate_main_contact_name()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_main_contact_name(var_main_contact_name, var_script_case_init, do_ajax_form_clients_mob_validate_main_contact_name_cb);
  } // do_ajax_form_clients_mob_validate_main_contact_name

  function do_ajax_form_clients_mob_validate_main_contact_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_main_contact_name_cb

  // ---------- Validate main_contact_phone
  function do_ajax_form_clients_mob_validate_main_contact_phone()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_main_contact_phone(var_main_contact_phone, var_script_case_init, do_ajax_form_clients_mob_validate_main_contact_phone_cb);
  } // do_ajax_form_clients_mob_validate_main_contact_phone

  function do_ajax_form_clients_mob_validate_main_contact_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_main_contact_phone_cb

  // ---------- Validate main_contact_email
  function do_ajax_form_clients_mob_validate_main_contact_email()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_main_contact_email(var_main_contact_email, var_script_case_init, do_ajax_form_clients_mob_validate_main_contact_email_cb);
  } // do_ajax_form_clients_mob_validate_main_contact_email

  function do_ajax_form_clients_mob_validate_main_contact_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_main_contact_email_cb

  // ---------- Validate main_contact_title
  function do_ajax_form_clients_mob_validate_main_contact_title()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_main_contact_title(var_main_contact_title, var_script_case_init, do_ajax_form_clients_mob_validate_main_contact_title_cb);
  } // do_ajax_form_clients_mob_validate_main_contact_title

  function do_ajax_form_clients_mob_validate_main_contact_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_main_contact_title_cb

  // ---------- Validate main_contact_img_id
  function do_ajax_form_clients_mob_validate_main_contact_img_id()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_main_contact_img_id(var_main_contact_img_id, var_script_case_init, do_ajax_form_clients_mob_validate_main_contact_img_id_cb);
  } // do_ajax_form_clients_mob_validate_main_contact_img_id

  function do_ajax_form_clients_mob_validate_main_contact_img_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_main_contact_img_id_cb

  // ---------- Validate buyers
  function do_ajax_form_clients_mob_validate_buyers()
  {
    var nomeCampo_buyers = "buyers";
    var var_buyers = scAjaxGetFieldText(nomeCampo_buyers);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_buyers(var_buyers, var_script_case_init, do_ajax_form_clients_mob_validate_buyers_cb);
  } // do_ajax_form_clients_mob_validate_buyers

  function do_ajax_form_clients_mob_validate_buyers_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "buyers";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_buyers_cb

  // ---------- Validate pmts
  function do_ajax_form_clients_mob_validate_pmts()
  {
    var nomeCampo_pmts = "pmts";
    var var_pmts = scAjaxGetFieldText(nomeCampo_pmts);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_pmts(var_pmts, var_script_case_init, do_ajax_form_clients_mob_validate_pmts_cb);
  } // do_ajax_form_clients_mob_validate_pmts

  function do_ajax_form_clients_mob_validate_pmts_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pmts";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_pmts_cb

  // ---------- Validate notes
  function do_ajax_form_clients_mob_validate_notes()
  {
    var nomeCampo_notes = "notes";
    var var_notes = scAjaxGetFieldText(nomeCampo_notes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_mob_validate_notes(var_notes, var_script_case_init, do_ajax_form_clients_mob_validate_notes_cb);
  } // do_ajax_form_clients_mob_validate_notes

  function do_ajax_form_clients_mob_validate_notes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_validate_notes_cb

  // ---------- Refresh bus_cat_id
  function do_ajax_form_clients_mob_refresh_bus_cat_id()
  {
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    var var_nmgp_refresh_fields = "bus_subcat_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_mob_refresh_bus_cat_id(var_bus_cat_id, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_clients_mob_refresh_bus_cat_id_cb);
  } // do_ajax_form_clients_mob_refresh_bus_cat_id

  function do_ajax_form_clients_mob_refresh_bus_cat_id_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_mob_refresh_bus_cat_id_cb

  // ---------- Event onchange bus_subcat_id
  function do_ajax_form_clients_mob_event_bus_subcat_id_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_mob_event_bus_subcat_id_onchange(var_bus_subcat_id, var_bus_subcat_other, var_bus_cat_id, var_script_case_init, do_ajax_form_clients_mob_event_bus_subcat_id_onchange_cb);
  } // do_ajax_form_clients_mob_event_bus_subcat_id_onchange

  function do_ajax_form_clients_mob_event_bus_subcat_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bus_subcat_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_mob_event_bus_subcat_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_mob_event_bus_subcat_id_onchange_cb
  function do_ajax_form_clients_mob_event_bus_subcat_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_mob_event_bus_subcat_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clients_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_clients_mob_submit_form(var_co_name, var_client_id, var_mailing_address, var_pricing_level_id, var_city, var_type_company, var_state, var_bus_cat_id, var_zip_code, var_bus_subcat_id, var_phone_number, var_bus_subcat_other, var_email, var_website_url, var_permanent_member_date, var_acct_instagram, var_renewal_date, var_acct_facebook, var_archive, var_memb_status_id, var_main_contact_name, var_main_contact_phone, var_main_contact_email, var_main_contact_title, var_main_contact_img_id, var_main_contact_img_id_ul_name, var_main_contact_img_id_ul_type, var_main_contact_img_id_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clients_mob_submit_form_cb);
  } // do_ajax_form_clients_mob_submit_form

  function do_ajax_form_clients_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("buyers");
      scAjaxHideErrorDisplay("pmts");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clients_mob_submit_form_cb_after_alert);
  } // do_ajax_form_clients_mob_submit_form_cb
  function do_ajax_form_clients_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clients_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_members_mob"] = "off";
  scStatusDetail["form_client_pmts_mob"] = "off";
  scStatusDetail["form_client_notes_mob"] = "off";

  function do_ajax_form_clients_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clients_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_clients_mob_navigate_form();
    }
  }

  function perform_ajax_form_clients_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scStatusDetail["form_client_notes_mob"] = "on";
    x_ajax_form_clients_mob_navigate_form(var_client_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clients_mob_navigate_form_cb);
  } // do_ajax_form_clients_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clients_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    else if (oResp["navSummary"] && oResp["navSummary"].reg_tot == 0)
    {
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_members_mob"] && "nmsc_iframe_liga_form_members_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_members_mob"]) {
        ...
        document.getElementById('nmsc_iframe_liga_form_members_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_members_mob').style.height = "1";
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_client_pmts_mob"] && "nmsc_iframe_liga_form_client_pmts_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_client_pmts_mob"]) {
        ...
        document.getElementById('nmsc_iframe_liga_form_client_pmts_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_client_pmts_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_client_pmts_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_client_notes_mob"] && "nmsc_iframe_liga_form_client_notes_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_client_notes_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_client_notes_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_client_notes_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_client_notes_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_client_notes_mob').style.display = "none";
    }
    document.F1.main_contact_img_id_ul_name.value = '';
    document.F1.main_contact_img_id_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clients_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_clients_mob_navigate_form_cb
  function do_ajax_form_clients_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clients_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_clients_mob_navigate_form_cb_after_alert

  function sc_hide_form_clients_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_members_mob"] && "off" == scStatusDetail["form_client_pmts_mob"] && "off" == scStatusDetail["form_client_notes_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "co_name";
  ajax_field_list[1] = "client_id";
  ajax_field_list[2] = "mailing_address";
  ajax_field_list[3] = "pricing_level_id";
  ajax_field_list[4] = "city";
  ajax_field_list[5] = "type_company";
  ajax_field_list[6] = "state";
  ajax_field_list[7] = "bus_cat_id";
  ajax_field_list[8] = "zip_code";
  ajax_field_list[9] = "bus_subcat_id";
  ajax_field_list[10] = "phone_number";
  ajax_field_list[11] = "bus_subcat_other";
  ajax_field_list[12] = "email";
  ajax_field_list[13] = "website_url";
  ajax_field_list[14] = "permanent_member_date";
  ajax_field_list[15] = "acct_instagram";
  ajax_field_list[16] = "renewal_date";
  ajax_field_list[17] = "acct_facebook";
  ajax_field_list[18] = "archive";
  ajax_field_list[19] = "memb_status_id";
  ajax_field_list[20] = "main_contact_name";
  ajax_field_list[21] = "main_contact_phone";
  ajax_field_list[22] = "main_contact_email";
  ajax_field_list[23] = "main_contact_title";
  ajax_field_list[24] = "main_contact_img_id";
  ajax_field_list[25] = "buyers";
  ajax_field_list[26] = "pmts";
  ajax_field_list[27] = "notes";
  ...
  var ajax_error_list = {
    ...
    "client_id": {"label": "Membership ID#", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "memb_status_id": {"label": "Status", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "buyers": {"label": "buyers", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pmts": {"label": "pmts", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  ajax_field_mult["buyers"][1] = "buyers";
  ajax_field_mult["pmts"][1] = "pmts";
  ...
  var ajax_field_id = {
    ...
    "buyers": new Array("hidden_field_label_buyers", "hidden_field_data_buyers"),
    "pmts": new Array("hidden_field_label_pmts", "hidden_field_data_pmts"),
