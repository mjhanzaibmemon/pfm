  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clients" == sTestField)
        {
...
?>
  ...
  // ---------- Validate co_name
  function do_ajax_form_clients_validate_co_name()
  {
    var nomeCampo_co_name = "co_name";
    var var_co_name = scAjaxGetFieldText(nomeCampo_co_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_co_name(var_co_name, var_script_case_init, do_ajax_form_clients_validate_co_name_cb);
  } // do_ajax_form_clients_validate_co_name

  function do_ajax_form_clients_validate_co_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_co_name_cb

  // ---------- Validate client_id
  function do_ajax_form_clients_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldHidden(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_clients_validate_client_id_cb);
  } // do_ajax_form_clients_validate_client_id

  function do_ajax_form_clients_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_client_id_cb

  // ---------- Validate mailing_address
  function do_ajax_form_clients_validate_mailing_address()
  {
    var nomeCampo_mailing_address = "mailing_address";
    var var_mailing_address = scAjaxGetFieldText(nomeCampo_mailing_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_mailing_address(var_mailing_address, var_script_case_init, do_ajax_form_clients_validate_mailing_address_cb);
  } // do_ajax_form_clients_validate_mailing_address

  function do_ajax_form_clients_validate_mailing_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_mailing_address_cb

  // ---------- Validate pricing_level_id
  function do_ajax_form_clients_validate_pricing_level_id()
  {
    var nomeCampo_pricing_level_id = "pricing_level_id";
    var var_pricing_level_id = scAjaxGetFieldSelect(nomeCampo_pricing_level_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_pricing_level_id(var_pricing_level_id, var_script_case_init, do_ajax_form_clients_validate_pricing_level_id_cb);
  } // do_ajax_form_clients_validate_pricing_level_id

  function do_ajax_form_clients_validate_pricing_level_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_pricing_level_id_cb

  // ---------- Validate city
  function do_ajax_form_clients_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_city(var_city, var_script_case_init, do_ajax_form_clients_validate_city_cb);
  } // do_ajax_form_clients_validate_city

  function do_ajax_form_clients_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_city_cb

  // ---------- Validate type_company
  function do_ajax_form_clients_validate_type_company()
  {
    var nomeCampo_type_company = "type_company";
    var var_type_company = scAjaxGetFieldSelect(nomeCampo_type_company);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_type_company(var_type_company, var_script_case_init, do_ajax_form_clients_validate_type_company_cb);
  } // do_ajax_form_clients_validate_type_company

  function do_ajax_form_clients_validate_type_company_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_type_company_cb

  // ---------- Validate state
  function do_ajax_form_clients_validate_state()
  {
    var nomeCampo_state = "state";
    var var_state = scAjaxGetFieldText(nomeCampo_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_state(var_state, var_script_case_init, do_ajax_form_clients_validate_state_cb);
  } // do_ajax_form_clients_validate_state

  function do_ajax_form_clients_validate_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "state";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_state_cb

  // ---------- Validate bus_cat_id
  function do_ajax_form_clients_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldSelect(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_clients_validate_bus_cat_id_cb);
  } // do_ajax_form_clients_validate_bus_cat_id

  function do_ajax_form_clients_validate_bus_cat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_bus_cat_id_cb

  // ---------- Validate zip_code
  function do_ajax_form_clients_validate_zip_code()
  {
    var nomeCampo_zip_code = "zip_code";
    var var_zip_code = scAjaxGetFieldText(nomeCampo_zip_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_zip_code(var_zip_code, var_script_case_init, do_ajax_form_clients_validate_zip_code_cb);
  } // do_ajax_form_clients_validate_zip_code

  function do_ajax_form_clients_validate_zip_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_zip_code_cb

  // ---------- Validate bus_subcat_id
  function do_ajax_form_clients_validate_bus_subcat_id()
  {
    var nomeCampo_bus_subcat_id = "bus_subcat_id";
    var var_bus_subcat_id = scAjaxGetFieldSelect(nomeCampo_bus_subcat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_bus_subcat_id(var_bus_subcat_id, var_script_case_init, do_ajax_form_clients_validate_bus_subcat_id_cb);
  } // do_ajax_form_clients_validate_bus_subcat_id

  function do_ajax_form_clients_validate_bus_subcat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_bus_subcat_id_cb

  // ---------- Validate phone_number
  function do_ajax_form_clients_validate_phone_number()
  {
    var nomeCampo_phone_number = "phone_number";
    var var_phone_number = scAjaxGetFieldText(nomeCampo_phone_number);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_phone_number(var_phone_number, var_script_case_init, do_ajax_form_clients_validate_phone_number_cb);
  } // do_ajax_form_clients_validate_phone_number

  function do_ajax_form_clients_validate_phone_number_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_phone_number_cb

  // ---------- Validate bus_subcat_other
  function do_ajax_form_clients_validate_bus_subcat_other()
  {
    var nomeCampo_bus_subcat_other = "bus_subcat_other";
    var var_bus_subcat_other = scAjaxGetFieldText(nomeCampo_bus_subcat_other);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_bus_subcat_other(var_bus_subcat_other, var_script_case_init, do_ajax_form_clients_validate_bus_subcat_other_cb);
  } // do_ajax_form_clients_validate_bus_subcat_other

  function do_ajax_form_clients_validate_bus_subcat_other_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_bus_subcat_other_cb

  // ---------- Validate email
  function do_ajax_form_clients_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_email(var_email, var_script_case_init, do_ajax_form_clients_validate_email_cb);
  } // do_ajax_form_clients_validate_email

  function do_ajax_form_clients_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_email_cb

  // ---------- Validate website_url
  function do_ajax_form_clients_validate_website_url()
  {
    var nomeCampo_website_url = "website_url";
    var var_website_url = scAjaxGetFieldText(nomeCampo_website_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_website_url(var_website_url, var_script_case_init, do_ajax_form_clients_validate_website_url_cb);
  } // do_ajax_form_clients_validate_website_url

  function do_ajax_form_clients_validate_website_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_website_url_cb

  // ---------- Validate permanent_member_date
  function do_ajax_form_clients_validate_permanent_member_date()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_permanent_member_date(var_permanent_member_date, var_script_case_init, do_ajax_form_clients_validate_permanent_member_date_cb);
  } // do_ajax_form_clients_validate_permanent_member_date

  function do_ajax_form_clients_validate_permanent_member_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_permanent_member_date_cb

  // ---------- Validate acct_instagram
  function do_ajax_form_clients_validate_acct_instagram()
  {
    var nomeCampo_acct_instagram = "acct_instagram";
    var var_acct_instagram = scAjaxGetFieldText(nomeCampo_acct_instagram);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_acct_instagram(var_acct_instagram, var_script_case_init, do_ajax_form_clients_validate_acct_instagram_cb);
  } // do_ajax_form_clients_validate_acct_instagram

  function do_ajax_form_clients_validate_acct_instagram_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_acct_instagram_cb

  // ---------- Validate renewal_date
  function do_ajax_form_clients_validate_renewal_date()
  {
    var nomeCampo_renewal_date = "renewal_date";
    var var_renewal_date = scAjaxGetFieldText(nomeCampo_renewal_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_renewal_date(var_renewal_date, var_script_case_init, do_ajax_form_clients_validate_renewal_date_cb);
  } // do_ajax_form_clients_validate_renewal_date

  function do_ajax_form_clients_validate_renewal_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_renewal_date_cb

  // ---------- Validate acct_facebook
  function do_ajax_form_clients_validate_acct_facebook()
  {
    var nomeCampo_acct_facebook = "acct_facebook";
    var var_acct_facebook = scAjaxGetFieldText(nomeCampo_acct_facebook);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_acct_facebook(var_acct_facebook, var_script_case_init, do_ajax_form_clients_validate_acct_facebook_cb);
  } // do_ajax_form_clients_validate_acct_facebook

  function do_ajax_form_clients_validate_acct_facebook_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_acct_facebook_cb

  // ---------- Validate archive
  function do_ajax_form_clients_validate_archive()
  {
    var nomeCampo_archive = "archive";
    var var_archive = scAjaxGetFieldCheckbox(nomeCampo_archive, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_archive(var_archive, var_script_case_init, do_ajax_form_clients_validate_archive_cb);
  } // do_ajax_form_clients_validate_archive

  function do_ajax_form_clients_validate_archive_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "archive";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_archive_cb

  // ---------- Validate memb_status_id
  function do_ajax_form_clients_validate_memb_status_id()
  {
    var nomeCampo_memb_status_id = "memb_status_id";
    var var_memb_status_id = scAjaxGetFieldSelect(nomeCampo_memb_status_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_memb_status_id(var_memb_status_id, var_script_case_init, do_ajax_form_clients_validate_memb_status_id_cb);
  } // do_ajax_form_clients_validate_memb_status_id

  function do_ajax_form_clients_validate_memb_status_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_memb_status_id_cb

  // ---------- Validate main_contact_name
  function do_ajax_form_clients_validate_main_contact_name()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_main_contact_name(var_main_contact_name, var_script_case_init, do_ajax_form_clients_validate_main_contact_name_cb);
  } // do_ajax_form_clients_validate_main_contact_name

  function do_ajax_form_clients_validate_main_contact_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_main_contact_name_cb

  // ---------- Validate main_contact_phone
  function do_ajax_form_clients_validate_main_contact_phone()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_main_contact_phone(var_main_contact_phone, var_script_case_init, do_ajax_form_clients_validate_main_contact_phone_cb);
  } // do_ajax_form_clients_validate_main_contact_phone

  function do_ajax_form_clients_validate_main_contact_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_main_contact_phone_cb

  // ---------- Validate main_contact_email
  function do_ajax_form_clients_validate_main_contact_email()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_main_contact_email(var_main_contact_email, var_script_case_init, do_ajax_form_clients_validate_main_contact_email_cb);
  } // do_ajax_form_clients_validate_main_contact_email

  function do_ajax_form_clients_validate_main_contact_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_main_contact_email_cb

  // ---------- Validate main_contact_title
  function do_ajax_form_clients_validate_main_contact_title()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_main_contact_title(var_main_contact_title, var_script_case_init, do_ajax_form_clients_validate_main_contact_title_cb);
  } // do_ajax_form_clients_validate_main_contact_title

  function do_ajax_form_clients_validate_main_contact_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_main_contact_title_cb

  // ---------- Validate main_contact_img_id
  function do_ajax_form_clients_validate_main_contact_img_id()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_main_contact_img_id(var_main_contact_img_id, var_script_case_init, do_ajax_form_clients_validate_main_contact_img_id_cb);
  } // do_ajax_form_clients_validate_main_contact_img_id

  function do_ajax_form_clients_validate_main_contact_img_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_main_contact_img_id_cb

  // ---------- Validate buyers
  function do_ajax_form_clients_validate_buyers()
  {
    var nomeCampo_buyers = "buyers";
    var var_buyers = scAjaxGetFieldText(nomeCampo_buyers);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_buyers(var_buyers, var_script_case_init, do_ajax_form_clients_validate_buyers_cb);
  } // do_ajax_form_clients_validate_buyers

  function do_ajax_form_clients_validate_buyers_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "buyers";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_buyers_cb

  // ---------- Validate pmts
  function do_ajax_form_clients_validate_pmts()
  {
    var nomeCampo_pmts = "pmts";
    var var_pmts = scAjaxGetFieldText(nomeCampo_pmts);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_pmts(var_pmts, var_script_case_init, do_ajax_form_clients_validate_pmts_cb);
  } // do_ajax_form_clients_validate_pmts

  function do_ajax_form_clients_validate_pmts_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pmts";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_pmts_cb

  // ---------- Validate notes
  function do_ajax_form_clients_validate_notes()
  {
    var nomeCampo_notes = "notes";
    var var_notes = scAjaxGetFieldText(nomeCampo_notes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_validate_notes(var_notes, var_script_case_init, do_ajax_form_clients_validate_notes_cb);
  } // do_ajax_form_clients_validate_notes

  function do_ajax_form_clients_validate_notes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_validate_notes_cb

  // ---------- Refresh bus_cat_id
  function do_ajax_form_clients_refresh_bus_cat_id()
  {
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    var var_nmgp_refresh_fields = "bus_subcat_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_refresh_bus_cat_id(var_bus_cat_id, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_clients_refresh_bus_cat_id_cb);
  } // do_ajax_form_clients_refresh_bus_cat_id

  function do_ajax_form_clients_refresh_bus_cat_id_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_refresh_bus_cat_id_cb

  // ---------- Event onchange bus_subcat_id
  function do_ajax_form_clients_event_bus_subcat_id_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_event_bus_subcat_id_onchange(var_bus_subcat_id, var_bus_subcat_other, var_bus_cat_id, var_script_case_init, do_ajax_form_clients_event_bus_subcat_id_onchange_cb);
  } // do_ajax_form_clients_event_bus_subcat_id_onchange

  function do_ajax_form_clients_event_bus_subcat_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bus_subcat_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_event_bus_subcat_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_event_bus_subcat_id_onchange_cb
  function do_ajax_form_clients_event_bus_subcat_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_event_bus_subcat_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clients_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_clients_submit_form(var_co_name, var_client_id, var_mailing_address, var_pricing_level_id, var_city, var_type_company, var_state, var_bus_cat_id, var_zip_code, var_bus_subcat_id, var_phone_number, var_bus_subcat_other, var_email, var_website_url, var_permanent_member_date, var_acct_instagram, var_renewal_date, var_acct_facebook, var_archive, var_memb_status_id, var_main_contact_name, var_main_contact_phone, var_main_contact_email, var_main_contact_title, var_main_contact_img_id, var_main_contact_img_id_ul_name, var_main_contact_img_id_ul_type, var_main_contact_img_id_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clients_submit_form_cb);
  } // do_ajax_form_clients_submit_form

  function do_ajax_form_clients_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clients_submit_form_cb_after_alert);
  } // do_ajax_form_clients_submit_form_cb
  function do_ajax_form_clients_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clients_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_members"] = "off";
  scStatusDetail["form_client_pmts"] = "off";
  scStatusDetail["form_client_notes"] = "off";

  function do_ajax_form_clients_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clients_navigate_form, function() {});
    } else {
      perform_ajax_form_clients_navigate_form();
    }
  }

  function perform_ajax_form_clients_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scStatusDetail["form_client_notes"] = "on";
    x_ajax_form_clients_navigate_form(var_client_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clients_navigate_form_cb);
  } // do_ajax_form_clients_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clients_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_members"] && "nmsc_iframe_liga_form_members" != scMasterDetailIframe["nmsc_iframe_liga_form_members"]) {
        ...
        document.getElementById('nmsc_iframe_liga_form_members').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_members').style.height = "1";
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_client_pmts"] && "nmsc_iframe_liga_form_client_pmts" != scMasterDetailIframe["nmsc_iframe_liga_form_client_pmts"]) {
        ...
        document.getElementById('nmsc_iframe_liga_form_client_pmts').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_client_pmts').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_client_pmts').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_client_notes"] && "nmsc_iframe_liga_form_client_notes" != scMasterDetailIframe["nmsc_iframe_liga_form_client_notes"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_client_notes"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_client_notes').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_client_notes').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_client_notes').style.display = "none";
    }
    document.F1.main_contact_img_id_ul_name.value = '';
    document.F1.main_contact_img_id_ul_type.value = '';
    scAjaxSetBtnVars();
    ...
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clients_navigate_form_cb_after_alert);
  } // do_ajax_form_clients_navigate_form_cb
  function do_ajax_form_clients_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clients_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_clients_navigate_form_cb_after_alert

  function sc_hide_form_clients_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_members"] && "off" == scStatusDetail["form_client_pmts"] && "off" == scStatusDetail["form_client_notes"])
    {
      return true;
    }
    return false;
