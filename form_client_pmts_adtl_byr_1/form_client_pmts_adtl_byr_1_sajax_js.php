  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_client_pmts_adtl_byr_1" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_client_pmts_adtl_byr_1_form();
        }
...
?>
  ...
  function do_ajax_form_client_pmts_adtl_byr_1_validate_adtl_byr_id()
  {
    var nomeCampo_adtl_byr_id = "adtl_byr_id";
    var var_adtl_byr_id = scAjaxGetFieldHidden(nomeCampo_adtl_byr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_adtl_byr_id(var_adtl_byr_id, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_adtl_byr_id_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_adtl_byr_id

  function do_ajax_form_client_pmts_adtl_byr_1_validate_adtl_byr_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_adtl_byr_id_cb

  // ---------- Validate client_id
  function do_ajax_form_client_pmts_adtl_byr_1_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldText(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_client_id_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_client_id

  function do_ajax_form_client_pmts_adtl_byr_1_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_client_id_cb

  // ---------- Validate stripe_price_id
  function do_ajax_form_client_pmts_adtl_byr_1_validate_stripe_price_id()
  {
    var nomeCampo_stripe_price_id = "stripe_price_id";
    var var_stripe_price_id = scAjaxGetFieldText(nomeCampo_stripe_price_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_stripe_price_id(var_stripe_price_id, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_stripe_price_id_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_stripe_price_id

  function do_ajax_form_client_pmts_adtl_byr_1_validate_stripe_price_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_stripe_price_id_cb

  // ---------- Validate adtl_buyers
  function do_ajax_form_client_pmts_adtl_byr_1_validate_adtl_buyers()
  {
    var nomeCampo_adtl_buyers = "adtl_buyers";
    var var_adtl_buyers = scAjaxGetFieldText(nomeCampo_adtl_buyers);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_adtl_buyers(var_adtl_buyers, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_adtl_buyers_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_adtl_buyers

  function do_ajax_form_client_pmts_adtl_byr_1_validate_adtl_buyers_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_adtl_buyers_cb

  // ---------- Validate user
  function do_ajax_form_client_pmts_adtl_byr_1_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_user(var_user, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_user_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_user

  function do_ajax_form_client_pmts_adtl_byr_1_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_user_cb

  // ---------- Validate bus_cat_id
  function do_ajax_form_client_pmts_adtl_byr_1_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldText(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_bus_cat_id_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_bus_cat_id

  function do_ajax_form_client_pmts_adtl_byr_1_validate_bus_cat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_bus_cat_id_cb

  // ---------- Validate bus_subcat_id
  function do_ajax_form_client_pmts_adtl_byr_1_validate_bus_subcat_id()
  {
    var nomeCampo_bus_subcat_id = "bus_subcat_id";
    var var_bus_subcat_id = scAjaxGetFieldText(nomeCampo_bus_subcat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_bus_subcat_id(var_bus_subcat_id, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_bus_subcat_id_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_bus_subcat_id

  function do_ajax_form_client_pmts_adtl_byr_1_validate_bus_subcat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_bus_subcat_id_cb

  // ---------- Validate notif_name
  function do_ajax_form_client_pmts_adtl_byr_1_validate_notif_name()
  {
    var nomeCampo_notif_name = "notif_name";
    var var_notif_name = scAjaxGetFieldText(nomeCampo_notif_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_notif_name(var_notif_name, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_notif_name_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_notif_name

  function do_ajax_form_client_pmts_adtl_byr_1_validate_notif_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_notif_name_cb

  // ---------- Validate notif_email
  function do_ajax_form_client_pmts_adtl_byr_1_validate_notif_email()
  {
    var nomeCampo_notif_email = "notif_email";
    var var_notif_email = scAjaxGetFieldText(nomeCampo_notif_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_notif_email(var_notif_email, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_notif_email_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_notif_email

  function do_ajax_form_client_pmts_adtl_byr_1_validate_notif_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_notif_email_cb

  // ---------- Validate token
  function do_ajax_form_client_pmts_adtl_byr_1_validate_token()
  {
    var nomeCampo_token = "token";
    var var_token = scAjaxGetFieldText(nomeCampo_token);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_token(var_token, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_token_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_token

  function do_ajax_form_client_pmts_adtl_byr_1_validate_token_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "token";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_token_cb

  // ---------- Validate token_exp
  function do_ajax_form_client_pmts_adtl_byr_1_validate_token_exp()
  {
    var nomeCampo_token_exp = "token_exp";
    var var_token_exp = scAjaxGetFieldText(nomeCampo_token_exp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_token_exp(var_token_exp, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_token_exp_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_token_exp

  function do_ajax_form_client_pmts_adtl_byr_1_validate_token_exp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_token_exp_cb

  // ---------- Validate ts
  function do_ajax_form_client_pmts_adtl_byr_1_validate_ts()
  {
    var nomeCampo_ts = "ts";
    var var_ts = scAjaxGetFieldText(nomeCampo_ts);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_validate_ts(var_ts, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_validate_ts_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_ts

  function do_ajax_form_client_pmts_adtl_byr_1_validate_ts_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ts";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_validate_ts_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_client_pmts_adtl_byr_1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_client_pmts_adtl_byr_1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_client_pmts_adtl_byr_1_submit_form(var_adtl_byr_id, var_client_id, var_stripe_price_id, var_adtl_buyers, var_user, var_bus_cat_id, var_bus_subcat_id, var_notif_name, var_notif_email, var_token, var_token_exp, var_ts, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_client_pmts_adtl_byr_1_submit_form_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_submit_form

  function do_ajax_form_client_pmts_adtl_byr_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_client_pmts_adtl_byr_1_submit_form_cb_after_alert);
  } // do_ajax_form_client_pmts_adtl_byr_1_submit_form_cb
  function do_ajax_form_client_pmts_adtl_byr_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_client_pmts_adtl_byr_1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_client_pmts_adtl_byr_1_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_client_pmts_adtl_byr_1_navigate_form, function() {});
    } else {
      perform_ajax_form_client_pmts_adtl_byr_1_navigate_form();
    }
  }

  function perform_ajax_form_client_pmts_adtl_byr_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_client_pmts_adtl_byr_1_navigate_form(var_adtl_byr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_navigate_form_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_adtl_byr_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_client_pmts_adtl_byr_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_client_pmts_adtl_byr_1_navigate_form_cb_after_alert);
  } // do_ajax_form_client_pmts_adtl_byr_1_navigate_form_cb
  function do_ajax_form_client_pmts_adtl_byr_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_client_pmts_adtl_byr_1_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_client_pmts_adtl_byr_1_navigate_form_cb_after_alert

  function sc_hide_form_client_pmts_adtl_byr_1_form()
  {
