  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_client_pmts_adtl_byr_1_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_client_pmts_adtl_byr_1_mob_form();
        }
...
?>
  ...
  // ---------- Validate adtl_byr_id
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_byr_id()
  {
    var nomeCampo_adtl_byr_id = "adtl_byr_id";
    var var_adtl_byr_id = scAjaxGetFieldHidden(nomeCampo_adtl_byr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_byr_id(var_adtl_byr_id, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_byr_id_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_byr_id

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_byr_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "adtl_byr_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_byr_id_cb

  // ---------- Validate client_id
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldText(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_client_id_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_client_id

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_client_id_cb

  // ---------- Validate stripe_price_id
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_stripe_price_id()
  {
    var nomeCampo_stripe_price_id = "stripe_price_id";
    var var_stripe_price_id = scAjaxGetFieldText(nomeCampo_stripe_price_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_stripe_price_id(var_stripe_price_id, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_stripe_price_id_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_stripe_price_id

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_stripe_price_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stripe_price_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_stripe_price_id_cb

  // ---------- Validate adtl_buyers
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_buyers()
  {
    var nomeCampo_adtl_buyers = "adtl_buyers";
    var var_adtl_buyers = scAjaxGetFieldText(nomeCampo_adtl_buyers);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_buyers(var_adtl_buyers, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_buyers_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_buyers

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_buyers_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "adtl_buyers";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_adtl_buyers_cb

  // ---------- Validate user
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_user(var_user, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_user_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_user

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_user_cb

  // ---------- Validate bus_cat_id
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldText(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_cat_id_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_cat_id

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_cat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_cat_id_cb

  // ---------- Validate bus_subcat_id
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_subcat_id()
  {
    var nomeCampo_bus_subcat_id = "bus_subcat_id";
    var var_bus_subcat_id = scAjaxGetFieldText(nomeCampo_bus_subcat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_subcat_id(var_bus_subcat_id, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_subcat_id_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_subcat_id

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_subcat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_bus_subcat_id_cb

  // ---------- Validate notif_name
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_name()
  {
    var nomeCampo_notif_name = "notif_name";
    var var_notif_name = scAjaxGetFieldText(nomeCampo_notif_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_name(var_notif_name, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_name_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_name

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notif_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_name_cb

  // ---------- Validate notif_email
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_email()
  {
    var nomeCampo_notif_email = "notif_email";
    var var_notif_email = scAjaxGetFieldText(nomeCampo_notif_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_email(var_notif_email, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_email_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_email

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notif_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_notif_email_cb

  // ---------- Validate token
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_token()
  {
    var nomeCampo_token = "token";
    var var_token = scAjaxGetFieldText(nomeCampo_token);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_token(var_token, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_token_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_token

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_token_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "token";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_token_cb

  // ---------- Validate token_exp
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_token_exp()
  {
    var nomeCampo_token_exp = "token_exp";
    var var_token_exp = scAjaxGetFieldText(nomeCampo_token_exp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_token_exp(var_token_exp, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_token_exp_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_token_exp

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_token_exp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "token_exp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_token_exp_cb

  // ---------- Validate ts
  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_ts()
  {
    var nomeCampo_ts = "ts";
    var var_ts = scAjaxGetFieldText(nomeCampo_ts);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_1_mob_validate_ts(var_ts, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_validate_ts_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_ts

  function do_ajax_form_client_pmts_adtl_byr_1_mob_validate_ts_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ts";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_validate_ts_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_client_pmts_adtl_byr_1_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_client_pmts_adtl_byr_1_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_adtl_byr_id = scAjaxGetFieldHidden("adtl_byr_id");
    var var_client_id = scAjaxGetFieldText("client_id");
    var var_stripe_price_id = scAjaxGetFieldText("stripe_price_id");
    var var_adtl_buyers = scAjaxGetFieldText("adtl_buyers");
    var var_user = scAjaxGetFieldText("user");
    var var_bus_cat_id = scAjaxGetFieldText("bus_cat_id");
    var var_bus_subcat_id = scAjaxGetFieldText("bus_subcat_id");
    var var_notif_name = scAjaxGetFieldText("notif_name");
    var var_notif_email = scAjaxGetFieldText("notif_email");
    var var_token = scAjaxGetFieldText("token");
    var var_token_exp = scAjaxGetFieldText("token_exp");
    var var_ts = scAjaxGetFieldText("ts");
    ...
    scAjaxProcOn();
    x_ajax_form_client_pmts_adtl_byr_1_mob_submit_form(var_adtl_byr_id, var_client_id, var_stripe_price_id, var_adtl_buyers, var_user, var_bus_cat_id, var_bus_subcat_id, var_notif_name, var_notif_email, var_token, var_token_exp, var_ts, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_client_pmts_adtl_byr_1_mob_submit_form_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_submit_form

  function do_ajax_form_client_pmts_adtl_byr_1_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("adtl_byr_id");
      scAjaxHideErrorDisplay("client_id");
      scAjaxHideErrorDisplay("stripe_price_id");
      scAjaxHideErrorDisplay("adtl_buyers");
      scAjaxHideErrorDisplay("user");
      scAjaxHideErrorDisplay("bus_cat_id");
      scAjaxHideErrorDisplay("bus_subcat_id");
      scAjaxHideErrorDisplay("notif_name");
      scAjaxHideErrorDisplay("notif_email");
      scAjaxHideErrorDisplay("token");
      scAjaxHideErrorDisplay("token_exp");
      scAjaxHideErrorDisplay("ts");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_client_pmts_adtl_byr_1_mob_submit_form_cb_after_alert);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_submit_form_cb
  function do_ajax_form_client_pmts_adtl_byr_1_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form();
    }
  }

  function perform_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("token_exp");
    scAjaxHideErrorDisplay("ts");
    var var_adtl_byr_id = document.F2.adtl_byr_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form(var_adtl_byr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form_cb);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_adtl_byr_1_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.adtl_byr_id.value = scAjaxGetKeyValue("adtl_byr_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form_cb
  function do_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_client_pmts_adtl_byr_1_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_client_pmts_adtl_byr_1_mob_navigate_form_cb_after_alert

  function sc_hide_form_client_pmts_adtl_byr_1_mob_form()
  {
  ...
  ajax_field_list[0] = "adtl_byr_id";
  ajax_field_list[1] = "client_id";
  ajax_field_list[2] = "stripe_price_id";
  ajax_field_list[3] = "adtl_buyers";
  ajax_field_list[4] = "user";
  ajax_field_list[5] = "bus_cat_id";
  ajax_field_list[6] = "bus_subcat_id";
  ajax_field_list[7] = "notif_name";
  ajax_field_list[8] = "notif_email";
  ajax_field_list[9] = "token";
  ajax_field_list[10] = "token_exp";
  ajax_field_list[11] = "ts";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "adtl_byr_id": {"label": "Adtl Byr Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "client_id": {"label": "Client Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "stripe_price_id": {"label": "Stripe Price Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "adtl_buyers": {"label": "Adtl Buyers", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "user": {"label": "User", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "bus_cat_id": {"label": "Bus Cat Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "bus_subcat_id": {"label": "Bus Subcat Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "notif_name": {"label": "Notif Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "notif_email": {"label": "Notif Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "token": {"label": "Token", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "token_exp": {"label": "Token Exp", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ts": {"label": "Ts", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "adtl_byr_id": new Array(),
    "client_id": new Array(),
    "stripe_price_id": new Array(),
    "adtl_buyers": new Array(),
    "user": new Array(),
    "bus_cat_id": new Array(),
    "bus_subcat_id": new Array(),
    "notif_name": new Array(),
    "notif_email": new Array(),
    "token": new Array(),
    "token_exp": new Array(),
    "ts": new Array()
  };
  ajax_field_mult["adtl_byr_id"][1] = "adtl_byr_id";
  ajax_field_mult["client_id"][1] = "client_id";
  ajax_field_mult["stripe_price_id"][1] = "stripe_price_id";
  ajax_field_mult["adtl_buyers"][1] = "adtl_buyers";
  ajax_field_mult["user"][1] = "user";
  ajax_field_mult["bus_cat_id"][1] = "bus_cat_id";
  ajax_field_mult["bus_subcat_id"][1] = "bus_subcat_id";
  ajax_field_mult["notif_name"][1] = "notif_name";
  ajax_field_mult["notif_email"][1] = "notif_email";
  ajax_field_mult["token"][1] = "token";
  ajax_field_mult["token_exp"][1] = "token_exp";
  ajax_field_mult["ts"][1] = "ts";

  var ajax_field_id = {
    "adtl_byr_id": new Array("hidden_field_label_adtl_byr_id", "hidden_field_data_adtl_byr_id"),
    "client_id": new Array("hidden_field_label_client_id", "hidden_field_data_client_id"),
    "stripe_price_id": new Array("hidden_field_label_stripe_price_id", "hidden_field_data_stripe_price_id"),
    "adtl_buyers": new Array("hidden_field_label_adtl_buyers", "hidden_field_data_adtl_buyers"),
    ...
    "notif_name": new Array("hidden_field_label_notif_name", "hidden_field_data_notif_name"),
    "notif_email": new Array("hidden_field_label_notif_email", "hidden_field_data_notif_email"),
    "token": new Array("hidden_field_label_token", "hidden_field_data_token"),
    "token_exp": new Array("hidden_field_label_token_exp", "hidden_field_data_token_exp"),
    "ts": new Array("hidden_field_label_ts", "hidden_field_data_ts")
  };
