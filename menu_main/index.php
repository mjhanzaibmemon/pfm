<?php
include_once('menu_main_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['menu_main']['glo_nm_perfil']         = "conn_mysql";
    $_SESSION['scriptcase']['menu_main']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['menu_main']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['menu_main']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['menu_main']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu_main']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class menu_main_class
{
  var $Db;
 ...
 {
    global $menu_main_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_main']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_main/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_main']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_main');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_main_erro.php");
}
include_once(dirname(__FILE__) . "/menu_main_erro.class.php"); 
$this->Erro = new menu_main_erro();
$str_path = substr($_SESSION['scriptcase']['menu_main']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_main']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_main']['glo_nm_conexao']);
}

/* Path definitions */
$menu_main_menuData         = array();
$menu_main_menuData['path'] = array();
$menu_main_menuData['url']  = array();
$menu_main_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_main_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_main_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_main_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_main_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_main_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_main_menuData['url']['web']   = str_replace("\\", '/', $menu_main_menuData['url']['web']);
$menu_main_menuData['path']['root'] = substr($menu_main_menuData['path']['sys'],  0, -1 * strlen($menu_main_menuData['url']['web']));
$menu_main_menuData['path']['app']  = substr($menu_main_menuData['path']['sys'],  0, strrpos($menu_main_menuData['path']['sys'],  '/'));
$menu_main_menuData['path']['link'] = substr($menu_main_menuData['path']['app'],  0, strrpos($menu_main_menuData['path']['app'],  '/'));
$menu_main_menuData['path']['link'] = substr($menu_main_menuData['path']['link'], 0, strrpos($menu_main_menuData['path']['link'], '/')) . '/';
$menu_main_menuData['path']['app'] .= '/';
$menu_main_menuData['url']['app']   = substr($menu_main_menuData['url']['web'],  0, strrpos($menu_main_menuData['url']['web'],  '/'));
$menu_main_menuData['url']['link']  = substr($menu_main_menuData['url']['app'],  0, strrpos($menu_main_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] == "S")
{
    $menu_main_menuData['url']['link']  = substr($menu_main_menuData['url']['link'], 0, strrpos($menu_main_menuData['url']['link'], '/'));
}
$menu_main_menuData['url']['link']  .= '/';
$menu_main_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_main']['sc_apl_link'] = $menu_main_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_main']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_main']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_main']['actual_lang']) || $_SESSION['scriptcase']['menu_main']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_main']['actual_lang'] = $this->str_lang;
...
include_once("menu_main_toolbar.php");

$this->tab_grupo[0] = "PFM_Staff/";
if ($_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
}

     $_SESSION['scriptcase']['menu_atual'] = "menu_main";
     $_SESSION['scriptcase']['menu_apls']['menu_main'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_main']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_main']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_main']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_main']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_main']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_main']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_main']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_main']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['menu_main']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_main']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_main']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_main']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_main']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_main']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['menu_main']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_main']['init']))
{
    $_SESSION['sc_session'][1]['menu_main']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_main']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_main']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_main'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_main'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_main'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['menu_main'] = "on";
} 
if (!isset($_SESSION['scriptcase']['menu_main']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['menu_main']) || $_SESSION['scriptcase']['sc_apl_seg']['menu_main'] != "on"))
{ 
...
<!DOCTYPE html>
 ...
 <META http <META http <META http <META http <META http      <link rel="shortcut icon" href="../_lib/img/grp__NM__bg__NM__pfm_img.png">
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['menu_main']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_main']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['menu_main']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod'], 'PFM_Staff', 2); 
}
if (isset($_SESSION['scriptcase']['menu_main']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['menu_main']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['menu_main']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['menu_main']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['menu_main']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['menu_main']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['menu_main']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['menu_main']['sc_outra_jan']) && $_SESSION['sc_session'][1]['menu_main']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['menu_main']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_main']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['menu_main']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod'], 'PFM_Staff'); 
} 
else 
{ 
...
if (in_array(strtolower($nm_tpbanco), $this->nm_bases_oracle))
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['menu_main']['decimal_db'] = ".";
} 
//
$this->NM_gera_log_insert("Scriptcase", "access");
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_main'))
{
    $_SESSION['sc_session'][1]['menu_main']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_main'] = "javascript:window.close()";
}
/* Menu configuration variables */
$menu_main_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_vw_clients_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_vw_clients_ini.php');
    ...
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_clients']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_vw_requests_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_vw_requests_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_requests']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_vw_requests'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_vw_clients_main_member_renew_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_vw_clients_main_member_renew_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_clients_main_member_renew']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_vw_clients_main_member_renew'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_vw_client_active_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_vw_client_active_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_client_active']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_vw_client_active'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_vw_clients_main_member_inactive_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_vw_clients_main_member_inactive_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_clients_main_member_inactive']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_vw_clients_main_member_inactive'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$_SESSION['scriptcase']['sc_apl_seg']['membership_exports'] = "on";
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_members_status_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_members_status_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_members_status']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_members_status'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_notifications_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_notifications_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_notifications']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_notifications'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[4]))
{
 ...
 $nm_var_lab[5] = "Recent Memberships";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[7]))
{
 ...
 $nm_var_lab[8] = "Inactive Memberships";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[8]))
{
 ...
 $nm_var_lab[9] = "Email Notifications";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[9]))
{
 ...
 $nm_var_lab[10] = "Membership Status (Email)";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[10]))
{
 ...
 $nm_var_lab[11] = "Email Notifications";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[4]))
{
 ...
 $nm_var_hint[5] = "Latest Enrollments and Renewals";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[7]))
{
 ...
 $nm_var_hint[8] = "Inform clients that their membership status has been updated to Inactive, should they require access to the Flower Market.";
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_main'];
$menu_main_menuData['data'] .= "item_4|.|" . $nm_var_lab[0] . "|menu_main_form_php.php?sc_item_menu=item_4&sc_apl_menu=https://pdxflowermarket.com/&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_main_target('_self') . "|" . "\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_clients']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_clients']) == "on")
{
    $menu_main_menuData['data'] .= "item_1|.|" . $nm_var_lab[1] . "|menu_main_form_php.php?sc_item_menu=item_1&sc_apl_menu=grid_vw_clients&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}
 $nm_var_lab[15] = "Membership Exports";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[15]))
{
 ...
 $nm_var_lab[16] = "Renewal Reviews (NEW)";
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_requests']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_requests']) == "on")
{
    $menu_main_menuData['data'] .= "item_3|.|" . $nm_var_lab[2] . "|menu_main_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_vw_requests&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_client_active']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_client_active']) == "on")
{
    $menu_main_menuData['data'] .= "item_22|..|" . $nm_var_lab[5] . "|menu_main_form_php.php?sc_item_menu=item_22&sc_apl_menu=grid_vw_client_active&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['membership_exports']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['membership_exports']) == "on")
{
    $menu_main_menuData['data'] .= "item_30|..|" . $nm_var_lab[15] . "|menu_main_form_php.php?sc_item_menu=item_30&sc_apl_menu=membership_exports&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[15] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}
$menu_main_menuData['data'] .= "item_20|.|" . $nm_var_lab[6] . "|menu_main_form_php.php?sc_item_menu=item_20&sc_apl_menu=https://dashboard.stripe.com/test/payments&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->menu_main_target('_blank') . "|" . "\n";
$menu_main_menuData['data'] .= "item_21|.|" . $nm_var_lab[7] . "|menu_main_form_php.php?sc_item_menu=item_21&sc_apl_menu=https://app.mailersend.com/activity&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->menu_main_target('_blank') . "|" . "\n";
...
{
    $menu_main_menuData['data'] .= "item_25|..|" . $nm_var_lab[8] . "|menu_main_form_php.php?sc_item_menu=item_25&sc_apl_menu=grid_vw_clients_main_member_inactive&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}

$menu_main_menuData['data'] .= "item_6|.|" . $this->Nm_lang['lang_menu_security'] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
...
{
    $menu_main_menuData['data'] .= "item_7|..|" . $this->Nm_lang['lang_list_users'] . "|menu_main_form_php.php?sc_item_menu=item_7&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) == "on")
{
    $menu_main_menuData['data'] .= "item_8|..|" . $this->Nm_lang['lang_list_apps'] . "|menu_main_form_php.php?sc_item_menu=item_8&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}
...
{
    $menu_main_menuData['data'] .= "item_9|..|" . $this->Nm_lang['lang_list_groups'] . "|menu_main_form_php.php?sc_item_menu=item_9&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}
...
{
    $menu_main_menuData['data'] .= "item_16|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "|menu_main_form_php.php?sc_item_menu=item_16&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users_x_groups'] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}
...
{
    $menu_main_menuData['data'] .= "item_10|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|menu_main_form_php.php?sc_item_menu=item_10&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) == "on")
{
    $menu_main_menuData['data'] .= "item_11|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|menu_main_form_php.php?sc_item_menu=item_11&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_add_2fa']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_add_2fa']) == "on")
{
    $menu_main_menuData['data'] .= "item_17|..|" . $this->Nm_lang['lang_2fa'] . "|menu_main_form_php.php?sc_item_menu=item_17&sc_apl_menu=app_add_2fa&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_2fa'] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}

$menu_main_menuData['data'] .= "item_18|..|" . $nm_var_lab[9] . "||" . $nm_var_hint[9] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_members_status']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_members_status']) == "on")
{
    $menu_main_menuData['data'] .= "item_23|...|" . $nm_var_lab[10] . "|menu_main_form_php.php?sc_item_menu=item_23&sc_apl_menu=form_members_status&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_notifications']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_notifications']) == "on")
{
    $menu_main_menuData['data'] .= "item_24|...|" . $nm_var_lab[11] . "|menu_main_form_php.php?sc_item_menu=item_24&sc_apl_menu=form_notifications&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_main_menuData['data'] .= "item_12|..|" . $this->Nm_lang['lang_change_pswd'] . "|menu_main_form_php.php?sc_item_menu=item_12&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->menu_main_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_main_menuData['data'] .= "item_13|.|" . $this->Nm_lang['lang_exit'] . "|menu_main_form_php.php?sc_item_menu=item_13&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "||" . $this->menu_main_target('_parent') . "|" . "\n";
}
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_4&sc_apl_menu=https://pdxflowermarket.com/&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
$str_icon = "";
$icon_aba = "";
$icon_aba_inactive = "";
...
$menu_main_menuData['data'][] = array(
    ...
    'target'   => " item-target=\"" . $this->menu_main_target('_self') . "\"",
    'sc_id'    => "item_4",
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_1&sc_apl_menu=grid_vw_clients&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_clients']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_clients']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_vw_requests&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_requests']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_requests']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_main_menuData['data'][] = array(
        ...
        'display'     => "text_fontawesomeicon",
        'display_position'=> "text_right",
        'icon_fa'     => "fas fa-inbox",
        'icon_color'     => "",
        'icon_color_hover'     => "",
        'icon_color_disabled'     => "",
    );
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_19&sc_apl_menu=grid_vw_clients_main_member_renew&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_clients_main_member_renew']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_clients_main_member_renew']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_22&sc_apl_menu=grid_vw_client_active&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_client_active']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_vw_client_active']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_30&sc_apl_menu=membership_exports&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['membership_exports']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['membership_exports']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_main_menuData['data'][] = array(
        ...
        'display'     => "text_img",
        'display_position'=> "text_right",
        'icon_fa'     => "fas fa-file-csv",
        'icon_color'     => "",
        'icon_color_hover'     => "",
        'icon_color_disabled'     => "",
    );
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_20&sc_apl_menu=https://dashboard.stripe.com/test/payments&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
$str_icon = "";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
...
$menu_main_menuData['data'][] = array(
    ...
    'display'     => "text_fontawesomeicon",
    'display_position'=> "text_right",
    'icon_fa'     => "fas fa-file-invoice-dollar",
    'icon_color'     => "",
    'icon_color_hover'     => "",
    'icon_color_disabled'     => "",
);
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_21&sc_apl_menu=https://app.mailersend.com/activity&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
$str_icon = "";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_7&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_8&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_9&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_16&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_10&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_11&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_17&sc_apl_menu=app_add_2fa&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_add_2fa']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_add_2fa']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_23&sc_apl_menu=form_members_status&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_members_status']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_members_status']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_24&sc_apl_menu=form_notifications&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_notifications']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_notifications']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_12&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_main_form_php.php?sc_item_menu=item_13&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_main_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_main_target('_parent') . "\"",
        'sc_id'    => "item_13",
        'disabled' => $str_disabled,
        'display'     => "text_fontawesomeicon",
        'display_position'=> "text_right",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_main']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_main']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_main');
    $menu_main_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_main_help.txt"))
{
    $Arq_WebHelp = file("menu_main_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_main_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_main_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_main']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_main']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_main_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_main']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_main_menuData['data'][$i_menu]);
       }
    ...
    $menu_main_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_main']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_main']))
{
    $disable_menu = false;
    foreach ($menu_main_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_main']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_main_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
foreach ($menu_main_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $menu_main_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($menu_main_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($menu_main_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $menu_main_menuData['data'][$chave]['level'];
                        unset($menu_main_menuData['data'][$chave]);
                }
        }
}
$menu_main_menuData['data'] = array_values($menu_main_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($menu_main_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if (isset($menu_main_menuData['data'][$chave + 1]) && !empty($menu_main_menuData['data'][$chave + 1]))
            {
                if ($menu_main_menuData['data'][$chave]['link'] == "#")
                {
                    if ($menu_main_menuData['data'][$chave]['level'] >= $menu_main_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($menu_main_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($menu_main_menuData['data'][$chave]['link'] == "#")
            {
                unset($menu_main_menuData['data'][$chave]);
            }
        }
...
/* HTML header */
if ($menu_main_menuData['iframe'])
{
    $menu_main_menuData['height'] = '100%';
    header("X-XSS-Protection: 1; mode=block");
    header("X-Frame-Options: SAMEORIGIN");
?>
<!DOCTYPE html>
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/scriptcase_Scriptcase_LigthBlueOcean_<?php echo ($this->menu_orientacao!='vertical')?'hor':'vert'; ?>_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "scriptcase_Scriptcase_LigthBlueOcean" . '_' . (($this->menu_orientacao!='vertical')?'hor':'vert') . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "scriptcase_Scriptcase_LigthBlueOcean" . '_' . (($this->menu_orientacao=='horizontal')?'hor':'vert') . '.css'); } ?>" />
<style>
   .scTabText {
   }
    <?php
...
{
    $menu_main_menuData['height'] = '30px';
}

/* JS files */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_main']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_main_message.js"></script>
...
<?php
 $seq = 0;
 if(isset($menu_main_menuData['data']) && !empty($menu_main_menuData['data']))
 {
   foreach ($menu_main_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menu_main_menuData['data_user']) && !empty($menu_main_menuData['data_user']))
 {
   foreach ($menu_main_menuData['data_user'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
 ...
 if(isset($menu_main_menuData['data_vertical']) && !empty($menu_main_menuData['data_vertical']))
 {
   foreach ($menu_main_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl, fa_ico)
{
    ...
    iframe.name = 'menu_main_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_main'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_main').hide();
    if (str_id == "")
    {
        $('#iframe_menu_main').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="menu_main_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            Iframe_atual = "menu_main_" + Tab_iframes[i] + '_iframe';
...
{
  str_target_sv = "";
  if (str_id != "iframe_menu_main")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("menu_main_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    if (str_target == "menu_main_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        ...
        if (str_id != "menu_main" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_menu_main').length)
        $('#iframe_menu_main')[0].contentWindow.focus();
  }
}
</script>
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $menu_main_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->menu_main_escreveMenu($menu_main_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Iframe control */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_main_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
?>
    <div id="Iframe_control" style='width:100%; height:100%; margin:0px; padding:0px;'>
      <iframe id="iframe_menu_main" name="menu_main_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "https://pdxflowermarket.com/"); ?> " ></iframe>
<?php
}
?></div></td>
  </tr>
...
/* Target control */
function menu_main_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function menu_main_target($str_target)
{
    global $menu_main_menuData;
    ...
    elseif ($menu_main_menuData['iframe'])
    {
        return 'menu_main_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_main_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_main_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_main_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_main_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_main']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_main_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_main']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_main']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_main']['sc_init'][$apl_menu];
   }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['scriptcase']['menu_main']['SC_sep_date']) && !empty($_SESSION['scriptcase']['menu_main']['SC_sep_date']))
       {
           $delim  = $_SESSION['scriptcase']['menu_main']['SC_sep_date'];
           $delim1 = $_SESSION['scriptcase']['menu_main']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'menu_main', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'menu_main', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'menu_main', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_main']['glo_nm_path_imag_temp'] . "/sc_apl_default_PFM_Staff.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_main']['glo_nm_path_imag_temp'] . "/sc_apl_default_PFM_Staff.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_main") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_main']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_main']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_main']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_PFM_Staff'])) {
            $_SESSION['scriptcase']['menu_main']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_PFM_Staff'];
        }
    }
}
...
$contr_menu_main = new menu_main_class;
$contr_menu_main->menu_main_menu();
