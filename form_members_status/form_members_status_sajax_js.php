  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_members_status" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_members_status_form();
        }
...
?>
  ...
  // ---------- Validate status
  function do_ajax_form_members_status_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldText(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_validate_status(var_status, var_script_case_init, do_ajax_form_members_status_validate_status_cb);
  } // do_ajax_form_members_status_validate_status

  function do_ajax_form_members_status_validate_status_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_validate_status_cb

  // ---------- Validate active
  function do_ajax_form_members_status_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldSelect(nomeCampo_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_validate_active(var_active, var_script_case_init, do_ajax_form_members_status_validate_active_cb);
  } // do_ajax_form_members_status_validate_active

  function do_ajax_form_members_status_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_validate_active_cb

  // ---------- Validate status_descript
  function do_ajax_form_members_status_validate_status_descript()
  {
    var nomeCampo_status_descript = "status_descript";
    var var_status_descript = scAjaxGetFieldText(nomeCampo_status_descript);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_validate_status_descript(var_status_descript, var_script_case_init, do_ajax_form_members_status_validate_status_descript_cb);
  } // do_ajax_form_members_status_validate_status_descript

  function do_ajax_form_members_status_validate_status_descript_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_validate_status_descript_cb

  // ---------- Validate sort_by
  function do_ajax_form_members_status_validate_sort_by()
  {
    var nomeCampo_sort_by = "sort_by";
    var var_sort_by = scAjaxGetFieldText(nomeCampo_sort_by);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_validate_sort_by(var_sort_by, var_script_case_init, do_ajax_form_members_status_validate_sort_by_cb);
  } // do_ajax_form_members_status_validate_sort_by

  function do_ajax_form_members_status_validate_sort_by_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sort_by";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_validate_sort_by_cb

  // ---------- Validate msg_subject
  function do_ajax_form_members_status_validate_msg_subject()
  {
    var nomeCampo_msg_subject = "msg_subject";
    var var_msg_subject = scAjaxGetFieldText(nomeCampo_msg_subject);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_validate_msg_subject(var_msg_subject, var_script_case_init, do_ajax_form_members_status_validate_msg_subject_cb);
  } // do_ajax_form_members_status_validate_msg_subject

  function do_ajax_form_members_status_validate_msg_subject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_validate_msg_subject_cb

  // ---------- Validate msg_body
  function do_ajax_form_members_status_validate_msg_body()
  {
    var nomeCampo_msg_body = "msg_body";
    var var_msg_body = scAjaxGetFieldEditorHtml(nomeCampo_msg_body);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_validate_msg_body(var_msg_body, var_script_case_init, do_ajax_form_members_status_validate_msg_body_cb);
  } // do_ajax_form_members_status_validate_msg_body

  function do_ajax_form_members_status_validate_msg_body_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_validate_msg_body_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_members_status_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_members_status_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_members_status_submit_form(var_status, var_active, var_status_descript, var_sort_by, var_msg_subject, var_msg_body, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_members_status_submit_form_cb);
  } // do_ajax_form_members_status_submit_form

  function do_ajax_form_members_status_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_members_status_submit_form_cb_after_alert);
  } // do_ajax_form_members_status_submit_form_cb
  function do_ajax_form_members_status_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_members_status_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_members_status_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_members_status_navigate_form, function() {});
    } else {
      perform_ajax_form_members_status_navigate_form();
    }
  }

  function perform_ajax_form_members_status_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_members_status_navigate_form(var_memb_status_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_members_status_navigate_form_cb);
  } // do_ajax_form_members_status_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_status']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_members_status_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_members_status_navigate_form_cb_after_alert);
  } // do_ajax_form_members_status_navigate_form_cb
  function do_ajax_form_members_status_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_members_status_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_members_status_navigate_form_cb_after_alert

  function sc_hide_form_members_status_form()
  {
