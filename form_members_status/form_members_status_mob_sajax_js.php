  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_members_status_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_members_status_mob_form();
        }
...
?>
  ...
  // ---------- Validate status
  function do_ajax_form_members_status_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldText(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_mob_validate_status(var_status, var_script_case_init, do_ajax_form_members_status_mob_validate_status_cb);
  } // do_ajax_form_members_status_mob_validate_status

  function do_ajax_form_members_status_mob_validate_status_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_mob_validate_status_cb

  // ---------- Validate active
  function do_ajax_form_members_status_mob_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldSelect(nomeCampo_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_mob_validate_active(var_active, var_script_case_init, do_ajax_form_members_status_mob_validate_active_cb);
  } // do_ajax_form_members_status_mob_validate_active

  function do_ajax_form_members_status_mob_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_mob_validate_active_cb

  // ---------- Validate status_descript
  function do_ajax_form_members_status_mob_validate_status_descript()
  {
    var nomeCampo_status_descript = "status_descript";
    var var_status_descript = scAjaxGetFieldText(nomeCampo_status_descript);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_mob_validate_status_descript(var_status_descript, var_script_case_init, do_ajax_form_members_status_mob_validate_status_descript_cb);
  } // do_ajax_form_members_status_mob_validate_status_descript

  function do_ajax_form_members_status_mob_validate_status_descript_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status_descript";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_mob_validate_status_descript_cb

  // ---------- Validate sort_by
  function do_ajax_form_members_status_mob_validate_sort_by()
  {
    var nomeCampo_sort_by = "sort_by";
    var var_sort_by = scAjaxGetFieldText(nomeCampo_sort_by);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_mob_validate_sort_by(var_sort_by, var_script_case_init, do_ajax_form_members_status_mob_validate_sort_by_cb);
  } // do_ajax_form_members_status_mob_validate_sort_by

  function do_ajax_form_members_status_mob_validate_sort_by_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sort_by";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_mob_validate_sort_by_cb

  // ---------- Validate msg_subject
  function do_ajax_form_members_status_mob_validate_msg_subject()
  {
    var nomeCampo_msg_subject = "msg_subject";
    var var_msg_subject = scAjaxGetFieldText(nomeCampo_msg_subject);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_mob_validate_msg_subject(var_msg_subject, var_script_case_init, do_ajax_form_members_status_mob_validate_msg_subject_cb);
  } // do_ajax_form_members_status_mob_validate_msg_subject

  function do_ajax_form_members_status_mob_validate_msg_subject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "msg_subject";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_mob_validate_msg_subject_cb

  // ---------- Validate msg_body
  function do_ajax_form_members_status_mob_validate_msg_body()
  {
    var nomeCampo_msg_body = "msg_body";
    var var_msg_body = scAjaxGetFieldEditorHtml(nomeCampo_msg_body);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_status_mob_validate_msg_body(var_msg_body, var_script_case_init, do_ajax_form_members_status_mob_validate_msg_body_cb);
  } // do_ajax_form_members_status_mob_validate_msg_body

  function do_ajax_form_members_status_mob_validate_msg_body_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "msg_body";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_status_mob_validate_msg_body_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_members_status_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_members_status_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_status = scAjaxGetFieldText("status");
    var var_active = scAjaxGetFieldSelect("active");
    var var_status_descript = scAjaxGetFieldText("status_descript");
    var var_sort_by = scAjaxGetFieldText("sort_by");
    var var_msg_subject = scAjaxGetFieldText("msg_subject");
    var var_msg_body = scAjaxGetFieldEditorHtml("msg_body");
    var var_memb_status_id = scAjaxGetFieldText("memb_status_id");
    ...
    scAjaxProcOn();
    x_ajax_form_members_status_mob_submit_form(var_status, var_active, var_status_descript, var_sort_by, var_msg_subject, var_msg_body, var_memb_status_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_members_status_mob_submit_form_cb);
  } // do_ajax_form_members_status_mob_submit_form

  function do_ajax_form_members_status_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("status_descript");
      scAjaxHideErrorDisplay("sort_by");
      scAjaxHideErrorDisplay("msg_subject");
      scAjaxHideErrorDisplay("msg_body");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_members_status_mob_submit_form_cb_after_alert);
  } // do_ajax_form_members_status_mob_submit_form_cb
  function do_ajax_form_members_status_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_members_status_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_members_status_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_members_status_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_members_status_mob_navigate_form();
    }
  }

  function perform_ajax_form_members_status_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("msg_subject");
    scAjaxHideErrorDisplay("msg_body");
    var var_memb_status_id = document.F2.memb_status_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_members_status_mob_navigate_form(var_memb_status_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_members_status_mob_navigate_form_cb);
  } // do_ajax_form_members_status_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_status_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_members_status_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.memb_status_id.value = scAjaxGetKeyValue("memb_status_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_members_status_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_members_status_mob_navigate_form_cb
  function do_ajax_form_members_status_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_members_status_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_members_status_mob_navigate_form_cb_after_alert

  function sc_hide_form_members_status_mob_form()
  {
  ...
  ajax_field_list[2] = "status_descript";
  ajax_field_list[3] = "sort_by";
  ajax_field_list[4] = "msg_subject";
  ajax_field_list[5] = "msg_body";
  ...
  var ajax_error_list = {
    ...
    "status_descript": {"label": "Description", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sort_by": {"label": "Sort By", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "msg_subject": {"label": "Subject", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "msg_body": {"label": "Message", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "status": new Array(),
    "active": new Array(),
    "status_descript": new Array(),
    "sort_by": new Array(),
    "msg_subject": new Array(),
    "msg_body": new Array()
  };
  ajax_field_mult["status"][1] = "status";
  ajax_field_mult["active"][1] = "active";
  ajax_field_mult["status_descript"][1] = "status_descript";
  ajax_field_mult["sort_by"][1] = "sort_by";
  ajax_field_mult["msg_subject"][1] = "msg_subject";
  ajax_field_mult["msg_body"][1] = "msg_body";
  ...
  var ajax_field_id = {
    ...
    "status_descript": new Array("hidden_field_label_status_descript", "hidden_field_data_status_descript"),
    "sort_by": new Array("hidden_field_label_sort_by", "hidden_field_data_sort_by"),
    "msg_subject": new Array("hidden_field_label_msg_subject", "hidden_field_data_msg_subject"),
    "msg_body": new Array("hidden_field_label_msg_body", "hidden_field_data_msg_body")
  };
