  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_members_det_appn_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_members_det_appn_mob_form();
        }
...
?>
  ...
  function do_ajax_form_members_det_appn_mob_validate_member_name()
  {
    var nomeCampo_member_name = "member_name";
    var var_member_name = scAjaxGetFieldText(nomeCampo_member_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_appn_mob_validate_member_name(var_member_name, var_script_case_init, do_ajax_form_members_det_appn_mob_validate_member_name_cb);
  } // do_ajax_form_members_det_appn_mob_validate_member_name

  function do_ajax_form_members_det_appn_mob_validate_member_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "member_name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_appn_mob_validate_member_name_cb

  // ---------- Validate email
  function do_ajax_form_members_det_appn_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_appn_mob_validate_email(var_email, var_script_case_init, do_ajax_form_members_det_appn_mob_validate_email_cb);
  } // do_ajax_form_members_det_appn_mob_validate_email

  function do_ajax_form_members_det_appn_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_appn_mob_validate_email_cb

  // ---------- Validate phone1
  function do_ajax_form_members_det_appn_mob_validate_phone1()
  {
    var nomeCampo_phone1 = "phone1";
    var var_phone1 = scAjaxGetFieldText(nomeCampo_phone1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_appn_mob_validate_phone1(var_phone1, var_script_case_init, do_ajax_form_members_det_appn_mob_validate_phone1_cb);
  } // do_ajax_form_members_det_appn_mob_validate_phone1

  function do_ajax_form_members_det_appn_mob_validate_phone1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "phone1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_appn_mob_validate_phone1_cb

  // ---------- Validate main_contact
  function do_ajax_form_members_det_appn_mob_validate_main_contact()
  {
    var nomeCampo_main_contact = "main_contact";
    var var_main_contact = scAjaxGetFieldRadio(nomeCampo_main_contact);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_appn_mob_validate_main_contact(var_main_contact, var_script_case_init, do_ajax_form_members_det_appn_mob_validate_main_contact_cb);
  } // do_ajax_form_members_det_appn_mob_validate_main_contact

  function do_ajax_form_members_det_appn_mob_validate_main_contact_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_appn_mob_validate_main_contact_cb

  // ---------- Validate driver_lic_id
  function do_ajax_form_members_det_appn_mob_validate_driver_lic_id()
  {
    var nomeCampo_driver_lic_id = "driver_lic_id";
    var var_driver_lic_id = scAjaxGetFieldText(nomeCampo_driver_lic_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_appn_mob_validate_driver_lic_id(var_driver_lic_id, var_script_case_init, do_ajax_form_members_det_appn_mob_validate_driver_lic_id_cb);
  } // do_ajax_form_members_det_appn_mob_validate_driver_lic_id

  function do_ajax_form_members_det_appn_mob_validate_driver_lic_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "driver_lic_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_appn_mob_validate_driver_lic_id_cb

  // ---------- Validate note
  function do_ajax_form_members_det_appn_mob_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldText(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_appn_mob_validate_note(var_note, var_script_case_init, do_ajax_form_members_det_appn_mob_validate_note_cb);
  } // do_ajax_form_members_det_appn_mob_validate_note

  function do_ajax_form_members_det_appn_mob_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_appn_mob_validate_note_cb

  // ---------- Validate members_list
  function do_ajax_form_members_det_appn_mob_validate_members_list()
  {
    var nomeCampo_members_list = "members_list";
    var var_members_list = scAjaxGetFieldText(nomeCampo_members_list);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_appn_mob_validate_members_list(var_members_list, var_script_case_init, do_ajax_form_members_det_appn_mob_validate_members_list_cb);
  } // do_ajax_form_members_det_appn_mob_validate_members_list

  function do_ajax_form_members_det_appn_mob_validate_members_list_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "members_list";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_appn_mob_validate_members_list_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_members_det_appn_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_members_det_appn_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_member_name = scAjaxGetFieldText("member_name");
    var var_email = scAjaxGetFieldText("email");
    var var_phone1 = scAjaxGetFieldText("phone1");
    var var_main_contact = scAjaxGetFieldRadio("main_contact");
    var var_driver_lic_id = scAjaxGetFieldText("driver_lic_id");
    var var_note = scAjaxGetFieldText("note");
    var var_member_id = scAjaxGetFieldText("member_id");
    var var_driver_lic_id_ul_name = scAjaxSpecCharProtect(document.F1.driver_lic_id_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_driver_lic_id_ul_type = document.F1.driver_lic_id_ul_type.value;
    var var_driver_lic_id_limpa = document.F1.driver_lic_id_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_members_det_appn_mob_submit_form(var_member_name, var_email, var_phone1, var_main_contact, var_driver_lic_id, var_note, var_member_id, var_driver_lic_id_ul_name, var_driver_lic_id_ul_type, var_driver_lic_id_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_members_det_appn_mob_submit_form_cb);
  } // do_ajax_form_members_det_appn_mob_submit_form

  function do_ajax_form_members_det_appn_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.driver_lic_id_limpa && document.F1.driver_lic_id_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("driver_lic_id", oImgTemp, "", "", "", "N");
      }
    document.F1.driver_lic_id_ul_name.value = '';
    document.F1.driver_lic_id_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_members_det_appn_mob_submit_form_cb_after_alert);
  } // do_ajax_form_members_det_appn_mob_submit_form_cb
  function do_ajax_form_members_det_appn_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_members_det_appn_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_members_appn"] = "off";

  function do_ajax_form_members_det_appn_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_members_det_appn_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_members_det_appn_mob_navigate_form();
    }
  }

  function perform_ajax_form_members_det_appn_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("note");
    scAjaxHideErrorDisplay("members_list");
    var var_member_id = document.F2.member_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_members_appn"] = "on";
    x_ajax_form_members_det_appn_mob_navigate_form(var_member_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_members_det_appn_mob_navigate_form_cb);
  } // do_ajax_form_members_det_appn_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_det_appn_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_members_det_appn_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.member_id.value = scAjaxGetKeyValue("member_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_members_appn"] && "nmsc_iframe_liga_grid_members_appn" != scMasterDetailIframe["nmsc_iframe_liga_grid_members_appn"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_members_appn"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_members_appn').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    document.F1.driver_lic_id_ul_name.value = '';
    document.F1.driver_lic_id_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_members_det_appn_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_members_det_appn_mob_navigate_form_cb
  function do_ajax_form_members_det_appn_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_members_det_appn_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_members_det_appn_mob_navigate_form_cb_after_alert

  function sc_hide_form_members_det_appn_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_members_appn"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "member_name";
  ajax_field_list[1] = "email";
  ajax_field_list[2] = "phone1";
  ajax_field_list[3] = "main_contact";
  ajax_field_list[4] = "driver_lic_id";
  ajax_field_list[5] = "note";
  ajax_field_list[6] = "members_list";
  ...
  var ajax_error_list = {
    "member_name": {"label": "Member Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "email": {"label": "Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "phone1": {"label": "Phone", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "main_contact": {"label": "Main Contact", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "driver_lic_id": {"label": "Driver Lic/ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "note": {"label": "Note", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "members_list": {"label": "members_list", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "member_name": new Array(),
    "email": new Array(),
    "phone1": new Array(),
    "main_contact": new Array(),
    "driver_lic_id": new Array(),
    "note": new Array(),
    "members_list": new Array()
  };
  ajax_field_mult["member_name"][1] = "member_name";
  ajax_field_mult["email"][1] = "email";
  ajax_field_mult["phone1"][1] = "phone1";
  ajax_field_mult["main_contact"][1] = "main_contact";
  ajax_field_mult["driver_lic_id"][1] = "driver_lic_id";
  ajax_field_mult["note"][1] = "note";
  ajax_field_mult["members_list"][1] = "members_list";

  var ajax_field_id = {
    "member_name": new Array("hidden_field_label_member_name", "hidden_field_data_member_name"),
    ...
    "driver_lic_id": new Array("hidden_field_label_driver_lic_id", "hidden_field_data_driver_lic_id"),
    "note": new Array("hidden_field_label_note", "hidden_field_data_note"),
    "members_list": new Array("hidden_field_label_members_list", "hidden_field_data_members_list")
  };
