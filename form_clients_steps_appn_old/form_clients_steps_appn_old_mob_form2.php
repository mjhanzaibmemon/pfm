<div id="form_clients_steps_appn_old_mob_form2" style='<?php echo (2 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_old_mob']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
