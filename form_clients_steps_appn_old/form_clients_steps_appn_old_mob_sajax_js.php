  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clients_steps_appn_old_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_clients_steps_appn_old_mob_form();
        }
...
?>
  ...
  // ---------- Validate dummy02
  function do_ajax_form_clients_steps_appn_old_mob_validate_dummy02()
  {
  } // do_ajax_form_clients_steps_appn_old_mob_validate_dummy02

  function do_ajax_form_clients_steps_appn_old_mob_validate_dummy02_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_dummy02_cb

  // ---------- Validate dummy03
  function do_ajax_form_clients_steps_appn_old_mob_validate_dummy03()
  {
  } // do_ajax_form_clients_steps_appn_old_mob_validate_dummy03

  function do_ajax_form_clients_steps_appn_old_mob_validate_dummy03_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy03";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_dummy03_cb

  // ---------- Validate co_name
  function do_ajax_form_clients_steps_appn_old_mob_validate_co_name()
  {
    var nomeCampo_co_name = "co_name";
    var var_co_name = scAjaxGetFieldText(nomeCampo_co_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_co_name(var_co_name, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_co_name_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_co_name

  function do_ajax_form_clients_steps_appn_old_mob_validate_co_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "co_name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_co_name_cb

  // ---------- Validate client_id
  function do_ajax_form_clients_steps_appn_old_mob_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldHidden(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_client_id_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_client_id

  function do_ajax_form_clients_steps_appn_old_mob_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_client_id_cb

  // ---------- Validate mailing_address
  function do_ajax_form_clients_steps_appn_old_mob_validate_mailing_address()
  {
    var nomeCampo_mailing_address = "mailing_address";
    var var_mailing_address = scAjaxGetFieldText(nomeCampo_mailing_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_mailing_address(var_mailing_address, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_mailing_address_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_mailing_address

  function do_ajax_form_clients_steps_appn_old_mob_validate_mailing_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_mailing_address_cb

  // ---------- Validate appn_date
  function do_ajax_form_clients_steps_appn_old_mob_validate_appn_date()
  {
    var nomeCampo_appn_date = "appn_date";
    var var_appn_date = scAjaxGetFieldHidden(nomeCampo_appn_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_appn_date(var_appn_date, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_appn_date_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_appn_date

  function do_ajax_form_clients_steps_appn_old_mob_validate_appn_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_appn_date_cb

  // ---------- Validate city
  function do_ajax_form_clients_steps_appn_old_mob_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_city(var_city, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_city_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_city

  function do_ajax_form_clients_steps_appn_old_mob_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_city_cb

  // ---------- Validate bus_cat_id
  function do_ajax_form_clients_steps_appn_old_mob_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldSelect(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_bus_cat_id_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_bus_cat_id

  function do_ajax_form_clients_steps_appn_old_mob_validate_bus_cat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_bus_cat_id_cb

  // ---------- Validate state
  function do_ajax_form_clients_steps_appn_old_mob_validate_state()
  {
    var nomeCampo_state = "state";
    var var_state = scAjaxGetFieldText(nomeCampo_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_state(var_state, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_state_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_state

  function do_ajax_form_clients_steps_appn_old_mob_validate_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "state";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_state_cb

  // ---------- Validate bus_subcat_id
  function do_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_id()
  {
    var nomeCampo_bus_subcat_id = "bus_subcat_id";
    var var_bus_subcat_id = scAjaxGetFieldSelect(nomeCampo_bus_subcat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_id(var_bus_subcat_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_id_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_id

  function do_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_id_cb

  // ---------- Validate zip_code
  function do_ajax_form_clients_steps_appn_old_mob_validate_zip_code()
  {
    var nomeCampo_zip_code = "zip_code";
    var var_zip_code = scAjaxGetFieldText(nomeCampo_zip_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_zip_code(var_zip_code, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_zip_code_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_zip_code

  function do_ajax_form_clients_steps_appn_old_mob_validate_zip_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_zip_code_cb

  // ---------- Validate bus_subcat_other
  function do_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_other()
  {
    var nomeCampo_bus_subcat_other = "bus_subcat_other";
    var var_bus_subcat_other = scAjaxGetFieldText(nomeCampo_bus_subcat_other);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_other(var_bus_subcat_other, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_other_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_other

  function do_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_other_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_bus_subcat_other_cb

  // ---------- Validate phone_number
  function do_ajax_form_clients_steps_appn_old_mob_validate_phone_number()
  {
    var nomeCampo_phone_number = "phone_number";
    var var_phone_number = scAjaxGetFieldText(nomeCampo_phone_number);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_phone_number(var_phone_number, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_phone_number_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_phone_number

  function do_ajax_form_clients_steps_appn_old_mob_validate_phone_number_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_phone_number_cb

  // ---------- Validate website_url
  function do_ajax_form_clients_steps_appn_old_mob_validate_website_url()
  {
    var nomeCampo_website_url = "website_url";
    var var_website_url = scAjaxGetFieldText(nomeCampo_website_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_website_url(var_website_url, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_website_url_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_website_url

  function do_ajax_form_clients_steps_appn_old_mob_validate_website_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_website_url_cb

  // ---------- Validate email
  function do_ajax_form_clients_steps_appn_old_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_email(var_email, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_email_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_email

  function do_ajax_form_clients_steps_appn_old_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_email_cb

  // ---------- Validate acct_instagram
  function do_ajax_form_clients_steps_appn_old_mob_validate_acct_instagram()
  {
    var nomeCampo_acct_instagram = "acct_instagram";
    var var_acct_instagram = scAjaxGetFieldText(nomeCampo_acct_instagram);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_acct_instagram(var_acct_instagram, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_acct_instagram_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_acct_instagram

  function do_ajax_form_clients_steps_appn_old_mob_validate_acct_instagram_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_acct_instagram_cb

  // ---------- Validate dummy01
  function do_ajax_form_clients_steps_appn_old_mob_validate_dummy01()
  {
  } // do_ajax_form_clients_steps_appn_old_mob_validate_dummy01

  function do_ajax_form_clients_steps_appn_old_mob_validate_dummy01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_dummy01_cb

  // ---------- Validate acct_facebook
  function do_ajax_form_clients_steps_appn_old_mob_validate_acct_facebook()
  {
    var nomeCampo_acct_facebook = "acct_facebook";
    var var_acct_facebook = scAjaxGetFieldText(nomeCampo_acct_facebook);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_acct_facebook(var_acct_facebook, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_acct_facebook_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_acct_facebook

  function do_ajax_form_clients_steps_appn_old_mob_validate_acct_facebook_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_acct_facebook_cb

  // ---------- Validate dummy04
  function do_ajax_form_clients_steps_appn_old_mob_validate_dummy04()
  {
  } // do_ajax_form_clients_steps_appn_old_mob_validate_dummy04

  function do_ajax_form_clients_steps_appn_old_mob_validate_dummy04_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy04";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_dummy04_cb

  // ---------- Validate memb_01
  function do_ajax_form_clients_steps_appn_old_mob_validate_memb_01()
  {
  } // do_ajax_form_clients_steps_appn_old_mob_validate_memb_01

  function do_ajax_form_clients_steps_appn_old_mob_validate_memb_01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "memb_01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_memb_01_cb

  // ---------- Validate member1_name
  function do_ajax_form_clients_steps_appn_old_mob_validate_member1_name()
  {
    var nomeCampo_member1_name = "member1_name";
    var var_member1_name = scAjaxGetFieldText(nomeCampo_member1_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member1_name(var_member1_name, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member1_name_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member1_name

  function do_ajax_form_clients_steps_appn_old_mob_validate_member1_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member1_name_cb

  // ---------- Validate member1_phone
  function do_ajax_form_clients_steps_appn_old_mob_validate_member1_phone()
  {
    var nomeCampo_member1_phone = "member1_phone";
    var var_member1_phone = scAjaxGetFieldText(nomeCampo_member1_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member1_phone(var_member1_phone, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member1_phone_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member1_phone

  function do_ajax_form_clients_steps_appn_old_mob_validate_member1_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member1_phone_cb

  // ---------- Validate member1_email
  function do_ajax_form_clients_steps_appn_old_mob_validate_member1_email()
  {
    var nomeCampo_member1_email = "member1_email";
    var var_member1_email = scAjaxGetFieldText(nomeCampo_member1_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member1_email(var_member1_email, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member1_email_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member1_email

  function do_ajax_form_clients_steps_appn_old_mob_validate_member1_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member1_email_cb

  // ---------- Validate member1_main_cont
  function do_ajax_form_clients_steps_appn_old_mob_validate_member1_main_cont()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member1_main_cont(var_member1_main_cont, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member1_main_cont_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member1_main_cont

  function do_ajax_form_clients_steps_appn_old_mob_validate_member1_main_cont_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member1_main_cont_cb

  // ---------- Validate member1_driver_lic_id
  function do_ajax_form_clients_steps_appn_old_mob_validate_member1_driver_lic_id()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member1_driver_lic_id(var_member1_driver_lic_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member1_driver_lic_id_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member1_driver_lic_id

  function do_ajax_form_clients_steps_appn_old_mob_validate_member1_driver_lic_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member1_driver_lic_id_cb

  // ---------- Validate memb_02
  function do_ajax_form_clients_steps_appn_old_mob_validate_memb_02()
  {
  } // do_ajax_form_clients_steps_appn_old_mob_validate_memb_02

  function do_ajax_form_clients_steps_appn_old_mob_validate_memb_02_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "memb_02";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_memb_02_cb

  // ---------- Validate member2_name
  function do_ajax_form_clients_steps_appn_old_mob_validate_member2_name()
  {
    var nomeCampo_member2_name = "member2_name";
    var var_member2_name = scAjaxGetFieldText(nomeCampo_member2_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member2_name(var_member2_name, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member2_name_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member2_name

  function do_ajax_form_clients_steps_appn_old_mob_validate_member2_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member2_name_cb

  // ---------- Validate member2_phone
  function do_ajax_form_clients_steps_appn_old_mob_validate_member2_phone()
  {
    var nomeCampo_member2_phone = "member2_phone";
    var var_member2_phone = scAjaxGetFieldText(nomeCampo_member2_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member2_phone(var_member2_phone, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member2_phone_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member2_phone

  function do_ajax_form_clients_steps_appn_old_mob_validate_member2_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member2_phone_cb

  // ---------- Validate member2_email
  function do_ajax_form_clients_steps_appn_old_mob_validate_member2_email()
  {
    var nomeCampo_member2_email = "member2_email";
    var var_member2_email = scAjaxGetFieldText(nomeCampo_member2_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member2_email(var_member2_email, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member2_email_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member2_email

  function do_ajax_form_clients_steps_appn_old_mob_validate_member2_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member2_email_cb

  // ---------- Validate member2_main_cont
  function do_ajax_form_clients_steps_appn_old_mob_validate_member2_main_cont()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member2_main_cont(var_member2_main_cont, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member2_main_cont_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member2_main_cont

  function do_ajax_form_clients_steps_appn_old_mob_validate_member2_main_cont_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member2_main_cont_cb

  // ---------- Validate member2_driver_lic_id
  function do_ajax_form_clients_steps_appn_old_mob_validate_member2_driver_lic_id()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member2_driver_lic_id(var_member2_driver_lic_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member2_driver_lic_id_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member2_driver_lic_id

  function do_ajax_form_clients_steps_appn_old_mob_validate_member2_driver_lic_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member2_driver_lic_id_cb

  // ---------- Validate memb_03
  function do_ajax_form_clients_steps_appn_old_mob_validate_memb_03()
  {
  } // do_ajax_form_clients_steps_appn_old_mob_validate_memb_03

  function do_ajax_form_clients_steps_appn_old_mob_validate_memb_03_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "memb_03";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_memb_03_cb

  // ---------- Validate member3_name
  function do_ajax_form_clients_steps_appn_old_mob_validate_member3_name()
  {
    var nomeCampo_member3_name = "member3_name";
    var var_member3_name = scAjaxGetFieldText(nomeCampo_member3_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member3_name(var_member3_name, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member3_name_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member3_name

  function do_ajax_form_clients_steps_appn_old_mob_validate_member3_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member3_name_cb

  // ---------- Validate member3_phone
  function do_ajax_form_clients_steps_appn_old_mob_validate_member3_phone()
  {
    var nomeCampo_member3_phone = "member3_phone";
    var var_member3_phone = scAjaxGetFieldText(nomeCampo_member3_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member3_phone(var_member3_phone, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member3_phone_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member3_phone

  function do_ajax_form_clients_steps_appn_old_mob_validate_member3_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member3_phone_cb

  // ---------- Validate member3_email
  function do_ajax_form_clients_steps_appn_old_mob_validate_member3_email()
  {
    var nomeCampo_member3_email = "member3_email";
    var var_member3_email = scAjaxGetFieldText(nomeCampo_member3_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member3_email(var_member3_email, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member3_email_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member3_email

  function do_ajax_form_clients_steps_appn_old_mob_validate_member3_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member3_email_cb

  // ---------- Validate member3_main_cont
  function do_ajax_form_clients_steps_appn_old_mob_validate_member3_main_cont()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member3_main_cont(var_member3_main_cont, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member3_main_cont_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member3_main_cont

  function do_ajax_form_clients_steps_appn_old_mob_validate_member3_main_cont_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member3_main_cont_cb

  // ---------- Validate member3_drive_lic_id
  function do_ajax_form_clients_steps_appn_old_mob_validate_member3_drive_lic_id()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_member3_drive_lic_id(var_member3_drive_lic_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_member3_drive_lic_id_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member3_drive_lic_id

  function do_ajax_form_clients_steps_appn_old_mob_validate_member3_drive_lic_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_member3_drive_lic_id_cb

  // ---------- Validate dummy05
  function do_ajax_form_clients_steps_appn_old_mob_validate_dummy05()
  {
  } // do_ajax_form_clients_steps_appn_old_mob_validate_dummy05

  function do_ajax_form_clients_steps_appn_old_mob_validate_dummy05_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy05";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_dummy05_cb

  // ---------- Validate doc_sec_of_state
  function do_ajax_form_clients_steps_appn_old_mob_validate_doc_sec_of_state()
  {
    var nomeCampo_doc_sec_of_state = "doc_sec_of_state";
    var var_doc_sec_of_state = scAjaxGetFieldText(nomeCampo_doc_sec_of_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_doc_sec_of_state(var_doc_sec_of_state, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_doc_sec_of_state_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_doc_sec_of_state

  function do_ajax_form_clients_steps_appn_old_mob_validate_doc_sec_of_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_doc_sec_of_state_cb

  // ---------- Validate doc_city_bus_lic
  function do_ajax_form_clients_steps_appn_old_mob_validate_doc_city_bus_lic()
  {
    var nomeCampo_doc_city_bus_lic = "doc_city_bus_lic";
    var var_doc_city_bus_lic = scAjaxGetFieldText(nomeCampo_doc_city_bus_lic);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_doc_city_bus_lic(var_doc_city_bus_lic, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_doc_city_bus_lic_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_doc_city_bus_lic

  function do_ajax_form_clients_steps_appn_old_mob_validate_doc_city_bus_lic_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_doc_city_bus_lic_cb

  // ---------- Validate doc_agric_lic
  function do_ajax_form_clients_steps_appn_old_mob_validate_doc_agric_lic()
  {
    var nomeCampo_doc_agric_lic = "doc_agric_lic";
    var var_doc_agric_lic = scAjaxGetFieldText(nomeCampo_doc_agric_lic);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_doc_agric_lic(var_doc_agric_lic, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_doc_agric_lic_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_doc_agric_lic

  function do_ajax_form_clients_steps_appn_old_mob_validate_doc_agric_lic_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_doc_agric_lic_cb

  // ---------- Validate doc_last_year_tax
  function do_ajax_form_clients_steps_appn_old_mob_validate_doc_last_year_tax()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_doc_last_year_tax(var_doc_last_year_tax, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_doc_last_year_tax_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_doc_last_year_tax

  function do_ajax_form_clients_steps_appn_old_mob_validate_doc_last_year_tax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_doc_last_year_tax_cb

  // ---------- Validate appn_note
  function do_ajax_form_clients_steps_appn_old_mob_validate_appn_note()
  {
    var nomeCampo_appn_note = "appn_note";
    var var_appn_note = scAjaxGetFieldEditorHtml(nomeCampo_appn_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_appn_note(var_appn_note, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_appn_note_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_appn_note

  function do_ajax_form_clients_steps_appn_old_mob_validate_appn_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_appn_note_cb

  // ---------- Validate read_at_sign
  function do_ajax_form_clients_steps_appn_old_mob_validate_read_at_sign()
  {
  } // do_ajax_form_clients_steps_appn_old_mob_validate_read_at_sign

  function do_ajax_form_clients_steps_appn_old_mob_validate_read_at_sign_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_read_at_sign_cb

  // ---------- Validate applicant_name
  function do_ajax_form_clients_steps_appn_old_mob_validate_applicant_name()
  {
    var nomeCampo_applicant_name = "applicant_name";
    var var_applicant_name = scAjaxGetFieldText(nomeCampo_applicant_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_applicant_name(var_applicant_name, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_applicant_name_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_applicant_name

  function do_ajax_form_clients_steps_appn_old_mob_validate_applicant_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_applicant_name_cb

  // ---------- Validate applicant_title
  function do_ajax_form_clients_steps_appn_old_mob_validate_applicant_title()
  {
    var nomeCampo_applicant_title = "applicant_title";
    var var_applicant_title = scAjaxGetFieldText(nomeCampo_applicant_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_applicant_title(var_applicant_title, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_applicant_title_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_applicant_title

  function do_ajax_form_clients_steps_appn_old_mob_validate_applicant_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_applicant_title_cb

  // ---------- Validate applicant_signature
  function do_ajax_form_clients_steps_appn_old_mob_validate_applicant_signature()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_mob_validate_applicant_signature(var_applicant_signature, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_validate_applicant_signature_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_validate_applicant_signature

  function do_ajax_form_clients_steps_appn_old_mob_validate_applicant_signature_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_validate_applicant_signature_cb

  // ---------- Refresh bus_cat_id
  function do_ajax_form_clients_steps_appn_old_mob_refresh_bus_cat_id()
  {
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    var var_nmgp_refresh_fields = "bus_subcat_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_old_mob_refresh_bus_cat_id(var_bus_cat_id, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_refresh_bus_cat_id_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_refresh_bus_cat_id

  function do_ajax_form_clients_steps_appn_old_mob_refresh_bus_cat_id_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_mob_refresh_bus_cat_id_cb

  // ---------- Event onchange bus_subcat_id
  function do_ajax_form_clients_steps_appn_old_mob_event_bus_subcat_id_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_old_mob_event_bus_subcat_id_onchange(var_bus_subcat_id, var_bus_subcat_other, var_bus_cat_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_event_bus_subcat_id_onchange_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_event_bus_subcat_id_onchange

  function do_ajax_form_clients_steps_appn_old_mob_event_bus_subcat_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bus_subcat_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_old_mob_event_bus_subcat_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_old_mob_event_bus_subcat_id_onchange_cb
  function do_ajax_form_clients_steps_appn_old_mob_event_bus_subcat_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_old_mob_event_bus_subcat_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clients_steps_appn_old_mob_submit_page_0(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_old_mob_submit_page_0(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      url: "form_clients_steps_appn_old_mob.php",
      method: "POST",
      dataType: "json",
      data: {
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_0(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_old_mob_submit_page_0

  function do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_0(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
  ...
  } // do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_0

  function do_ajax_form_clients_steps_appn_old_mob_submit_page_1(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_old_mob_submit_page_1(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_1(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_old_mob_submit_page_1

  function do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_1(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_1

  function do_ajax_form_clients_steps_appn_old_mob_submit_page_2(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_old_mob_submit_page_2(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_2(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_old_mob_submit_page_2

  function do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_2(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_2

  function do_ajax_form_clients_steps_appn_old_mob_submit_page_3(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_old_mob_submit_page_3(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_3(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_old_mob_submit_page_3

  function do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_3(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_old_mob_submit_page_cb_3

  function do_ajax_form_clients_steps_appn_old_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_old_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clients_steps_appn_old_mob_submit_form_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_old_mob_submit_form_cb
  function do_ajax_form_clients_steps_appn_old_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clients_steps_appn_old_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_clients_steps_appn_old_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clients_steps_appn_old_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_clients_steps_appn_old_mob_navigate_form();
    }
  }

  function perform_ajax_form_clients_steps_appn_old_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_clients_steps_appn_old_mob_navigate_form(var_client_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clients_steps_appn_old_mob_navigate_form_cb);
  } // do_ajax_form_clients_steps_appn_old_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_old_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clients_steps_appn_old_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clients_steps_appn_old_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_old_mob_navigate_form_cb
  function do_ajax_form_clients_steps_appn_old_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clients_steps_appn_old_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_clients_steps_appn_old_mob_navigate_form_cb_after_alert

  function sc_hide_form_clients_steps_appn_old_mob_form()
  {
