<div id="form_clients_steps_appn_old_form1" style='<?php echo (1 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_old']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_old']['Lookup_member1_main_cont'][] = '1'; ?>
 <option  value="0" <?php  if ($this->member1_main_cont == "0") { echo " selected" ;} ?><?php  if (empty($this->member1_main_cont)) { echo " selected" ;} ?>>No</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_old']['Lookup_member1_main_cont'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_memb_01_dumb = ('' == $sStyleHidden_memb_01) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_memb_01_dumb" style="<?php echo $sStyleHidden_memb_01_dumb; ?>"></TD>
...
<?php $sStyleHidden_member1_main_cont_dumb = ('' == $sStyleHidden_member1_main_cont) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_member1_main_cont_dumb" style="<?php echo $sStyleHidden_member1_main_cont_dumb; ?>"></TD>
<?php $sStyleHidden_member1_driver_lic_id_dumb = ('' == $sStyleHidden_member1_driver_lic_id) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_member1_driver_lic_id_dumb" style="<?php echo $sStyleHidden_member1_driver_lic_id_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_old']['Lookup_member2_main_cont'][] = '1'; ?>
 <option  value="0" <?php  if ($this->member2_main_cont == "0") { echo " selected" ;} ?><?php  if (empty($this->member2_main_cont)) { echo " selected" ;} ?>>No</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_old']['Lookup_member2_main_cont'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_memb_02_dumb = ('' == $sStyleHidden_memb_02) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_memb_02_dumb" style="<?php echo $sStyleHidden_memb_02_dumb; ?>"></TD>
...
<?php $sStyleHidden_member2_main_cont_dumb = ('' == $sStyleHidden_member2_main_cont) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_member2_main_cont_dumb" style="<?php echo $sStyleHidden_member2_main_cont_dumb; ?>"></TD>
<?php $sStyleHidden_member2_driver_lic_id_dumb = ('' == $sStyleHidden_member2_driver_lic_id) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_member2_driver_lic_id_dumb" style="<?php echo $sStyleHidden_member2_driver_lic_id_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_old']['Lookup_member3_main_cont'][] = '1'; ?>
 <option  value="0" <?php  if ($this->member3_main_cont == "0") { echo " selected" ;} ?><?php  if (empty($this->member3_main_cont)) { echo " selected" ;} ?>>No</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_old']['Lookup_member3_main_cont'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_memb_03_dumb = ('' == $sStyleHidden_memb_03) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_memb_03_dumb" style="<?php echo $sStyleHidden_memb_03_dumb; ?>"></TD>
...
<?php $sStyleHidden_member3_main_cont_dumb = ('' == $sStyleHidden_member3_main_cont) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_member3_main_cont_dumb" style="<?php echo $sStyleHidden_member3_main_cont_dumb; ?>"></TD>
<?php $sStyleHidden_member3_drive_lic_id_dumb = ('' == $sStyleHidden_member3_drive_lic_id) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_member3_drive_lic_id_dumb" style="<?php echo $sStyleHidden_member3_drive_lic_id_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
