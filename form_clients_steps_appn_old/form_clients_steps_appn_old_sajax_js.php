  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clients_steps_appn_old" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_clients_steps_appn_old_form();
        }
...
?>
  ...
  // ---------- Validate dummy02
  function do_ajax_form_clients_steps_appn_old_validate_dummy02()
  {
  } // do_ajax_form_clients_steps_appn_old_validate_dummy02

  function do_ajax_form_clients_steps_appn_old_validate_dummy02_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_dummy02_cb

  // ---------- Validate dummy03
  function do_ajax_form_clients_steps_appn_old_validate_dummy03()
  {
  } // do_ajax_form_clients_steps_appn_old_validate_dummy03

  function do_ajax_form_clients_steps_appn_old_validate_dummy03_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy03";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_dummy03_cb

  // ---------- Validate co_name
  function do_ajax_form_clients_steps_appn_old_validate_co_name()
  {
    var nomeCampo_co_name = "co_name";
    var var_co_name = scAjaxGetFieldText(nomeCampo_co_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_co_name(var_co_name, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_co_name_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_co_name

  function do_ajax_form_clients_steps_appn_old_validate_co_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "co_name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_co_name_cb

  // ---------- Validate client_id
  function do_ajax_form_clients_steps_appn_old_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldHidden(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_client_id_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_client_id

  function do_ajax_form_clients_steps_appn_old_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_client_id_cb

  // ---------- Validate mailing_address
  function do_ajax_form_clients_steps_appn_old_validate_mailing_address()
  {
    var nomeCampo_mailing_address = "mailing_address";
    var var_mailing_address = scAjaxGetFieldText(nomeCampo_mailing_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_mailing_address(var_mailing_address, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_mailing_address_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_mailing_address

  function do_ajax_form_clients_steps_appn_old_validate_mailing_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_mailing_address_cb

  // ---------- Validate appn_date
  function do_ajax_form_clients_steps_appn_old_validate_appn_date()
  {
    var nomeCampo_appn_date = "appn_date";
    var var_appn_date = scAjaxGetFieldHidden(nomeCampo_appn_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_appn_date(var_appn_date, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_appn_date_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_appn_date

  function do_ajax_form_clients_steps_appn_old_validate_appn_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_appn_date_cb

  // ---------- Validate city
  function do_ajax_form_clients_steps_appn_old_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_city(var_city, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_city_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_city

  function do_ajax_form_clients_steps_appn_old_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_city_cb

  // ---------- Validate bus_cat_id
  function do_ajax_form_clients_steps_appn_old_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldSelect(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_bus_cat_id_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_bus_cat_id

  function do_ajax_form_clients_steps_appn_old_validate_bus_cat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_bus_cat_id_cb

  // ---------- Validate state
  function do_ajax_form_clients_steps_appn_old_validate_state()
  {
    var nomeCampo_state = "state";
    var var_state = scAjaxGetFieldText(nomeCampo_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_state(var_state, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_state_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_state

  function do_ajax_form_clients_steps_appn_old_validate_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "state";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_state_cb

  // ---------- Validate bus_subcat_id
  function do_ajax_form_clients_steps_appn_old_validate_bus_subcat_id()
  {
    var nomeCampo_bus_subcat_id = "bus_subcat_id";
    var var_bus_subcat_id = scAjaxGetFieldSelect(nomeCampo_bus_subcat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_bus_subcat_id(var_bus_subcat_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_bus_subcat_id_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_bus_subcat_id

  function do_ajax_form_clients_steps_appn_old_validate_bus_subcat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_bus_subcat_id_cb

  // ---------- Validate zip_code
  function do_ajax_form_clients_steps_appn_old_validate_zip_code()
  {
    var nomeCampo_zip_code = "zip_code";
    var var_zip_code = scAjaxGetFieldText(nomeCampo_zip_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_zip_code(var_zip_code, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_zip_code_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_zip_code

  function do_ajax_form_clients_steps_appn_old_validate_zip_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_zip_code_cb

  // ---------- Validate bus_subcat_other
  function do_ajax_form_clients_steps_appn_old_validate_bus_subcat_other()
  {
    var nomeCampo_bus_subcat_other = "bus_subcat_other";
    var var_bus_subcat_other = scAjaxGetFieldText(nomeCampo_bus_subcat_other);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_bus_subcat_other(var_bus_subcat_other, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_bus_subcat_other_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_bus_subcat_other

  function do_ajax_form_clients_steps_appn_old_validate_bus_subcat_other_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_bus_subcat_other_cb

  // ---------- Validate phone_number
  function do_ajax_form_clients_steps_appn_old_validate_phone_number()
  {
    var nomeCampo_phone_number = "phone_number";
    var var_phone_number = scAjaxGetFieldText(nomeCampo_phone_number);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_phone_number(var_phone_number, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_phone_number_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_phone_number

  function do_ajax_form_clients_steps_appn_old_validate_phone_number_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_phone_number_cb

  // ---------- Validate website_url
  function do_ajax_form_clients_steps_appn_old_validate_website_url()
  {
    var nomeCampo_website_url = "website_url";
    var var_website_url = scAjaxGetFieldText(nomeCampo_website_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_website_url(var_website_url, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_website_url_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_website_url

  function do_ajax_form_clients_steps_appn_old_validate_website_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_website_url_cb

  // ---------- Validate email
  function do_ajax_form_clients_steps_appn_old_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_email(var_email, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_email_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_email

  function do_ajax_form_clients_steps_appn_old_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_email_cb

  // ---------- Validate acct_instagram
  function do_ajax_form_clients_steps_appn_old_validate_acct_instagram()
  {
    var nomeCampo_acct_instagram = "acct_instagram";
    var var_acct_instagram = scAjaxGetFieldText(nomeCampo_acct_instagram);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_acct_instagram(var_acct_instagram, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_acct_instagram_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_acct_instagram

  function do_ajax_form_clients_steps_appn_old_validate_acct_instagram_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_acct_instagram_cb

  // ---------- Validate dummy01
  function do_ajax_form_clients_steps_appn_old_validate_dummy01()
  {
  } // do_ajax_form_clients_steps_appn_old_validate_dummy01

  function do_ajax_form_clients_steps_appn_old_validate_dummy01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_dummy01_cb

  // ---------- Validate acct_facebook
  function do_ajax_form_clients_steps_appn_old_validate_acct_facebook()
  {
    var nomeCampo_acct_facebook = "acct_facebook";
    var var_acct_facebook = scAjaxGetFieldText(nomeCampo_acct_facebook);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_acct_facebook(var_acct_facebook, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_acct_facebook_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_acct_facebook

  function do_ajax_form_clients_steps_appn_old_validate_acct_facebook_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_acct_facebook_cb

  // ---------- Validate dummy04
  function do_ajax_form_clients_steps_appn_old_validate_dummy04()
  {
  } // do_ajax_form_clients_steps_appn_old_validate_dummy04

  function do_ajax_form_clients_steps_appn_old_validate_dummy04_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy04";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_dummy04_cb

  // ---------- Validate memb_01
  function do_ajax_form_clients_steps_appn_old_validate_memb_01()
  {
  } // do_ajax_form_clients_steps_appn_old_validate_memb_01

  function do_ajax_form_clients_steps_appn_old_validate_memb_01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "memb_01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_memb_01_cb

  // ---------- Validate member1_name
  function do_ajax_form_clients_steps_appn_old_validate_member1_name()
  {
    var nomeCampo_member1_name = "member1_name";
    var var_member1_name = scAjaxGetFieldText(nomeCampo_member1_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member1_name(var_member1_name, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member1_name_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member1_name

  function do_ajax_form_clients_steps_appn_old_validate_member1_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member1_name_cb

  // ---------- Validate member1_phone
  function do_ajax_form_clients_steps_appn_old_validate_member1_phone()
  {
    var nomeCampo_member1_phone = "member1_phone";
    var var_member1_phone = scAjaxGetFieldText(nomeCampo_member1_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member1_phone(var_member1_phone, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member1_phone_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member1_phone

  function do_ajax_form_clients_steps_appn_old_validate_member1_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member1_phone_cb

  // ---------- Validate member1_email
  function do_ajax_form_clients_steps_appn_old_validate_member1_email()
  {
    var nomeCampo_member1_email = "member1_email";
    var var_member1_email = scAjaxGetFieldText(nomeCampo_member1_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member1_email(var_member1_email, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member1_email_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member1_email

  function do_ajax_form_clients_steps_appn_old_validate_member1_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member1_email_cb

  // ---------- Validate member1_main_cont
  function do_ajax_form_clients_steps_appn_old_validate_member1_main_cont()
  {
    var nomeCampo_member1_main_cont = "member1_main_cont";
    var var_member1_main_cont = scAjaxGetFieldSelect(nomeCampo_member1_main_cont);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member1_main_cont(var_member1_main_cont, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member1_main_cont_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member1_main_cont

  function do_ajax_form_clients_steps_appn_old_validate_member1_main_cont_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "member1_main_cont";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member1_main_cont_cb

  // ---------- Validate member1_driver_lic_id
  function do_ajax_form_clients_steps_appn_old_validate_member1_driver_lic_id()
  {
    var nomeCampo_member1_driver_lic_id = "member1_driver_lic_id";
    var var_member1_driver_lic_id = scAjaxGetFieldText(nomeCampo_member1_driver_lic_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member1_driver_lic_id(var_member1_driver_lic_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member1_driver_lic_id_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member1_driver_lic_id

  function do_ajax_form_clients_steps_appn_old_validate_member1_driver_lic_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "member1_driver_lic_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member1_driver_lic_id_cb

  // ---------- Validate memb_02
  function do_ajax_form_clients_steps_appn_old_validate_memb_02()
  {
  } // do_ajax_form_clients_steps_appn_old_validate_memb_02

  function do_ajax_form_clients_steps_appn_old_validate_memb_02_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "memb_02";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_memb_02_cb

  // ---------- Validate member2_name
  function do_ajax_form_clients_steps_appn_old_validate_member2_name()
  {
    var nomeCampo_member2_name = "member2_name";
    var var_member2_name = scAjaxGetFieldText(nomeCampo_member2_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member2_name(var_member2_name, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member2_name_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member2_name

  function do_ajax_form_clients_steps_appn_old_validate_member2_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member2_name_cb

  // ---------- Validate member2_phone
  function do_ajax_form_clients_steps_appn_old_validate_member2_phone()
  {
    var nomeCampo_member2_phone = "member2_phone";
    var var_member2_phone = scAjaxGetFieldText(nomeCampo_member2_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member2_phone(var_member2_phone, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member2_phone_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member2_phone

  function do_ajax_form_clients_steps_appn_old_validate_member2_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member2_phone_cb

  // ---------- Validate member2_email
  function do_ajax_form_clients_steps_appn_old_validate_member2_email()
  {
    var nomeCampo_member2_email = "member2_email";
    var var_member2_email = scAjaxGetFieldText(nomeCampo_member2_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member2_email(var_member2_email, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member2_email_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member2_email

  function do_ajax_form_clients_steps_appn_old_validate_member2_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member2_email_cb

  // ---------- Validate member2_main_cont
  function do_ajax_form_clients_steps_appn_old_validate_member2_main_cont()
  {
    var nomeCampo_member2_main_cont = "member2_main_cont";
    var var_member2_main_cont = scAjaxGetFieldSelect(nomeCampo_member2_main_cont);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member2_main_cont(var_member2_main_cont, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member2_main_cont_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member2_main_cont

  function do_ajax_form_clients_steps_appn_old_validate_member2_main_cont_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "member2_main_cont";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member2_main_cont_cb

  // ---------- Validate member2_driver_lic_id
  function do_ajax_form_clients_steps_appn_old_validate_member2_driver_lic_id()
  {
    var nomeCampo_member2_driver_lic_id = "member2_driver_lic_id";
    var var_member2_driver_lic_id = scAjaxGetFieldText(nomeCampo_member2_driver_lic_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member2_driver_lic_id(var_member2_driver_lic_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member2_driver_lic_id_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member2_driver_lic_id

  function do_ajax_form_clients_steps_appn_old_validate_member2_driver_lic_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "member2_driver_lic_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member2_driver_lic_id_cb

  // ---------- Validate memb_03
  function do_ajax_form_clients_steps_appn_old_validate_memb_03()
  {
  } // do_ajax_form_clients_steps_appn_old_validate_memb_03

  function do_ajax_form_clients_steps_appn_old_validate_memb_03_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "memb_03";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_memb_03_cb

  // ---------- Validate member3_name
  function do_ajax_form_clients_steps_appn_old_validate_member3_name()
  {
    var nomeCampo_member3_name = "member3_name";
    var var_member3_name = scAjaxGetFieldText(nomeCampo_member3_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member3_name(var_member3_name, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member3_name_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member3_name

  function do_ajax_form_clients_steps_appn_old_validate_member3_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member3_name_cb

  // ---------- Validate member3_phone
  function do_ajax_form_clients_steps_appn_old_validate_member3_phone()
  {
    var nomeCampo_member3_phone = "member3_phone";
    var var_member3_phone = scAjaxGetFieldText(nomeCampo_member3_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member3_phone(var_member3_phone, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member3_phone_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member3_phone

  function do_ajax_form_clients_steps_appn_old_validate_member3_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member3_phone_cb

  // ---------- Validate member3_email
  function do_ajax_form_clients_steps_appn_old_validate_member3_email()
  {
    var nomeCampo_member3_email = "member3_email";
    var var_member3_email = scAjaxGetFieldText(nomeCampo_member3_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member3_email(var_member3_email, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member3_email_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member3_email

  function do_ajax_form_clients_steps_appn_old_validate_member3_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member3_email_cb

  // ---------- Validate member3_main_cont
  function do_ajax_form_clients_steps_appn_old_validate_member3_main_cont()
  {
    var nomeCampo_member3_main_cont = "member3_main_cont";
    var var_member3_main_cont = scAjaxGetFieldSelect(nomeCampo_member3_main_cont);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member3_main_cont(var_member3_main_cont, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member3_main_cont_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member3_main_cont

  function do_ajax_form_clients_steps_appn_old_validate_member3_main_cont_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "member3_main_cont";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member3_main_cont_cb

  // ---------- Validate member3_drive_lic_id
  function do_ajax_form_clients_steps_appn_old_validate_member3_drive_lic_id()
  {
    var nomeCampo_member3_drive_lic_id = "member3_drive_lic_id";
    var var_member3_drive_lic_id = scAjaxGetFieldText(nomeCampo_member3_drive_lic_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_member3_drive_lic_id(var_member3_drive_lic_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_member3_drive_lic_id_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_member3_drive_lic_id

  function do_ajax_form_clients_steps_appn_old_validate_member3_drive_lic_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "member3_drive_lic_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_member3_drive_lic_id_cb

  // ---------- Validate dummy05
  function do_ajax_form_clients_steps_appn_old_validate_dummy05()
  {
  } // do_ajax_form_clients_steps_appn_old_validate_dummy05

  function do_ajax_form_clients_steps_appn_old_validate_dummy05_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy05";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_dummy05_cb

  // ---------- Validate doc_sec_of_state
  function do_ajax_form_clients_steps_appn_old_validate_doc_sec_of_state()
  {
    var nomeCampo_doc_sec_of_state = "doc_sec_of_state";
    var var_doc_sec_of_state = scAjaxGetFieldText(nomeCampo_doc_sec_of_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_doc_sec_of_state(var_doc_sec_of_state, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_doc_sec_of_state_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_doc_sec_of_state

  function do_ajax_form_clients_steps_appn_old_validate_doc_sec_of_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doc_sec_of_state";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_doc_sec_of_state_cb

  // ---------- Validate doc_city_bus_lic
  function do_ajax_form_clients_steps_appn_old_validate_doc_city_bus_lic()
  {
    var nomeCampo_doc_city_bus_lic = "doc_city_bus_lic";
    var var_doc_city_bus_lic = scAjaxGetFieldText(nomeCampo_doc_city_bus_lic);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_doc_city_bus_lic(var_doc_city_bus_lic, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_doc_city_bus_lic_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_doc_city_bus_lic

  function do_ajax_form_clients_steps_appn_old_validate_doc_city_bus_lic_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doc_city_bus_lic";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_doc_city_bus_lic_cb

  // ---------- Validate doc_agric_lic
  function do_ajax_form_clients_steps_appn_old_validate_doc_agric_lic()
  {
    var nomeCampo_doc_agric_lic = "doc_agric_lic";
    var var_doc_agric_lic = scAjaxGetFieldText(nomeCampo_doc_agric_lic);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_doc_agric_lic(var_doc_agric_lic, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_doc_agric_lic_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_doc_agric_lic

  function do_ajax_form_clients_steps_appn_old_validate_doc_agric_lic_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doc_agric_lic";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_doc_agric_lic_cb

  // ---------- Validate doc_last_year_tax
  function do_ajax_form_clients_steps_appn_old_validate_doc_last_year_tax()
  {
    var nomeCampo_doc_last_year_tax = "doc_last_year_tax";
    var var_doc_last_year_tax = scAjaxGetFieldText(nomeCampo_doc_last_year_tax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_doc_last_year_tax(var_doc_last_year_tax, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_doc_last_year_tax_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_doc_last_year_tax

  function do_ajax_form_clients_steps_appn_old_validate_doc_last_year_tax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doc_last_year_tax";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_doc_last_year_tax_cb

  // ---------- Validate appn_note
  function do_ajax_form_clients_steps_appn_old_validate_appn_note()
  {
    var nomeCampo_appn_note = "appn_note";
    var var_appn_note = scAjaxGetFieldEditorHtml(nomeCampo_appn_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_appn_note(var_appn_note, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_appn_note_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_appn_note

  function do_ajax_form_clients_steps_appn_old_validate_appn_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_appn_note_cb

  // ---------- Validate read_at_sign
  function do_ajax_form_clients_steps_appn_old_validate_read_at_sign()
  {
  } // do_ajax_form_clients_steps_appn_old_validate_read_at_sign

  function do_ajax_form_clients_steps_appn_old_validate_read_at_sign_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_read_at_sign_cb

  // ---------- Validate applicant_name
  function do_ajax_form_clients_steps_appn_old_validate_applicant_name()
  {
    var nomeCampo_applicant_name = "applicant_name";
    var var_applicant_name = scAjaxGetFieldText(nomeCampo_applicant_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_applicant_name(var_applicant_name, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_applicant_name_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_applicant_name

  function do_ajax_form_clients_steps_appn_old_validate_applicant_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_applicant_name_cb

  // ---------- Validate applicant_title
  function do_ajax_form_clients_steps_appn_old_validate_applicant_title()
  {
    var nomeCampo_applicant_title = "applicant_title";
    var var_applicant_title = scAjaxGetFieldText(nomeCampo_applicant_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_applicant_title(var_applicant_title, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_applicant_title_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_applicant_title

  function do_ajax_form_clients_steps_appn_old_validate_applicant_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_applicant_title_cb

  // ---------- Validate applicant_signature
  function do_ajax_form_clients_steps_appn_old_validate_applicant_signature()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_old_validate_applicant_signature(var_applicant_signature, var_script_case_init, do_ajax_form_clients_steps_appn_old_validate_applicant_signature_cb);
  } // do_ajax_form_clients_steps_appn_old_validate_applicant_signature

  function do_ajax_form_clients_steps_appn_old_validate_applicant_signature_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_validate_applicant_signature_cb

  // ---------- Refresh bus_cat_id
  function do_ajax_form_clients_steps_appn_old_refresh_bus_cat_id()
  {
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    var var_nmgp_refresh_fields = "bus_subcat_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_old_refresh_bus_cat_id(var_bus_cat_id, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_clients_steps_appn_old_refresh_bus_cat_id_cb);
  } // do_ajax_form_clients_steps_appn_old_refresh_bus_cat_id

  function do_ajax_form_clients_steps_appn_old_refresh_bus_cat_id_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_old_refresh_bus_cat_id_cb

  // ---------- Event onchange bus_subcat_id
  function do_ajax_form_clients_steps_appn_old_event_bus_subcat_id_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_old_event_bus_subcat_id_onchange(var_bus_subcat_id, var_bus_subcat_other, var_bus_cat_id, var_script_case_init, do_ajax_form_clients_steps_appn_old_event_bus_subcat_id_onchange_cb);
  } // do_ajax_form_clients_steps_appn_old_event_bus_subcat_id_onchange

  function do_ajax_form_clients_steps_appn_old_event_bus_subcat_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bus_subcat_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_old_event_bus_subcat_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_old_event_bus_subcat_id_onchange_cb
  function do_ajax_form_clients_steps_appn_old_event_bus_subcat_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_old_event_bus_subcat_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clients_steps_appn_old_submit_page_0(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_old_submit_page_0(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      url: "form_clients_steps_appn_old.php",
      method: "POST",
      dataType: "json",
      data: {
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_old_submit_page_cb_0(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_old_submit_page_0

  function do_ajax_form_clients_steps_appn_old_submit_page_cb_0(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
  ...
  } // do_ajax_form_clients_steps_appn_old_submit_page_cb_0

  function do_ajax_form_clients_steps_appn_old_submit_page_1(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_old_submit_page_1(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      data: {
        ...
        member1_main_cont: scAjaxGetFieldSelect("member1_main_cont"),
        member1_driver_lic_id: scAjaxGetFieldText("member1_driver_lic_id"),
        ...
        member2_main_cont: scAjaxGetFieldSelect("member2_main_cont"),
        member2_driver_lic_id: scAjaxGetFieldText("member2_driver_lic_id"),
        ...
        member3_main_cont: scAjaxGetFieldSelect("member3_main_cont"),
        member3_drive_lic_id: scAjaxGetFieldText("member3_drive_lic_id"),
        dummy05: scAjaxGetFieldHidden("dummy05"),
        member1_driver_lic_id_ul_name: scAjaxSpecCharProtect(document.F1.member1_driver_lic_id_ul_name.value),
        member1_driver_lic_id_ul_type: document.F1.member1_driver_lic_id_ul_type.value,
        member2_driver_lic_id_ul_name: scAjaxSpecCharProtect(document.F1.member2_driver_lic_id_ul_name.value),
        member2_driver_lic_id_ul_type: document.F1.member2_driver_lic_id_ul_type.value,
        member3_drive_lic_id_ul_name: scAjaxSpecCharProtect(document.F1.member3_drive_lic_id_ul_name.value),
        member3_drive_lic_id_ul_type: document.F1.member3_drive_lic_id_ul_type.value,
        member1_driver_lic_id_limpa: document.F1.member1_driver_lic_id_limpa.checked ? "S" : "N",
        member2_driver_lic_id_limpa: document.F1.member2_driver_lic_id_limpa.checked ? "S" : "N",
        member3_drive_lic_id_limpa: document.F1.member3_drive_lic_id_limpa.checked ? "S" : "N",
        nm_form_submit: document.F1.nm_form_submit.value,
        nmgp_url_saida: document.F1.nmgp_url_saida.value,
        nmgp_ancora: document.F1.nmgp_ancora.value,
        nmgp_num_form: document.F1.nmgp_num_form.value,
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_old_submit_page_cb_1(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_old_submit_page_1

  function do_ajax_form_clients_steps_appn_old_submit_page_cb_1(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_old_submit_page_cb_1

  function do_ajax_form_clients_steps_appn_old_submit_page_2(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_old_submit_page_2(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      dataType: "json",
      data: {
        doc_sec_of_state: scAjaxGetFieldText("doc_sec_of_state"),
        doc_city_bus_lic: scAjaxGetFieldText("doc_city_bus_lic"),
        doc_agric_lic: scAjaxGetFieldText("doc_agric_lic"),
        doc_last_year_tax: scAjaxGetFieldText("doc_last_year_tax"),
        appn_note: scAjaxGetFieldEditorHtml("appn_note"),
        doc_sec_of_state_ul_name: scAjaxSpecCharProtect(document.F1.doc_sec_of_state_ul_name.value),
        doc_sec_of_state_ul_type: document.F1.doc_sec_of_state_ul_type.value,
        doc_city_bus_lic_ul_name: scAjaxSpecCharProtect(document.F1.doc_city_bus_lic_ul_name.value),
        doc_city_bus_lic_ul_type: document.F1.doc_city_bus_lic_ul_type.value,
        doc_agric_lic_ul_name: scAjaxSpecCharProtect(document.F1.doc_agric_lic_ul_name.value),
        doc_agric_lic_ul_type: document.F1.doc_agric_lic_ul_type.value,
        doc_last_year_tax_ul_name: scAjaxSpecCharProtect(document.F1.doc_last_year_tax_ul_name.value),
        doc_last_year_tax_ul_type: document.F1.doc_last_year_tax_ul_type.value,
        doc_sec_of_state_limpa: document.F1.doc_sec_of_state_limpa.checked ? "S" : "N",
        doc_city_bus_lic_limpa: document.F1.doc_city_bus_lic_limpa.checked ? "S" : "N",
        doc_agric_lic_limpa: document.F1.doc_agric_lic_limpa.checked ? "S" : "N",
        doc_last_year_tax_limpa: document.F1.doc_last_year_tax_limpa.checked ? "S" : "N",
        nm_form_submit: document.F1.nm_form_submit.value,
        nmgp_url_saida: document.F1.nmgp_url_saida.value,
        nmgp_ancora: document.F1.nmgp_ancora.value,
        nmgp_num_form: document.F1.nmgp_num_form.value,
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_old_submit_page_cb_2(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_old_submit_page_2

  function do_ajax_form_clients_steps_appn_old_submit_page_cb_2(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_old_submit_page_cb_2

  function do_ajax_form_clients_steps_appn_old_submit_page_3(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_old_submit_page_3(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_old_submit_page_cb_3(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_old_submit_page_3

  function do_ajax_form_clients_steps_appn_old_submit_page_cb_3(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_old_submit_page_cb_3

  function do_ajax_form_clients_steps_appn_old_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_old_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_member1_main_cont = scAjaxGetFieldSelect("member1_main_cont");
    var var_member1_driver_lic_id = scAjaxGetFieldText("member1_driver_lic_id");
    ...
    var var_member2_main_cont = scAjaxGetFieldSelect("member2_main_cont");
    var var_member2_driver_lic_id = scAjaxGetFieldText("member2_driver_lic_id");
    ...
    var var_member3_main_cont = scAjaxGetFieldSelect("member3_main_cont");
    var var_member3_drive_lic_id = scAjaxGetFieldText("member3_drive_lic_id");
    var var_dummy05 = scAjaxGetFieldHidden("dummy05");
    var var_doc_sec_of_state = scAjaxGetFieldText("doc_sec_of_state");
    var var_doc_city_bus_lic = scAjaxGetFieldText("doc_city_bus_lic");
    var var_doc_agric_lic = scAjaxGetFieldText("doc_agric_lic");
    var var_doc_last_year_tax = scAjaxGetFieldText("doc_last_year_tax");
    ...
    var var_doc_sec_of_state_ul_name = scAjaxSpecCharProtect(document.F1.doc_sec_of_state_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_doc_sec_of_state_ul_type = document.F1.doc_sec_of_state_ul_type.value;
    var var_doc_city_bus_lic_ul_name = scAjaxSpecCharProtect(document.F1.doc_city_bus_lic_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_doc_city_bus_lic_ul_type = document.F1.doc_city_bus_lic_ul_type.value;
    var var_doc_agric_lic_ul_name = scAjaxSpecCharProtect(document.F1.doc_agric_lic_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_doc_agric_lic_ul_type = document.F1.doc_agric_lic_ul_type.value;
    var var_doc_last_year_tax_ul_name = scAjaxSpecCharProtect(document.F1.doc_last_year_tax_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_doc_last_year_tax_ul_type = document.F1.doc_last_year_tax_ul_type.value;
    var var_member1_driver_lic_id_ul_name = scAjaxSpecCharProtect(document.F1.member1_driver_lic_id_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_member1_driver_lic_id_ul_type = document.F1.member1_driver_lic_id_ul_type.value;
    var var_member2_driver_lic_id_ul_name = scAjaxSpecCharProtect(document.F1.member2_driver_lic_id_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_member2_driver_lic_id_ul_type = document.F1.member2_driver_lic_id_ul_type.value;
    var var_member3_drive_lic_id_ul_name = scAjaxSpecCharProtect(document.F1.member3_drive_lic_id_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_member3_drive_lic_id_ul_type = document.F1.member3_drive_lic_id_ul_type.value;
    var var_member1_driver_lic_id_limpa = document.F1.member1_driver_lic_id_limpa.checked ? "S" : "N";
    var var_member2_driver_lic_id_limpa = document.F1.member2_driver_lic_id_limpa.checked ? "S" : "N";
    var var_member3_drive_lic_id_limpa = document.F1.member3_drive_lic_id_limpa.checked ? "S" : "N";
    var var_doc_sec_of_state_limpa = document.F1.doc_sec_of_state_limpa.checked ? "S" : "N";
    var var_doc_city_bus_lic_limpa = document.F1.doc_city_bus_lic_limpa.checked ? "S" : "N";
    var var_doc_agric_lic_limpa = document.F1.doc_agric_lic_limpa.checked ? "S" : "N";
    var var_doc_last_year_tax_limpa = document.F1.doc_last_year_tax_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_clients_steps_appn_old_submit_form(var_dummy02, var_dummy03, var_co_name, var_client_id, var_mailing_address, var_appn_date, var_city, var_bus_cat_id, var_state, var_bus_subcat_id, var_zip_code, var_bus_subcat_other, var_phone_number, var_website_url, var_email, var_acct_instagram, var_dummy01, var_acct_facebook, var_dummy04, var_memb_01, var_member1_name, var_member1_phone, var_member1_email, var_member1_main_cont, var_member1_driver_lic_id, var_memb_02, var_member2_name, var_member2_phone, var_member2_email, var_member2_main_cont, var_member2_driver_lic_id, var_memb_03, var_member3_name, var_member3_phone, var_member3_email, var_member3_main_cont, var_member3_drive_lic_id, var_dummy05, var_doc_sec_of_state, var_doc_city_bus_lic, var_doc_agric_lic, var_doc_last_year_tax, var_appn_note, var_read_at_sign, var_applicant_name, var_applicant_title, var_applicant_signature, var_doc_sec_of_state_ul_name, var_doc_sec_of_state_ul_type, var_doc_city_bus_lic_ul_name, var_doc_city_bus_lic_ul_type, var_doc_agric_lic_ul_name, var_doc_agric_lic_ul_type, var_doc_last_year_tax_ul_name, var_doc_last_year_tax_ul_type, var_member1_driver_lic_id_ul_name, var_member1_driver_lic_id_ul_type, var_member2_driver_lic_id_ul_name, var_member2_driver_lic_id_ul_type, var_member3_drive_lic_id_ul_name, var_member3_drive_lic_id_ul_type, var_member1_driver_lic_id_limpa, var_member2_driver_lic_id_limpa, var_member3_drive_lic_id_limpa, var_doc_sec_of_state_limpa, var_doc_city_bus_lic_limpa, var_doc_agric_lic_limpa, var_doc_last_year_tax_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clients_steps_appn_old_submit_form_cb);
  } // do_ajax_form_clients_steps_appn_old_submit_form

  function do_ajax_form_clients_steps_appn_old_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxUpdateErrors("valid");
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("member1_main_cont");
      scAjaxHideErrorDisplay("member1_driver_lic_id");
      ...
      scAjaxHideErrorDisplay("member2_main_cont");
      scAjaxHideErrorDisplay("member2_driver_lic_id");
      ...
      scAjaxHideErrorDisplay("member3_main_cont");
      scAjaxHideErrorDisplay("member3_drive_lic_id");
      scAjaxHideErrorDisplay("dummy05");
      scAjaxHideErrorDisplay("doc_sec_of_state");
      scAjaxHideErrorDisplay("doc_city_bus_lic");
      scAjaxHideErrorDisplay("doc_agric_lic");
      scAjaxHideErrorDisplay("doc_last_year_tax");
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.member1_driver_lic_id_limpa && document.F1.member1_driver_lic_id_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("member1_driver_lic_id", oImgTemp, "", "", "", "N");
      }
      if (document.F1.member2_driver_lic_id_limpa && document.F1.member2_driver_lic_id_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("member2_driver_lic_id", oImgTemp, "", "", "", "N");
      }
      if (document.F1.member3_drive_lic_id_limpa && document.F1.member3_drive_lic_id_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("member3_drive_lic_id", oImgTemp, "", "", "", "N");
      }
      if (document.F1.doc_sec_of_state_limpa && document.F1.doc_sec_of_state_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("doc_sec_of_state", oImgTemp, "", "", "", "N");
      }
      if (document.F1.doc_city_bus_lic_limpa && document.F1.doc_city_bus_lic_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("doc_city_bus_lic", oImgTemp, "", "", "", "N");
      }
      if (document.F1.doc_agric_lic_limpa && document.F1.doc_agric_lic_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("doc_agric_lic", oImgTemp, "", "", "", "N");
      }
      if (document.F1.doc_last_year_tax_limpa && document.F1.doc_last_year_tax_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("doc_last_year_tax", oImgTemp, "", "", "", "N");
      }
    document.F1.member1_driver_lic_id_ul_name.value = '';
    document.F1.member1_driver_lic_id_ul_type.value = '';
    document.F1.member2_driver_lic_id_ul_name.value = '';
    document.F1.member2_driver_lic_id_ul_type.value = '';
    document.F1.member3_drive_lic_id_ul_name.value = '';
    document.F1.member3_drive_lic_id_ul_type.value = '';
    document.F1.doc_sec_of_state_ul_name.value = '';
    document.F1.doc_sec_of_state_ul_type.value = '';
    document.F1.doc_city_bus_lic_ul_name.value = '';
    document.F1.doc_city_bus_lic_ul_type.value = '';
    document.F1.doc_agric_lic_ul_name.value = '';
    document.F1.doc_agric_lic_ul_type.value = '';
    document.F1.doc_last_year_tax_ul_name.value = '';
    document.F1.doc_last_year_tax_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clients_steps_appn_old_submit_form_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_old_submit_form_cb
  function do_ajax_form_clients_steps_appn_old_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clients_steps_appn_old_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_clients_steps_appn_old_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clients_steps_appn_old_navigate_form, function() {});
    } else {
      perform_ajax_form_clients_steps_appn_old_navigate_form();
    }
  }

  function perform_ajax_form_clients_steps_appn_old_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_clients_steps_appn_old_navigate_form(var_client_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clients_steps_appn_old_navigate_form_cb);
  } // do_ajax_form_clients_steps_appn_old_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_old']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clients_steps_appn_old_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clients_steps_appn_old_navigate_form_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_old_navigate_form_cb
  function do_ajax_form_clients_steps_appn_old_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clients_steps_appn_old_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_clients_steps_appn_old_navigate_form_cb_after_alert

  function sc_hide_form_clients_steps_appn_old_form()
  {
  ...
  ajax_field_list[19] = "memb_01";
  ajax_field_list[20] = "member1_name";
  ajax_field_list[21] = "member1_phone";
  ajax_field_list[22] = "member1_email";
  ajax_field_list[23] = "member1_main_cont";
  ajax_field_list[24] = "member1_driver_lic_id";
  ajax_field_list[25] = "memb_02";
  ajax_field_list[26] = "member2_name";
  ajax_field_list[27] = "member2_phone";
  ajax_field_list[28] = "member2_email";
  ajax_field_list[29] = "member2_main_cont";
  ajax_field_list[30] = "member2_driver_lic_id";
  ajax_field_list[31] = "memb_03";
  ajax_field_list[32] = "member3_name";
  ajax_field_list[33] = "member3_phone";
  ajax_field_list[34] = "member3_email";
  ajax_field_list[35] = "member3_main_cont";
  ajax_field_list[36] = "member3_drive_lic_id";
  ajax_field_list[37] = "dummy05";
  ajax_field_list[38] = "doc_sec_of_state";
  ajax_field_list[39] = "doc_city_bus_lic";
  ajax_field_list[40] = "doc_agric_lic";
  ajax_field_list[41] = "doc_last_year_tax";
  ajax_field_list[42] = "appn_note";
  ajax_field_list[43] = "read_at_sign";
  ajax_field_list[44] = "applicant_name";
  ajax_field_list[45] = "applicant_title";
  ajax_field_list[46] = "applicant_signature";
  ...
  var ajax_error_list = {
    ...
    "member1_main_cont": {"label": "Main Contact", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "member1_driver_lic_id": {"label": "Driver Lic or ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "member2_main_cont": {"label": "Main Contact", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "member2_driver_lic_id": {"label": "Driver Lic or ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "member3_main_cont": {"label": "Main Contact", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "member3_drive_lic_id": {"label": "Drive Lic or ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "dummy05": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "doc_sec_of_state": {"label": "Active Secretary of State Registration", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "doc_city_bus_lic": {"label": "City Business License", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "doc_agric_lic": {"label": "Agricultural License", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "doc_last_year_tax": {"label": "Last Year's Business Tax return", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  var ajax_field_mult = {
    ...
    "member1_main_cont": new Array(),
    "member1_driver_lic_id": new Array(),
    "memb_02": new Array(),
    "member2_name": new Array(),
    "member2_phone": new Array(),
    "member2_email": new Array(),
    "member2_main_cont": new Array(),
    "member2_driver_lic_id": new Array(),
    "memb_03": new Array(),
    "member3_name": new Array(),
    "member3_phone": new Array(),
    "member3_email": new Array(),
    "member3_main_cont": new Array(),
    "member3_drive_lic_id": new Array(),
    "dummy05": new Array(),
    "doc_sec_of_state": new Array(),
    "doc_city_bus_lic": new Array(),
    "doc_agric_lic": new Array(),
    "doc_last_year_tax": new Array(),
    "appn_note": new Array(),
  ...
  ajax_field_mult["member1_main_cont"][1] = "member1_main_cont";
  ajax_field_mult["member1_driver_lic_id"][1] = "member1_driver_lic_id";
  ...
  ajax_field_mult["member2_main_cont"][1] = "member2_main_cont";
  ajax_field_mult["member2_driver_lic_id"][1] = "member2_driver_lic_id";
  ...
  ajax_field_mult["member3_main_cont"][1] = "member3_main_cont";
  ajax_field_mult["member3_drive_lic_id"][1] = "member3_drive_lic_id";
  ajax_field_mult["dummy05"][1] = "dummy05";
  ajax_field_mult["doc_sec_of_state"][1] = "doc_sec_of_state";
  ajax_field_mult["doc_city_bus_lic"][1] = "doc_city_bus_lic";
  ajax_field_mult["doc_agric_lic"][1] = "doc_agric_lic";
  ajax_field_mult["doc_last_year_tax"][1] = "doc_last_year_tax";
  ...
  var ajax_field_id = {
    ...
    "member1_main_cont": new Array("hidden_field_label_member1_main_cont", "hidden_field_data_member1_main_cont"),
    "member1_driver_lic_id": new Array("hidden_field_label_member1_driver_lic_id", "hidden_field_data_member1_driver_lic_id"),
    ...
    "member2_main_cont": new Array("hidden_field_label_member2_main_cont", "hidden_field_data_member2_main_cont"),
    "member2_driver_lic_id": new Array("hidden_field_label_member2_driver_lic_id", "hidden_field_data_member2_driver_lic_id"),
    ...
    "member3_main_cont": new Array("hidden_field_label_member3_main_cont", "hidden_field_data_member3_main_cont"),
    "member3_drive_lic_id": new Array("hidden_field_label_member3_drive_lic_id", "hidden_field_data_member3_drive_lic_id"),
    "dummy05": new Array("hidden_field_label_dummy05", "hidden_field_data_dummy05"),
    "doc_sec_of_state": new Array("hidden_field_label_doc_sec_of_state", "hidden_field_data_doc_sec_of_state"),
    "doc_city_bus_lic": new Array("hidden_field_label_doc_city_bus_lic", "hidden_field_data_doc_city_bus_lic"),
    "doc_agric_lic": new Array("hidden_field_label_doc_agric_lic", "hidden_field_data_doc_agric_lic"),
    "doc_last_year_tax": new Array("hidden_field_label_doc_last_year_tax", "hidden_field_data_doc_last_year_tax"),
  ...
  var ajax_read_only = {
    ...
    "member1_phone": "off",
    "member1_email": "off",
    "member1_main_cont": "off",
    "member1_driver_lic_id": "off",
    "memb_02": "off",
    "member2_name": "off",
    "member2_phone": "off",
    "member2_email": "off",
    "member2_main_cont": "off",
    "member2_driver_lic_id": "off",
    "memb_03": "off",
    "member3_name": "off",
    "member3_phone": "off",
    "member3_email": "off",
    "member3_main_cont": "off",
    "member3_drive_lic_id": "off",
    "dummy05": "off",
    "doc_sec_of_state": "off",
    "doc_city_bus_lic": "off",
    "doc_agric_lic": "off",
    "doc_last_year_tax": "off",
    "appn_note": "off",
    "read_at_sign": "off",
    "applicant_name": "off",
    "applicant_title": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("member1_driver_lic_id" == sIndex)
    {
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("member2_driver_lic_id" == sIndex)
    {
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("member3_drive_lic_id" == sIndex)
    {
      updateHeaderFooter(sIndex, aValue);
