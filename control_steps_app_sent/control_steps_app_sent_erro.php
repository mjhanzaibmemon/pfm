...
$old_error_handler = set_error_handler("control_steps_app_sent_scriptcase_error_handler");

function control_steps_app_sent_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['control_steps_app_sent']['contr_erro']) && $_SESSION['scriptcase']['control_steps_app_sent']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_steps_app_sent->contr_control_steps_app_sent->Apl_com_erro = true;
            if ($inicial_control_steps_app_sent->contr_control_steps_app_sent->NM_ajax_flag)
            {
                $inicial_control_steps_app_sent->contr_control_steps_app_sent->NM_ajax_info['errList']['geral_control_steps_app_sent'][] = $msg;
                return;
            }
            control_steps_app_sent_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_steps_app_sent_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_steps_app_sent'])  && '' != $_SESSION['scriptcase']['error_icon']['control_steps_app_sent'])  ? $_SESSION['scriptcase']['error_icon']['control_steps_app_sent']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_steps_app_sent']) && '' != $_SESSION['scriptcase']['error_span_title']['control_steps_app_sent']) ? $_SESSION['scriptcase']['error_span_title']['control_steps_app_sent'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_steps_app_sent']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_steps_app_sent']) ? $_SESSION['scriptcase']['error_icon_title']['control_steps_app_sent'] : '';
?>
