<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vw_clients_main_member_renew']['sc_process_barr'] = true;
require_once('../grid_vw_clients_main_member_renew/index.php');
unset($_SESSION['scriptcase']['grid_vw_clients_main_member_renew']['sc_process_barr']);
$ExportCtrl = new grid_vw_clients_main_member_renew_export_control;
$ExportCtrl->Export_barr();

class grid_vw_clients_main_member_renew_export_control
{
