...
class grid_vw_clients_main_member_renew_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_vw_clients_main_member_renew_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_vw_clients_main_member_renew_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_vw_clients_main_member_renew_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = 'permanent_member_date';$Nm_datas[] = 'renewal_date';
      ...
      else
      {
         ...
         $nome_sum = "vw_clients_main_member_renew.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $NM_cond = str_replace(array("##ini##","##fim##"), array("",""),$NM_cond);
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_vw_clients_main_member_renew/grid_vw_clients_main_member_renew_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
<?php
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_vw_clients_main_member_renew_ajax_search.js"></script>
 <script type="text/javascript" src="grid_vw_clients_main_member_renew_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_vw_clients_main_member_renew_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_vw_clients_main_member_renew']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_vw_clients_main_member_renew']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_renewal_date_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_renewal_date_dia').value + '/';
          var_dt_ini += document.getElementById('SC_renewal_date_mes').value + '/';
          var_dt_ini += document.getElementById('SC_renewal_date_ano').value;
          document.getElementById('sc_renewal_date_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_renewal_date_dia').value = aParts[0];
          document.getElementById('SC_renewal_date_mes').value = aParts[1];
          document.getElementById('SC_renewal_date_ano').value = aParts[2];
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
  ...
  $("#sc_renewal_date_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_renewal_date_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_renewal_date_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_renewal_date_input_2_ano').value;
          document.getElementById('sc_renewal_date_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_renewal_date_input_2_dia').value = aParts[0];
          document.getElementById('SC_renewal_date_input_2_mes').value = aParts[1];
          document.getElementById('SC_renewal_date_input_2_ano').value = aParts[2];
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
 ...
 function nm_save_form(pos)
 {
  ...
  opc = search_get_sel_txt('SC_renewal_date_cond');
  if (opc.substring(0, 3) != "bi_")
  {
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Renewals Search</div>
...
<?php
   ...
   {
      global 
             $renewal_date_cond, $renewal_date, $renewal_date_dia, $renewal_date_mes, $renewal_date_ano, $renewal_date_input_2_dia, $renewal_date_input_2_mes, $renewal_date_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $renewal_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_dia']; 
          $renewal_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_mes']; 
          $renewal_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_ano']; 
          $renewal_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_input_2_dia']; 
          $renewal_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_input_2_mes']; 
          $renewal_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_input_2_ano']; 
          $renewal_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['NM_operador']; 
      } 
      ...
      {
         $renewal_date_cond = "bi_custom_MM@@last@@2@@S";
      }
      if (isset($renewal_date_cond) && substr($renewal_date_cond, 0, 3) == "bi_")
      {
         $Temp_cond = $renewal_date_cond;
         $this->Ini->process_cond_bi($Temp_cond, $BI_data1, $BI_data2);
         $renewal_date_dia = substr($BI_data1, 0, 2);
         $renewal_date_mes = substr($BI_data1, 2, 2);
         $renewal_date_ano = substr($BI_data1, 4, 4);
         if (strlen($BI_data1) > 8)
         {
             $renewal_date_hor = substr($BI_data1, 8, 2);
             $renewal_date_min = substr($BI_data1, 10, 2);
             $renewal_date_seg = substr($BI_data1, 12, 2);
         }
         $renewal_date_input_2_dia = substr($BI_data2, 0, 2);
         $renewal_date_input_2_mes = substr($BI_data2, 2, 2);
         $renewal_date_input_2_ano = substr($BI_data2, 4, 4);
         if (strlen($BI_data2) > 8)
         {
             $renewal_date_input_2_hor = substr($BI_data2, 8, 2);
             $renewal_date_input_2_min = substr($BI_data2, 10, 2);
             $renewal_date_input_2_seg = substr($BI_data2, 12, 2);
         }
         $Script_BI .= "  formata_bi_renewal_date('" . $renewal_date_cond . "', '" . $Temp_cond . "', '" . $BI_data1 . "');\r\n";
      }
      ...
      $str_display_renewal_date = ('bw' == $renewal_date_cond || 'bi_' == substr($renewal_date_cond, 0, 3)) ? $display_aberto : $display_fechado;
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_renewal_date_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['renewal_date'])) ? $this->New_label['renewal_date'] : "Renewal Date"; ?> <span class="requiredMark">*</span></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_renewal_date_cond" name="renewal_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_renewal_date'), this, 'renewal_date')">
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_spec'] ?>">
       <OPTION value="bi_este_mes_full" <?php if ("bi_este_mes_full" == $renewal_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_este_mes_full'] ?></OPTION>
       <OPTION value="bi_UM" <?php if ("bi_UM" == $renewal_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_mnth'] ?></OPTION>
       <OPTION value="bi_PM" <?php if ("bi_PM" == $renewal_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_next_mnth'] ?></OPTION>
       <OPTION value="bi_custom_MM@@last@@2@@S" <?php if ("bi_custom_MM@@last@@2@@S" == $renewal_date_cond) { echo "selected"; } ?>><?php echo "Last 2 Months (Incl. current)" ?></OPTION>
       <OPTION value="bi_current_week" <?php if ("bi_current_week" == $renewal_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_week'] ?></OPTION>
       <OPTION value="bi_last_week" <?php if ("bi_last_week" == $renewal_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_last_week'] ?></OPTION>
       <OPTION value="bi_next_week" <?php if ("bi_next_week" == $renewal_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_next_week'] ?></OPTION>
       <OPTION value="bi_HJ" <?php if ("bi_HJ" == $renewal_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tday'] ?></OPTION>
       <OPTION value="bi_OT" <?php if ("bi_OT" == $renewal_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_yest'] ?></OPTION>
       <OPTION value="bi_AM" <?php if ("bi_AM" == $renewal_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tomw'] ?></OPTION>
       <OPTION value="bi_custom_WEEK@@last@@2@@S" <?php if ("bi_custom_WEEK@@last@@2@@S" == $renewal_date_cond) { echo "selected"; } ?>><?php echo "Last 2 Weeks (Incl. current)" ?></OPTION>
       <OPTION value="bi_TP" <?php if ("bi_TP" == $renewal_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_ever'] ?></OPTION>
       ...
       <OPTION value="le" <?php if ("le" == $renewal_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less_equl'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd"><SPAN id="Nm_bi_dados_renewal_date" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_renewal_date"  style=display:  border="0" cellpadding="0" cellspacing="0">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_renewal_date_mes" name="renewal_date_mes" value="<?php echo NM_encode_input($renewal_date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
<span id='id_date_part_renewal_date_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_renewal_date_dia" name="renewal_date_dia" value="<?php echo NM_encode_input($renewal_date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
<span id='id_date_part_renewal_date_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_renewal_date_ano" name="renewal_date_ano" value="<?php echo NM_encode_input($renewal_date_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_renewal_date_jq">
</span>
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_renewal_date"  <?php echo $str_display_renewal_date; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>
         <BR>
         
         <span id='id_date_part_renewal_date_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_renewal_date_input_2_mes" name="renewal_date_input_2_mes" value="<?php echo NM_encode_input($renewal_date_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
<span id='id_date_part_renewal_date_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_renewal_date_input_2_dia" name="renewal_date_input_2_dia" value="<?php echo NM_encode_input($renewal_date_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
<span id='id_date_part_renewal_date_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_renewal_date_input_2_ano" name="renewal_date_input_2_ano" value="<?php echo NM_encode_input($renewal_date_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_renewal_date_jq2">
</span>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
<?php
   ...
   {
?>
          <?php echo nmButtonOutput($this->arr_buttons, "blimpar", "limpa_form();", "limpa_form();", "limpa_frm_bot", "", "Reset", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "Clear All Search conditions (Ctrl + K)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
<?php
   }
?>
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_renew']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_renew']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.renewal_date_cond.value = 'bi_custom_MM@@last@@2@@S';
 ...
 {
    $('#SC_renewal_date_dia').bind('change', function() {sc_grid_vw_clients_main_member_renew_valida_dia(this)});
    $('#SC_renewal_date_input_2_dia').bind('change', function() {sc_grid_vw_clients_main_member_renew_valida_dia(this)});
    $('#SC_renewal_date_input_2_mes').bind('change', function() {sc_grid_vw_clients_main_member_renew_valida_mes(this)});
    $('#SC_renewal_date_mes').bind('change', function() {sc_grid_vw_clients_main_member_renew_valida_mes(this)});
 }
 function sc_grid_vw_clients_main_member_renew_valida_mes(obj)
 {
 ...
 function sc_grid_vw_clients_main_member_renew_valida_dia(obj)
 {
...
function formata_bi_renewal_date(opc, opc_bi, dt_fmt)
{
   if (opc.substring(0,3) != "bi_")
   {
       document.getElementById('Nm_bi_dados_renewal_date').style.display = 'none';
       document.getElementById('opc_bi_TP_renewal_date').style.display = '';
       return;
   }
   if (opc == "bi_TP")
   {
       document.getElementById('Nm_bi_dados_renewal_date').style.display = 'none';
       document.getElementById('opc_bi_TP_renewal_date').style.display = 'none';
       return;
   }
   saida = document.F1.renewal_date_mes.value + '/' + document.F1.renewal_date_dia.value + '/' + document.F1.renewal_date_ano.value;
   if (opc_bi == "bw")
   {
       saida += " and ";
       saida += document.F1.renewal_date_input_2_mes.value + '/' + document.F1.renewal_date_input_2_dia.value + '/' + document.F1.renewal_date_input_2_ano.value;
   }
   document.getElementById('Nm_bi_dados_renewal_date').innerHTML = saida;
   document.getElementById('opc_bi_TP_renewal_date').style.display = 'none';
   document.getElementById('Nm_bi_dados_renewal_date').style.display = '';
}
<?php
  echo $Script_BI;
?>
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_orig'] = "";
      }
      $this->init_comando();
   ...
   function init_comando()
   {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_orig'];
      }
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_vw_clients_main_member_renew/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              else
              {
                  ...
                  if ($Cada_cmp[0] == 'SC_renewal_date_cond')
                  {
                      $opc = $Cada_cmp[1];
   ...
   {
      global $renewal_date_cond, $renewal_date, $renewal_date_dia, $renewal_date_mes, $renewal_date_ano, $renewal_date_input_2_dia, $renewal_date_input_2_mes, $renewal_date_input_2_ano, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!$this->NM_ajax_flag || $this->NM_ajax_opcao != "ajax_grid_search")
      {
          if (substr($renewal_date_cond, 0, 3) != "bi_" && $renewal_date_cond != "nu" && $renewal_date_cond != "nn" && $renewal_date_cond != "ep" && $renewal_date_cond != "ne")
          {
              if ($renewal_date_dia == "" && $renewal_date_mes == "" && $renewal_date_ano == "")
              {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Renewal Date : " . $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_dia'] = $renewal_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_mes'] = $renewal_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_ano'] = $renewal_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_input_2_dia'] = $renewal_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_input_2_mes'] = $renewal_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_input_2_ano'] = $renewal_date_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $renewal_date_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $renewal_date_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $renewal_date_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $renewal_date_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $renewal_date_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $renewal_date_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_cond'] = $renewal_date_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['Grid_search'][$I_Grid]['cmp'] = "renewal_date"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['Grid_search'][$I_Grid]['opc'] = $renewal_date_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq']['renewal_date'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if ($renewal_date_cond != "bi_TP" && $Res_comp != 'calend')
      {
          ...
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATETIME", $renewal_date_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $renewal_date = $val[0];
          $this->cmp_formatado['renewal_date'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['renewal_date'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['renewal_date'] = $this->nm_data->FormataSaida("m/d/Y");
          $this->cmp_formatado['renewal_date'] = "'" . $this->cmp_formatado['renewal_date'] . "'";
          if ($renewal_date_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']['renewal_date_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['renewal_date_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['renewal_date_input_2'] = $this->nm_data->FormataSaida("m/d/Y");
          $this->cmp_formatado['renewal_date_input_2'] = "'" . $this->cmp_formatado['renewal_date_input_2'] . "'";
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq']['renewal_date']['label'] = $nmgp_tab_label['renewal_date'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq']['renewal_date']['descr'] = $nmgp_tab_label['renewal_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['grid_pesq']['renewal_date']['hint']  = $nmgp_tab_label['renewal_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq_fast'] . ")";
           }
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['cond_pesq'] .= $this->NM_operador;
...
$_SESSION['scriptcase']['grid_vw_clients_main_member_renew']['contr_erro'] = 'on';
    ...
    $insert_sql = "INSERT INTO sec_approvals (client_id, login, memb_status_id, ts) 
                   VALUES (" . $client_id . ", '" . $login . "', " . $memb_status_id . ", NOW())";
