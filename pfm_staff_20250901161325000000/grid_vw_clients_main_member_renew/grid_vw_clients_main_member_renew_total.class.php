...
class grid_vw_clients_main_member_renew_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_vw_clients_main_member_renew']['campos_busca']))
      { 
   ...
   function quebra_geral_sc_free_total($res_limit=false, $res_export=false)
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['contr_total_geral'] = "OK";
   } 
