...
/*------*/
    ...
    if (isset($_POST['bok_graf']) && $_POST['bok_graf'] == "OK")
    {
       ...
       if ($campo_apl == "nm_resumo_graf")
       {
           ...
           if (isset($_POST['chart_enable_scroll'])) {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['chart_enable_scroll'] = $_POST['chart_enable_scroll'];
           } else {
               $_SESSION['sc_session'][$sc_page][$nome_apl] ['chart_enable_scroll'] = 'N';
           }
       }
       else
       {
...
<?php
    ...
    elseif ($campo_apl == "nm_resumo_graf")
    {
        ...
        $chart_enable_scroll = $_SESSION['sc_session'][$sc_page][$nome_apl]['chart_has_enable_scroll'] ? $_SESSION['sc_session'][$sc_page][$nome_apl]['chart_enable_scroll'] : 'N';
    }
    else
    {
...
?>
 ...
 <tr>
     <td class="scGridFieldOdd">
         ...
         <div id="group_data_Scroll" style="display: none;">
             <div class="scInputs scGridFieldOddFont">
                 <div class='scInputsRow'>
                     <div class="scInputsCol">
                         <div class='scInput'>
                             <input id="sc-id-enable-scroll" type="checkbox" name="chart_enable_scroll"<?php if ('S' == $chart_enable_scroll) { echo ' checked'; } ?> value="S" />
                             <label for="sc-id-enable-scroll"><?php echo $tradutor[$language]['chart_enable_scroll'] ?></label>
                         </div>
                     </div>
                 </div>
             </div>
...
function scHideEnableScroll()
{
    $("#group_data_Scroll").hide();
}
function scShowEnableScroll()
{
<?php
if ($_SESSION['sc_session'][$sc_page][$nome_apl]['chart_has_enable_scroll'] && $_SESSION['sc_session'][$sc_page][$nome_apl]['chart_show_enable_scroll']) {
?>
    $("#group_data_Scroll").show();
<?php
} else {
?>
    $("#group_data_Scroll").hide();
