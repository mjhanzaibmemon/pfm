...
*/
    ...
    $SC_cod_proj = "PFM_Staff";
    $SC_apl_proc = "grid_vw_clients_main_member_renew";
    $SC_ver_93   = true;
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['grid_vw_clients_main_member_renew']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['grid_vw_clients_main_member_renew']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['grid_vw_clients_main_member_renew']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['grid_vw_clients_main_member_renew']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['grid_vw_clients_main_member_renew']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['grid_vw_clients_main_member_renew']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['grid_vw_clients_main_member_renew']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['grid_vw_clients_main_member_renew']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['grid_vw_clients_main_member_renew']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['grid_vw_clients_main_member_renew']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
/*                     !in_array("chart_level", $SC_conf_opt) || */
                     ($opc == 'pdf_det')
                    ? ' style="display: none"' : '';
            if (isset($_SESSION['sc_session'] [$script_case_init] [$app_name] ['cfg_graf'] ['graf_tipo']) && in_array($_SESSION['sc_session'] [$script_case_init] [$app_name] ['cfg_graf'] ['graf_tipo'], ['Chord', 'Heatmap', 'Sankey', 'Sunburst', 'Treemap'])) {
