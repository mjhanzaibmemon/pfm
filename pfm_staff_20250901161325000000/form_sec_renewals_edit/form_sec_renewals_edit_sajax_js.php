  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sec_renewals_edit" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_sec_renewals_edit_form();
        }
...
?>
  ...
  // ---------- Validate client_id_
  function do_ajax_form_sec_renewals_edit_validate_client_id_(iNumLinha)
  {
    var nomeCampo_client_id_ = "client_id_" + iNumLinha;
    var var_client_id_ = scAjaxGetFieldHidden(nomeCampo_client_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_renewals_edit_validate_client_id_(var_client_id_, iNumLinha, var_script_case_init, do_ajax_form_sec_renewals_edit_validate_client_id__cb);
  } // do_ajax_form_sec_renewals_edit_validate_client_id_

  function do_ajax_form_sec_renewals_edit_validate_client_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "client_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "client_id_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sec_renewals_edit_validate_client_id__cb

  // ---------- Validate token_
  function do_ajax_form_sec_renewals_edit_validate_token_(iNumLinha)
  {
    var nomeCampo_token_ = "token_" + iNumLinha;
    var var_token_ = scAjaxGetFieldHidden(nomeCampo_token_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_renewals_edit_validate_token_(var_token_, iNumLinha, var_script_case_init, do_ajax_form_sec_renewals_edit_validate_token__cb);
  } // do_ajax_form_sec_renewals_edit_validate_token_

  function do_ajax_form_sec_renewals_edit_validate_token__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "token_" + iLineNumber;
    }
    else
    {
      sFieldValid = "token_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sec_renewals_edit_validate_token__cb

  // ---------- Validate token_created_
  function do_ajax_form_sec_renewals_edit_validate_token_created_(iNumLinha)
  {
    var nomeCampo_token_created_ = "token_created_" + iNumLinha;
    var var_token_created_ = scAjaxGetFieldHidden(nomeCampo_token_created_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_renewals_edit_validate_token_created_(var_token_created_, iNumLinha, var_script_case_init, do_ajax_form_sec_renewals_edit_validate_token_created__cb);
  } // do_ajax_form_sec_renewals_edit_validate_token_created_

  function do_ajax_form_sec_renewals_edit_validate_token_created__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "token_created_" + iLineNumber;
    }
    else
    {
      sFieldValid = "token_created_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sec_renewals_edit_validate_token_created__cb

  // ---------- Validate token_exp_
  function do_ajax_form_sec_renewals_edit_validate_token_exp_(iNumLinha)
  {
    var nomeCampo_token_exp_ = "token_exp_" + iNumLinha;
    var var_token_exp_ = scAjaxGetFieldText(nomeCampo_token_exp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_renewals_edit_validate_token_exp_(var_token_exp_, iNumLinha, var_script_case_init, do_ajax_form_sec_renewals_edit_validate_token_exp__cb);
  } // do_ajax_form_sec_renewals_edit_validate_token_exp_

  function do_ajax_form_sec_renewals_edit_validate_token_exp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "token_exp_" + iLineNumber;
    }
    else
    {
      sFieldValid = "token_exp_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sec_renewals_edit_validate_token_exp__cb

  // ---------- Validate applied_
  function do_ajax_form_sec_renewals_edit_validate_applied_(iNumLinha)
  {
    var nomeCampo_applied_ = "applied_" + iNumLinha;
    var var_applied_ = scAjaxGetFieldText(nomeCampo_applied_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_renewals_edit_validate_applied_(var_applied_, iNumLinha, var_script_case_init, do_ajax_form_sec_renewals_edit_validate_applied__cb);
  } // do_ajax_form_sec_renewals_edit_validate_applied_

  function do_ajax_form_sec_renewals_edit_validate_applied__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "applied_" + iLineNumber;
    }
    else
    {
      sFieldValid = "applied_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sec_renewals_edit_validate_applied__cb

  // ---------- Validate sec_renew_id_
  function do_ajax_form_sec_renewals_edit_validate_sec_renew_id_(iNumLinha)
  {
    var nomeCampo_sec_renew_id_ = "sec_renew_id_" + iNumLinha;
    var var_sec_renew_id_ = scAjaxGetFieldHidden(nomeCampo_sec_renew_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_renewals_edit_validate_sec_renew_id_(var_sec_renew_id_, iNumLinha, var_script_case_init, do_ajax_form_sec_renewals_edit_validate_sec_renew_id__cb);
  } // do_ajax_form_sec_renewals_edit_validate_sec_renew_id_

  function do_ajax_form_sec_renewals_edit_validate_sec_renew_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "sec_renew_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sec_renew_id_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sec_renewals_edit_validate_sec_renew_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sec_renewals_edit_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sec_renewals_edit_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sec_renewals_edit_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sec_renewals_edit_add_new_line_cb);
  } // do_ajax_form_sec_renewals_edit_add_new_line

  function do_ajax_form_sec_renewals_edit_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_form_sec_renewals_edit_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sec_renewals_edit_backup_line(iNumLinha)
  {
    var var_sec_renew_id_ = scAjaxGetFieldHidden("sec_renew_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_renewals_edit_backup_line(var_sec_renew_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sec_renewals_edit_backup_line_cb);
  } // do_ajax_form_sec_renewals_edit_backup_line

  function do_ajax_form_sec_renewals_edit_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sec_renewals_edit_backup_line_cb

  function do_ajax_form_sec_renewals_edit_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_sec_renewals_edit_cancel_insert

  function do_ajax_form_sec_renewals_edit_cancel_update(iSeqVert)
  {
    do_ajax_form_sec_renewals_edit_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sec_renewals_edit_cancel_update

  function do_ajax_form_sec_renewals_edit_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sec_renewals_edit_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sec_renewals_edit_table_refresh()
  {
    var var_sec_renew_id_ = document.F2.sec_renew_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sec_renewals_edit_table_refresh(var_sec_renew_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sec_renewals_edit_table_refresh_cb);
  } //  do_ajax_form_sec_renewals_edit_table_refresh

  function do_ajax_form_sec_renewals_edit_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.sec_renew_id_.value = scAjaxGetKeyValue("sec_renew_id_");
    ...
    scAjaxAlert(do_ajax_form_sec_renewals_edit_table_refresh_cb_after_alert);
  } // do_ajax_form_sec_renewals_edit_table_refresh_cb
  function do_ajax_form_sec_renewals_edit_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sec_renewals_edit_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sec_renewals_edit_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sec_renewals_edit_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_client_id_ = scAjaxGetFieldHidden("client_id_" + iNumLinha);
    var var_token_ = scAjaxGetFieldHidden("token_" + iNumLinha);
    var var_token_created_ = scAjaxGetFieldHidden("token_created_" + iNumLinha);
    var var_token_exp_ = scAjaxGetFieldText("token_exp_" + iNumLinha);
    var var_applied_ = scAjaxGetFieldText("applied_" + iNumLinha);
    var var_sec_renew_id_ = scAjaxGetFieldHidden("sec_renew_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sec_renewals_edit_submit_form(var_client_id_, var_token_, var_token_created_, var_token_exp_, var_applied_, var_sec_renew_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sec_renewals_edit_submit_form_cb);
  } // do_ajax_form_sec_renewals_edit_submit_form

  function do_ajax_form_sec_renewals_edit_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sec_renewals_edit_submit_form_cb_after_alert);
  } // do_ajax_form_sec_renewals_edit_submit_form_cb
  function do_ajax_form_sec_renewals_edit_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sec_renewals_edit_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sec_renewals_edit_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sec_renewals_edit_navigate_form, function() {});
    } else {
      perform_ajax_form_sec_renewals_edit_navigate_form();
    }
  }

  function perform_ajax_form_sec_renewals_edit_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sec_renewals_edit_cancel_insert(sc_form_sec_renewals_edit_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sec_renewals_edit_navigate_form(var_sec_renew_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sec_renewals_edit_navigate_form_cb);
  } // do_ajax_form_sec_renewals_edit_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_renewals_edit']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sec_renewals_edit_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.sec_renew_id_.value = scAjaxGetKeyValue("sec_renew_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sec_renewals_edit_navigate_form_cb_after_alert);
  } // do_ajax_form_sec_renewals_edit_navigate_form_cb
  function do_ajax_form_sec_renewals_edit_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sec_renewals_edit_navigate_form_cb_after_alert

    function sc_form_sec_renewals_edit_get_last_line_number()
    {
    ...
    } //sc_form_sec_renewals_edit_get_last_line_number

  function sc_hide_form_sec_renewals_edit_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "client_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "token_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "token_created_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "token_exp_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "applied_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sec_renew_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["client_id_" + iNumLinha] = {"label": "ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["token_" + iNumLinha] = {"label": "Token<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["token_created_" + iNumLinha] = {"label": "Created At<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["token_exp_" + iNumLinha] = {"label": "Expires At<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["applied_" + iNumLinha] = {"label": "Date Applied<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["sec_renew_id_" + iNumLinha] = {"label": "Sec Renew Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["client_id_"][iNumLinha] = "client_id_" + iNumLinha;
    ajax_field_mult["token_"][iNumLinha] = "token_" + iNumLinha;
    ajax_field_mult["token_created_"][iNumLinha] = "token_created_" + iNumLinha;
    ajax_field_mult["token_exp_"][iNumLinha] = "token_exp_" + iNumLinha;
    ajax_field_mult["applied_"][iNumLinha] = "applied_" + iNumLinha;
    ajax_field_mult["sec_renew_id_"][iNumLinha] = "sec_renew_id_" + iNumLinha;
    ajax_field_id["client_id_" + iNumLinha] = new Array("hidden_field_label_client_id_", "hidden_field_data_client_id_" + iNumLinha);
    ajax_field_id["token_" + iNumLinha] = new Array("hidden_field_label_token_", "hidden_field_data_token_" + iNumLinha);
    ajax_field_id["token_created_" + iNumLinha] = new Array("hidden_field_label_token_created_", "hidden_field_data_token_created_" + iNumLinha);
    ajax_field_id["token_exp_" + iNumLinha] = new Array("hidden_field_label_token_exp_", "hidden_field_data_token_exp_" + iNumLinha);
    ajax_field_id["applied_" + iNumLinha] = new Array("hidden_field_label_applied_", "hidden_field_data_applied_" + iNumLinha);
    ajax_error_count["client_id_" + iNumLinha] = "off";
    ajax_error_count["token_" + iNumLinha] = "off";
    ajax_error_count["token_created_" + iNumLinha] = "off";
    ajax_error_count["token_exp_" + iNumLinha] = "off";
    ajax_error_count["applied_" + iNumLinha] = "off";
    ajax_error_count["sec_renew_id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["client_id_" + iNumLinha] = "off";
    ajax_read_only["token_" + iNumLinha] = "off";
    ajax_read_only["token_created_" + iNumLinha] = "off";
    ajax_read_only["token_exp_" + iNumLinha] = "off";
    ajax_read_only["applied_" + iNumLinha] = "off";
    ajax_read_only["sec_renew_id_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["client_id_" + iNumLinha] = "on";
    ajax_read_only["token_" + iNumLinha] = "on";
    ajax_read_only["token_created_" + iNumLinha] = "on";
    ajax_read_only["token_exp_" + iNumLinha] = "on";
    ajax_read_only["applied_" + iNumLinha] = "on";
    ajax_read_only["sec_renew_id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["client_id_" + iNumLinha] = null;
    ajax_error_list["token_" + iNumLinha] = null;
    ajax_error_list["token_created_" + iNumLinha] = null;
    ajax_error_list["token_exp_" + iNumLinha] = null;
    ajax_error_list["applied_" + iNumLinha] = null;
    ajax_error_list["sec_renew_id_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "client_id_": new Array(),
    "token_": new Array(),
    "token_created_": new Array(),
    "token_exp_": new Array(),
    "applied_": new Array(),
    "sec_renew_id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["client_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["client_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["client_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["client_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["client_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["token_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["token_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["token_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["token_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["token_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["token_created_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["token_created_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["token_created_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["token_created_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["token_created_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["token_exp_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["token_exp_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["token_exp_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["token_exp_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["token_exp_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["applied_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["applied_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["applied_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["applied_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["applied_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sec_renew_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sec_renew_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sec_renew_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sec_renew_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sec_renew_id_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['client_id_'])) ? $this->nmgp_cmp_readonly['client_id_'] : 'off';
?>
    scAjaxFieldRead("client_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['token_'])) ? $this->nmgp_cmp_readonly['token_'] : 'off';
?>
    scAjaxFieldRead("token_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['token_created_'])) ? $this->nmgp_cmp_readonly['token_created_'] : 'off';
?>
    scAjaxFieldRead("token_created_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['token_exp_'])) ? $this->nmgp_cmp_readonly['token_exp_'] : 'off';
?>
    scAjaxFieldRead("token_exp_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['applied_'])) ? $this->nmgp_cmp_readonly['applied_'] : 'off';
?>
    scAjaxFieldRead("applied_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sec_renew_id_'])) ? $this->nmgp_cmp_readonly['sec_renew_id_'] : 'on';
?>
    scAjaxFieldRead("sec_renew_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("client_id_" + iSeq, "on");
    scAjaxFieldRead("token_" + iSeq, "on");
    scAjaxFieldRead("token_created_" + iSeq, "on");
    scAjaxFieldRead("token_exp_" + iSeq, "on");
    scAjaxFieldRead("applied_" + iSeq, "on");
    scAjaxFieldRead("sec_renew_id_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["client_id_" + iRow] || "on" == ajax_error_count["token_" + iRow] || "on" == ajax_error_count["token_created_" + iRow] || "on" == ajax_error_count["token_exp_" + iRow] || "on" == ajax_error_count["applied_" + iRow] || "on" == ajax_error_count["sec_renew_id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_client_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_token_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_token_created_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_token_exp_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_applied_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sec_renew_id_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["client_id_" + iRow] && "off" == ajax_error_count["token_" + iRow] && "off" == ajax_error_count["token_created_" + iRow] && "off" == ajax_error_count["token_exp_" + iRow] && "off" == ajax_error_count["applied_" + iRow] && "off" == ajax_error_count["sec_renew_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["client_id_" + iRow] = "off";
        ajax_error_count["token_" + iRow] = "off";
        ajax_error_count["token_created_" + iRow] = "off";
        ajax_error_count["token_exp_" + iRow] = "off";
        ajax_error_count["applied_" + iRow] = "off";
        ajax_error_count["sec_renew_id_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_client_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_token_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_token_created_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_token_exp_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_applied_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sec_renew_id_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  {
    if (bRefreshTable || document.F2.nmgp_opcao.value == "dyn_search_descr" || document.F2.nmgp_opcao.value == "fast_search")
    {
      do_ajax_form_sec_renewals_edit_table_refresh();
      bRefreshTable = false;
      return true;
