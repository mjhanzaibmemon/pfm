<?php
@session_start() ;
$_SESSION['scriptcase']['grid_client_docs_2']['sc_process_barr'] = true;
require_once('../grid_client_docs_2/index.php');
unset($_SESSION['scriptcase']['grid_client_docs_2']['sc_process_barr']);
$ExportCtrl = new grid_client_docs_2_export_control;
$ExportCtrl->Export_barr();

class grid_client_docs_2_export_control
{
