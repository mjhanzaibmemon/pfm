...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PFM_Staff_____grid_client_docs_2"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PFM_Staff_____grid_client_docs_2"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_client_docs_2'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_client_docs_2']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_client_docs_2']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_client_docs_2']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_client_docs_2']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_client_docs_2']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_client_docs_2</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_client_docs_2']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_client_docs_2']['embutida_filho'] as $ind => $sc_init)
          {
