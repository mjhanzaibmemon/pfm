<?php
   ...
   if(!$bol_sel_campos_include)
   {
     ...
     if (!isset($_SESSION['sc_session']))
     {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_vw_clients_main_member_inactive']['glo_nm_path_imag_temp'] . "/sc_apl_default_PFM_Staff.txt"))
       {
?>
...
<?php
     ...
     if (!function_exists("NM_is_utf8"))
     {
      ...
      $Sel_Cmp = new grid_vw_clients_main_member_inactive_sel_cmp($bol_sel_campos_include); 
      $Sel_Cmp->Sel_cmp_init();
      $Sel_Cmp->Sel_cmp_init_fields();
      $Sel_Cmp->Sel_cmp_process();
     
  }
class grid_vw_clients_main_member_inactive_sel_cmp
{
function Sel_cmp_init($bol_sel_campos_include = false, $sc_init = '', $path_img = '', $path_btn = '', $path_fields = '',$embbed = true, $tbar_pos = '')
{
   ...
   $this->Tab_Labels = array();
   $save_charset     = $_SESSION['scriptcase']['charset'];
   foreach ($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['labels'] as $ind => $dados) {
       if (!$this->embbed && $_SESSION['scriptcase']['charset'] != "UTF-8") {
          $this->Tab_Labels[$ind] = sc_convert_encoding($dados, "UTF-8", $_SESSION['scriptcase']['charset']);
       }
       else {
          $this->Tab_Labels[$ind] = $dados;
       }
   }
   if (!$this->embbed) {
       $_SESSION['scriptcase']['charset'] = "UTF-8";
...
function Sel_cmp_process()
{
   ...
   function Sel_cmp_init_fields()
   {
      ...
      $tab_ger_campos['client_id'] = "on";
      $tab_ger_campos['status'] = "on";
      $tab_ger_campos['renewal_date'] = "on";
      $tab_blk_campos[] = "renewal_date";
      $tab_ger_campos['day_count'] = "on";
      $tab_blk_campos[] = "day_count";
      $tab_ger_campos['co_name'] = "on";
      $tab_ger_campos['main_contact_name'] = "on";
      $tab_blk_campos[] = "main_contact_name";
      $tab_ger_campos['main_contact_phone'] = "on";
      $tab_blk_campos[] = "main_contact_phone";
      $tab_ger_campos['email_sent'] = "on";
      $tab_blk_campos[] = "email_sent";
      $tab_ger_campos['renewal_msg'] = "on";
      $tab_blk_campos[] = "renewal_msg";
      $tab_ger_campos['main_phone'] = "on";
      $tab_ger_campos['main_email'] = "on";
      $tab_ger_campos['bus_cat'] = "on";
      $tab_ger_campos['bus_subcategory'] = "on";
      $tab_ger_campos['street_address'] = "on";
      $tab_ger_campos['mailing_address'] = "on";
      $tab_ger_campos['city'] = "on";
      $tab_ger_campos['state'] = "on";
      $tab_ger_campos['zip_code'] = "on";
      $tab_ger_campos['home_phone'] = "on";
      $tab_ger_campos['main_contact_email'] = "on";
      $tab_ger_campos['main_contact_title'] = "on";
      $tab_ger_campos['permanent_member_date'] = "on";
      ...
      if (isset($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['php_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              if ($NM_cada_opc == "off")
              {
                 $tab_ger_campos[$NM_cada_field] = "none";
      ...
      if ($this->restore)
      {
          if (isset($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel_orig']) && !empty($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel_orig']))
          {
              foreach ($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel_orig'] as $NM_cada_field => $NM_cada_opc)
              {
      ...
      {
          if (isset($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel']))
          {
              foreach ($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
              {
                  $tab_ger_campos[$NM_cada_field] = $NM_cada_opc;
              }
          }
...
function Sel_processa_out()
{
   ...
   $arr_temp = array();
   if (!isset($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel']))
   {
       $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel'] = array();
   }
   if($this->bol_sel_campos_include)
   {
       $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['export_sel_columns']['field_order'] = $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order'];
       $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['export_sel_columns']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel'];
   }
   $arr_order = $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order'];
   $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order'] = array();
   $campos_sel = explode("@?@", $this->campos_sel);
   foreach ($campos_sel as $campo_order)
   {
       if (isset($tab_ger_campos[$campo_order]))
       {
           $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order'][] = $campo_order;
       }
   }
   foreach ($arr_order as $campo_order)
   {
       if (!in_array($campo_order, $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order']))
       {
           $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order'][] = $campo_order;
       }
   }
   ...
   $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel'] = $arr_temp;
   if($this->bol_sel_campos_include)
   {
       return;
   }
...
?>
   $.ajax({
    type: "POST",
    url: "grid_vw_clients_main_member_inactive_sel_campos.php",
    data: {
          ...
          if ($this->proc_ajax)
          {
           ...
           foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
           {
               if ($NM_cada_opc != "none")
               {
                   ...
                   {
/*--- mantis 24870 ---*/
/*                       $prep_combo[strtolower($NM_cada_field)] = $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['labels'][$NM_cada_field]; */
                       $prep_combo[strtolower($NM_cada_field)] = $this->Tab_Labels[$NM_cada_field];
/*------*/
                   }
               }
           }
...
?>
   ...
   if ($this->restore && isset($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order_orig']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order_orig'] as $NM_cada_field)
       {
...
?>
                        ...
                        echo $this->Tab_Labels[$NM_cada_field];
                        if ($_SESSION['scriptcase']['proc_mobile']) {
                            echo '<div class="sc_ui_sorting-list-item-handle"><i class="fa-solid fa-grip-vertical"></i></div>';
                        }
                        ?></li>
<?php
   ...
   if (!$this->restore && isset($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order'] as $NM_cada_field)
       {
           if ($tab_ger_campos[$NM_cada_field] == "on")
           {
               $str_class = "scAppDivSelectFieldsDisabled";
...
?>
                        <li class="sc_ui_litem <?php echo $str_class; ?>" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $this->Tab_Labels[$NM_cada_field]; ?></li>
<?php
           }
       }
   }
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel']) && isset($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel_orig']) && $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel'] != $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel_orig']) {
      $disp_rest = "";
  }
  else {
      $order_orig = array();
      $order_atu  = array();
      foreach ($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order_orig'] as $ix => $cmp) {
          if (!isset($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel_orig'][$cmp]) || $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel_orig'][$cmp] != "off") {
              $order_orig[] = $cmp;
          }
      }
      foreach ($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['field_order'] as $ix => $cmp) {
          if (!isset($_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel'][$cmp]) || $_SESSION['sc_session'][$this->sc_init]['grid_vw_clients_main_member_inactive']['usr_cmp_sel'][$cmp] != "off") {
              $order_atu[] = $cmp;
          }
      }
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> vw_clients_main_member_renew</TITLE>
