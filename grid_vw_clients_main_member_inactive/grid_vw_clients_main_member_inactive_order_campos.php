...
<?php
   ...
   $Ord_Cmp = new grid_vw_clients_main_member_inactive_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_vw_clients_main_member_inactive_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["client_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["client_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["client_id"] : "Client ID";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["status"] : "Status";
   $tab_ger_campos['renewal_date'] = "on";
   $tab_def_campos['renewal_date'] = "renewal_date";
   $tab_labels["renewal_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["renewal_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["renewal_date"] : "Renewal Date";
   $tab_ger_campos['day_count'] = "on";
   $tab_def_campos['day_count'] = "day_count";
   $tab_labels["day_count"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["day_count"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["day_count"] : "Days";
   $tab_ger_campos['co_name'] = "on";
   $tab_def_campos['co_name'] = "co_name";
   $tab_labels["co_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["co_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["co_name"] : "Company";
   $tab_ger_campos['main_contact_name'] = "on";
   $tab_def_campos['main_contact_name'] = "main_contact_name";
   $tab_labels["main_contact_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["main_contact_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["main_contact_name"] : "Main Contact Name";
   $tab_ger_campos['main_contact_phone'] = "on";
   $tab_def_campos['main_contact_phone'] = "main_contact_phone";
   $tab_labels["main_contact_phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["main_contact_phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["main_contact_phone"] : "Main Contact Phone";
...
WHERE client_id = {client_id}";
   ...
   $tab_labels["email_sent"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["email_sent"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["email_sent"] : "Notified On";
   $tab_ger_campos['renewal_msg'] = "on";
   $tab_def_campos['renewal_msg'] = "renewal_msg";
   $tab_labels["renewal_msg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["renewal_msg"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['labels']["renewal_msg"] : "Membership";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_vw_clients_main_member_inactive_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_vw_clients_main_member_inactive']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
