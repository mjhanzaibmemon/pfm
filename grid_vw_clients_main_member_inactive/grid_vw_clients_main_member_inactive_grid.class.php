<?php
class grid_vw_clients_main_member_inactive_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['charts_html'] = '';
   ...
   { 
    if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       if (!$this->Proc_link_res && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != 'pdf' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] != 'print')
       { 
       $nm_saida->saida("     <TR>\r\n");
       $nm_saida->saida("      <TD id=\"div_refin_search\" class=\"scGridRefinedSearchPadding\" valign='top'>\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ajax_nav'])
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['refresh_interativ']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['refresh_interativ'] == "S") {
                   $this->Ini->Arr_result['setValue'][] = array('field' => 'div_refin_search', 'value' => NM_charset_to_utf8($_SESSION['scriptcase']['saida_html']));
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['refresh_interativ']);
               $tb_disp = (!empty($this->nm_grid_sem_reg) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_int_search']) ? 'none' : '';
               $this->Ini->Arr_result['setDisplay'][] = array('field' => 'TB_Interativ_Search', 'value' => $tb_disp);
           } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_int_search'] = false;
       $nm_saida->saida("      </TD>\r\n");
       $nm_saida->saida("      <TD class=\"scGridRefinedSearchMolduraResult\" valign='top'>\r\n");
       $nm_saida->saida("       <table width='100%' cellspacing=0 cellpadding=0>\r\n");
       } 
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_vw_clients_main_member_inactive'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'];
       ...
       $descr_refin = "";
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] != 'print' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_search']))
       { 
           $display_tag_interativ = "";
           $descr_refin = "<div class='scGridFilterTagList'>";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_search'] as $fil => $dados_fil) {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['save_grid']))
       {
           $this->refresh_interativ_search();
       }
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("en_us");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_vw_clients_main_member_inactive/grid_vw_clients_main_member_inactive_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_vw_clients_main_member_inactive", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_vw_clients_main_member_inactive'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_vw_clients_main_member_inactive'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
           $this->nmgp_botoes[$BTN] = $BTN_opc;
       }
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_sql_btn_run'] = array(); 
   $this->NM_btn_run_show = ($this->Ini->SC_Link_View || $this->grid_emb_form || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida']) ? false : true;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_psq']) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "print" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pdf") 
   { 
      $this->NM_btn_run_show = false;
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'])
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_vw_clients_main_member_inactive/grid_vw_clients_main_member_inactive_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_vw_clients_main_member_inactive_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_select'] = array(); 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao']       = "igual" ; 
...
// 
   ...
   $this->Tot->$Gb_geral();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['tot_geral'][1];
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid'];
   }
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->renewal_date = $this->rs_grid->fields[2] ;  
       $this->day_count = $this->rs_grid->fields[3] ;  
       $this->day_count = (string)$this->day_count;
       $this->co_name = $this->rs_grid->fields[4] ;  
       $this->main_contact_name = $this->rs_grid->fields[5] ;  
       $this->main_contact_phone = $this->rs_grid->fields[6] ;  
       $this->renewal_msg = $this->rs_grid->fields[7] ;  
       $this->main_phone = $this->rs_grid->fields[8] ;  
       $this->main_email = $this->rs_grid->fields[9] ;  
       $this->bus_cat = $this->rs_grid->fields[10] ;  
       $this->bus_subcategory = $this->rs_grid->fields[11] ;  
       $this->street_address = $this->rs_grid->fields[12] ;  
       $this->mailing_address = $this->rs_grid->fields[13] ;  
       $this->city = $this->rs_grid->fields[14] ;  
       $this->state = $this->rs_grid->fields[15] ;  
       $this->zip_code = $this->rs_grid->fields[16] ;  
       $this->home_phone = $this->rs_grid->fields[17] ;  
       $this->main_contact_email = $this->rs_grid->fields[18] ;  
       $this->main_contact_title = $this->rs_grid->fields[19] ;  
       $this->permanent_member_date = $this->rs_grid->fields[20] ;  
       $this->notif_color = $this->rs_grid->fields[21] ;  
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
<!DOCTYPE html>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_vw_clients_main_member_inactive_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_vw_clients_main_member_inactive_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_vw_clients_main_member_inactive_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_vw_clients_main_member_inactive_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_vw_clients_main_member_inactive_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/grp__NM__bg__NM__pfm_img.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_vw_clients_main_member_inactive_jquery_8639.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_vw_clients_main_member_inactive_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_vw_clients_main_member_inactive_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida']) {  
...
foreach ($this->Ini->tippy_themes as $tippyTheme => $tippyThemeInfo) {
        ...
        if ($this->Fix_bar_top) {
           ...
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    selectedFields = $(\".sc-ui-grid-header-row-grid_vw_clients_main_member_inactive-1 .sc-op-fix-col.sc-op-fix-col-fixed\");\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid']) . ";\r\n");
           }
           $gridWidthCorrection = '';
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_vw_clients_main_member_inactive-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_vw_clients_main_member_inactive-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_vw_clients_main_member_inactive-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-319502ff\");\r\n");
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_vw_clients_main_member_inactive_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_vw_clients_main_member_inactive_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_vw_clients_main_member_inactive_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_vw_clients_main_member_inactive/grid_vw_clients_main_member_inactive_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_vw_clients_main_member_inactive_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_vw_clients_main_member_inactive_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_vw_clients_main_member_inactive_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'])
   { 
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pdf" && !$this->Print_All && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby'] == "sc_free_total")
           {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['doc_word'])
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf_vert'])
   {
   }
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] != "print") 
       { 
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_grid_vw_clients_main_member_inactive\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" style=\"display: block;\" name=\"nm_iframe_liga_A_grid_vw_clients_main_member_inactive\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
       }
           $nm_saida->saida("    <TR>\r\n");
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_grid_vw_clients_main_member_inactive\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" style=\"display: block;\" name=\"nm_iframe_liga_E_grid_vw_clients_main_member_inactive\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_grid_vw_clients_main_member_inactive\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" style=\"display: block;\" name=\"nm_iframe_liga_AL_grid_vw_clients_main_member_inactive\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_vw_clients_main_member_inactive']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_vw_clients_main_member_inactive']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_vw_clients_main_member_inactive']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_vw_clients_main_member_inactive']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida']) ? "grid_vw_clients_main_member_inactive_" : "";
   $this->css_sep = " ";
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_vw_clients_main_member_inactive__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_vw_clients_main_member_inactive-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_label']) { 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf") {
       $classColFld = "";
       $classColTitle = "";
       $classColActions = "";
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != 'pdf') {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_vw_clients_main_member_inactive_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
...
function SC_label_rightActionBar()
{
   ...
   $nm_saida->saida("</TD>\r\n");
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['client_id'])) ? $this->New_label['client_id'] : "Client ID";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['client_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['status'])) ? $this->New_label['status'] : "Status";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['status'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['renewal_date'])) ? $this->New_label['renewal_date'] : "Renewal Date";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['renewal_date'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['day_count'])) ? $this->New_label['day_count'] : "Days";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['day_count'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['co_name'])) ? $this->New_label['co_name'] : "Company";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['co_name'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['main_contact_name'])) ? $this->New_label['main_contact_name'] : "Main Contact Name";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['main_contact_name'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['main_contact_phone'])) ? $this->New_label['main_contact_phone'] : "Main Contact Phone";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['main_contact_phone'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['email_sent'])) ? $this->New_label['email_sent'] : "Notified On";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['email_sent'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['renewal_msg'])) ? $this->New_label['renewal_msg'] : "Membership";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['renewal_msg'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['main_phone'])) ? $this->New_label['main_phone'] : "Main Phone";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['main_phone'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['main_email'])) ? $this->New_label['main_email'] : "Main Email";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['main_email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bus_cat'])) ? $this->New_label['bus_cat'] : "Bus. Category";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['bus_cat'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bus_subcategory'])) ? $this->New_label['bus_subcategory'] : "Bus. Subcategory";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['bus_subcategory'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['street_address'])) ? $this->New_label['street_address'] : "Street Address";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['street_address'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['mailing_address'])) ? $this->New_label['mailing_address'] : "Mailing Address";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['mailing_address'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['city'])) ? $this->New_label['city'] : "City";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['city'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['state'])) ? $this->New_label['state'] : "State";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['state'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['zip_code'])) ? $this->New_label['zip_code'] : "Zip Code";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['zip_code'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['home_phone'])) ? $this->New_label['home_phone'] : "Home Phone";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['home_phone'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['main_contact_email'])) ? $this->New_label['main_contact_email'] : "Main Contact Email";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['main_contact_email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['main_contact_title'])) ? $this->New_label['main_contact_title'] : "Main Contact Title";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['main_contact_title'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['permanent_member_date'])) ? $this->New_label['permanent_member_date'] : "Member Since";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['labels']['permanent_member_date'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_vw_clients_main_member_inactive']['lig_edit'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ajax_nav'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_refresh'])
   {
       $this->refresh_interativ_search();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_refresh'] = false;
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_vw_clients_main_member_inactive#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff']['lig_iframe_modal'] = "nmsc_iframe_liga_grid_vw_clients_main_member_inactive";
           }
           $nm_saida->saida(" <TR> \r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] != "print") 
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_vw_clients_main_member_inactive\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" style=\"display: block;\" name=\"nm_iframe_liga_EL_grid_vw_clients_main_member_inactive\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_grid_vw_clients_main_member_inactive', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_grid_vw_clients_main_member_inactive', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_grid_vw_clients_main_member_inactive', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" &&
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_grid_vw_clients_main_member_inactive\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" style=\"display: block;\" name=\"nm_iframe_liga_DL_grid_vw_clients_main_member_inactive\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               if (!$_SESSION['scriptcase']['proc_mobile']) {
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_grid_vw_clients_main_member_inactive\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" style=\"display: block;\" name=\"nm_iframe_liga_D_grid_vw_clients_main_member_inactive\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               }
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
...
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_vw_clients_main_member_inactive\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" style=\"display: block;\" name=\"nm_iframe_liga_EL_grid_vw_clients_main_member_inactive\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_grid_vw_clients_main_member_inactive#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-319502ff\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Page_break_PDF'] = array();
       }
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_vw_clients_main_member_inactive_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          {
              $this->SC_seq_btn_run++;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_sql_btn_run'][$this->SC_seq_btn_run] = $this->rs_grid->fields;
          }
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['rows_emb']++;
...
$_SESSION['scriptcase']['grid_vw_clients_main_member_inactive']['contr_erro'] = 'off';
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['mostra_edit'] != "N"){ 
              if ($this->grid_emb_form_full)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff']['lig_iframe_modal'] = "nmsc_iframe_liga_grid_vw_clients_main_member_inactive";
              }
              ...
              {
                  $Parms_Edt  = "client_id*scin" . str_replace('"', "@aspasd@", $this->client_id) . "*scoutgv_cust_id*scin" . str_replace('"', "@aspasd@", $this->client_id) . "*scoutgv_from_grid*scinrenewals*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutsc_redir_atualiz*scinok*scoutsc_redir_atualiz*scinok*scout";
                  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['under_dashboard'] && isset($linkTarget))
                  {
                      if ('' != $Parms_Edt && '?@?' != substr($Parms_Edt, -3) && '*scout' != substr($Parms_Edt, -6))
                      {
                          $Parms_Edt .= '*scout';
                      }
                      $Parms_Edt .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['remove_margin'] ? '1' : '0') . '*scoutremove_border*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['remove_border'] ? '1' : '0') . '*scoutremove_background*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['remove_background'] ? '1' : '0');
                  }
                  $Md5_Edt    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_vw_clients_main_member_inactive@SC_par@" . md5($Parms_Edt);
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Lig_Md5'][md5($Parms_Edt)] = $Parms_Edt;
              }
              else
              {
                  $Md5_Edt  = "client_id*scin" . str_replace('"', "@aspasd@", $this->client_id) . "*scoutgv_cust_id*scin" . str_replace('"', "@aspasd@", $this->client_id) . "*scoutgv_from_grid*scinrenewals*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutsc_redir_atualiz*scinok*scoutsc_redir_atualiz*scinok*scout";
              }
 ...
 $this->grid_fixed_column_no++;} 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
...
function SC_grid_rightActionBar()
{
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['mostra_edit'] != "N"){ 
   ...
   $nm_saida->saida("<td style=\"padding: 0\">\r\n");
            ...
            if (isset($this->Ini->sc_lig_md5["blank_renewal_link"]) && $this->Ini->sc_lig_md5["blank_renewal_link"] == "S") {
                ...
                $Md5_Lig = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_vw_clients_main_member_inactive@SC_par@" . md5($Parms_Lig);
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
            } else {
 ...
 function NM_grid_client_id()
 {
      ...
      if (!isset($this->NM_cmp_hidden['client_id']) || $this->NM_cmp_hidden['client_id'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && !empty($conteudo)) 
          { 
 ...
 function NM_grid_status()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['status']) || $this->NM_cmp_hidden['status'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 {
   $this->NM_colspan  = 26;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_psq'] || $this->NM_btn_run_show)
   {
       $this->NM_colspan++;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['print_navigator'] == "Netscape")
            {
        ...
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ajax_nav'])
          {
          ...
          $SC_Label_atu['client_id'] = (isset($this->New_label['client_id'])) ? $this->New_label['client_id'] : 'Client ID'; 
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_vw_clients_main_member_inactive/grid_vw_clients_main_member_inactive_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_vw_clients_main_member_inactive/grid_vw_clients_main_member_inactive_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_vw_clients_main_member_inactive/grid_vw_clients_main_member_inactive_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_vw_clients_main_member_inactive/grid_vw_clients_main_member_inactive_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby'] != "sc_free_total")
          {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['SC_Gb_Free_cmp']))
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_vw_clients_main_member_inactive/grid_vw_clients_main_member_inactive_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_vw_clients_main_member_inactive&nm_tp_xls=xlsx&nm_tot_xls=N&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=cons&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if (is_file("grid_vw_clients_main_member_inactive_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_vw_clients_main_member_inactive_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_lin_grid'] == '50') ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
   ...
   function nmgp_embbed_placeholder_bot()
   {
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ] as $ind => $vals)
                        {
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ], $str_value) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ], $str_value_original) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        else
                        {
                            $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ], '/');
                            $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                        }
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ] as $ind => $vals)
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ] as $ind => $vals)
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ]))) == 0)
                        {
                            $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campos_busca'][ $field ]));
                        }
                    }
                }
            }
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dyn_search']) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dyn_search'])
            )
            {
                foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dyn_search'] as $_fld)
                {
                    if($_fld['cmp'] == $field)
                    {
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][0] == 'SC_all_Cmp' &&
                    ...
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
   ...
   function html_interativ_search()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['int_search_label'] = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['int_search_dados']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['int_search_dados'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['int_search_sql']   = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_search'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['int_search_label']['day_count'] = (isset($this->New_label['day_count'])) ? $this->New_label['day_count'] : 'Days';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['int_search_sql']['day_count']   = "day_count";
   ...
   function refresh_interativ_search()
   {
       ...
       if(is_array($array_fields) && !empty($array_fields))
       {
           ...
           {
               if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_search'][$str_field]))
               {
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_search']["day_count"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_search']["day_count"])) ? "none" : "";
       $displ_open= true;
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['int_search_label']['day_count'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       ...
       $tmp_where = "";
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_pesq']))
       {
           $tmp_where = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['where_pesq'];
       }
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['interativ_search']['day_count'])) ? "" : "none";
     ...
     if(count($result) >=2)
     {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['refin_slider_day_count'])) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['refin_slider_day_count']['min'] = $range_min;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['refin_slider_day_count']['max'] = $range_max;
           $range_min_orig = $range_min;
           $range_max_orig = $range_max;
       }
       else {
           $range_min_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['refin_slider_day_count']['min'];
           $range_max_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['refin_slider_day_count']['max'];
       }
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       $lin_obj  .= "   </div></td></tr>";
           ...
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('range', 'bw','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['int_search_label']['day_count']) . "','day_count','id_int_search_day_count','day_count', '', 'S');", "nm_proc_int_search('range', 'bw','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['int_search_label']['day_count']) . "','day_count','id_int_search_day_count','day_count', '', 'S');", "app_int_search_range_day_count", "", "", "display: $disp_btn_range", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $lin_obj .= "      </div>";
           $lin_obj .= "     </td>";
           $lin_obj .= "    </tr>";
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if ($nm_target == "modal")
      {
          ...
          $par_modal = "?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&nmgp_outra_jan=true&nmgp_url_saida=modal&NMSC_modal=ok&";
           if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida_form_full']) || (isset($this->grid_emb_form_full) && $this->grid_emb_form_full))
           {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
...
?>
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_grid_vw_clients_main_member_inactive\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" style=\"display: block;\" name=\"nm_iframe_liga_B_grid_vw_clients_main_member_inactive\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ajax_nav'])
       {
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ajax_nav'])
       {
           $this->Ini->Arr_result['setDisabled'][] = array('field' => 'first_bot', 'value' => "true");
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ajax_nav'])
               {
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['ajax_nav'])
               {
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_vw_clients_main_member_inactive', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_vw_clients_main_member_inactive\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_vw_clients_main_member_inactive_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_vw_clients_main_member_inactive/grid_vw_clients_main_member_inactive_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_vw_clients_main_member_inactive_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("       scJs_confirm('Are you sure you want to send emails notifying Inactive status for the selected records? This process may take around 10 seconds per email.', sc_btn_send_emails_ok, sc_btn_send_emails_cancel)\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_modal']) || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['dashboard_info']['under_dashboard'])) {
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_vw_clients_main_member_inactive';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_grid_vw_clients_main_member_inactive');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_grid_vw_clients_main_member_inactive');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_grid_vw_clients_main_member_inactive');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_grid_vw_clients_main_member_inactive');} \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['grid_vw_clients_main_member_inactive_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_vw_clients_main_member_inactive@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_vw_clients_main_member_inactive_iframe.php\";\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_vw_clients_main_member_inactive_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_vw_clients_main_member_inactive']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_vw_clients_main_member_inactive_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_inactive']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_vw_clients_main_member_inactive')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_vw_clients_main_member_inactive', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
