<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vw_clients_main_member_inactive']['sc_process_barr'] = true;
require_once('../grid_vw_clients_main_member_inactive/index.php');
unset($_SESSION['scriptcase']['grid_vw_clients_main_member_inactive']['sc_process_barr']);
$ExportCtrl = new grid_vw_clients_main_member_inactive_export_control;
$ExportCtrl->Export_barr();

class grid_vw_clients_main_member_inactive_export_control
{
