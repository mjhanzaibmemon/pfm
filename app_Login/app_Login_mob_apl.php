...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->app_ver) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['app_ver'] = $this->app_ver;
      }
      ...
      if (isset($_POST["app_ver"]) && isset($this->app_ver)) 
      {
          $_SESSION['app_ver'] = $this->app_ver;
      }
      ...
      if (isset($_GET["app_ver"]) && isset($this->app_ver)) 
      {
          $_SESSION['app_ver'] = $this->app_ver;
      }
...
if (!isset($this->sc_temp_app_ver)) {$this->sc_temp_app_ver = (isset($_SESSION['app_ver'])) ? $_SESSION['app_ver'] : "";}
...
$this->sc_temp_app_ver = 'Version '.$this->Ini->nm_app_version;
if (isset($this->sc_temp_app_ver)) { $_SESSION['app_ver'] = $this->sc_temp_app_ver;}
$_SESSION['scriptcase']['app_Login_mob']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_Login_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_Login_mob']['label'] = "PFM - Login";
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['opc_ant'] : "";
      } 
...
$_SESSION['scriptcase']['app_Login_mob']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
...
<HEAD>
 <TITLE><?php echo strip_tags("PFM - Login") ?></TITLE>
...
;
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('menu_main') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
 };	
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['dyn_search_cache']);
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo ""; } else { echo "PFM - Login"; } ?></div>
    <div class="scFormHeaderFont" style="float: right;"><?php echo "" . $_SESSION['app_ver'] . "" ?></div>
</div>
    </td></tr>
<?php
    }
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['total'] + 1,
            ],
            $summaryLine
        );
