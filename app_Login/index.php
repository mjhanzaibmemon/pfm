...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_Login']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['app_Login']['dashboard_info']['remove_background'] = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_background'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_Login']['dashboard_info']['remove_background'] = 1 == $_GET['remove_background'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_background)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_Login']['dashboard_info']['remove_background'] = 1 == $remove_background;
              }
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['app_Login']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_remove_background) && 'ok' == $link_remove_background) {
            ...
            $_SESSION['sc_session'][$this->sc_page]['app_Login']['link_info']['remove_background'] = true;
        }
        if (isset($link_margin_top) && '' != $link_margin_top) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_Login']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_Login']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_Login']['link_info']['margin_top'] = $link_margin_top;
        }
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'PFM_Staff', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'PFM_Staff', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    else
    {
        ...
        if (isset($_POST["app_ver"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['app_ver']);
        }
...
//
    ...
    function ajax_app_Login_submit_form($login, $pswd, $remember_me, $new_user, $retrieve_pswd, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
...
/* mantis 0021191 */            $inicial_app_Login->contr_app_Login->NM_ajax_info['buttonDisplay'] = $inicial_app_Login->contr_app_Login->nmgp_botoes;
         ...
         if (isset($inicial_app_Login->contr_app_Login->NM_ajax_info['dyn_search']) && !empty($inicial_app_Login->contr_app_Login->NM_ajax_info['dyn_search']))
         {
            $aResp['dyn_search'] = array();
            foreach ($inicial_app_Login->contr_app_Login->NM_ajax_info['dyn_search'] as $Tag => $Val) {
