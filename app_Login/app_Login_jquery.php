...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_new_user' + iSeqRow).bind('change', function() { sc_app_Login_new_user_onchange(this, iSeqRow) });
  $('#id_sc_field_retrieve_pswd' + iSeqRow).bind('change', function() { sc_app_Login_retrieve_pswd_onchange(this, iSeqRow) });
