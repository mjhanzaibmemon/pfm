  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_members_pmt_links_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_members_pmt_links_mob_form();
        }
...
?>
  ...
  // ---------- Validate bus_cat_id
  function do_ajax_form_members_pmt_links_mob_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldSelect(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_pmt_links_mob_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_members_pmt_links_mob_validate_bus_cat_id_cb);
  } // do_ajax_form_members_pmt_links_mob_validate_bus_cat_id

  function do_ajax_form_members_pmt_links_mob_validate_bus_cat_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_pmt_links_mob_validate_bus_cat_id_cb

  // ---------- Validate stripe_price_id
  function do_ajax_form_members_pmt_links_mob_validate_stripe_price_id()
  {
    var nomeCampo_stripe_price_id = "stripe_price_id";
    var var_stripe_price_id = scAjaxGetFieldText(nomeCampo_stripe_price_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_pmt_links_mob_validate_stripe_price_id(var_stripe_price_id, var_script_case_init, do_ajax_form_members_pmt_links_mob_validate_stripe_price_id_cb);
  } // do_ajax_form_members_pmt_links_mob_validate_stripe_price_id

  function do_ajax_form_members_pmt_links_mob_validate_stripe_price_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_pmt_links_mob_validate_stripe_price_id_cb

  // ---------- Validate stripe_id
  function do_ajax_form_members_pmt_links_mob_validate_stripe_id()
  {
    var nomeCampo_stripe_id = "stripe_id";
    var var_stripe_id = scAjaxGetFieldHidden(nomeCampo_stripe_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_pmt_links_mob_validate_stripe_id(var_stripe_id, var_script_case_init, do_ajax_form_members_pmt_links_mob_validate_stripe_id_cb);
  } // do_ajax_form_members_pmt_links_mob_validate_stripe_id

  function do_ajax_form_members_pmt_links_mob_validate_stripe_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stripe_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_pmt_links_mob_validate_stripe_id_cb

  // ---------- Validate pmt_link
  function do_ajax_form_members_pmt_links_mob_validate_pmt_link()
  {
    var nomeCampo_pmt_link = "pmt_link";
    var var_pmt_link = scAjaxGetFieldText(nomeCampo_pmt_link);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_pmt_links_mob_validate_pmt_link(var_pmt_link, var_script_case_init, do_ajax_form_members_pmt_links_mob_validate_pmt_link_cb);
  } // do_ajax_form_members_pmt_links_mob_validate_pmt_link

  function do_ajax_form_members_pmt_links_mob_validate_pmt_link_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pmt_link";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_pmt_links_mob_validate_pmt_link_cb

  // ---------- Validate num_of_members
  function do_ajax_form_members_pmt_links_mob_validate_num_of_members()
  {
    var nomeCampo_num_of_members = "num_of_members";
    var var_num_of_members = scAjaxGetFieldText(nomeCampo_num_of_members);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_pmt_links_mob_validate_num_of_members(var_num_of_members, var_script_case_init, do_ajax_form_members_pmt_links_mob_validate_num_of_members_cb);
  } // do_ajax_form_members_pmt_links_mob_validate_num_of_members

  function do_ajax_form_members_pmt_links_mob_validate_num_of_members_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "num_of_members";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_pmt_links_mob_validate_num_of_members_cb

  // ---------- Validate memb_cost
  function do_ajax_form_members_pmt_links_mob_validate_memb_cost()
  {
    var nomeCampo_memb_cost = "memb_cost";
    var var_memb_cost = scAjaxGetFieldText(nomeCampo_memb_cost);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_pmt_links_mob_validate_memb_cost(var_memb_cost, var_script_case_init, do_ajax_form_members_pmt_links_mob_validate_memb_cost_cb);
  } // do_ajax_form_members_pmt_links_mob_validate_memb_cost

  function do_ajax_form_members_pmt_links_mob_validate_memb_cost_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "memb_cost";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_pmt_links_mob_validate_memb_cost_cb

  // ---------- Validate descript
  function do_ajax_form_members_pmt_links_mob_validate_descript()
  {
    var nomeCampo_descript = "descript";
    var var_descript = scAjaxGetFieldText(nomeCampo_descript);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_pmt_links_mob_validate_descript(var_descript, var_script_case_init, do_ajax_form_members_pmt_links_mob_validate_descript_cb);
  } // do_ajax_form_members_pmt_links_mob_validate_descript

  function do_ajax_form_members_pmt_links_mob_validate_descript_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descript";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_pmt_links_mob_validate_descript_cb

  // ---------- Validate active
  function do_ajax_form_members_pmt_links_mob_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldRadio(nomeCampo_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_pmt_links_mob_validate_active(var_active, var_script_case_init, do_ajax_form_members_pmt_links_mob_validate_active_cb);
  } // do_ajax_form_members_pmt_links_mob_validate_active

  function do_ajax_form_members_pmt_links_mob_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_pmt_links_mob_validate_active_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_members_pmt_links_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_members_pmt_links_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    var var_stripe_price_id = scAjaxGetFieldText("stripe_price_id");
    var var_stripe_id = scAjaxGetFieldHidden("stripe_id");
    var var_pmt_link = scAjaxGetFieldText("pmt_link");
    var var_num_of_members = scAjaxGetFieldText("num_of_members");
    var var_memb_cost = scAjaxGetFieldText("memb_cost");
    var var_descript = scAjaxGetFieldText("descript");
    var var_active = scAjaxGetFieldRadio("active");
    var var_memb_pmt_link_id = scAjaxGetFieldText("memb_pmt_link_id");
    ...
    scAjaxProcOn();
    x_ajax_form_members_pmt_links_mob_submit_form(var_bus_cat_id, var_stripe_price_id, var_stripe_id, var_pmt_link, var_num_of_members, var_memb_cost, var_descript, var_active, var_memb_pmt_link_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_members_pmt_links_mob_submit_form_cb);
  } // do_ajax_form_members_pmt_links_mob_submit_form

  function do_ajax_form_members_pmt_links_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("stripe_id");
      scAjaxHideErrorDisplay("pmt_link");
      scAjaxHideErrorDisplay("num_of_members");
      scAjaxHideErrorDisplay("memb_cost");
      scAjaxHideErrorDisplay("descript");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_members_pmt_links_mob_submit_form_cb_after_alert);
  } // do_ajax_form_members_pmt_links_mob_submit_form_cb
  function do_ajax_form_members_pmt_links_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_members_pmt_links_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_members_pmt_links_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_members_pmt_links_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_members_pmt_links_mob_navigate_form();
    }
  }

  function perform_ajax_form_members_pmt_links_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("descript");
    scAjaxHideErrorDisplay("active");
    var var_memb_pmt_link_id = document.F2.memb_pmt_link_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_members_pmt_links_mob_navigate_form(var_memb_pmt_link_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_members_pmt_links_mob_navigate_form_cb);
  } // do_ajax_form_members_pmt_links_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_pmt_links_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_members_pmt_links_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.memb_pmt_link_id.value = scAjaxGetKeyValue("memb_pmt_link_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_members_pmt_links_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_members_pmt_links_mob_navigate_form_cb
  function do_ajax_form_members_pmt_links_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_members_pmt_links_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_members_pmt_links_mob_navigate_form_cb_after_alert

  function sc_hide_form_members_pmt_links_mob_form()
  {
  ...
  ajax_field_list[0] = "bus_cat_id";
  ajax_field_list[1] = "stripe_price_id";
  ajax_field_list[2] = "stripe_id";
  ajax_field_list[3] = "pmt_link";
  ajax_field_list[4] = "num_of_members";
  ajax_field_list[5] = "memb_cost";
  ajax_field_list[6] = "descript";
  ajax_field_list[7] = "active";
  ...
  var ajax_error_list = {
    ...
    "stripe_id": {"label": "Stripe Product ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pmt_link": {"label": "Payment Link", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "num_of_members": {"label": "Number of Members", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "memb_cost": {"label": "Price", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "descript": {"label": "Description", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "active": {"label": "Active", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["stripe_id"][1] = "stripe_id";
  ajax_field_mult["pmt_link"][1] = "pmt_link";
  ajax_field_mult["num_of_members"][1] = "num_of_members";
  ajax_field_mult["memb_cost"][1] = "memb_cost";
  ajax_field_mult["descript"][1] = "descript";
  ...
  var ajax_field_id = {
    ...
    "stripe_id": new Array("hidden_field_label_stripe_id", "hidden_field_data_stripe_id"),
    "pmt_link": new Array("hidden_field_label_pmt_link", "hidden_field_data_pmt_link"),
    "num_of_members": new Array("hidden_field_label_num_of_members", "hidden_field_data_num_of_members"),
    "memb_cost": new Array("hidden_field_label_memb_cost", "hidden_field_data_memb_cost"),
    "descript": new Array("hidden_field_label_descript", "hidden_field_data_descript"),
