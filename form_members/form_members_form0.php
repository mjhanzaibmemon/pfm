<?php
class form_members_form extends form_members_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['sc_redir_atualiz'] == 'ok')
{
?>
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_members/form_members_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_members_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_members_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['link_info']['remove_border']) {
...
<?php
 include_once("form_members_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_members'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_members'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_members);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_members = $this->form_vert_form_members;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_members))
   {
       $sc_seq_vert = 0;
   }
   foreach ($this->form_vert_form_members as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       $this->loadRecordState($sc_seq_vert);
       $this->member_id_ = $this->form_vert_form_members[$sc_seq_vert]['member_id_'];
       $this->client_id_ = $this->form_vert_form_members[$sc_seq_vert]['client_id_'];
       $this->include_ = $this->form_vert_form_members[$sc_seq_vert]['include_'];
       $this->driver_lic_id_ = $this->form_vert_form_members[$sc_seq_vert]['driver_lic_id_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->member_name_ = $this->form_vert_form_members[$sc_seq_vert]['member_name_']; 
       ...
       $this->main_contact_ = $this->form_vert_form_members[$sc_seq_vert]['main_contact_']; 
       ...
       $this->phone1_ = $this->form_vert_form_members[$sc_seq_vert]['phone1_']; 
       ...
       $this->email_ = $this->form_vert_form_members[$sc_seq_vert]['email_']; 
       $email_ = $this->email_; 
       $sStyleHidden_email_ = '';
       ...
       $this->note_ = $this->form_vert_form_members[$sc_seq_vert]['note_']; 
       $note_ = $this->note_; 
       $sStyleHidden_note_ = '';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_members_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_members_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_members_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_members_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_members_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_members_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['Lookup_main_contact_'][] = '1'; ?>
 <option  value="0" <?php  if ($this->main_contact_ == "0") { echo " selected" ;} ?><?php  if (empty($this->main_contact_)) { echo " selected" ;} ?>>--</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['Lookup_main_contact_'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<span id="id_read_on_phone1_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-phone1_<?php echo $sc_seq_vert ?> css_phone1__line" style="<?php echo $sStyleReadLab_phone1_; ?>"><?php echo $this->form_format_readonly("phone1_", $this->form_encode_input($this->phone1_)); ?></span><span id="id_read_off_phone1_<?php echo $sc_seq_vert ?>" class="css_read_off_phone1_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_phone1_; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=14"; } ?> maxlength=124 alt="{datatype: 'mask', maxLength: 100, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', maskList: '(999) 999-999 **********', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<span id="id_read_on_email_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-email_<?php echo $sc_seq_vert ?> css_email__line" style="<?php echo $sStyleReadLab_email_; ?>"><?php echo $this->form_format_readonly("email_", $this->form_encode_input($this->email_)); ?></span><span id="id_read_off_email_<?php echo $sc_seq_vert ?>" class="css_read_off_email_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_email_; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=20"; } ?> maxlength=255 alt="{enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" >&nbsp;<span style="display: none"><?php echo nmButtonOutput($this->arr_buttons, "bemail", "if (document.F1.email_" . $sc_seq_vert . ".value != '') {window.open('mailto:' + document.F1.email_" . $sc_seq_vert . ".value); }", "if (document.F1.email_" . $sc_seq_vert . ".value != '') {window.open('mailto:' + document.F1.email_" . $sc_seq_vert . ".value); }", "email_" . $sc_seq_vert . "_mail", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
</span>
</span><?php } ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_members = $guarda_form_vert_form_members;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['last'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['btn_label']['exit'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_members");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_members");
 parent.scAjaxDetailHeight("form_members", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
        ...
        function scBtnFn_sys_format_inc() {
                if ($("#sc_b_new_b.sc-unique-btn-1").length && $("#sc_b_new_b.sc-unique-btn-1").is(":visible")) {
                    if ($("#sc_b_new_b.sc-unique-btn-1").hasClass("disabled")) {
                        ...
                        do_ajax_form_members_add_new_line(); return false;
                         return;
                }
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
