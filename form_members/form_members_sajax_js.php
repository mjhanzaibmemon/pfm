  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_members" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_members_validate_member_name_(iNumLinha)
  {
    ...
    x_ajax_form_members_validate_member_name_(var_member_name_, iNumLinha, var_script_case_init, do_ajax_form_members_validate_member_name__cb);
  } // do_ajax_form_members_validate_member_name_

  function do_ajax_form_members_validate_member_name__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_validate_member_name__cb

  // ---------- Validate main_contact_
  function do_ajax_form_members_validate_main_contact_(iNumLinha)
  {
    var nomeCampo_main_contact_ = "main_contact_" + iNumLinha;
    var var_main_contact_ = scAjaxGetFieldSelect(nomeCampo_main_contact_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_validate_main_contact_(var_main_contact_, iNumLinha, var_script_case_init, do_ajax_form_members_validate_main_contact__cb);
  } // do_ajax_form_members_validate_main_contact_

  function do_ajax_form_members_validate_main_contact__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_validate_main_contact__cb

  // ---------- Validate phone1_
  function do_ajax_form_members_validate_phone1_(iNumLinha)
  {
    var nomeCampo_phone1_ = "phone1_" + iNumLinha;
    var var_phone1_ = scAjaxGetFieldText(nomeCampo_phone1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_validate_phone1_(var_phone1_, iNumLinha, var_script_case_init, do_ajax_form_members_validate_phone1__cb);
  } // do_ajax_form_members_validate_phone1_

  function do_ajax_form_members_validate_phone1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_validate_phone1__cb

  // ---------- Validate email_
  function do_ajax_form_members_validate_email_(iNumLinha)
  {
    var nomeCampo_email_ = "email_" + iNumLinha;
    var var_email_ = scAjaxGetFieldText(nomeCampo_email_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_validate_email_(var_email_, iNumLinha, var_script_case_init, do_ajax_form_members_validate_email__cb);
  } // do_ajax_form_members_validate_email_

  function do_ajax_form_members_validate_email__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_validate_email__cb

  // ---------- Validate note_
  function do_ajax_form_members_validate_note_(iNumLinha)
  {
    var nomeCampo_note_ = "note_" + iNumLinha;
    var var_note_ = scAjaxGetFieldText(nomeCampo_note_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_validate_note_(var_note_, iNumLinha, var_script_case_init, do_ajax_form_members_validate_note__cb);
  } // do_ajax_form_members_validate_note_

  function do_ajax_form_members_validate_note__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_validate_note__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_members_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_members_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_members_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_members_add_new_line_cb);
  } // do_ajax_form_members_add_new_line

  function do_ajax_form_members_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_members_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_members_backup_line(iNumLinha)
  {
    var var_member_id_ = scAjaxGetFieldText("member_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_backup_line(var_member_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_members_backup_line_cb);
  } // do_ajax_form_members_backup_line

  function do_ajax_form_members_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_members_backup_line_cb

  function do_ajax_form_members_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_members_cancel_insert

  function do_ajax_form_members_cancel_update(iSeqVert)
  {
    do_ajax_form_members_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_members_cancel_update

  function do_ajax_form_members_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_members_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_members_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_members_table_refresh(var_member_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_members_table_refresh_cb);
  } //  do_ajax_form_members_table_refresh

  function do_ajax_form_members_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_members_table_refresh_cb_after_alert);
  } // do_ajax_form_members_table_refresh_cb
  function do_ajax_form_members_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_members_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_members_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_members_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_members_submit_form(var_member_name_, var_main_contact_, var_phone1_, var_email_, var_note_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_members_submit_form_cb);
  } // do_ajax_form_members_submit_form

  function do_ajax_form_members_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_members_submit_form_cb_after_alert);
  } // do_ajax_form_members_submit_form_cb
  function do_ajax_form_members_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_members_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_members_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_members_navigate_form, function() {});
    } else {
      perform_ajax_form_members_navigate_form();
    }
  }

  function perform_ajax_form_members_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_members_cancel_insert(sc_form_members_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_members_navigate_form(var_member_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_members_navigate_form_cb);
  } // do_ajax_form_members_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_members_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_members_navigate_form_cb_after_alert);
  } // do_ajax_form_members_navigate_form_cb
  function do_ajax_form_members_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_members_navigate_form_cb_after_alert

    function sc_form_members_get_last_line_number()
    {
    ...
    } //sc_form_members_get_last_line_number

  function sc_hide_form_members_form()
  {
