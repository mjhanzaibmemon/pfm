...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "appn_date";$Nm_numeric[] = "client_id";$Nm_numeric[] = "memb_status_id";$Nm_numeric[] = "memb_qty";$Nm_numeric[] = "synced";$Nm_numeric[] = "bus_cat_id";$Nm_numeric[] = "bus_subcat_id";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_client_id"  <?php echo $str_hide_client_id?>><INPUT  type="text" id="SC_client_id" name="client_id" value="<?php echo NM_encode_input($client_id) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_memb_status_id_cond" name="memb_status_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_memb_status_id'), this, 'memb_status_id')">
      ...
      <br><span id="id_hide_memb_status_id"  <?php echo $str_hide_memb_status_id?>><INPUT  type="text" id="SC_memb_status_id" name="memb_status_id" value="<?php echo NM_encode_input($memb_status_id) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
