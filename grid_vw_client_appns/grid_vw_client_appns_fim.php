...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PFM_Staff_____grid_vw_client_appns"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PFM_Staff_____grid_vw_client_appns"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vw_client_appns']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_vw_client_appns']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vw_client_appns']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_vw_client_appns']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_vw_client_appns']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_vw_client_appns</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_vw_client_appns']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_vw_client_appns']['embutida_filho'] as $ind => $sc_init)
          {
