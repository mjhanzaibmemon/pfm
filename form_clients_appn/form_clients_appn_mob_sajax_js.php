  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clients_appn_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_clients_appn_mob_form();
        }
...
?>
  ...
  // ---------- Validate co_name
  function do_ajax_form_clients_appn_mob_validate_co_name()
  {
    var nomeCampo_co_name = "co_name";
    var var_co_name = scAjaxGetFieldText(nomeCampo_co_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_co_name(var_co_name, var_script_case_init, do_ajax_form_clients_appn_mob_validate_co_name_cb);
  } // do_ajax_form_clients_appn_mob_validate_co_name

  function do_ajax_form_clients_appn_mob_validate_co_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_co_name_cb

  // ---------- Validate client_id
  function do_ajax_form_clients_appn_mob_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldHidden(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_clients_appn_mob_validate_client_id_cb);
  } // do_ajax_form_clients_appn_mob_validate_client_id

  function do_ajax_form_clients_appn_mob_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_client_id_cb

  // ---------- Validate mailing_address
  function do_ajax_form_clients_appn_mob_validate_mailing_address()
  {
    var nomeCampo_mailing_address = "mailing_address";
    var var_mailing_address = scAjaxGetFieldText(nomeCampo_mailing_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_mailing_address(var_mailing_address, var_script_case_init, do_ajax_form_clients_appn_mob_validate_mailing_address_cb);
  } // do_ajax_form_clients_appn_mob_validate_mailing_address

  function do_ajax_form_clients_appn_mob_validate_mailing_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_mailing_address_cb

  // ---------- Validate appn_date
  function do_ajax_form_clients_appn_mob_validate_appn_date()
  {
    var nomeCampo_appn_date = "appn_date";
    var var_appn_date = scAjaxGetFieldHidden(nomeCampo_appn_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_appn_date(var_appn_date, var_script_case_init, do_ajax_form_clients_appn_mob_validate_appn_date_cb);
  } // do_ajax_form_clients_appn_mob_validate_appn_date

  function do_ajax_form_clients_appn_mob_validate_appn_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_appn_date_cb

  // ---------- Validate city
  function do_ajax_form_clients_appn_mob_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_city(var_city, var_script_case_init, do_ajax_form_clients_appn_mob_validate_city_cb);
  } // do_ajax_form_clients_appn_mob_validate_city

  function do_ajax_form_clients_appn_mob_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_city_cb

  // ---------- Validate bus_cat_id
  function do_ajax_form_clients_appn_mob_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldSelect(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_clients_appn_mob_validate_bus_cat_id_cb);
  } // do_ajax_form_clients_appn_mob_validate_bus_cat_id

  function do_ajax_form_clients_appn_mob_validate_bus_cat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_bus_cat_id_cb

  // ---------- Validate state
  function do_ajax_form_clients_appn_mob_validate_state()
  {
    var nomeCampo_state = "state";
    var var_state = scAjaxGetFieldText(nomeCampo_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_state(var_state, var_script_case_init, do_ajax_form_clients_appn_mob_validate_state_cb);
  } // do_ajax_form_clients_appn_mob_validate_state

  function do_ajax_form_clients_appn_mob_validate_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "state";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_state_cb

  // ---------- Validate bus_subcat_id
  function do_ajax_form_clients_appn_mob_validate_bus_subcat_id()
  {
    var nomeCampo_bus_subcat_id = "bus_subcat_id";
    var var_bus_subcat_id = scAjaxGetFieldSelect(nomeCampo_bus_subcat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_bus_subcat_id(var_bus_subcat_id, var_script_case_init, do_ajax_form_clients_appn_mob_validate_bus_subcat_id_cb);
  } // do_ajax_form_clients_appn_mob_validate_bus_subcat_id

  function do_ajax_form_clients_appn_mob_validate_bus_subcat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_bus_subcat_id_cb

  // ---------- Validate zip_code
  function do_ajax_form_clients_appn_mob_validate_zip_code()
  {
    var nomeCampo_zip_code = "zip_code";
    var var_zip_code = scAjaxGetFieldText(nomeCampo_zip_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_zip_code(var_zip_code, var_script_case_init, do_ajax_form_clients_appn_mob_validate_zip_code_cb);
  } // do_ajax_form_clients_appn_mob_validate_zip_code

  function do_ajax_form_clients_appn_mob_validate_zip_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_zip_code_cb

  // ---------- Validate bus_subcat_other
  function do_ajax_form_clients_appn_mob_validate_bus_subcat_other()
  {
    var nomeCampo_bus_subcat_other = "bus_subcat_other";
    var var_bus_subcat_other = scAjaxGetFieldText(nomeCampo_bus_subcat_other);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_bus_subcat_other(var_bus_subcat_other, var_script_case_init, do_ajax_form_clients_appn_mob_validate_bus_subcat_other_cb);
  } // do_ajax_form_clients_appn_mob_validate_bus_subcat_other

  function do_ajax_form_clients_appn_mob_validate_bus_subcat_other_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_bus_subcat_other_cb

  // ---------- Validate phone_number
  function do_ajax_form_clients_appn_mob_validate_phone_number()
  {
    var nomeCampo_phone_number = "phone_number";
    var var_phone_number = scAjaxGetFieldText(nomeCampo_phone_number);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_phone_number(var_phone_number, var_script_case_init, do_ajax_form_clients_appn_mob_validate_phone_number_cb);
  } // do_ajax_form_clients_appn_mob_validate_phone_number

  function do_ajax_form_clients_appn_mob_validate_phone_number_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_phone_number_cb

  // ---------- Validate website_url
  function do_ajax_form_clients_appn_mob_validate_website_url()
  {
    var nomeCampo_website_url = "website_url";
    var var_website_url = scAjaxGetFieldText(nomeCampo_website_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_website_url(var_website_url, var_script_case_init, do_ajax_form_clients_appn_mob_validate_website_url_cb);
  } // do_ajax_form_clients_appn_mob_validate_website_url

  function do_ajax_form_clients_appn_mob_validate_website_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_website_url_cb

  // ---------- Validate email
  function do_ajax_form_clients_appn_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_email(var_email, var_script_case_init, do_ajax_form_clients_appn_mob_validate_email_cb);
  } // do_ajax_form_clients_appn_mob_validate_email

  function do_ajax_form_clients_appn_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_email_cb

  // ---------- Validate acct_instagram
  function do_ajax_form_clients_appn_mob_validate_acct_instagram()
  {
    var nomeCampo_acct_instagram = "acct_instagram";
    var var_acct_instagram = scAjaxGetFieldText(nomeCampo_acct_instagram);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_acct_instagram(var_acct_instagram, var_script_case_init, do_ajax_form_clients_appn_mob_validate_acct_instagram_cb);
  } // do_ajax_form_clients_appn_mob_validate_acct_instagram

  function do_ajax_form_clients_appn_mob_validate_acct_instagram_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_acct_instagram_cb

  // ---------- Validate dummy01
  function do_ajax_form_clients_appn_mob_validate_dummy01()
  {
  } // do_ajax_form_clients_appn_mob_validate_dummy01

  function do_ajax_form_clients_appn_mob_validate_dummy01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_dummy01_cb

  // ---------- Validate acct_facebook
  function do_ajax_form_clients_appn_mob_validate_acct_facebook()
  {
    var nomeCampo_acct_facebook = "acct_facebook";
    var var_acct_facebook = scAjaxGetFieldText(nomeCampo_acct_facebook);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_acct_facebook(var_acct_facebook, var_script_case_init, do_ajax_form_clients_appn_mob_validate_acct_facebook_cb);
  } // do_ajax_form_clients_appn_mob_validate_acct_facebook

  function do_ajax_form_clients_appn_mob_validate_acct_facebook_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_acct_facebook_cb

  // ---------- Validate buyers
  function do_ajax_form_clients_appn_mob_validate_buyers()
  {
    var nomeCampo_buyers = "buyers";
    var var_buyers = scAjaxGetFieldText(nomeCampo_buyers);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_buyers(var_buyers, var_script_case_init, do_ajax_form_clients_appn_mob_validate_buyers_cb);
  } // do_ajax_form_clients_appn_mob_validate_buyers

  function do_ajax_form_clients_appn_mob_validate_buyers_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "buyers";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_buyers_cb

  // ---------- Validate appn_note
  function do_ajax_form_clients_appn_mob_validate_appn_note()
  {
    var nomeCampo_appn_note = "appn_note";
    var var_appn_note = scAjaxGetFieldEditorHtml(nomeCampo_appn_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_appn_note(var_appn_note, var_script_case_init, do_ajax_form_clients_appn_mob_validate_appn_note_cb);
  } // do_ajax_form_clients_appn_mob_validate_appn_note

  function do_ajax_form_clients_appn_mob_validate_appn_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_appn_note_cb

  // ---------- Validate doc_sec_of_state
  function do_ajax_form_clients_appn_mob_validate_doc_sec_of_state()
  {
    var nomeCampo_doc_sec_of_state = "doc_sec_of_state";
    var var_doc_sec_of_state = scAjaxGetFieldText(nomeCampo_doc_sec_of_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_doc_sec_of_state(var_doc_sec_of_state, var_script_case_init, do_ajax_form_clients_appn_mob_validate_doc_sec_of_state_cb);
  } // do_ajax_form_clients_appn_mob_validate_doc_sec_of_state

  function do_ajax_form_clients_appn_mob_validate_doc_sec_of_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_doc_sec_of_state_cb

  // ---------- Validate doc_city_bus_lic
  function do_ajax_form_clients_appn_mob_validate_doc_city_bus_lic()
  {
    var nomeCampo_doc_city_bus_lic = "doc_city_bus_lic";
    var var_doc_city_bus_lic = scAjaxGetFieldText(nomeCampo_doc_city_bus_lic);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_doc_city_bus_lic(var_doc_city_bus_lic, var_script_case_init, do_ajax_form_clients_appn_mob_validate_doc_city_bus_lic_cb);
  } // do_ajax_form_clients_appn_mob_validate_doc_city_bus_lic

  function do_ajax_form_clients_appn_mob_validate_doc_city_bus_lic_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_doc_city_bus_lic_cb

  // ---------- Validate doc_agric_lic
  function do_ajax_form_clients_appn_mob_validate_doc_agric_lic()
  {
    var nomeCampo_doc_agric_lic = "doc_agric_lic";
    var var_doc_agric_lic = scAjaxGetFieldText(nomeCampo_doc_agric_lic);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_doc_agric_lic(var_doc_agric_lic, var_script_case_init, do_ajax_form_clients_appn_mob_validate_doc_agric_lic_cb);
  } // do_ajax_form_clients_appn_mob_validate_doc_agric_lic

  function do_ajax_form_clients_appn_mob_validate_doc_agric_lic_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_doc_agric_lic_cb

  // ---------- Validate doc_last_year_tax
  function do_ajax_form_clients_appn_mob_validate_doc_last_year_tax()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_appn_mob_validate_doc_last_year_tax(var_doc_last_year_tax, var_script_case_init, do_ajax_form_clients_appn_mob_validate_doc_last_year_tax_cb);
  } // do_ajax_form_clients_appn_mob_validate_doc_last_year_tax

  function do_ajax_form_clients_appn_mob_validate_doc_last_year_tax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_validate_doc_last_year_tax_cb

  // ---------- Refresh bus_cat_id
  function do_ajax_form_clients_appn_mob_refresh_bus_cat_id()
  {
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    var var_nmgp_refresh_fields = "bus_subcat_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_appn_mob_refresh_bus_cat_id(var_bus_cat_id, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_clients_appn_mob_refresh_bus_cat_id_cb);
  } // do_ajax_form_clients_appn_mob_refresh_bus_cat_id

  function do_ajax_form_clients_appn_mob_refresh_bus_cat_id_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_appn_mob_refresh_bus_cat_id_cb

  // ---------- Event onchange bus_subcat_id
  function do_ajax_form_clients_appn_mob_event_bus_subcat_id_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_appn_mob_event_bus_subcat_id_onchange(var_bus_subcat_id, var_bus_subcat_other, var_bus_cat_id, var_script_case_init, do_ajax_form_clients_appn_mob_event_bus_subcat_id_onchange_cb);
  } // do_ajax_form_clients_appn_mob_event_bus_subcat_id_onchange

  function do_ajax_form_clients_appn_mob_event_bus_subcat_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bus_subcat_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_appn_mob_event_bus_subcat_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_appn_mob_event_bus_subcat_id_onchange_cb
  function do_ajax_form_clients_appn_mob_event_bus_subcat_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_appn_mob_event_bus_subcat_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clients_appn_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_appn_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_clients_appn_mob_submit_form(var_co_name, var_client_id, var_mailing_address, var_appn_date, var_city, var_bus_cat_id, var_state, var_bus_subcat_id, var_zip_code, var_bus_subcat_other, var_phone_number, var_website_url, var_email, var_acct_instagram, var_dummy01, var_acct_facebook, var_appn_note, var_doc_sec_of_state, var_doc_city_bus_lic, var_doc_agric_lic, var_doc_last_year_tax, var_doc_sec_of_state_ul_name, var_doc_sec_of_state_ul_type, var_doc_city_bus_lic_ul_name, var_doc_city_bus_lic_ul_type, var_doc_agric_lic_ul_name, var_doc_agric_lic_ul_type, var_doc_last_year_tax_ul_name, var_doc_last_year_tax_ul_type, var_doc_sec_of_state_limpa, var_doc_city_bus_lic_limpa, var_doc_agric_lic_limpa, var_doc_last_year_tax_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clients_appn_mob_submit_form_cb);
  } // do_ajax_form_clients_appn_mob_submit_form

  function do_ajax_form_clients_appn_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clients_appn_mob_submit_form_cb_after_alert);
  } // do_ajax_form_clients_appn_mob_submit_form_cb
  function do_ajax_form_clients_appn_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clients_appn_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_members_appn_mob"] = "off";

  function do_ajax_form_clients_appn_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clients_appn_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_clients_appn_mob_navigate_form();
    }
  }

  function perform_ajax_form_clients_appn_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_members_appn_mob"] = "on";
    x_ajax_form_clients_appn_mob_navigate_form(var_client_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clients_appn_mob_navigate_form_cb);
  } // do_ajax_form_clients_appn_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_appn_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clients_appn_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_members_appn_mob"] && "nmsc_iframe_liga_form_members_appn_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_members_appn_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_members_appn_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_members_appn_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_members_appn_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_members_appn_mob').style.display = "none";
    }
    document.F1.doc_sec_of_state_ul_name.value = '';
    document.F1.doc_sec_of_state_ul_type.value = '';
    document.F1.doc_city_bus_lic_ul_name.value = '';
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clients_appn_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_clients_appn_mob_navigate_form_cb
  function do_ajax_form_clients_appn_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_clients_appn_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_clients_appn_mob_navigate_form_cb_after_alert

  function sc_hide_form_clients_appn_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_members_appn_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[3] = "appn_date";
  ajax_field_list[4] = "city";
  ajax_field_list[5] = "bus_cat_id";
  ajax_field_list[6] = "state";
  ajax_field_list[7] = "bus_subcat_id";
  ajax_field_list[8] = "zip_code";
  ajax_field_list[9] = "bus_subcat_other";
  ajax_field_list[10] = "phone_number";
  ajax_field_list[11] = "website_url";
  ajax_field_list[12] = "email";
  ajax_field_list[13] = "acct_instagram";
  ajax_field_list[14] = "dummy01";
  ajax_field_list[15] = "acct_facebook";
  ajax_field_list[16] = "buyers";
  ajax_field_list[17] = "appn_note";
  ajax_field_list[18] = "doc_sec_of_state";
  ajax_field_list[19] = "doc_city_bus_lic";
  ajax_field_list[20] = "doc_agric_lic";
  ajax_field_list[21] = "doc_last_year_tax";
  ...
  var ajax_error_list = {
    ...
    "doc_sec_of_state": {"label": "Active Secretary of State Registratoion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
