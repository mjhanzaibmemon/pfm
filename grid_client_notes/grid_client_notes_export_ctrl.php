<?php
@session_start() ;
$_SESSION['scriptcase']['grid_client_notes']['sc_process_barr'] = true;
require_once('../grid_client_notes/index.php');
unset($_SESSION['scriptcase']['grid_client_notes']['sc_process_barr']);
$ExportCtrl = new grid_client_notes_export_control;
$ExportCtrl->Export_barr();

class grid_client_notes_export_control
{
