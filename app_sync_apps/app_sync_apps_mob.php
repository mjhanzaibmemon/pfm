...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['dashboard_info']['remove_background'] = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_background'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['dashboard_info']['remove_background'] = 1 == $_GET['remove_background'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_background)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['dashboard_info']['remove_background'] = 1 == $remove_background;
              }
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_remove_background) && 'ok' == $link_remove_background) {
            ...
            $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info']['remove_background'] = true;
        }
        if (isset($link_margin_top) && '' != $link_margin_top) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_sync_apps_mob']['link_info']['margin_top'] = $link_margin_top;
        }
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'PFM_Staff', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'PFM_Staff', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_PFM_Staff.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_PFM_Staff.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_PFM_Staff'])) {
                $_SESSION['scriptcase']['app_sync_apps']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_PFM_Staff'];
            }
        }
    }
...
/* mantis 0021191 */            $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['buttonDisplay'] = $inicial_app_sync_apps_mob->contr_app_sync_apps_mob->nmgp_botoes;
         ...
         if (isset($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['dyn_search']) && !empty($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['dyn_search']))
         {
            $aResp['dyn_search'] = array();
            foreach ($inicial_app_sync_apps_mob->contr_app_sync_apps_mob->NM_ajax_info['dyn_search'] as $Tag => $Val) {
