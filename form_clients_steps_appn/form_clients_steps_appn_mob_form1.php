<div id="form_clients_steps_appn_mob_form1" style='<?php echo (1 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_mob']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_mob']['Lookup_doc_type'][] = 'Active Secretary of State Registration'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_mob']['Lookup_doc_type'][] = 'City Business License'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_mob']['Lookup_doc_type'][] = 'Agricultural License'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_mob']['Lookup_doc_type'][] = 'Other type of document'; ?>
