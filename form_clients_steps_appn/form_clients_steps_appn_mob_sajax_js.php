  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clients_steps_appn_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_clients_steps_appn_mob_form();
        }
...
?>
  ...
  // ---------- Validate dummy02
  function do_ajax_form_clients_steps_appn_mob_validate_dummy02()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy02

  function do_ajax_form_clients_steps_appn_mob_validate_dummy02_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy02_cb

  // ---------- Validate dummy03
  function do_ajax_form_clients_steps_appn_mob_validate_dummy03()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy03

  function do_ajax_form_clients_steps_appn_mob_validate_dummy03_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy03";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy03_cb

  // ---------- Validate co_name
  function do_ajax_form_clients_steps_appn_mob_validate_co_name()
  {
    var nomeCampo_co_name = "co_name";
    var var_co_name = scAjaxGetFieldText(nomeCampo_co_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_co_name(var_co_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_co_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_co_name

  function do_ajax_form_clients_steps_appn_mob_validate_co_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "co_name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_co_name_cb

  // ---------- Validate client_id
  function do_ajax_form_clients_steps_appn_mob_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldHidden(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_client_id_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_client_id

  function do_ajax_form_clients_steps_appn_mob_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_client_id_cb

  // ---------- Validate mailing_address
  function do_ajax_form_clients_steps_appn_mob_validate_mailing_address()
  {
    var nomeCampo_mailing_address = "mailing_address";
    var var_mailing_address = scAjaxGetFieldText(nomeCampo_mailing_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_mailing_address(var_mailing_address, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_mailing_address_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_mailing_address

  function do_ajax_form_clients_steps_appn_mob_validate_mailing_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_mailing_address_cb

  // ---------- Validate appn_date
  function do_ajax_form_clients_steps_appn_mob_validate_appn_date()
  {
    var nomeCampo_appn_date = "appn_date";
    var var_appn_date = scAjaxGetFieldHidden(nomeCampo_appn_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_appn_date(var_appn_date, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_appn_date_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_appn_date

  function do_ajax_form_clients_steps_appn_mob_validate_appn_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_appn_date_cb

  // ---------- Validate city
  function do_ajax_form_clients_steps_appn_mob_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_city(var_city, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_city_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_city

  function do_ajax_form_clients_steps_appn_mob_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_city_cb

  // ---------- Validate bus_cat_id
  function do_ajax_form_clients_steps_appn_mob_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldSelect(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_bus_cat_id_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_bus_cat_id

  function do_ajax_form_clients_steps_appn_mob_validate_bus_cat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_bus_cat_id_cb

  // ---------- Validate state
  function do_ajax_form_clients_steps_appn_mob_validate_state()
  {
    var nomeCampo_state = "state";
    var var_state = scAjaxGetFieldText(nomeCampo_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_state(var_state, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_state_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_state

  function do_ajax_form_clients_steps_appn_mob_validate_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "state";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_state_cb

  // ---------- Validate bus_subcat_id
  function do_ajax_form_clients_steps_appn_mob_validate_bus_subcat_id()
  {
    var nomeCampo_bus_subcat_id = "bus_subcat_id";
    var var_bus_subcat_id = scAjaxGetFieldSelect(nomeCampo_bus_subcat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_bus_subcat_id(var_bus_subcat_id, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_bus_subcat_id_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_bus_subcat_id

  function do_ajax_form_clients_steps_appn_mob_validate_bus_subcat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_bus_subcat_id_cb

  // ---------- Validate zip_code
  function do_ajax_form_clients_steps_appn_mob_validate_zip_code()
  {
    var nomeCampo_zip_code = "zip_code";
    var var_zip_code = scAjaxGetFieldText(nomeCampo_zip_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_zip_code(var_zip_code, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_zip_code_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_zip_code

  function do_ajax_form_clients_steps_appn_mob_validate_zip_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_zip_code_cb

  // ---------- Validate bus_subcat_other
  function do_ajax_form_clients_steps_appn_mob_validate_bus_subcat_other()
  {
    var nomeCampo_bus_subcat_other = "bus_subcat_other";
    var var_bus_subcat_other = scAjaxGetFieldText(nomeCampo_bus_subcat_other);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_bus_subcat_other(var_bus_subcat_other, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_bus_subcat_other_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_bus_subcat_other

  function do_ajax_form_clients_steps_appn_mob_validate_bus_subcat_other_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_bus_subcat_other_cb

  // ---------- Validate phone_number
  function do_ajax_form_clients_steps_appn_mob_validate_phone_number()
  {
    var nomeCampo_phone_number = "phone_number";
    var var_phone_number = scAjaxGetFieldText(nomeCampo_phone_number);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_phone_number(var_phone_number, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_phone_number_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_phone_number

  function do_ajax_form_clients_steps_appn_mob_validate_phone_number_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_phone_number_cb

  // ---------- Validate website_url
  function do_ajax_form_clients_steps_appn_mob_validate_website_url()
  {
    var nomeCampo_website_url = "website_url";
    var var_website_url = scAjaxGetFieldText(nomeCampo_website_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_website_url(var_website_url, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_website_url_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_website_url

  function do_ajax_form_clients_steps_appn_mob_validate_website_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_website_url_cb

  // ---------- Validate email
  function do_ajax_form_clients_steps_appn_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_email(var_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_email

  function do_ajax_form_clients_steps_appn_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_email_cb

  // ---------- Validate acct_instagram
  function do_ajax_form_clients_steps_appn_mob_validate_acct_instagram()
  {
    var nomeCampo_acct_instagram = "acct_instagram";
    var var_acct_instagram = scAjaxGetFieldText(nomeCampo_acct_instagram);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_acct_instagram(var_acct_instagram, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_acct_instagram_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_acct_instagram

  function do_ajax_form_clients_steps_appn_mob_validate_acct_instagram_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_acct_instagram_cb

  // ---------- Validate dummy01
  function do_ajax_form_clients_steps_appn_mob_validate_dummy01()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy01

  function do_ajax_form_clients_steps_appn_mob_validate_dummy01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy01_cb

  // ---------- Validate acct_facebook
  function do_ajax_form_clients_steps_appn_mob_validate_acct_facebook()
  {
    var nomeCampo_acct_facebook = "acct_facebook";
    var var_acct_facebook = scAjaxGetFieldText(nomeCampo_acct_facebook);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_acct_facebook(var_acct_facebook, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_acct_facebook_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_acct_facebook

  function do_ajax_form_clients_steps_appn_mob_validate_acct_facebook_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_acct_facebook_cb

  // ---------- Validate dummy04
  function do_ajax_form_clients_steps_appn_mob_validate_dummy04()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy04

  function do_ajax_form_clients_steps_appn_mob_validate_dummy04_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy04";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy04_cb

  // ---------- Validate dummy07
  function do_ajax_form_clients_steps_appn_mob_validate_dummy07()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy07

  function do_ajax_form_clients_steps_appn_mob_validate_dummy07_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy07";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy07_cb

  // ---------- Validate dummy08
  function do_ajax_form_clients_steps_appn_mob_validate_dummy08()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy08

  function do_ajax_form_clients_steps_appn_mob_validate_dummy08_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy08";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy08_cb

  // ---------- Validate main_contact_name
  function do_ajax_form_clients_steps_appn_mob_validate_main_contact_name()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_main_contact_name(var_main_contact_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_main_contact_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_main_contact_name

  function do_ajax_form_clients_steps_appn_mob_validate_main_contact_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_main_contact_name_cb

  // ---------- Validate main_contact_phone
  function do_ajax_form_clients_steps_appn_mob_validate_main_contact_phone()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_main_contact_phone(var_main_contact_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_main_contact_phone_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_main_contact_phone

  function do_ajax_form_clients_steps_appn_mob_validate_main_contact_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_main_contact_phone_cb

  // ---------- Validate main_contact_email
  function do_ajax_form_clients_steps_appn_mob_validate_main_contact_email()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_main_contact_email(var_main_contact_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_main_contact_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_main_contact_email

  function do_ajax_form_clients_steps_appn_mob_validate_main_contact_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_main_contact_email_cb

  // ---------- Validate main_contact_title
  function do_ajax_form_clients_steps_appn_mob_validate_main_contact_title()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_main_contact_title(var_main_contact_title, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_main_contact_title_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_main_contact_title

  function do_ajax_form_clients_steps_appn_mob_validate_main_contact_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_main_contact_title_cb

  // ---------- Validate main_contact_img_id
  function do_ajax_form_clients_steps_appn_mob_validate_main_contact_img_id()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_main_contact_img_id(var_main_contact_img_id, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_main_contact_img_id_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_main_contact_img_id

  function do_ajax_form_clients_steps_appn_mob_validate_main_contact_img_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_main_contact_img_id_cb

  // ---------- Validate doc_type
  function do_ajax_form_clients_steps_appn_mob_validate_doc_type()
  {
    var nomeCampo_doc_type = "doc_type";
    var var_doc_type = scAjaxGetFieldCheckbox(nomeCampo_doc_type, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_doc_type(var_doc_type, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_doc_type_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_doc_type

  function do_ajax_form_clients_steps_appn_mob_validate_doc_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_doc_type_cb

  // ---------- Validate doc_file
  function do_ajax_form_clients_steps_appn_mob_validate_doc_file()
  {
    var nomeCampo_doc_file = "doc_file";
    var var_doc_file = scAjaxGetFieldText(nomeCampo_doc_file);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_doc_file(var_doc_file, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_doc_file_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_doc_file

  function do_ajax_form_clients_steps_appn_mob_validate_doc_file_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_doc_file_cb

  // ---------- Validate appn_note
  function do_ajax_form_clients_steps_appn_mob_validate_appn_note()
  {
    var nomeCampo_appn_note = "appn_note";
    var var_appn_note = scAjaxGetFieldEditorHtml(nomeCampo_appn_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_appn_note(var_appn_note, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_appn_note_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_appn_note

  function do_ajax_form_clients_steps_appn_mob_validate_appn_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_appn_note_cb

  // ---------- Validate memb_name
  function do_ajax_form_clients_steps_appn_mob_validate_memb_name()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_memb_name

  function do_ajax_form_clients_steps_appn_mob_validate_memb_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_memb_name_cb

  // ---------- Validate memb_phone
  function do_ajax_form_clients_steps_appn_mob_validate_memb_phone()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_memb_phone

  function do_ajax_form_clients_steps_appn_mob_validate_memb_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_memb_phone_cb

  // ---------- Validate memb_email
  function do_ajax_form_clients_steps_appn_mob_validate_memb_email()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_memb_email

  function do_ajax_form_clients_steps_appn_mob_validate_memb_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_memb_email_cb

  // ---------- Validate memb_note
  function do_ajax_form_clients_steps_appn_mob_validate_memb_note()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_memb_note

  function do_ajax_form_clients_steps_appn_mob_validate_memb_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_memb_note_cb

  // ---------- Validate member1_name
  function do_ajax_form_clients_steps_appn_mob_validate_member1_name()
  {
    var nomeCampo_member1_name = "member1_name";
    var var_member1_name = scAjaxGetFieldText(nomeCampo_member1_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member1_name(var_member1_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member1_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member1_name

  function do_ajax_form_clients_steps_appn_mob_validate_member1_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member1_name_cb

  // ---------- Validate member1_phone
  function do_ajax_form_clients_steps_appn_mob_validate_member1_phone()
  {
    var nomeCampo_member1_phone = "member1_phone";
    var var_member1_phone = scAjaxGetFieldText(nomeCampo_member1_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member1_phone(var_member1_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member1_phone_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member1_phone

  function do_ajax_form_clients_steps_appn_mob_validate_member1_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member1_phone_cb

  // ---------- Validate member1_email
  function do_ajax_form_clients_steps_appn_mob_validate_member1_email()
  {
    var nomeCampo_member1_email = "member1_email";
    var var_member1_email = scAjaxGetFieldText(nomeCampo_member1_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member1_email(var_member1_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member1_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member1_email

  function do_ajax_form_clients_steps_appn_mob_validate_member1_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member1_email_cb

  // ---------- Validate member1_note
  function do_ajax_form_clients_steps_appn_mob_validate_member1_note()
  {
    var nomeCampo_member1_note = "member1_note";
    var var_member1_note = scAjaxGetFieldText(nomeCampo_member1_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member1_note(var_member1_note, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member1_note_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member1_note

  function do_ajax_form_clients_steps_appn_mob_validate_member1_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member1_note_cb

  // ---------- Validate member2_name
  function do_ajax_form_clients_steps_appn_mob_validate_member2_name()
  {
    var nomeCampo_member2_name = "member2_name";
    var var_member2_name = scAjaxGetFieldText(nomeCampo_member2_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member2_name(var_member2_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member2_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member2_name

  function do_ajax_form_clients_steps_appn_mob_validate_member2_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member2_name_cb

  // ---------- Validate member2_phone
  function do_ajax_form_clients_steps_appn_mob_validate_member2_phone()
  {
    var nomeCampo_member2_phone = "member2_phone";
    var var_member2_phone = scAjaxGetFieldText(nomeCampo_member2_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member2_phone(var_member2_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member2_phone_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member2_phone

  function do_ajax_form_clients_steps_appn_mob_validate_member2_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member2_phone_cb

  // ---------- Validate member2_email
  function do_ajax_form_clients_steps_appn_mob_validate_member2_email()
  {
    var nomeCampo_member2_email = "member2_email";
    var var_member2_email = scAjaxGetFieldText(nomeCampo_member2_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member2_email(var_member2_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member2_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member2_email

  function do_ajax_form_clients_steps_appn_mob_validate_member2_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member2_email_cb

  // ---------- Validate member2_note
  function do_ajax_form_clients_steps_appn_mob_validate_member2_note()
  {
    var nomeCampo_member2_note = "member2_note";
    var var_member2_note = scAjaxGetFieldText(nomeCampo_member2_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member2_note(var_member2_note, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member2_note_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member2_note

  function do_ajax_form_clients_steps_appn_mob_validate_member2_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member2_note_cb

  // ---------- Validate member3_name
  function do_ajax_form_clients_steps_appn_mob_validate_member3_name()
  {
    var nomeCampo_member3_name = "member3_name";
    var var_member3_name = scAjaxGetFieldText(nomeCampo_member3_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member3_name(var_member3_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member3_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member3_name

  function do_ajax_form_clients_steps_appn_mob_validate_member3_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member3_name_cb

  // ---------- Validate member3_phone
  function do_ajax_form_clients_steps_appn_mob_validate_member3_phone()
  {
    var nomeCampo_member3_phone = "member3_phone";
    var var_member3_phone = scAjaxGetFieldText(nomeCampo_member3_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member3_phone(var_member3_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member3_phone_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member3_phone

  function do_ajax_form_clients_steps_appn_mob_validate_member3_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member3_phone_cb

  // ---------- Validate member3_email
  function do_ajax_form_clients_steps_appn_mob_validate_member3_email()
  {
    var nomeCampo_member3_email = "member3_email";
    var var_member3_email = scAjaxGetFieldText(nomeCampo_member3_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member3_email(var_member3_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member3_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member3_email

  function do_ajax_form_clients_steps_appn_mob_validate_member3_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member3_email_cb

  // ---------- Validate member3_note
  function do_ajax_form_clients_steps_appn_mob_validate_member3_note()
  {
    var nomeCampo_member3_note = "member3_note";
    var var_member3_note = scAjaxGetFieldText(nomeCampo_member3_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member3_note(var_member3_note, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member3_note_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member3_note

  function do_ajax_form_clients_steps_appn_mob_validate_member3_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member3_note_cb

  // ---------- Validate dummy05
  function do_ajax_form_clients_steps_appn_mob_validate_dummy05()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy05

  function do_ajax_form_clients_steps_appn_mob_validate_dummy05_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy05";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy05_cb

  // ---------- Validate adtl_memb_name
  function do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_name()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_name

  function do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_name_cb

  // ---------- Validate adtl_memb_phone
  function do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_phone()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_phone

  function do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_phone_cb

  // ---------- Validate adtl_memb_note
  function do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_note()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_note

  function do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_adtl_memb_note_cb

  // ---------- Validate addtl_memb_mail
  function do_ajax_form_clients_steps_appn_mob_validate_addtl_memb_mail()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_addtl_memb_mail

  function do_ajax_form_clients_steps_appn_mob_validate_addtl_memb_mail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_addtl_memb_mail_cb

  // ---------- Validate member4_name
  function do_ajax_form_clients_steps_appn_mob_validate_member4_name()
  {
    var nomeCampo_member4_name = "member4_name";
    var var_member4_name = scAjaxGetFieldText(nomeCampo_member4_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member4_name(var_member4_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member4_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member4_name

  function do_ajax_form_clients_steps_appn_mob_validate_member4_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member4_name_cb

  // ---------- Validate member4_phone
  function do_ajax_form_clients_steps_appn_mob_validate_member4_phone()
  {
    var nomeCampo_member4_phone = "member4_phone";
    var var_member4_phone = scAjaxGetFieldText(nomeCampo_member4_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member4_phone(var_member4_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member4_phone_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member4_phone

  function do_ajax_form_clients_steps_appn_mob_validate_member4_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member4_phone_cb

  // ---------- Validate member4_email
  function do_ajax_form_clients_steps_appn_mob_validate_member4_email()
  {
    var nomeCampo_member4_email = "member4_email";
    var var_member4_email = scAjaxGetFieldText(nomeCampo_member4_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member4_email(var_member4_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member4_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member4_email

  function do_ajax_form_clients_steps_appn_mob_validate_member4_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member4_email_cb

  // ---------- Validate member4_note
  function do_ajax_form_clients_steps_appn_mob_validate_member4_note()
  {
    var nomeCampo_member4_note = "member4_note";
    var var_member4_note = scAjaxGetFieldText(nomeCampo_member4_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member4_note(var_member4_note, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member4_note_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member4_note

  function do_ajax_form_clients_steps_appn_mob_validate_member4_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member4_note_cb

  // ---------- Validate member5_name
  function do_ajax_form_clients_steps_appn_mob_validate_member5_name()
  {
    var nomeCampo_member5_name = "member5_name";
    var var_member5_name = scAjaxGetFieldText(nomeCampo_member5_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member5_name(var_member5_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member5_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member5_name

  function do_ajax_form_clients_steps_appn_mob_validate_member5_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member5_name_cb

  // ---------- Validate member5_phone
  function do_ajax_form_clients_steps_appn_mob_validate_member5_phone()
  {
    var nomeCampo_member5_phone = "member5_phone";
    var var_member5_phone = scAjaxGetFieldText(nomeCampo_member5_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member5_phone(var_member5_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member5_phone_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member5_phone

  function do_ajax_form_clients_steps_appn_mob_validate_member5_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member5_phone_cb

  // ---------- Validate member5_email
  function do_ajax_form_clients_steps_appn_mob_validate_member5_email()
  {
    var nomeCampo_member5_email = "member5_email";
    var var_member5_email = scAjaxGetFieldText(nomeCampo_member5_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member5_email(var_member5_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member5_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member5_email

  function do_ajax_form_clients_steps_appn_mob_validate_member5_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member5_email_cb

  // ---------- Validate member5_note
  function do_ajax_form_clients_steps_appn_mob_validate_member5_note()
  {
    var nomeCampo_member5_note = "member5_note";
    var var_member5_note = scAjaxGetFieldText(nomeCampo_member5_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member5_note(var_member5_note, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member5_note_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member5_note

  function do_ajax_form_clients_steps_appn_mob_validate_member5_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member5_note_cb

  // ---------- Validate member6_name
  function do_ajax_form_clients_steps_appn_mob_validate_member6_name()
  {
    var nomeCampo_member6_name = "member6_name";
    var var_member6_name = scAjaxGetFieldText(nomeCampo_member6_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member6_name(var_member6_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member6_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member6_name

  function do_ajax_form_clients_steps_appn_mob_validate_member6_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member6_name_cb

  // ---------- Validate member6_phone
  function do_ajax_form_clients_steps_appn_mob_validate_member6_phone()
  {
    var nomeCampo_member6_phone = "member6_phone";
    var var_member6_phone = scAjaxGetFieldText(nomeCampo_member6_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member6_phone(var_member6_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member6_phone_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member6_phone

  function do_ajax_form_clients_steps_appn_mob_validate_member6_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member6_phone_cb

  // ---------- Validate member6_email
  function do_ajax_form_clients_steps_appn_mob_validate_member6_email()
  {
    var nomeCampo_member6_email = "member6_email";
    var var_member6_email = scAjaxGetFieldText(nomeCampo_member6_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member6_email(var_member6_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member6_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member6_email

  function do_ajax_form_clients_steps_appn_mob_validate_member6_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member6_email_cb

  // ---------- Validate member6_note
  function do_ajax_form_clients_steps_appn_mob_validate_member6_note()
  {
    var nomeCampo_member6_note = "member6_note";
    var var_member6_note = scAjaxGetFieldText(nomeCampo_member6_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member6_note(var_member6_note, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member6_note_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member6_note

  function do_ajax_form_clients_steps_appn_mob_validate_member6_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member6_note_cb

  // ---------- Validate member7_name
  function do_ajax_form_clients_steps_appn_mob_validate_member7_name()
  {
    var nomeCampo_member7_name = "member7_name";
    var var_member7_name = scAjaxGetFieldText(nomeCampo_member7_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member7_name(var_member7_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member7_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member7_name

  function do_ajax_form_clients_steps_appn_mob_validate_member7_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member7_name_cb

  // ---------- Validate member7_phone
  function do_ajax_form_clients_steps_appn_mob_validate_member7_phone()
  {
    var nomeCampo_member7_phone = "member7_phone";
    var var_member7_phone = scAjaxGetFieldText(nomeCampo_member7_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member7_phone(var_member7_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member7_phone_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member7_phone

  function do_ajax_form_clients_steps_appn_mob_validate_member7_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member7_phone_cb

  // ---------- Validate member7_email
  function do_ajax_form_clients_steps_appn_mob_validate_member7_email()
  {
    var nomeCampo_member7_email = "member7_email";
    var var_member7_email = scAjaxGetFieldText(nomeCampo_member7_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member7_email(var_member7_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member7_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member7_email

  function do_ajax_form_clients_steps_appn_mob_validate_member7_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member7_email_cb

  // ---------- Validate member7_note
  function do_ajax_form_clients_steps_appn_mob_validate_member7_note()
  {
    var nomeCampo_member7_note = "member7_note";
    var var_member7_note = scAjaxGetFieldText(nomeCampo_member7_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member7_note(var_member7_note, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member7_note_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member7_note

  function do_ajax_form_clients_steps_appn_mob_validate_member7_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member7_note_cb

  // ---------- Validate member8_name
  function do_ajax_form_clients_steps_appn_mob_validate_member8_name()
  {
    var nomeCampo_member8_name = "member8_name";
    var var_member8_name = scAjaxGetFieldText(nomeCampo_member8_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member8_name(var_member8_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member8_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member8_name

  function do_ajax_form_clients_steps_appn_mob_validate_member8_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member8_name_cb

  // ---------- Validate member8_phone
  function do_ajax_form_clients_steps_appn_mob_validate_member8_phone()
  {
    var nomeCampo_member8_phone = "member8_phone";
    var var_member8_phone = scAjaxGetFieldText(nomeCampo_member8_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member8_phone(var_member8_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member8_phone_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member8_phone

  function do_ajax_form_clients_steps_appn_mob_validate_member8_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member8_phone_cb

  // ---------- Validate member8_email
  function do_ajax_form_clients_steps_appn_mob_validate_member8_email()
  {
    var nomeCampo_member8_email = "member8_email";
    var var_member8_email = scAjaxGetFieldText(nomeCampo_member8_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member8_email(var_member8_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member8_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member8_email

  function do_ajax_form_clients_steps_appn_mob_validate_member8_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member8_email_cb

  // ---------- Validate member8_note
  function do_ajax_form_clients_steps_appn_mob_validate_member8_note()
  {
    var nomeCampo_member8_note = "member8_note";
    var var_member8_note = scAjaxGetFieldText(nomeCampo_member8_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member8_note(var_member8_note, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member8_note_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member8_note

  function do_ajax_form_clients_steps_appn_mob_validate_member8_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member8_note_cb

  // ---------- Validate member9_name
  function do_ajax_form_clients_steps_appn_mob_validate_member9_name()
  {
    var nomeCampo_member9_name = "member9_name";
    var var_member9_name = scAjaxGetFieldText(nomeCampo_member9_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member9_name(var_member9_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member9_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member9_name

  function do_ajax_form_clients_steps_appn_mob_validate_member9_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member9_name_cb

  // ---------- Validate member9_phone
  function do_ajax_form_clients_steps_appn_mob_validate_member9_phone()
  {
    var nomeCampo_member9_phone = "member9_phone";
    var var_member9_phone = scAjaxGetFieldText(nomeCampo_member9_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member9_phone(var_member9_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member9_phone_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member9_phone

  function do_ajax_form_clients_steps_appn_mob_validate_member9_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member9_phone_cb

  // ---------- Validate member9_email
  function do_ajax_form_clients_steps_appn_mob_validate_member9_email()
  {
    var nomeCampo_member9_email = "member9_email";
    var var_member9_email = scAjaxGetFieldText(nomeCampo_member9_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member9_email(var_member9_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member9_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member9_email

  function do_ajax_form_clients_steps_appn_mob_validate_member9_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member9_email_cb

  // ---------- Validate member9_note
  function do_ajax_form_clients_steps_appn_mob_validate_member9_note()
  {
    var nomeCampo_member9_note = "member9_note";
    var var_member9_note = scAjaxGetFieldText(nomeCampo_member9_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member9_note(var_member9_note, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member9_note_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member9_note

  function do_ajax_form_clients_steps_appn_mob_validate_member9_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member9_note_cb

  // ---------- Validate member10_name
  function do_ajax_form_clients_steps_appn_mob_validate_member10_name()
  {
    var nomeCampo_member10_name = "member10_name";
    var var_member10_name = scAjaxGetFieldText(nomeCampo_member10_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member10_name(var_member10_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member10_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member10_name

  function do_ajax_form_clients_steps_appn_mob_validate_member10_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member10_name_cb

  // ---------- Validate member10_phone
  function do_ajax_form_clients_steps_appn_mob_validate_member10_phone()
  {
    var nomeCampo_member10_phone = "member10_phone";
    var var_member10_phone = scAjaxGetFieldText(nomeCampo_member10_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member10_phone(var_member10_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member10_phone_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member10_phone

  function do_ajax_form_clients_steps_appn_mob_validate_member10_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member10_phone_cb

  // ---------- Validate member10_email
  function do_ajax_form_clients_steps_appn_mob_validate_member10_email()
  {
    var nomeCampo_member10_email = "member10_email";
    var var_member10_email = scAjaxGetFieldText(nomeCampo_member10_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member10_email(var_member10_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member10_email_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member10_email

  function do_ajax_form_clients_steps_appn_mob_validate_member10_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member10_email_cb

  // ---------- Validate member10_note
  function do_ajax_form_clients_steps_appn_mob_validate_member10_note()
  {
    var nomeCampo_member10_note = "member10_note";
    var var_member10_note = scAjaxGetFieldText(nomeCampo_member10_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_member10_note(var_member10_note, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_member10_note_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_member10_note

  function do_ajax_form_clients_steps_appn_mob_validate_member10_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_member10_note_cb

  // ---------- Validate dummy06
  function do_ajax_form_clients_steps_appn_mob_validate_dummy06()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy06

  function do_ajax_form_clients_steps_appn_mob_validate_dummy06_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy06";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy06_cb

  // ---------- Validate xlsx_sample
  function do_ajax_form_clients_steps_appn_mob_validate_xlsx_sample()
  {
    var nomeCampo_xlsx_sample = "xlsx_sample";
    var var_xlsx_sample = scAjaxGetFieldText(nomeCampo_xlsx_sample);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_xlsx_sample(var_xlsx_sample, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_xlsx_sample_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_xlsx_sample

  function do_ajax_form_clients_steps_appn_mob_validate_xlsx_sample_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_xlsx_sample_cb

  // ---------- Validate more_buyers_xlsx
  function do_ajax_form_clients_steps_appn_mob_validate_more_buyers_xlsx()
  {
    var nomeCampo_more_buyers_xlsx = "more_buyers_xlsx";
    var var_more_buyers_xlsx = scAjaxGetFieldText(nomeCampo_more_buyers_xlsx);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_more_buyers_xlsx(var_more_buyers_xlsx, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_more_buyers_xlsx_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_more_buyers_xlsx

  function do_ajax_form_clients_steps_appn_mob_validate_more_buyers_xlsx_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_more_buyers_xlsx_cb

  // ---------- Validate buyers_excel_qty
  function do_ajax_form_clients_steps_appn_mob_validate_buyers_excel_qty()
  {
    var nomeCampo_buyers_excel_qty = "buyers_excel_qty";
    var var_buyers_excel_qty = scAjaxGetFieldText(nomeCampo_buyers_excel_qty);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_buyers_excel_qty(var_buyers_excel_qty, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_buyers_excel_qty_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_buyers_excel_qty

  function do_ajax_form_clients_steps_appn_mob_validate_buyers_excel_qty_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_buyers_excel_qty_cb

  // ---------- Validate dummy09
  function do_ajax_form_clients_steps_appn_mob_validate_dummy09()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy09

  function do_ajax_form_clients_steps_appn_mob_validate_dummy09_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy09";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy09_cb

  // ---------- Validate dummy11
  function do_ajax_form_clients_steps_appn_mob_validate_dummy11()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy11

  function do_ajax_form_clients_steps_appn_mob_validate_dummy11_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy11";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy11_cb

  // ---------- Validate rules
  function do_ajax_form_clients_steps_appn_mob_validate_rules()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_rules

  function do_ajax_form_clients_steps_appn_mob_validate_rules_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rules";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_rules_cb

  // ---------- Validate rules_warn
  function do_ajax_form_clients_steps_appn_mob_validate_rules_warn()
  {
    var nomeCampo_rules_warn = "rules_warn";
    var var_rules_warn = scAjaxGetFieldText(nomeCampo_rules_warn);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_rules_warn(var_rules_warn, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_rules_warn_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_rules_warn

  function do_ajax_form_clients_steps_appn_mob_validate_rules_warn_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_rules_warn_cb

  // ---------- Validate memb_levels
  function do_ajax_form_clients_steps_appn_mob_validate_memb_levels()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_memb_levels

  function do_ajax_form_clients_steps_appn_mob_validate_memb_levels_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_memb_levels_cb

  // ---------- Validate est_memb_cost
  function do_ajax_form_clients_steps_appn_mob_validate_est_memb_cost()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_est_memb_cost

  function do_ajax_form_clients_steps_appn_mob_validate_est_memb_cost_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_est_memb_cost_cb

  // ---------- Validate pay
  function do_ajax_form_clients_steps_appn_mob_validate_pay()
  {
    var nomeCampo_pay = "pay";
    var var_pay = scAjaxGetFieldText(nomeCampo_pay);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_pay(var_pay, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_pay_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_pay

  function do_ajax_form_clients_steps_appn_mob_validate_pay_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pay";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_pay_cb

  // ---------- Validate read_at_sign
  function do_ajax_form_clients_steps_appn_mob_validate_read_at_sign()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_read_at_sign

  function do_ajax_form_clients_steps_appn_mob_validate_read_at_sign_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_read_at_sign_cb

  // ---------- Validate applicant_name
  function do_ajax_form_clients_steps_appn_mob_validate_applicant_name()
  {
    var nomeCampo_applicant_name = "applicant_name";
    var var_applicant_name = scAjaxGetFieldText(nomeCampo_applicant_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_applicant_name(var_applicant_name, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_applicant_name_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_applicant_name

  function do_ajax_form_clients_steps_appn_mob_validate_applicant_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_applicant_name_cb

  // ---------- Validate applicant_title
  function do_ajax_form_clients_steps_appn_mob_validate_applicant_title()
  {
    var nomeCampo_applicant_title = "applicant_title";
    var var_applicant_title = scAjaxGetFieldText(nomeCampo_applicant_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_applicant_title(var_applicant_title, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_applicant_title_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_applicant_title

  function do_ajax_form_clients_steps_appn_mob_validate_applicant_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_applicant_title_cb

  // ---------- Validate dummy10
  function do_ajax_form_clients_steps_appn_mob_validate_dummy10()
  {
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy10

  function do_ajax_form_clients_steps_appn_mob_validate_dummy10_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy10";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_dummy10_cb

  // ---------- Validate applicant_signature
  function do_ajax_form_clients_steps_appn_mob_validate_applicant_signature()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_mob_validate_applicant_signature(var_applicant_signature, var_script_case_init, do_ajax_form_clients_steps_appn_mob_validate_applicant_signature_cb);
  } // do_ajax_form_clients_steps_appn_mob_validate_applicant_signature

  function do_ajax_form_clients_steps_appn_mob_validate_applicant_signature_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_validate_applicant_signature_cb

  // ---------- Refresh bus_cat_id
  function do_ajax_form_clients_steps_appn_mob_refresh_bus_cat_id()
  {
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    var var_nmgp_refresh_fields = "bus_subcat_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_refresh_bus_cat_id(var_bus_cat_id, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_clients_steps_appn_mob_refresh_bus_cat_id_cb);
  } // do_ajax_form_clients_steps_appn_mob_refresh_bus_cat_id

  function do_ajax_form_clients_steps_appn_mob_refresh_bus_cat_id_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_mob_refresh_bus_cat_id_cb

  // ---------- Event onchange bus_cat_id
  function do_ajax_form_clients_steps_appn_mob_event_bus_cat_id_onchange()
  {
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_bus_cat_id_onchange(var_bus_cat_id, var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_bus_cat_id_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_bus_cat_id_onchange

  function do_ajax_form_clients_steps_appn_mob_event_bus_cat_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bus_cat_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_bus_cat_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_bus_cat_id_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_bus_cat_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_clients_steps_appn_mob_refresh_bus_cat_id();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_bus_cat_id_onchange_cb_after_alert

  // ---------- Event onchange bus_subcat_id
  function do_ajax_form_clients_steps_appn_mob_event_bus_subcat_id_onchange()
  {
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    var var_member3_name = scAjaxGetFieldText("member3_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_bus_subcat_id_onchange(var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_bus_subcat_other, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_bus_subcat_id_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_bus_subcat_id_onchange

  function do_ajax_form_clients_steps_appn_mob_event_bus_subcat_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bus_subcat_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_bus_subcat_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_bus_subcat_id_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_bus_subcat_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_bus_subcat_id_onchange_cb_after_alert

  // ---------- Event onchange buyers_excel_qty
  function do_ajax_form_clients_steps_appn_mob_event_buyers_excel_qty_onchange()
  {
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    var var_member3_name = scAjaxGetFieldText("member3_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_buyers_excel_qty_onchange(var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_buyers_excel_qty_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_buyers_excel_qty_onchange

  function do_ajax_form_clients_steps_appn_mob_event_buyers_excel_qty_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "buyers_excel_qty";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_buyers_excel_qty_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_buyers_excel_qty_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_buyers_excel_qty_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_buyers_excel_qty_onchange_cb_after_alert

  // ---------- Event onchange main_contact_email
  function do_ajax_form_clients_steps_appn_mob_event_main_contact_email_onchange()
  {
    var var_member1_email = scAjaxGetFieldText("member1_email");
    var var_main_contact_email = scAjaxGetFieldText("main_contact_email");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_main_contact_email_onchange(var_member1_email, var_main_contact_email, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_main_contact_email_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_email_onchange

  function do_ajax_form_clients_steps_appn_mob_event_main_contact_email_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_email";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_main_contact_email_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_email_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_main_contact_email_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_email_onchange_cb_after_alert

  // ---------- Event onchange main_contact_name
  function do_ajax_form_clients_steps_appn_mob_event_main_contact_name_onchange()
  {
    var var_member1_name = scAjaxGetFieldText("member1_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_main_contact_name_onchange(var_member1_name, var_main_contact_name, var_applicant_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_main_contact_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_name_onchange

  function do_ajax_form_clients_steps_appn_mob_event_main_contact_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_main_contact_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_name_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_main_contact_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_name_onchange_cb_after_alert

  // ---------- Event onchange main_contact_phone
  function do_ajax_form_clients_steps_appn_mob_event_main_contact_phone_onchange()
  {
    var var_member1_phone = scAjaxGetFieldText("member1_phone");
    var var_main_contact_phone = scAjaxGetFieldText("main_contact_phone");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_main_contact_phone_onchange(var_member1_phone, var_main_contact_phone, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_main_contact_phone_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_phone_onchange

  function do_ajax_form_clients_steps_appn_mob_event_main_contact_phone_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_phone";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_main_contact_phone_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_phone_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_main_contact_phone_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_phone_onchange_cb_after_alert

  // ---------- Event onchange main_contact_title
  function do_ajax_form_clients_steps_appn_mob_event_main_contact_title_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_main_contact_title_onchange(var_applicant_title, var_main_contact_title, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_main_contact_title_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_title_onchange

  function do_ajax_form_clients_steps_appn_mob_event_main_contact_title_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_title";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_main_contact_title_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_title_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_main_contact_title_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_main_contact_title_onchange_cb_after_alert

  // ---------- Event onchange member10_name
  function do_ajax_form_clients_steps_appn_mob_event_member10_name_onchange()
  {
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    var var_member3_name = scAjaxGetFieldText("member3_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_member10_name_onchange(var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_member10_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_member10_name_onchange

  function do_ajax_form_clients_steps_appn_mob_event_member10_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "member10_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_member10_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_member10_name_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_member10_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_member10_name_onchange_cb_after_alert

  // ---------- Event onchange member1_name
  function do_ajax_form_clients_steps_appn_mob_event_member1_name_onchange()
  {
    var var_est_memb_cost = scAjaxGetFieldHidden("est_memb_cost");
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_member1_name_onchange(var_est_memb_cost, var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_member1_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_member1_name_onchange

  function do_ajax_form_clients_steps_appn_mob_event_member1_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "member1_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_member1_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_member1_name_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_member1_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_member1_name_onchange_cb_after_alert

  // ---------- Event onchange member2_name
  function do_ajax_form_clients_steps_appn_mob_event_member2_name_onchange()
  {
    var var_est_memb_cost = scAjaxGetFieldHidden("est_memb_cost");
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_member2_name_onchange(var_est_memb_cost, var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_member2_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_member2_name_onchange

  function do_ajax_form_clients_steps_appn_mob_event_member2_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "member2_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_member2_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_member2_name_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_member2_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_member2_name_onchange_cb_after_alert

  // ---------- Event onchange member3_name
  function do_ajax_form_clients_steps_appn_mob_event_member3_name_onchange()
  {
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    var var_member3_name = scAjaxGetFieldText("member3_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_member3_name_onchange(var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_member3_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_member3_name_onchange

  function do_ajax_form_clients_steps_appn_mob_event_member3_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "member3_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_member3_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_member3_name_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_member3_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_member3_name_onchange_cb_after_alert

  // ---------- Event onchange member4_name
  function do_ajax_form_clients_steps_appn_mob_event_member4_name_onchange()
  {
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    var var_member3_name = scAjaxGetFieldText("member3_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_member4_name_onchange(var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_member4_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_member4_name_onchange

  function do_ajax_form_clients_steps_appn_mob_event_member4_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "member4_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_member4_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_member4_name_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_member4_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_member4_name_onchange_cb_after_alert

  // ---------- Event onchange member5_name
  function do_ajax_form_clients_steps_appn_mob_event_member5_name_onchange()
  {
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    var var_member3_name = scAjaxGetFieldText("member3_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_member5_name_onchange(var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_member5_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_member5_name_onchange

  function do_ajax_form_clients_steps_appn_mob_event_member5_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "member5_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_member5_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_member5_name_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_member5_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_member5_name_onchange_cb_after_alert

  // ---------- Event onchange member6_name
  function do_ajax_form_clients_steps_appn_mob_event_member6_name_onchange()
  {
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    var var_member3_name = scAjaxGetFieldText("member3_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_member6_name_onchange(var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_member6_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_member6_name_onchange

  function do_ajax_form_clients_steps_appn_mob_event_member6_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "member6_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_member6_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_member6_name_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_member6_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_member6_name_onchange_cb_after_alert

  // ---------- Event onchange member7_name
  function do_ajax_form_clients_steps_appn_mob_event_member7_name_onchange()
  {
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    var var_member3_name = scAjaxGetFieldText("member3_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_member7_name_onchange(var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_member7_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_member7_name_onchange

  function do_ajax_form_clients_steps_appn_mob_event_member7_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "member7_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_member7_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_member7_name_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_member7_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_member7_name_onchange_cb_after_alert

  // ---------- Event onchange member8_name
  function do_ajax_form_clients_steps_appn_mob_event_member8_name_onchange()
  {
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    var var_member3_name = scAjaxGetFieldText("member3_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_member8_name_onchange(var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_member8_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_member8_name_onchange

  function do_ajax_form_clients_steps_appn_mob_event_member8_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "member8_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_member8_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_member8_name_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_member8_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_member8_name_onchange_cb_after_alert

  // ---------- Event onchange member9_name
  function do_ajax_form_clients_steps_appn_mob_event_member9_name_onchange()
  {
    var var_member1_name = scAjaxGetFieldText("member1_name");
    var var_member2_name = scAjaxGetFieldText("member2_name");
    var var_member3_name = scAjaxGetFieldText("member3_name");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_mob_event_member9_name_onchange(var_member1_name, var_member2_name, var_member3_name, var_member4_name, var_member5_name, var_member6_name, var_member7_name, var_member8_name, var_member9_name, var_member10_name, var_buyers_excel_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_mob_event_member9_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_mob_event_member9_name_onchange

  function do_ajax_form_clients_steps_appn_mob_event_member9_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "member9_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_event_member9_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_event_member9_name_onchange_cb
  function do_ajax_form_clients_steps_appn_mob_event_member9_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_mob_event_member9_name_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clients_steps_appn_mob_submit_page_0(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_mob_submit_page_0(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      url: "form_clients_steps_appn_mob.php",
      method: "POST",
      dataType: "json",
      data: {
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_mob_submit_page_cb_0(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_mob_submit_page_0

  function do_ajax_form_clients_steps_appn_mob_submit_page_cb_0(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
  ...
  } // do_ajax_form_clients_steps_appn_mob_submit_page_cb_0

  function do_ajax_form_clients_steps_appn_mob_submit_page_1(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_mob_submit_page_1(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_mob_submit_page_cb_1(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_mob_submit_page_1

  function do_ajax_form_clients_steps_appn_mob_submit_page_cb_1(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_mob_submit_page_cb_1

  function do_ajax_form_clients_steps_appn_mob_submit_page_2(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_mob_submit_page_2(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_mob_submit_page_cb_2(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_mob_submit_page_2

  function do_ajax_form_clients_steps_appn_mob_submit_page_cb_2(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_mob_submit_page_cb_2

  function do_ajax_form_clients_steps_appn_mob_submit_page_3(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_mob_submit_page_3(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_mob_submit_page_cb_3(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_mob_submit_page_3

  function do_ajax_form_clients_steps_appn_mob_submit_page_cb_3(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_mob_submit_page_cb_3

  function do_ajax_form_clients_steps_appn_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
  ...
  function do_ajax_form_clients_steps_appn_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_submit_form_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_submit_form_cb
  function do_ajax_form_clients_steps_appn_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clients_steps_appn_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_clients_steps_appn_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clients_steps_appn_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_clients_steps_appn_mob_navigate_form();
    }
  }

  function perform_ajax_form_clients_steps_appn_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_clients_steps_appn_mob_navigate_form(var_client_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clients_steps_appn_mob_navigate_form_cb);
  } // do_ajax_form_clients_steps_appn_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clients_steps_appn_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clients_steps_appn_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_mob_navigate_form_cb
  function do_ajax_form_clients_steps_appn_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clients_steps_appn_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_clients_steps_appn_mob_navigate_form_cb_after_alert

  function sc_hide_form_clients_steps_appn_mob_form()
  {
