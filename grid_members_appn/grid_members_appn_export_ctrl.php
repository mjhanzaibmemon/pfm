<?php
@session_start() ;
$_SESSION['scriptcase']['grid_members_appn']['sc_process_barr'] = true;
require_once('../grid_members_appn/index.php');
unset($_SESSION['scriptcase']['grid_members_appn']['sc_process_barr']);
$ExportCtrl = new grid_members_appn_export_control;
$ExportCtrl->Export_barr();

class grid_members_appn_export_control
{
