...
<?php
   ...
   $Ord_Cmp = new grid_members_appn_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_members_appn_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['member_name'] = "member_name";
   $tab_labels["member_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_members_appn']['labels']["member_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_members_appn']['labels']["member_name"] : "Member Name";
   $tab_ger_campos['phone1'] = "on";
   $tab_def_campos['phone1'] = "phone1";
   $tab_labels["phone1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_members_appn']['labels']["phone1"])) ? $_SESSION['sc_session'][$sc_init]['grid_members_appn']['labels']["phone1"] : "Phone";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_members_appn']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_members_appn']['labels']["email"] : "Email";
   $tab_ger_campos['main_contact'] = "on";
   $tab_def_campos['main_contact'] = "main_contact";
   $tab_labels["main_contact"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_members_appn']['labels']["main_contact"])) ? $_SESSION['sc_session'][$sc_init]['grid_members_appn']['labels']["main_contact"] : "Main Contact";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_members_appn']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_members_appn']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_members_appn']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_members_appn_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_members_appn']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
