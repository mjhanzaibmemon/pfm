...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
else
{
    ...
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['link_info']['remove_background']) {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_login_label" id="hidden_field_label_login" style="<?php echo $sStyleHidden_login; ?>"><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['login'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pswd_label" id="hidden_field_label_pswd" style="<?php echo $sStyleHidden_pswd; ?>"><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_confirm_pswd_label" id="hidden_field_label_confirm_pswd" style="<?php echo $sStyleHidden_confirm_pswd; ?>"><span id="id_label_confirm_pswd"><?php echo $this->nm_new_label['confirm_pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['confirm_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['confirm_pswd'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_email_label" id="hidden_field_label_email" style="<?php echo $sStyleHidden_email; ?>"><span id="id_label_email"><?php echo $this->nm_new_label['email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['php_cmp_required']['email'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></TD>
