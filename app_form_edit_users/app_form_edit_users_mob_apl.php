...
//
      ...
      if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form" && !$this->Apl_com_erro)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sc_redir_atualiz'] == "ok")
          {
...
sc_send_mail_api(array(
    'profile' => '',
		...
		'settings' => [
				...
				'smtp_port'     => '587',
				'smtp_user'     => 'pfm.dba@gmail.com',
				'smtp_password' => ' e4F5A2#D',
				'from_email'    => ' e4F5A2#D',
				'from_name'    => 'pfm.dba@gmail.com',
		],
    'message' => [
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dyn_search_cache']);
