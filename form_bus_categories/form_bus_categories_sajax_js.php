  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_bus_categories" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_bus_categories_form();
        }
...
?>
  ...
  // ---------- Validate bus_cat_id
  function do_ajax_form_bus_categories_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldHidden(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bus_categories_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_bus_categories_validate_bus_cat_id_cb);
  } // do_ajax_form_bus_categories_validate_bus_cat_id

  function do_ajax_form_bus_categories_validate_bus_cat_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bus_categories_validate_bus_cat_id_cb

  // ---------- Validate memb_lev_id
  function do_ajax_form_bus_categories_validate_memb_lev_id()
  {
    var nomeCampo_memb_lev_id = "memb_lev_id";
    var var_memb_lev_id = scAjaxGetFieldText(nomeCampo_memb_lev_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bus_categories_validate_memb_lev_id(var_memb_lev_id, var_script_case_init, do_ajax_form_bus_categories_validate_memb_lev_id_cb);
  } // do_ajax_form_bus_categories_validate_memb_lev_id

  function do_ajax_form_bus_categories_validate_memb_lev_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bus_categories_validate_memb_lev_id_cb

  // ---------- Validate bus_cat
  function do_ajax_form_bus_categories_validate_bus_cat()
  {
    var nomeCampo_bus_cat = "bus_cat";
    var var_bus_cat = scAjaxGetFieldText(nomeCampo_bus_cat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bus_categories_validate_bus_cat(var_bus_cat, var_script_case_init, do_ajax_form_bus_categories_validate_bus_cat_cb);
  } // do_ajax_form_bus_categories_validate_bus_cat

  function do_ajax_form_bus_categories_validate_bus_cat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bus_cat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bus_categories_validate_bus_cat_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_bus_categories_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldSelect(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bus_categories_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_bus_categories_validate_sc_field_0_cb);
  } // do_ajax_form_bus_categories_validate_sc_field_0

  function do_ajax_form_bus_categories_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bus_categories_validate_sc_field_0_cb

  // ---------- Validate descript
  function do_ajax_form_bus_categories_validate_descript()
  {
    var nomeCampo_descript = "descript";
    var var_descript = scAjaxGetFieldText(nomeCampo_descript);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bus_categories_validate_descript(var_descript, var_script_case_init, do_ajax_form_bus_categories_validate_descript_cb);
  } // do_ajax_form_bus_categories_validate_descript

  function do_ajax_form_bus_categories_validate_descript_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bus_categories_validate_descript_cb

  // ---------- Validate active
  function do_ajax_form_bus_categories_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldText(nomeCampo_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bus_categories_validate_active(var_active, var_script_case_init, do_ajax_form_bus_categories_validate_active_cb);
  } // do_ajax_form_bus_categories_validate_active

  function do_ajax_form_bus_categories_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bus_categories_validate_active_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_bus_categories_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_bus_categories_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_bus_categories_submit_form(var_bus_cat_id, var_memb_lev_id, var_bus_cat, var_sc_field_0, var_descript, var_active, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_bus_categories_submit_form_cb);
  } // do_ajax_form_bus_categories_submit_form

  function do_ajax_form_bus_categories_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_bus_categories_submit_form_cb_after_alert);
  } // do_ajax_form_bus_categories_submit_form_cb
  function do_ajax_form_bus_categories_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_bus_categories_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_bus_categories_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_bus_categories_navigate_form, function() {});
    } else {
      perform_ajax_form_bus_categories_navigate_form();
    }
  }

  function perform_ajax_form_bus_categories_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_bus_categories_navigate_form(var_bus_cat_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_bus_categories_navigate_form_cb);
  } // do_ajax_form_bus_categories_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_bus_categories']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_bus_categories_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_bus_categories_navigate_form_cb_after_alert);
  } // do_ajax_form_bus_categories_navigate_form_cb
  function do_ajax_form_bus_categories_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_bus_categories_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_bus_categories_navigate_form_cb_after_alert

  function sc_hide_form_bus_categories_form()
  {
