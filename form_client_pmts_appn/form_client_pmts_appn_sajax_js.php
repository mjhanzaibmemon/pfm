  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_client_pmts_appn" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_client_pmts_appn_form();
        }
...
?>
  ...
  // ---------- Validate pmt_date_
  function do_ajax_form_client_pmts_appn_validate_pmt_date_(iNumLinha)
  {
    var nomeCampo_pmt_date_ = "pmt_date_" + iNumLinha;
    var var_pmt_date_ = scAjaxGetFieldText(nomeCampo_pmt_date_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_appn_validate_pmt_date_(var_pmt_date_, iNumLinha, var_script_case_init, do_ajax_form_client_pmts_appn_validate_pmt_date__cb);
  } // do_ajax_form_client_pmts_appn_validate_pmt_date_

  function do_ajax_form_client_pmts_appn_validate_pmt_date__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "pmt_date_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pmt_date_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "pmt_date_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pmt_date_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_appn_validate_pmt_date__cb

  // ---------- Validate amt_received_
  function do_ajax_form_client_pmts_appn_validate_amt_received_(iNumLinha)
  {
    var nomeCampo_amt_received_ = "amt_received_" + iNumLinha;
    var var_amt_received_ = scAjaxGetFieldText(nomeCampo_amt_received_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_appn_validate_amt_received_(var_amt_received_, iNumLinha, var_script_case_init, do_ajax_form_client_pmts_appn_validate_amt_received__cb);
  } // do_ajax_form_client_pmts_appn_validate_amt_received_

  function do_ajax_form_client_pmts_appn_validate_amt_received__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "amt_received_" + iLineNumber;
    }
    else
    {
      sFieldValid = "amt_received_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "amt_received_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "amt_received_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_appn_validate_amt_received__cb

  // ---------- Validate pmt_mode_
  function do_ajax_form_client_pmts_appn_validate_pmt_mode_(iNumLinha)
  {
    var nomeCampo_pmt_mode_ = "pmt_mode_" + iNumLinha;
    var var_pmt_mode_ = scAjaxGetFieldSelect(nomeCampo_pmt_mode_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_appn_validate_pmt_mode_(var_pmt_mode_, iNumLinha, var_script_case_init, do_ajax_form_client_pmts_appn_validate_pmt_mode__cb);
  } // do_ajax_form_client_pmts_appn_validate_pmt_mode_

  function do_ajax_form_client_pmts_appn_validate_pmt_mode__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pmt_mode_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pmt_mode_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pmt_mode_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pmt_mode_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_appn_validate_pmt_mode__cb

  // ---------- Validate reference_
  function do_ajax_form_client_pmts_appn_validate_reference_(iNumLinha)
  {
    var nomeCampo_reference_ = "reference_" + iNumLinha;
    var var_reference_ = scAjaxGetFieldText(nomeCampo_reference_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_appn_validate_reference_(var_reference_, iNumLinha, var_script_case_init, do_ajax_form_client_pmts_appn_validate_reference__cb);
  } // do_ajax_form_client_pmts_appn_validate_reference_

  function do_ajax_form_client_pmts_appn_validate_reference__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "reference_" + iLineNumber;
    }
    else
    {
      sFieldValid = "reference_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "reference_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "reference_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_appn_validate_reference__cb

  // ---------- Validate remarks_
  function do_ajax_form_client_pmts_appn_validate_remarks_(iNumLinha)
  {
    var nomeCampo_remarks_ = "remarks_" + iNumLinha;
    var var_remarks_ = scAjaxGetFieldSelect(nomeCampo_remarks_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_appn_validate_remarks_(var_remarks_, iNumLinha, var_script_case_init, do_ajax_form_client_pmts_appn_validate_remarks__cb);
  } // do_ajax_form_client_pmts_appn_validate_remarks_

  function do_ajax_form_client_pmts_appn_validate_remarks__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "remarks_" + iLineNumber;
    }
    else
    {
      sFieldValid = "remarks_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "remarks_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "remarks_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_appn_validate_remarks__cb

  // ---------- Validate client_pmt_id_
  function do_ajax_form_client_pmts_appn_validate_client_pmt_id_(iNumLinha)
  {
    var nomeCampo_client_pmt_id_ = "client_pmt_id_" + iNumLinha;
    var var_client_pmt_id_ = scAjaxGetFieldHidden(nomeCampo_client_pmt_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_appn_validate_client_pmt_id_(var_client_pmt_id_, iNumLinha, var_script_case_init, do_ajax_form_client_pmts_appn_validate_client_pmt_id__cb);
  } // do_ajax_form_client_pmts_appn_validate_client_pmt_id_

  function do_ajax_form_client_pmts_appn_validate_client_pmt_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "client_pmt_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "client_pmt_id_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "client_pmt_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "client_pmt_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_appn_validate_client_pmt_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_client_pmts_appn_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_client_pmts_appn_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_client_pmts_appn_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_client_pmts_appn_add_new_line_cb);
  } // do_ajax_form_client_pmts_appn_add_new_line

  function do_ajax_form_client_pmts_appn_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_form_client_pmts_appn_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_client_pmts_appn_backup_line(iNumLinha)
  {
    var var_client_pmt_id_ = scAjaxGetFieldHidden("client_pmt_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_appn_backup_line(var_client_pmt_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_client_pmts_appn_backup_line_cb);
  } // do_ajax_form_client_pmts_appn_backup_line

  function do_ajax_form_client_pmts_appn_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_client_pmts_appn_backup_line_cb

  function do_ajax_form_client_pmts_appn_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_client_pmts_appn_cancel_insert

  function do_ajax_form_client_pmts_appn_cancel_update(iSeqVert)
  {
    do_ajax_form_client_pmts_appn_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_client_pmts_appn_cancel_update

  function do_ajax_form_client_pmts_appn_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_client_pmts_appn_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_client_pmts_appn_table_refresh()
  {
    var var_client_pmt_id_ = document.F2.client_pmt_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_client_pmts_appn_table_refresh(var_client_pmt_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_client_pmts_appn_table_refresh_cb);
  } //  do_ajax_form_client_pmts_appn_table_refresh

  function do_ajax_form_client_pmts_appn_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.client_pmt_id_.value = scAjaxGetKeyValue("client_pmt_id_");
    ...
    scAjaxAlert(do_ajax_form_client_pmts_appn_table_refresh_cb_after_alert);
  } // do_ajax_form_client_pmts_appn_table_refresh_cb
  function do_ajax_form_client_pmts_appn_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_client_pmts_appn_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_client_pmts_appn_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_client_pmts_appn_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_pmt_date_ = scAjaxGetFieldText("pmt_date_" + iNumLinha);
    var var_amt_received_ = scAjaxGetFieldText("amt_received_" + iNumLinha);
    var var_pmt_mode_ = scAjaxGetFieldSelect("pmt_mode_" + iNumLinha);
    var var_reference_ = scAjaxGetFieldText("reference_" + iNumLinha);
    var var_remarks_ = scAjaxGetFieldSelect("remarks_" + iNumLinha);
    var var_client_pmt_id_ = scAjaxGetFieldHidden("client_pmt_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_client_pmts_appn_submit_form(var_pmt_date_, var_amt_received_, var_pmt_mode_, var_reference_, var_remarks_, var_client_pmt_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_client_pmts_appn_submit_form_cb);
  } // do_ajax_form_client_pmts_appn_submit_form

  function do_ajax_form_client_pmts_appn_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pmt_date_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("amt_received_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pmt_mode_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("reference_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("remarks_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("client_pmt_id_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_client_pmts_appn_submit_form_cb_after_alert);
  } // do_ajax_form_client_pmts_appn_submit_form_cb
  function do_ajax_form_client_pmts_appn_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_client_pmts_appn_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_client_pmts_appn_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_client_pmts_appn_navigate_form, function() {});
    } else {
      perform_ajax_form_client_pmts_appn_navigate_form();
    }
  }

  function perform_ajax_form_client_pmts_appn_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_client_pmts_appn_cancel_insert(sc_form_client_pmts_appn_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("pmt_date_" + iNavForm);
      scAjaxHideErrorDisplay("amt_received_" + iNavForm);
      scAjaxHideErrorDisplay("pmt_mode_" + iNavForm);
      scAjaxHideErrorDisplay("reference_" + iNavForm);
      scAjaxHideErrorDisplay("remarks_" + iNavForm);
      scAjaxHideErrorDisplay("client_pmt_id_" + iNavForm);
    }
    var var_client_pmt_id_ = document.F2.client_pmt_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_client_pmts_appn_navigate_form(var_client_pmt_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_client_pmts_appn_navigate_form_cb);
  } // do_ajax_form_client_pmts_appn_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_client_pmts_appn_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.client_pmt_id_.value = scAjaxGetKeyValue("client_pmt_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_client_pmts_appn_navigate_form_cb_after_alert);
  } // do_ajax_form_client_pmts_appn_navigate_form_cb
  function do_ajax_form_client_pmts_appn_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_client_pmts_appn_navigate_form_cb_after_alert

    function sc_form_client_pmts_appn_get_last_line_number()
    {
    ...
    } //sc_form_client_pmts_appn_get_last_line_number

  function sc_hide_form_client_pmts_appn_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "pmt_date_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "amt_received_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pmt_mode_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "reference_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "remarks_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "client_pmt_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["pmt_date_" + iNumLinha] = {"label": "Date<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["amt_received_" + iNumLinha] = {"label": "Amount<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["pmt_mode_" + iNumLinha] = {"label": "Pmt Mode<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["reference_" + iNumLinha] = {"label": "Reference<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["remarks_" + iNumLinha] = {"label": "Access Options<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["client_pmt_id_" + iNumLinha] = {"label": "Client Pmt Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["pmt_date_"][iNumLinha] = "pmt_date_" + iNumLinha;
    ajax_field_mult["amt_received_"][iNumLinha] = "amt_received_" + iNumLinha;
    ajax_field_mult["pmt_mode_"][iNumLinha] = "pmt_mode_" + iNumLinha;
    ajax_field_mult["reference_"][iNumLinha] = "reference_" + iNumLinha;
    ajax_field_mult["remarks_"][iNumLinha] = "remarks_" + iNumLinha;
    ajax_field_mult["client_pmt_id_"][iNumLinha] = "client_pmt_id_" + iNumLinha;
    ajax_field_id["pmt_date_" + iNumLinha] = new Array("hidden_field_label_pmt_date_", "hidden_field_data_pmt_date_" + iNumLinha);
    ajax_field_id["amt_received_" + iNumLinha] = new Array("hidden_field_label_amt_received_", "hidden_field_data_amt_received_" + iNumLinha);
    ajax_field_id["pmt_mode_" + iNumLinha] = new Array("hidden_field_label_pmt_mode_", "hidden_field_data_pmt_mode_" + iNumLinha);
    ajax_field_id["reference_" + iNumLinha] = new Array("hidden_field_label_reference_", "hidden_field_data_reference_" + iNumLinha);
    ajax_field_id["remarks_" + iNumLinha] = new Array("hidden_field_label_remarks_", "hidden_field_data_remarks_" + iNumLinha);
    ajax_error_count["pmt_date_" + iNumLinha] = "off";
    ajax_error_count["amt_received_" + iNumLinha] = "off";
    ajax_error_count["pmt_mode_" + iNumLinha] = "off";
    ajax_error_count["reference_" + iNumLinha] = "off";
    ajax_error_count["remarks_" + iNumLinha] = "off";
    ajax_error_count["client_pmt_id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["pmt_date_" + iNumLinha] = "off";
    ajax_read_only["amt_received_" + iNumLinha] = "off";
    ajax_read_only["pmt_mode_" + iNumLinha] = "off";
    ajax_read_only["reference_" + iNumLinha] = "off";
    ajax_read_only["remarks_" + iNumLinha] = "off";
    ajax_read_only["client_pmt_id_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["pmt_date_" + iNumLinha] = "on";
    ajax_read_only["amt_received_" + iNumLinha] = "on";
    ajax_read_only["pmt_mode_" + iNumLinha] = "on";
    ajax_read_only["reference_" + iNumLinha] = "on";
    ajax_read_only["remarks_" + iNumLinha] = "on";
    ajax_read_only["client_pmt_id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["pmt_date_" + iNumLinha] = null;
    ajax_error_list["amt_received_" + iNumLinha] = null;
    ajax_error_list["pmt_mode_" + iNumLinha] = null;
    ajax_error_list["reference_" + iNumLinha] = null;
    ajax_error_list["remarks_" + iNumLinha] = null;
    ajax_error_list["client_pmt_id_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "pmt_date_": new Array(),
    "amt_received_": new Array(),
    "pmt_mode_": new Array(),
    "reference_": new Array(),
    "remarks_": new Array(),
    "client_pmt_id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["pmt_date_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pmt_date_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pmt_date_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pmt_date_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pmt_date_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["amt_received_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["amt_received_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["amt_received_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["amt_received_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["amt_received_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pmt_mode_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pmt_mode_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pmt_mode_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pmt_mode_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pmt_mode_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["reference_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["reference_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["reference_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["reference_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["reference_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["remarks_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["remarks_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["remarks_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["remarks_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["remarks_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["client_pmt_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["client_pmt_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["client_pmt_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["client_pmt_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["client_pmt_id_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pmt_date_'])) ? $this->nmgp_cmp_readonly['pmt_date_'] : 'off';
?>
    scAjaxFieldRead("pmt_date_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['amt_received_'])) ? $this->nmgp_cmp_readonly['amt_received_'] : 'off';
?>
    scAjaxFieldRead("amt_received_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pmt_mode_'])) ? $this->nmgp_cmp_readonly['pmt_mode_'] : 'off';
?>
    scAjaxFieldRead("pmt_mode_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['reference_'])) ? $this->nmgp_cmp_readonly['reference_'] : 'off';
?>
    scAjaxFieldRead("reference_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['remarks_'])) ? $this->nmgp_cmp_readonly['remarks_'] : 'off';
?>
    scAjaxFieldRead("remarks_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['client_pmt_id_'])) ? $this->nmgp_cmp_readonly['client_pmt_id_'] : 'on';
?>
    scAjaxFieldRead("client_pmt_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("pmt_date_" + iSeq, "on");
    scAjaxFieldRead("amt_received_" + iSeq, "on");
    scAjaxFieldRead("pmt_mode_" + iSeq, "on");
    scAjaxFieldRead("reference_" + iSeq, "on");
    scAjaxFieldRead("remarks_" + iSeq, "on");
    scAjaxFieldRead("client_pmt_id_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pmt_date_" + iRow] || "on" == ajax_error_count["amt_received_" + iRow] || "on" == ajax_error_count["pmt_mode_" + iRow] || "on" == ajax_error_count["reference_" + iRow] || "on" == ajax_error_count["remarks_" + iRow] || "on" == ajax_error_count["client_pmt_id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pmt_date_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_amt_received_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pmt_mode_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_reference_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_remarks_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_client_pmt_id_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pmt_date_" + iRow] && "off" == ajax_error_count["amt_received_" + iRow] && "off" == ajax_error_count["pmt_mode_" + iRow] && "off" == ajax_error_count["reference_" + iRow] && "off" == ajax_error_count["remarks_" + iRow] && "off" == ajax_error_count["client_pmt_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["pmt_date_" + iRow] = "off";
        ajax_error_count["amt_received_" + iRow] = "off";
        ajax_error_count["pmt_mode_" + iRow] = "off";
        ajax_error_count["reference_" + iRow] = "off";
        ajax_error_count["remarks_" + iRow] = "off";
        ajax_error_count["client_pmt_id_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_pmt_date_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_amt_received_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pmt_mode_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_reference_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_remarks_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_client_pmt_id_" + iRow).removeClass("scFormErrorLine");
    }
  }
