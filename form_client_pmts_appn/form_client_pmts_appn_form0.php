<?php
class form_client_pmts_appn_form extends form_client_pmts_appn_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['sc_redir_atualiz'] == 'ok')
{
?>
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_client_pmts_appn/form_client_pmts_appn_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_client_pmts_appn_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_client_pmts_appn_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['link_info']['remove_border']) {
...
<?php
 include_once("form_client_pmts_appn_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_client_pmts_appn'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_client_pmts_appn'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_client_pmts_appn);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_client_pmts_appn = $this->form_vert_form_client_pmts_appn;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_client_pmts_appn))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_client_pmts_appn as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       $this->loadRecordState($sc_seq_vert);
       $this->client_id_ = $this->form_vert_form_client_pmts_appn[$sc_seq_vert]['client_id_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->pmt_date_ = $this->form_vert_form_client_pmts_appn[$sc_seq_vert]['pmt_date_']; 
       ...
       $this->amt_received_ = $this->form_vert_form_client_pmts_appn[$sc_seq_vert]['amt_received_']; 
       ...
       $this->pmt_mode_ = $this->form_vert_form_client_pmts_appn[$sc_seq_vert]['pmt_mode_']; 
       ...
       $this->reference_ = $this->form_vert_form_client_pmts_appn[$sc_seq_vert]['reference_']; 
       ...
       $this->remarks_ = $this->form_vert_form_client_pmts_appn[$sc_seq_vert]['remarks_']; 
       ...
       $this->client_pmt_id_ = $this->form_vert_form_client_pmts_appn[$sc_seq_vert]['client_pmt_id_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_client_pmts_appn_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_client_pmts_appn_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_client_pmts_appn_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_client_pmts_appn_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_client_pmts_appn_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_client_pmts_appn_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
 </TD>
   <?php 
       $this->form_fixed_column_no++;
}?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_client_pmts_appn = $guarda_form_vert_form_client_pmts_appn;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['last'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['btn_label']['exit'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_client_pmts_appn");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_client_pmts_appn");
 parent.scAjaxDetailHeight("form_client_pmts_appn", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
        ...
        function scBtnFn_sys_format_inc() {
                if ($("#sc_b_new_b.sc-unique-btn-5").length && $("#sc_b_new_b.sc-unique-btn-5").is(":visible")) {
                    if ($("#sc_b_new_b.sc-unique-btn-5").hasClass("disabled")) {
                        ...
                        do_ajax_form_client_pmts_appn_add_new_line(); return false;
                         return;
                }
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_appn']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
