...
function ajax_navigate(opc, parm, Fade='S')
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_grid_vw_clients').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_grid_vw_clients').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_grid_vw_clients').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_grid_vw_clients').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_grid_vw_clients').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_grid_vw_clients').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_grid_vw_clients').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_grid_vw_clients').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_grid_vw_clients').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_grid_vw_clients').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_grid_vw_clients').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_grid_vw_clients').style.width  = '0px';
        }
        if (oResp["setValue"]) {
        ...
        if (typeof SC_Link_View !== 'undefined' && !SC_Link_View)
        {
            ...
            if (("dyn_search_clear" == opc) && typeof(buttonDisable_dyn) === typeof(function(){})) {
                 buttonDisable_dyn('dyn_search_clear');
                 buttonDisable_dyn('dyn_search');
                 buttonDisable_dyn('Save_frm_dyn');
            }else if(("dyn_search_select" == opc ||  "dyn_search_save" == opc) && typeof(buttonEnable_dyn) === typeof(function(){}))
            {
...
function ajax_navigate_res(opc, parm, Fade='S')
{
    ...
    $.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (("dyn_search_clear_res" == opc) && typeof(buttonDisable_dyn) === typeof(function(){})) {
            buttonDisable_dyn('dyn_search_clear');
            buttonDisable_dyn('dyn_search');
            buttonDisable_dyn('Save_frm_dyn');
        }else if(("dyn_search_select_res" == opc || "dyn_search_save_res" == opc) && typeof(buttonEnable_dyn) === typeof(function(){}))
        {
            buttonDisable_dyn('dyn_search');
            buttonEnable_dyn('dyn_search_clear');
        }
...
function ajax_select_filter(opt, param)
{
    nmAjaxProcOn();
    $.ajax({
      type: "POST",
      url: "index.php",
      data: "nmgp_opcao=ajax_navigate&opc="+ opt +"&script_case_init=" + document.Fdyn_search.script_case_init.value + "&parm=" + param
     })
     .done(function(selectFilter) {
        nm_change_grid_search_dyn_navigate();
        nmAjaxProcOff();
     });
}
function ajax_add_dyn_search(str_field, str_origem)
{
    nm_hide_dynamicsearch_fields('id_dynamic_search_fields', true);
