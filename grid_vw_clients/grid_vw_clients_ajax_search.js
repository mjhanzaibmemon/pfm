...
// ---------- delete_filter
function ajax_delete_filter(parm, pos)
{
    nmAjaxProcOn();
    $.ajax({
      type: "POST",
     ...
     .done(function(json_del_fil) {
        ...
        if($("#sel_filters_del_"+ pos +" option[value!='']").length < 1)
        {
            $("#Apaga_filters_"+ pos).hide();
        }
        if($("#sel_recup_filters_"+ pos +" option[value!='']").length < 1)
        {
            $("#sel_recup_filters_"+ pos).hide();
        }
        nmAjaxProcOff();
...
Table_sv_fil[0] = "client_id";
Table_sv_fil[1] = "co_name";
Table_sv_fil[2] = "main_phone";
Table_sv_fil[3] = "membershipid";
Table_sv_fil[4] = "main_email";
Table_sv_fil[5] = "status";
Table_sv_fil[6] = "bus_cat";
Table_sv_fil[7] = "bus_subcategory";
Table_sv_fil[8] = "street_address";
Table_sv_fil[9] = "mailing_address";
Table_sv_fil[10] = "city";
Table_sv_fil[11] = "state";
Table_sv_fil[12] = "zip_code";
Table_sv_fil[13] = "home_phone";
Table_sv_fil[14] = "main_contact_name";
Table_sv_fil[15] = "main_contact_phone";
Table_sv_fil[16] = "main_contact_title";
Table_sv_fil[17] = "renewal_date";
