...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PFM_Staff_____grid_vw_clients"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PFM_Staff_____grid_vw_clients"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vw_clients']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_vw_clients']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vw_clients']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_vw_clients']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_vw_clients']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_vw_clients']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_vw_clients']['embutida_filho'] as $ind => $sc_init)
          {
