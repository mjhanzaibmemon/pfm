  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_members_det" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_members_det_validate_member_name()
  {
    var nomeCampo_member_name = "member_name";
    var var_member_name = scAjaxGetFieldText(nomeCampo_member_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_validate_member_name(var_member_name, var_script_case_init, do_ajax_form_members_det_validate_member_name_cb);
  } // do_ajax_form_members_det_validate_member_name

  function do_ajax_form_members_det_validate_member_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_validate_member_name_cb

  // ---------- Validate email
  function do_ajax_form_members_det_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_validate_email(var_email, var_script_case_init, do_ajax_form_members_det_validate_email_cb);
  } // do_ajax_form_members_det_validate_email

  function do_ajax_form_members_det_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_validate_email_cb

  // ---------- Validate phone1
  function do_ajax_form_members_det_validate_phone1()
  {
    var nomeCampo_phone1 = "phone1";
    var var_phone1 = scAjaxGetFieldText(nomeCampo_phone1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_validate_phone1(var_phone1, var_script_case_init, do_ajax_form_members_det_validate_phone1_cb);
  } // do_ajax_form_members_det_validate_phone1

  function do_ajax_form_members_det_validate_phone1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "phone1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_validate_phone1_cb

  // ---------- Validate main_contact
  function do_ajax_form_members_det_validate_main_contact()
  {
    var nomeCampo_main_contact = "main_contact";
    var var_main_contact = scAjaxGetFieldRadio(nomeCampo_main_contact);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_validate_main_contact(var_main_contact, var_script_case_init, do_ajax_form_members_det_validate_main_contact_cb);
  } // do_ajax_form_members_det_validate_main_contact

  function do_ajax_form_members_det_validate_main_contact_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_validate_main_contact_cb

  // ---------- Validate note
  function do_ajax_form_members_det_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldText(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_validate_note(var_note, var_script_case_init, do_ajax_form_members_det_validate_note_cb);
  } // do_ajax_form_members_det_validate_note

  function do_ajax_form_members_det_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_validate_note_cb

  // ---------- Validate driver_lic_id
  function do_ajax_form_members_det_validate_driver_lic_id()
  {
    var nomeCampo_driver_lic_id = "driver_lic_id";
    var var_driver_lic_id = scAjaxGetFieldText(nomeCampo_driver_lic_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_det_validate_driver_lic_id(var_driver_lic_id, var_script_case_init, do_ajax_form_members_det_validate_driver_lic_id_cb);
  } // do_ajax_form_members_det_validate_driver_lic_id

  function do_ajax_form_members_det_validate_driver_lic_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_det_validate_driver_lic_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_members_det_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_members_det_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_members_det_submit_form(var_member_name, var_email, var_phone1, var_main_contact, var_note, var_driver_lic_id, var_driver_lic_id_ul_name, var_driver_lic_id_ul_type, var_driver_lic_id_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_members_det_submit_form_cb);
  } // do_ajax_form_members_det_submit_form

  function do_ajax_form_members_det_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_members_det_submit_form_cb_after_alert);
  } // do_ajax_form_members_det_submit_form_cb
  function do_ajax_form_members_det_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_members_det_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_members_det_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_members_det_navigate_form, function() {});
    } else {
      perform_ajax_form_members_det_navigate_form();
    }
  }

  function perform_ajax_form_members_det_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_members_det_navigate_form(var_member_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_members_det_navigate_form_cb);
  } // do_ajax_form_members_det_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_det']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_members_det_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_members_det_navigate_form_cb_after_alert);
  } // do_ajax_form_members_det_navigate_form_cb
  function do_ajax_form_members_det_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_members_det_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_members_det_navigate_form_cb_after_alert

  function sc_hide_form_members_det_form()
  {
