...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['dyn_search_cache']);
