...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_login' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_app_form_add_users_login_onblur('#id_sc_field_login' + iSeqRow, iSeqRow);}, 300) })
                                   .bind('focus', function() { sc_app_form_add_users_login_onfocus(this, iSeqRow) });
  $('#id_sc_field_pswd' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_app_form_add_users_pswd_onblur('#id_sc_field_pswd' + iSeqRow, iSeqRow);}, 300) })
                                  .bind('focus', function() { sc_app_form_add_users_pswd_onfocus(this, iSeqRow) });
  $('#id_sc_field_name' + iSeqRow).bind('blur', function() { sc_app_form_add_users_name_onblur('#id_sc_field_name' + iSeqRow, iSeqRow) })
                                  .bind('focus', function() { sc_app_form_add_users_name_onfocus(this, iSeqRow) });
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_app_form_add_users_email_onblur('#id_sc_field_email' + iSeqRow, iSeqRow);}, 300) })
                                   .bind('focus', function() { sc_app_form_add_users_email_onfocus(this, iSeqRow) });
  $('#id_sc_field_picture' + iSeqRow).bind('blur', function() { sc_app_form_add_users_picture_onblur('#id_sc_field_picture' + iSeqRow, iSeqRow) })
                                     .bind('focus', function() { sc_app_form_add_users_picture_onfocus(this, iSeqRow) });
  $('#id_sc_field_confirm_pswd' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_app_form_add_users_confirm_pswd_onblur('#id_sc_field_confirm_pswd' + iSeqRow, iSeqRow);}, 300) })
