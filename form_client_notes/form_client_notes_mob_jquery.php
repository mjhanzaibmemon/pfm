...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_note_date_hora' + iSeqRow).bind('blur', function() { sc_form_client_notes_note_date_onblur('#id_sc_field_note_date' + iSeqRow, iSeqRow) })
                                            .bind('focus', function() { sc_form_client_notes_note_date_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
        $("#id_form_client_notes_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_client_notes_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
