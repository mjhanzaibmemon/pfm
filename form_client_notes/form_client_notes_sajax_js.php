  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_client_notes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_client_notes_form();
        }
...
?>
  ...
  // ---------- Validate note_date
  function do_ajax_form_client_notes_validate_note_date()
  {
    var nomeCampo_note_date = "note_date";
    var var_note_date = scAjaxGetFieldHidden(nomeCampo_note_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_notes_validate_note_date(var_note_date, var_script_case_init, do_ajax_form_client_notes_validate_note_date_cb);
  } // do_ajax_form_client_notes_validate_note_date

  function do_ajax_form_client_notes_validate_note_date_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_notes_validate_note_date_cb

  // ---------- Validate note
  function do_ajax_form_client_notes_validate_note()
  {
    var nomeCampo_note = "note";
    var var_note = scAjaxGetFieldEditorHtml(nomeCampo_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_notes_validate_note(var_note, var_script_case_init, do_ajax_form_client_notes_validate_note_cb);
  } // do_ajax_form_client_notes_validate_note

  function do_ajax_form_client_notes_validate_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "note";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_notes_validate_note_cb

  // ---------- Validate user
  function do_ajax_form_client_notes_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldHidden(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_notes_validate_user(var_user, var_script_case_init, do_ajax_form_client_notes_validate_user_cb);
  } // do_ajax_form_client_notes_validate_user

  function do_ajax_form_client_notes_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_notes_validate_user_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_client_notes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_client_notes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_client_notes_submit_form(var_note_date, var_note, var_user, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_client_notes_submit_form_cb);
  } // do_ajax_form_client_notes_submit_form

  function do_ajax_form_client_notes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_client_notes_submit_form_cb_after_alert);
  } // do_ajax_form_client_notes_submit_form_cb
  function do_ajax_form_client_notes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_client_notes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_client_notes_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_client_notes_navigate_form, function() {});
    } else {
      perform_ajax_form_client_notes_navigate_form();
    }
  }

  function perform_ajax_form_client_notes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_client_notes_navigate_form(var_notes_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_client_notes_navigate_form_cb);
  } // do_ajax_form_client_notes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_notes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_client_notes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_client_notes_navigate_form_cb_after_alert);
  } // do_ajax_form_client_notes_navigate_form_cb
  function do_ajax_form_client_notes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_client_notes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_client_notes_navigate_form_cb_after_alert

  function sc_hide_form_client_notes_form()
  {
