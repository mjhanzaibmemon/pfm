...
$old_error_handler = set_error_handler("form_sec_renewals_edit_scriptcase_error_handler");

function form_sec_renewals_edit_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_sec_renewals_edit']['contr_erro']) && $_SESSION['scriptcase']['form_sec_renewals_edit']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_sec_renewals_edit->contr_form_sec_renewals_edit->Apl_com_erro = true;
            if ($inicial_form_sec_renewals_edit->contr_form_sec_renewals_edit->NM_ajax_flag)
            {
                $inicial_form_sec_renewals_edit->contr_form_sec_renewals_edit->NM_ajax_info['errList']['geral_form_sec_renewals_edit'][] = $msg;
                return;
            }
            form_sec_renewals_edit_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_sec_renewals_edit_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_sec_renewals_edit'])  && '' != $_SESSION['scriptcase']['error_icon']['form_sec_renewals_edit'])  ? $_SESSION['scriptcase']['error_icon']['form_sec_renewals_edit']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_sec_renewals_edit']) && '' != $_SESSION['scriptcase']['error_span_title']['form_sec_renewals_edit']) ? $_SESSION['scriptcase']['error_span_title']['form_sec_renewals_edit'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_sec_renewals_edit']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_sec_renewals_edit']) ? $_SESSION['scriptcase']['error_icon_title']['form_sec_renewals_edit'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_sec_renewals_edit']['error_buffer'] .= ob_get_flush();
}
