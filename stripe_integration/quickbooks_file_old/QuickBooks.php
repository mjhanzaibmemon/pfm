...
define('QUICKBOOKS_ADD_Estimate', 'AddEstimate');
define('QUICKBOOKS_Mod_Estimate', 'ModEstimate');

define('QUICKBOOKS_ADD_Invoice', 'AddInvoice');
define('QUICKBOOKS_MOD_Invoice', 'ModEstimateInvoice');


define('QUICKBOOKS_ADD_Deposite_Invoice', 'AddDepositeInvoice');
 ...
 * @var string
 */
define('QUICKBOOKS_ADD_CUSTOMER', 'AddCustomer');
define('QUICKBOOKS_IMPORT_CUSTOMER', 'Customer');
define('QUICKBOOKS_SEARCH_CUSTOMER', 'SearchCustomer');
/**
 * QuickBooks request to modify a customer record
 * @var string
 */
define('QUICKBOOKS_MOD_CUSTOMER', 'modCustomer');
...
define('QUICKBOOKS_ADD_ITEM', 'AddItem');

define('QUICKBOOKS_MOD_ITEM', 'ModItem');
...
define('QUICKBOOKS_IMPORT_PAYMENT', 'Recieve_payments');
define('QUICKBOOKS_Invoice_Query', 'Invoice_Query');
define('QUICKBOOKS_Estimate_Query', 'Estimate_Query');
define('QUICKBOOKS_ADD_PAYMENT','AddPayment');
...
define('QUICKBOOKS_REPORT_GENERAL_DETAIL', 'GeneralDetailReportQuery');
