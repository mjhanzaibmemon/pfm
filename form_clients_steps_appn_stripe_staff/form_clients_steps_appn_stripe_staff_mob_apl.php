<?php
//
class form_clients_steps_appn_stripe_staff_mob_apl
{
   ...
   var $more_buyers_xlsx;
   var $more_buyers_xlsx_scfile_name;
   var $more_buyers_xlsx_ul_name;
   var $more_buyers_xlsx_ul_type;
   var $more_buyers_xlsx_limpa;
   var $more_buyers_xlsx_salva;
   var $buyers_excel_qty;
   var $qb_id;
   var $memb_qty;
   var $synced;
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['doc_file']))
          {
              $this->doc_file = $this->NM_ajax_info['param']['doc_file'];
          }
          if (isset($this->NM_ajax_info['param']['doc_file_limpa']))
          {
              $this->doc_file_limpa = $this->NM_ajax_info['param']['doc_file_limpa'];
          }
          if (isset($this->NM_ajax_info['param']['doc_file_ul_name']))
          {
              $this->doc_file_ul_name = $this->NM_ajax_info['param']['doc_file_ul_name'];
          }
          if (isset($this->NM_ajax_info['param']['doc_file_ul_type']))
          {
              $this->doc_file_ul_type = $this->NM_ajax_info['param']['doc_file_ul_type'];
          }
          if (isset($this->NM_ajax_info['param']['doc_type']))
          {
              $this->doc_type = $this->NM_ajax_info['param']['doc_type'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['est_memb_cost']))
          {
              $this->est_memb_cost = $this->NM_ajax_info['param']['est_memb_cost'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['memb_qty']))
          {
              $this->memb_qty = $this->NM_ajax_info['param']['memb_qty'];
          }
      ...
      $Sc_lig_md5 = false;
      $List_cmps = array('dummy02','dummy03','co_name','client_id','mailing_address','memb_status_id','city','bus_cat_id','state','bus_subcat_id','zip_code','bus_subcat_other','appn_date','acct_instagram','website_url','acct_facebook','dummy07','dummy08','main_contact_name','main_contact_phone','main_contact_email','main_contact_title','main_contact_img_id','doc_type','doc_file','appn_note','memb_list','est_memb_cost','memb_qty','read_at_sign','applicant_name','applicant_title','applicant_signature','ofa_contact','street_address','phone_number','home_phone','fax_number','email','business_type','fresh_cut_allowed','business_license','nursery_license','federal_tax_id','temporary_pass','ofa_member','starting_date','renewal_date','expiration_date','canceled','cancel_date','canceled_by','reason_canceled','retire_date','verified_receipts','date_last_updated','restricted','committee_approval_required','type_company','archive','archive_date','pricing_level_id','store_front_address','store_front_city','store_front_zip','home_base_address','home_base_city','home_base_zip','store_front_state','home_base_state','record_created','permanent_member_date','doc_filename','doc_filesize','more_buyers_xlsx','buyers_excel_qty','qb_id','synced','main_contact_img_file','main_contact_img_size','addtl_memb_mail','adtl_memb_name','adtl_memb_note','adtl_memb_phone','dummy01','dummy04','dummy05','dummy06','dummy09','dummy10','dummy11','dummy12','dummy13','main_contact_title_lbl','memb_01','memb_02','memb_03','memb_04','memb_05','memb_06','memb_07','memb_08','memb_09','memb_10','memb_11','memb_12','memb_13','memb_email','memb_levels','memb_name','memb_note','memb_phone','paid','pay','rules','rules_warn','xlsx_sample');
      if (!isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['Cache_wizard_form']) || (isset($_POST['rs']) && strpos($_POST['rs'], '_navigate_form'))) {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['Cache_wizard_form'] = array();
      }
      foreach ($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['Cache_wizard_form'] as $nmgp_var => $nmgp_val) {
      ...
      if (!empty($_POST))
      {
          foreach ($_POST as $nmgp_var => $nmgp_val)
          {
              ...
              if ($nmgp_var == "nmgp_parms" && substr($nmgp_val, 0, 8) == "@SC_par@")
              {
               ...
               $this->$nmgp_var = $nmgp_val;
               if (in_array($nmgp_var, $List_cmps)) {
                   $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['Cache_wizard_form'][$nmgp_var] = $nmgp_val;
               }
          }
      }
      if (!empty($_GET))
      ...
      if (isset($this->gv_cost_addtl_buyer) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['gv_cost_addtl_buyer'] = $this->gv_cost_addtl_buyer;
      }
      if (isset($this->gv_memb_price) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['gv_memb_price'] = $this->gv_memb_price;
      }
      ...
      if (isset($_POST["gv_cost_addtl_buyer"]) && isset($this->gv_cost_addtl_buyer)) 
      {
          $_SESSION['gv_cost_addtl_buyer'] = $this->gv_cost_addtl_buyer;
      }
      if (isset($_POST["gv_memb_price"]) && isset($this->gv_memb_price)) 
      {
          $_SESSION['gv_memb_price'] = $this->gv_memb_price;
      }
      ...
      if (isset($_GET["gv_cost_addtl_buyer"]) && isset($this->gv_cost_addtl_buyer)) 
      {
          $_SESSION['gv_cost_addtl_buyer'] = $this->gv_cost_addtl_buyer;
      }
      if (isset($_GET["gv_memb_price"]) && isset($this->gv_memb_price)) 
      {
          $_SESSION['gv_memb_price'] = $this->gv_memb_price;
      }
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_clients_steps_appn_stripe_staff_mob($cadapar[1]);
          ...
          if (isset($this->gv_cost_addtl_buyer)) 
          {
              $_SESSION['gv_cost_addtl_buyer'] = $this->gv_cost_addtl_buyer;
          }
          if (isset($this->gv_memb_price)) 
          {
              $_SESSION['gv_memb_price'] = $this->gv_memb_price;
          }
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['opc_ant']);
          }
          if (isset($this->gv_contact_pfm)) 
          {
              $_SESSION['gv_contact_pfm'] = $this->gv_contact_pfm;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_clients_steps_appn_stripe_staff_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['initialize'])
          {
              $_SESSION['scriptcase']['form_clients_steps_appn_stripe_staff_mob']['contr_erro'] = 'on';
  ?>
<style>
...
<?php
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_staff_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['upload_field_info']['main_contact_img_id'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_staff_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
          'upload_type'        => 'single',
          'upload_allowed_type'  => '/\.(pdf|jpg|jpeg|png|tiff|gif|bmp)$/i',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['upload_field_info']['doc_file'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_staff_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
          'upload_type'        => 'single',
          'upload_allowed_type'  => '/\.(pdf|jpg|jpeg|png|bmp|gif|tiff|svg|doc|docx|odp|ods|odt|xls|xlsx)$/i',
          'upload_max_size'  => null,
          'upload_file_height' => '',
          'upload_file_width'  => '',
          'upload_file_aspect' => '',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_staff_mob']['upload_field_info']['more_buyers_xlsx'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_staff_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_steps_appn_stripe_staff_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_steps_appn_stripe_staff_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe_staff_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe_staff_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_clients_steps_appn_stripe_staff_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe_staff_mob']['label'] = "PFM - Buyers Pass App";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_clients_steps_appn_stripe_staff_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->arr_buttons['snp']['hint']             = "";
      $this->arr_buttons['snp']['type']             = "button";
      $this->arr_buttons['snp']['value']            = "Submit & Pay";
      $this->arr_buttons['snp']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['snp']['display_position'] = "text_right";
      $this->arr_buttons['snp']['style']            = "default";
      $this->arr_buttons['snp']['image']            = "";
      $this->arr_buttons['snp']['has_fa']            = "true";
      $this->arr_buttons['snp']['fontawesomeicon']            = "";

      $this->arr_buttons['submit_app']['hint']             = "";
      $this->arr_buttons['submit_app']['type']             = "button";
      $this->arr_buttons['submit_app']['value']            = "Submit";
      $this->arr_buttons['submit_app']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['submit_app']['display_position'] = "text_right";
      $this->arr_buttons['submit_app']['style']            = "ok";
      $this->arr_buttons['submit_app']['image']            = "";
      $this->arr_buttons['submit_app']['has_fa']            = "true";
      $this->arr_buttons['submit_app']['fontawesomeicon']            = "far fa-check-circle";

      $this->arr_buttons['requests']['hint']             = "";
      $this->arr_buttons['requests']['type']             = "button";
      $this->arr_buttons['requests']['value']            = "Requests";
      $this->arr_buttons['requests']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['requests']['display_position'] = "text_right";
      $this->arr_buttons['requests']['style']            = "default";
      $this->arr_buttons['requests']['image']            = "";
      $this->arr_buttons['requests']['has_fa']            = "true";
      $this->arr_buttons['requests']['fontawesomeicon']            = "";
      ...
      $this->arr_buttons['approve_appn']['hint']             = "Email the customer to inform them that their membership is Active";
      $this->arr_buttons['approve_appn']['type']             = "button";
      $this->arr_buttons['approve_appn']['value']            = "Approve Membership";
      $this->arr_buttons['approve_appn']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['approve_appn']['display_position'] = "text_right";
      $this->arr_buttons['approve_appn']['style']            = "danger";
      $this->arr_buttons['approve_appn']['image']            = "";
      $this->arr_buttons['approve_appn']['has_fa']            = "true";
      $this->arr_buttons['approve_appn']['fontawesomeicon']            = "fas fa-check-circle";


      $_SESSION['scriptcase']['error_icon']['form_clients_steps_appn_stripe_staff_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_clients_steps_appn_stripe_staff_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['table_refresh'] = false;

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard'])) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard'] = array();
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['actual_step']) || $this->nmgp_opcao  == "novo" || $this->nmgp_opcao  == "incluir") {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['actual_step'] = 0;
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['total_steps'] = 4;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if (isset($this->NM_ajax_info['param']['doc_file_ul_name']) && '' != $this->NM_ajax_info['param']['doc_file_ul_name'])
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_field_ul_name'][$this->doc_file_ul_name]))
          {
              $this->NM_ajax_info['param']['doc_file_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_field_ul_name'][$this->doc_file_ul_name];
          }
          $this->doc_file = $this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->NM_ajax_info['param']['doc_file_ul_name'];
          $this->doc_file_scfile_name = substr($this->NM_ajax_info['param']['doc_file_ul_name'], 12);
          $this->doc_file_scfile_type = $this->NM_ajax_info['param']['doc_file_ul_type'];
          $this->doc_file_ul_name = $this->NM_ajax_info['param']['doc_file_ul_name'];
          $this->doc_file_ul_type = $this->NM_ajax_info['param']['doc_file_ul_type'];
      }
      elseif (isset($this->doc_file_ul_name) && '' != $this->doc_file_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_field_ul_name'][$this->doc_file_ul_name]))
          {
              $this->doc_file_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_field_ul_name'][$this->doc_file_ul_name];
          }
          $this->doc_file = $this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->doc_file_ul_name;
          $this->doc_file_scfile_name = substr($this->doc_file_ul_name, 12);
          $this->doc_file_scfile_type = $this->doc_file_ul_type;
      }
      if (isset($this->NM_ajax_info['param']['main_contact_img_id_ul_name']) && '' != $this->NM_ajax_info['param']['main_contact_img_id_ul_name'])
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->NM_ajax_info['param']['main_contact_img_id_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      elseif (isset($this->main_contact_img_id_ul_name) && '' != $this->main_contact_img_id_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->main_contact_img_id_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['goto']      = 'on';
          }
      }
      ...
      $this->nmgp_botoes['snp'] = "on";
      $this->nmgp_botoes['submit_app'] = "on";
      $this->nmgp_botoes['requests'] = "on";
      $this->nmgp_botoes['btn_back_reqs'] = "on";
      $this->nmgp_botoes['approve_appn'] = "on";
      if (isset($this->NM_btn_cancel) && 'N' == $this->NM_btn_cancel)
      {
          $this->nmgp_botoes['cancel'] = "off";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_staff_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_steps_appn_stripe_staff_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_steps_appn_stripe_staff_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_form'];
          ...
          if (!isset($this->more_buyers_xlsx)){$this->more_buyers_xlsx = $this->nmgp_dados_form['more_buyers_xlsx'];} 
          if (!isset($this->buyers_excel_qty)){$this->buyers_excel_qty = $this->nmgp_dados_form['buyers_excel_qty'];} 
          if (!isset($this->qb_id)){$this->qb_id = $this->nmgp_dados_form['qb_id'];} 
          if (!isset($this->synced)){$this->synced = $this->nmgp_dados_form['synced'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_clients_steps_appn_stripe_staff_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_clients_steps_appn_stripe_staff_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_clients_steps_appn_stripe_staff_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_clients_steps_appn_stripe_staff/form_clients_steps_appn_stripe_staff_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_clients_steps_appn_stripe_staff_mob_erro.class.php"); 
      }
      $this->Erro      = new form_clients_steps_appn_stripe_staff_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opcao']))
         { 
             if ($this->client_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff_mob']['start']);
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_staff']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "novo")  
      {
          $this->nmgp_botoes['btn_exit_app'] = "on";
          $this->nmgp_botoes['pdf_download'] = "on";
          $this->nmgp_botoes['snp'] = "off";
          $this->nmgp_botoes['submit_app'] = "off";
          $this->nmgp_botoes['requests'] = "on";
          $this->nmgp_botoes['btn_back_reqs'] = "off";
          $this->nmgp_botoes['approve_appn'] = "off";
      }
      elseif ($this->nmgp_opcao == "incluir")  
      {
          $this->nmgp_botoes['btn_exit_app'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['botoes']['btn_exit_app'];
          $this->nmgp_botoes['pdf_download'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['botoes']['pdf_download'];
          $this->nmgp_botoes['snp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['botoes']['snp'];
          $this->nmgp_botoes['submit_app'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['botoes']['submit_app'];
          $this->nmgp_botoes['requests'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['botoes']['requests'];
          $this->nmgp_botoes['btn_back_reqs'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['botoes']['btn_back_reqs'];
          $this->nmgp_botoes['approve_appn'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['botoes']['approve_appn'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_members_app_mob_script_case_init'] ]['form_members_app']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_members_app_mob_script_case_init'] ]['form_members_app']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_members_app_mob_script_case_init'] ]['form_members_app']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['total']);
          $detailAppName = 'form_members_app_mob';
          $detailAppObject = "form_members_app_mob";
          ...
          $this->form_members_app_mob = new $detailAppObject;
      }
...
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_staff_mob']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_clients_steps_appn_stripe_staff_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_clients_steps_appn_stripe_staff_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      if (isset($this->doc_type)) { $this->nm_limpa_alfa($this->doc_type); }
      ...
      if (isset($this->memb_qty)) { $this->nm_limpa_alfa($this->memb_qty); }
      ...
      { 
          ...
          if ($nm_call_php == "submit_app")
          { 
              $this->sc_btn_submit_app();
          } 
          if ($nm_call_php == "approve_appn")
          { 
              $this->sc_btn_approve_appn();
          } 
          $this->NM_close_db(); 
          exit;
      } 
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- buyers_excel_qty
      $this->field_config['buyers_excel_qty']               = array();
      $this->field_config['buyers_excel_qty']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['buyers_excel_qty']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['buyers_excel_qty']['symbol_dec'] = '';
      $this->field_config['buyers_excel_qty']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['buyers_excel_qty']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- qb_id
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Gera_log_access'] = false;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_doc_type' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'doc_type');
          }
          if ('validate_doc_file' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'doc_file');
          }
          ...
          if ('validate_memb_qty' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'memb_qty');
          }
          ...
          form_clients_steps_appn_stripe_staff_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
        ...
        if ($this->wizard_change_step && $this->wizard_go_forward) {
            ...
            if ($Campos_Crit != "" || !empty($Campos_Falta) || ($this->Campos_Mens_erro != "" && substr($this->Campos_Mens_erro, 0, 8) != "CAPTCHA:") ) {
        ...
        if ($this->wizard_change_step) {
            ...
            if (!$this->wizard_go_forward) {
                ...
                $wizardData['action'] = 'change_step';
                $wizardData['next_step'] = $this->wizard_step_goto;
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['actual_step'] = $this->wizard_step_goto;
            }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_clients_steps_appn_stripe_staff_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="form_clients_steps_appn_stripe_staff_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_clients_steps_appn_stripe_staff_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_clients_steps_appn_stripe_staff_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe_staff_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe_staff_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe_staff_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
include_once("form_clients_steps_appn_stripe_staff_mob_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opc_ant'] == "incluir")
      {
          $nmgp_opc_ant_saida_php = "novo";
          $nmgp_opcao_saida_php   = "recarga";
      }
      $nm_f_saida = "form_clients_steps_appn_stripe_staff_mob.php";
...
<?php
      ...
      {
          if (!isset($this->dummy12) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_form']['dummy12']))
          {
              $varloc_btn_php['dummy12'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_form']['dummy12'];
          }
      }
      $nm_f_saida = "form_clients_steps_appn_stripe_staff_mob.php";
      nm_limpa_numero($this->client_id, $this->field_config['client_id']['symbol_grp']) ; 
      ...
      $_SESSION['scriptcase']['form_clients_steps_appn_stripe_staff_mob']['contr_erro'] = 'on';
  $prod_descript = "Membership 1";
$prod_id = "prod_PYsLep5HJTgEWd";
$prod_price = 100;
$path_lib = "http://localhost/scriptcase/devel/conf/grp/PFM_Staff/libraries/stripe_qb/";
$redirect_url = $path_lib . "index.php?prod_descript=$prod_descript&prod_id=$prod_id&prod_price=$prod_price";
$this->dummy12  = "<iframe id='strp_pmt'src='$redirect_url' width='100%' height='100%' frameborder='0'></iframe>";
...
?>
      ...
      <input type=hidden name="nmgp_opcao" value=""/>
      <input type=hidden name="script_case_init" value="<?php  echo $this->form_encode_input($this->Ini->sc_page); ?>"/>
      <input type=hidden name="dummy02" value="<?php echo $this->form_encode_input($this->dummy02) ?>"/>
      <input type=hidden name="dummy03" value="<?php echo $this->form_encode_input($this->dummy03) ?>"/>
      <input type=hidden name="co_name" value="<?php echo $this->form_encode_input($this->co_name) ?>"/>
      <input type=hidden name="client_id" value="<?php echo $this->form_encode_input($this->client_id) ?>"/>
      <input type=hidden name="mailing_address" value="<?php echo $this->form_encode_input($this->mailing_address) ?>"/>
      ...
      <input type=hidden name="zip_code" value="<?php echo $this->form_encode_input($this->zip_code) ?>"/>
      <input type=hidden name="bus_subcat_other" value="<?php echo $this->form_encode_input($this->bus_subcat_other) ?>"/>
      <input type=hidden name="appn_date" value="<?php echo $this->form_encode_input($this->appn_date) ?>"/>
      <input type=hidden name="acct_instagram" value="<?php echo $this->form_encode_input($this->acct_instagram) ?>"/>
      <input type=hidden name="website_url" value="<?php echo $this->form_encode_input($this->website_url) ?>"/>
      <input type=hidden name="acct_facebook" value="<?php echo $this->form_encode_input($this->acct_facebook) ?>"/>
      <input type=hidden name="dummy07" value="<?php echo $this->form_encode_input($this->dummy07) ?>"/>
      <input type=hidden name="dummy08" value="<?php echo $this->form_encode_input($this->dummy08) ?>"/>
      <input type=hidden name="main_contact_name" value="<?php echo $this->form_encode_input($this->main_contact_name) ?>"/>
      <input type=hidden name="main_contact_phone" value="<?php echo $this->form_encode_input($this->main_contact_phone) ?>"/>
      <input type=hidden name="main_contact_email" value="<?php echo $this->form_encode_input($this->main_contact_email) ?>"/>
      <input type=hidden name="main_contact_title" value="<?php echo $this->form_encode_input($this->main_contact_title) ?>"/>
      <input type=hidden name="main_contact_img_id" value="<?php echo $this->form_encode_input($this->main_contact_img_id) ?>"/>
      <input type=hidden name="doc_type" value="<?php echo $this->form_encode_input($this->doc_type) ?>"/>
      <input type=hidden name="doc_file" value="<?php echo $this->form_encode_input($this->doc_file) ?>"/>
      <input type=hidden name="appn_note" value="<?php echo $this->form_encode_input($this->appn_note) ?>"/>
      <input type=hidden name="memb_list" value="<?php echo $this->form_encode_input($this->memb_list) ?>"/>
      <input type=hidden name="est_memb_cost" value="<?php echo $this->form_encode_input($this->est_memb_cost) ?>"/>
      <input type=hidden name="memb_qty" value="<?php echo $this->form_encode_input($this->memb_qty) ?>"/>
      <input type=hidden name="read_at_sign" value="<?php echo $this->form_encode_input($this->read_at_sign) ?>"/>
      <input type=hidden name="applicant_name" value="<?php echo $this->form_encode_input($this->applicant_name) ?>"/>
      <input type=hidden name="applicant_title" value="<?php echo $this->form_encode_input($this->applicant_title) ?>"/>
      <input type=hidden name="applicant_signature" value="<?php echo $this->form_encode_input($this->applicant_signature) ?>"/>
...
<?php
      ...
      {
          if (!isset($this->co_name) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_form']['co_name']))
          {
              $varloc_btn_php['co_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_form']['co_name'];
          }
          if (!isset($this->main_contact_email) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_form']['main_contact_email']))
          {
              $varloc_btn_php['main_contact_email'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_form']['main_contact_email'];
          }
          if (!isset($this->client_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_form']['client_id']))
          {
              $varloc_btn_php['client_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_form']['client_id'];
          }
      }
      $nm_f_saida = "form_clients_steps_appn_stripe_staff_mob.php";
      nm_limpa_numero($this->client_id, $this->field_config['client_id']['symbol_grp']) ; 
...
$sql = "SELECT client_id FROM clients WHERE appn_id = " . $this->client_id ;
...
$new_client_id = 0;
if ( isset($this->ds[0][0]) ) {
	$new_client_id = $this->ds[0][0];
}

$url = $this->Ini->path_link . "" . SC_dir_app_name('form_clients_staff') . "/?script_case_init=" . $this->form_encode_input($this->Ini->sc_page) . "&nmgp_url_saida=" . $this->nm_location . "&nmgp_parms=" . "client_id*scin" . $new_client_id . "*scout";
echo "
<script src='https://cdn.jsdelivr.net/npm/sweetalert2@11'></script>
<script>
  Swal.fire({
    title: 'Membership Approved',
    text: 'Client notified by email.',
    icon: 'success',
    timer: 5000,
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'applicant_signature':
               return "Applicant Signature<br>(Please use your mouse or input device to sign below)";
               break;
           case 'ofa_contact':
               return "Ofa Contact";
               break;
           ...
           case 'buyers_excel_qty':
               return "Please enter the number of buyers included in the attached Excel file:";
               break;
           case 'qb_id':
               return "Qb Id";
               break;
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_staff_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_staff_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_staff_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_staff_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "appn_date";
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'doc_type' == $filtro)) || (is_array($filtro) && in_array('doc_type', $filtro)))
        $this->ValidateField_doc_type($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "doc_type";

      if ((!is_array($filtro) && ('' == $filtro || 'doc_file' == $filtro)) || (is_array($filtro) && in_array('doc_file', $filtro)))
        $this->ValidateField_doc_file($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "doc_file";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "appn_note";
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'memb_qty' == $filtro)) || (is_array($filtro) && in_array('memb_qty', $filtro)))
        $this->ValidateField_memb_qty($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "memb_qty";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "applicant_name";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "applicant_title";
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "applicant_signature";
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_est_memb_cost = $this->est_memb_cost;
    $original_memb_qty = $this->memb_qty;
}
  $this->members_ct();
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_est_memb_cost != $this->est_memb_cost || (isset($bFlagRead_est_memb_cost) && $bFlagRead_est_memb_cost)))
    {
        $this->ajax_return_values_est_memb_cost(true);
    }
    if (($original_memb_qty != $this->memb_qty || (isset($bFlagRead_memb_qty) && $bFlagRead_memb_qty)))
    {
        $this->ajax_return_values_memb_qty(true);
    }
}
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_staff_mob']['contr_erro'] = 'off'; 
      }
    ...
    function ValidateField_co_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['co_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['co_name'] == "on")) 
      { 
          if ($this->co_name == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_mailing_address(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['mailing_address']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['mailing_address'] == "on")) 
      { 
   ...
   if (isset($this->Field_no_validate['memb_status_id'])) {
       return;
               ...
               if (!empty($this->memb_status_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_memb_status_id']) && !in_array($this->memb_status_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_memb_status_id']))
               {
                   $hasError = true;
    ...
    function ValidateField_city(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['city']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['city'] == "on")) 
      { 
          if ($this->city == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['bus_cat_id'])) {
      ...
      if ($this->bus_cat_id == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['bus_cat_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['bus_cat_id'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->bus_cat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_cat_id']) && !in_array($this->bus_cat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_cat_id']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['bus_cat_id']))
    ...
    function ValidateField_state(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['state']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['state'] == "on")) 
      { 
          if ($this->state == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['bus_subcat_id'])) {
      ...
      if ($this->bus_subcat_id == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['bus_subcat_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['bus_subcat_id'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->bus_subcat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_subcat_id']) && !in_array($this->bus_subcat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_subcat_id']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['bus_subcat_id']))
    ...
    function ValidateField_zip_code(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      $this->nm_tira_mask($this->zip_code, "99999-9999", "(){}[].,;:-+/ "); 
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['zip_code']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['zip_code'] == "on")) 
      { 
          if ($this->zip_code == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_main_contact_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_name'] == "on")) 
      { 
    ...
    function ValidateField_main_contact_phone(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      $this->nm_tira_mask($this->main_contact_phone, "(999) 999 - 9999", "(){}[].,;:-+/ "); 
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_phone']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_phone'] == "on")) 
      { 
    ...
    function ValidateField_main_contact_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_email'] == "on") 
          { 
              $hasError = true;
    ...
    function ValidateField_main_contact_title(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_title']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_title'] == "on")) 
      { 
    ...
    function ValidateField_main_contact_img_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_img_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_img_id'] == "on")) 
      { 
          if (($this->main_contact_img_id == "" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_select']['main_contact_img_id'] == "") || "S" == $this->main_contact_img_id_limpa)
          { 
              $hasError = true;
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if ("" != $this->main_contact_img_id && "S" != $this->main_contact_img_id_limpa && !$teste_validade->ArqExtensao($this->main_contact_img_id, array('pdf', 'jpg', 'jpeg', 'png', 'tiff', 'gif', 'bmp')))
            {
                $hasError = true;
            ...
            if (!$hasError && "" != $this->main_contact_img_id && "S" != $this->main_contact_img_id_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_clients_steps_appn_stripe_staff_mob_doc_name.php';
                }
                $pathParts = pathinfo(sc_upload_unprotect_chars($sTestFile));
                $fileSize = filesize(sc_upload_unprotect_chars($sTestFile));
                $sizeErrorSuffix = '';
                if ('pdf' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (PDF < 15 MB)';
                    $hasError = true;
                }
                if ('jpg' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (JPG < 15 MB)';
                    $hasError = true;
                }
                if ('jpeg' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (JPEG < 15 MB)';
                    $hasError = true;
                }
                if ('png' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (PNG < 15 MB)';
                    $hasError = true;
                }
                if ('tiff' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (TIFF < 15 MB)';
                    $hasError = true;
                }
                if ('gif' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (GIF < 15 MB)';
                    $hasError = true;
                }
                if ('bmp' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (BMP < 15 MB)';
                    $hasError = true;
                }
                if ($hasError) {
    ...
    function ValidateField_doc_type(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['doc_type'])) {
       return;
   }
      if ($this->doc_type == "" && $this->nmgp_opcao != "excluir")
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['doc_type']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['doc_type'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Choose ONE Document from the options below to Upload:" ; 
          if (!isset($Campos_Erros['doc_type']))
          {
              $Campos_Erros['doc_type'] = array();
          }
          $Campos_Erros['doc_type'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['doc_type']) || !is_array($this->NM_ajax_info['errList']['doc_type']))
                  {
                      $this->NM_ajax_info['errList']['doc_type'] = array();
                  }
                  $this->NM_ajax_info['errList']['doc_type'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
        } 
      } 
      else 
      { 
          if (is_array($this->doc_type))
          {
              ...
              foreach ($this->doc_type as $ind => $dados_doc_type_1 ) 
              {
                  if ($dados_doc_type_1 != "") 
                  {
                      $this->doc_type_1[] = $dados_doc_type_1;
                  } 
              } 
              $this->doc_type = ""; 
              foreach ($this->doc_type_1 as $dados_doc_type_1 ) 
    ...
    } // ValidateField_doc_type

    function ValidateField_doc_file(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['doc_file'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['doc_file']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['doc_file'] == "on")) 
      { 
          if (($this->doc_file == "" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_select']['doc_file'] == "") || "S" == $this->doc_file_limpa)
          { 
              $hasError = true;
              $Campos_Falta[] =  "Attachment:" ; 
              if (!isset($Campos_Erros['doc_file']))
              {
                  $Campos_Erros['doc_file'] = array();
              }
              $Campos_Erros['doc_file'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['doc_file']) || !is_array($this->NM_ajax_info['errList']['doc_file']))
                  {
                      $this->NM_ajax_info['errList']['doc_file'] = array();
                  }
                  $this->NM_ajax_info['errList']['doc_file'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          } 
      } 
        if ($this->nmgp_opcao != "excluir")
        {
            $sTestFile = $this->doc_file;
            if ("" != $this->doc_file && "S" != $this->doc_file_limpa && !$teste_validade->ArqExtensao($this->doc_file, array('pdf', 'jpg', 'jpeg', 'png', 'bmp', 'gif', 'tiff', 'svg', 'doc', 'docx', 'odp', 'ods', 'odt', 'xls', 'xlsx')))
            {
                $hasError = true;
                ...
                $Campos_Erros['doc_file'][] = $this->Ini->Nm_lang['lang_errm_file_invl'];
                if (!isset($this->NM_ajax_info['errList']['doc_file']) || !is_array($this->NM_ajax_info['errList']['doc_file']))
                {
                    $this->NM_ajax_info['errList']['doc_file'] = array();
                }
                $this->NM_ajax_info['errList']['doc_file'][] = $this->Ini->Nm_lang['lang_errm_file_invl'];
            }
            if (!$hasError && "" != $this->doc_file && "S" != $this->doc_file_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_clients_steps_appn_stripe_staff_mob_doc_name.php';
                }
                $pathParts = pathinfo(sc_upload_unprotect_chars($sTestFile));
                ...
                if ('svg' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (SVG < 15 MB)';
                    $hasError = true;
                }
                if ('doc' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (DOC < 15 MB)';
                    $hasError = true;
                }
                if ('docx' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (DOCX < 15 MB)';
                    $hasError = true;
                }
                if ('odp' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (ODP < 15 MB)';
                    $hasError = true;
                }
                if ('ods' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (ODS < 15 MB)';
                    $hasError = true;
                }
                if ('odt' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (ODT < 15 MB)';
                    $hasError = true;
                }
                if ('xls' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (XLS < 15 MB)';
                    $hasError = true;
                }
                if ('xlsx' == strtolower($pathParts['extension']) && 15728640 < $fileSize) {
                    $sizeErrorSuffix = ' (XLSX < 15 MB)';
                    $hasError = true;
                }
                if ($hasError) {
                    $Campos_Crit .= "Attachment:: " . $this->Ini->Nm_lang['lang_errm_file_size'] . $sizeErrorSuffix;
                    if (!isset($Campos_Erros['doc_file']))
                    {
                        $Campos_Erros['doc_file'] = array();
                    }
                    $Campos_Erros['doc_file'][] = $this->Ini->Nm_lang['lang_errm_file_size'] . $sizeErrorSuffix;
                    if (!isset($this->NM_ajax_info['errList']['doc_file']) || !is_array($this->NM_ajax_info['errList']['doc_file']))
                    {
                        $this->NM_ajax_info['errList']['doc_file'] = array();
                    }
                    $this->NM_ajax_info['errList']['doc_file'][] = $this->Ini->Nm_lang['lang_errm_file_size'] . $sizeErrorSuffix;
                }
            }
        }
        if ($hasError) {
    ...
    function ValidateField_memb_qty(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['memb_qty'])) {
          nm_limpa_numero($this->memb_qty, $this->field_config['memb_qty']['symbol_grp']) ; 
          return;
      }
      if ($this->memb_qty === "" || is_null($this->memb_qty))  
      { 
          $this->memb_qty = 0;
          $this->sc_force_zero[] = 'memb_qty';
      } 
      nm_limpa_numero($this->memb_qty, $this->field_config['memb_qty']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 10;
              if (strlen($this->memb_qty) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Memb Qty: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['memb_qty']))
                  {
                      $Campos_Erros['memb_qty'] = array();
                  }
                  $Campos_Erros['memb_qty'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['memb_qty']) || !is_array($this->NM_ajax_info['errList']['memb_qty']))
                  {
                      $this->NM_ajax_info['errList']['memb_qty'] = array();
                  }
                  $this->NM_ajax_info['errList']['memb_qty'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->memb_qty, 10, 0, -0, 9999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Memb Qty; " ; 
                  if (!isset($Campos_Erros['memb_qty']))
                  {
                      $Campos_Erros['memb_qty'] = array();
                  }
                  $Campos_Erros['memb_qty'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['memb_qty']) || !is_array($this->NM_ajax_info['errList']['memb_qty']))
                  {
                      $this->NM_ajax_info['errList']['memb_qty'] = array();
                  }
                  $this->NM_ajax_info['errList']['memb_qty'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
    ...
    function ValidateField_applicant_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['applicant_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['applicant_name'] == "on")) 
      { 
    ...
    function ValidateField_applicant_title(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['applicant_title']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['applicant_title'] == "on")) 
      { 
          if ($this->applicant_title == "")  
          { 
              $hasError = true;
              $Campos_Falta[] =  "Applicant Title" ; 
              if (!isset($Campos_Erros['applicant_title']))
              {
                  $Campos_Erros['applicant_title'] = array();
              }
              $Campos_Erros['applicant_title'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  ...
                  $this->NM_ajax_info['errList']['applicant_title'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          } 
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
    ...
    function ValidateField_applicant_signature(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['applicant_signature']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['applicant_signature'] == "on") 
          { 
              $hasError = true;
              $Campos_Falta[] = "Applicant Signature<br>(Please use your mouse or input device to sign below)" ; 
...
//--------------------------------------------------------------------------------------
   function upload_img_doc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros, $filtro = '') 
   {
     ...
     if (!$this->wizard_go_forward || (is_array($filtro) && in_array('main_contact_img_id', $filtro))) {
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->nmgp_opcao == "incluir" && ($this->main_contact_img_id == "none" || ($this->main_contact_img_id == "" && $this->main_contact_img_id_salva == "")) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_img_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['main_contact_img_id'] == "on")) 
          { 
              $Campos_Falta[] = "Contact Driver<br>License or ID" ; 
              if (!isset($Campos_Erros['main_contact_img_id']))
              {
     ...
     if (!$this->wizard_go_forward || (is_array($filtro) && in_array('doc_file', $filtro))) {
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->nmgp_opcao == "incluir" && ($this->doc_file == "none" || ($this->doc_file == "" && $this->doc_file_salva == "")) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['doc_file']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['php_cmp_required']['doc_file'] == "on")) 
          { 
              $Campos_Falta[] = "Attachment:" ; 
              if (!isset($Campos_Erros['doc_file']))
              {
          ...
          { 
              ...
              $this->doc_file = sc_upload_unprotect_chars($this->doc_file, true);
              $this->doc_file_scfile_name = sc_upload_unprotect_chars($this->doc_file_scfile_name, true);
              if (!is_file($this->doc_file) && isset($_SESSION['scriptcase']['charset']) && $_SESSION['scriptcase']['charset'] != 'UTF-8') {
                  $mbConvertFileName = mb_convert_encoding($this->doc_file, $_SESSION['scriptcase']['charset'], 'UTF-8');
                  $mbConvertScFileName = mb_convert_encoding($this->doc_file_scfile_name, $_SESSION['scriptcase']['charset'], 'UTF-8');
                  if (is_file($mbConvertFileName)) {
                      $this->doc_file = $mbConvertFileName;
                      $this->doc_file_scfile_name = $mbConvertScFileName;
                  }
              }
              if (is_file($this->doc_file))  
              { 
                  $this->NM_size_docs[$this->doc_file_scfile_name] = $this->sc_file_size($this->doc_file);
                  $this->doc_filename = $this->doc_file_scfile_name;
                  $this->doc_filesize = $this->NM_size_docs[$this->doc_file_scfile_name];
                  $reg_doc_file = file_get_contents($this->doc_file); 
                  $this->doc_file = $reg_doc_file; 
              } 
              else 
              { 
                  ...
                  $Campos_Erros['doc_file'][] = $this->Ini->Nm_lang['lang_errm_upld'];
                  if (!isset($this->NM_ajax_info['errList']['doc_file']) || !is_array($this->NM_ajax_info['errList']['doc_file']))
                  {
                      $this->NM_ajax_info['errList']['doc_file'] = array();
                  }
                  $this->NM_ajax_info['errList']['doc_file'][] = $this->Ini->Nm_lang['lang_errm_upld'];
              } 
          } 
      } 
     }
   ...
   function nm_guardar_campos()
   {
    ...
    if (empty($this->more_buyers_xlsx))
    {
        $this->more_buyers_xlsx = $this->nmgp_dados_form['more_buyers_xlsx'];
    }
    $this->nmgp_dados_form['more_buyers_xlsx'] = $this->more_buyers_xlsx;
    $this->nmgp_dados_form['more_buyers_xlsx_limpa'] = $this->more_buyers_xlsx_limpa;
    $this->nmgp_dados_form['buyers_excel_qty'] = $this->buyers_excel_qty;
    $this->nmgp_dados_form['qb_id'] = $this->qb_id;
    $this->nmgp_dados_form['synced'] = $this->synced;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['buyers_excel_qty'] = $this->buyers_excel_qty;
      nm_limpa_numero($this->buyers_excel_qty, $this->field_config['buyers_excel_qty']['symbol_grp']) ; 
      $this->Before_unformat['qb_id'] = $this->qb_id;
      nm_limpa_numero($this->qb_id, $this->field_config['qb_id']['symbol_grp']) ; 
   }
   function nm_tira_formatacao_client_id($Val_in)
   {
      nm_limpa_numero($Val_in, $this->field_config['client_id']['symbol_grp']) ; 
      return $Val_in;
   }
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "buyers_excel_qty")
      {
          nm_limpa_numero($this->buyers_excel_qty, $this->field_config['buyers_excel_qty']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "qb_id")
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ('' !== $this->memb_qty || (!empty($format_fields) && isset($format_fields['memb_qty'])))
      {
          nmgp_Form_Num_Val($this->memb_qty, $this->field_config['memb_qty']['symbol_grp'], $this->field_config['memb_qty']['symbol_dec'], "0", "S", $this->field_config['memb_qty']['format_neg'], "", "", "-", $this->field_config['memb_qty']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_doc_type();
          $this->ajax_return_values_doc_file();
          $this->ajax_return_values_appn_note();
          $this->ajax_return_values_memb_list();
          $this->ajax_return_values_est_memb_cost();
          $this->ajax_return_values_memb_qty();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['client_id']['keyVal'] = form_clients_steps_appn_stripe_staff_mob_pack_protect_string($this->nmgp_dados_form['client_id']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['total'] < 0)
              {
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_memb_status_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_memb_status_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_memb_status_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_memb_status_id'] = array(); 
}
   ...
   $old_value_memb_qty = $this->memb_qty;
   $this->nm_tira_formatacao();
   if ($this->nmgp_opcao != "nada") {
   ...
   $unformatted_value_memb_qty = $this->memb_qty;
   ...
   $this->memb_qty = $old_value_memb_qty;
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_clients_steps_appn_stripe_staff_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_clients_steps_appn_stripe_staff_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_memb_status_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['memb_status_id']['valList'][$i] = form_clients_steps_appn_stripe_staff_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_cat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_cat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_cat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_cat_id'] = array(); 
}
$aLookup[] = array(form_clients_steps_appn_stripe_staff_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_staff_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_cat_id'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_cat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_cat_id']['valList'][$i] = form_clients_steps_appn_stripe_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_subcat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_subcat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_subcat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_subcat_id'] = array(); 
}
$aLookup[] = array(form_clients_steps_appn_stripe_staff_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_staff_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_subcat_id'][] = '';
if ($this->bus_cat_id != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_bus_subcat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_subcat_id']['valList'][$i] = form_clients_steps_appn_stripe_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$main_contact_img_file]))
       {
           if ($this->NM_size_docs[$main_contact_img_file] != filesize($this->Ini->root . $out_main_contact_img_id))
           {
              ...
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['download_filenames']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['download_filenames'] = array();
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['download_filenames'][$sTmpFile] = $this->main_contact_img_file;
          ...
          $this->NM_ajax_info['fldList']['main_contact_img_id'] = array(
               ...
               'docLink' => "<a href=\"javascript:nm_mostra_doc('documento_db', '" . substr($sTmpFile, 3) . "', 'form_clients_steps_appn_stripe_staff')\">" . $tmp_file_main_contact_img_id . "</a>",
          ...
          //----- doc_type
   function ajax_return_values_doc_type($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("doc_type", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->doc_type);
              $aLookup = array();
              $this->_tmp_lookup_doc_type = $this->doc_type;

$aLookup[] = array(form_clients_steps_appn_stripe_staff_mob_pack_protect_string('Active Secretary of State Registration') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_staff_mob_pack_protect_string("Active Secretary of State Registration")));
$aLookup[] = array(form_clients_steps_appn_stripe_staff_mob_pack_protect_string('City Business License') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_staff_mob_pack_protect_string("City Business License")));
$aLookup[] = array(form_clients_steps_appn_stripe_staff_mob_pack_protect_string('Agricultural License') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_staff_mob_pack_protect_string("Agricultural License")));
$aLookup[] = array(form_clients_steps_appn_stripe_staff_mob_pack_protect_string('Other type of document') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_staff_mob_pack_protect_string("Other type of document")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_doc_type'][] = 'Active Secretary of State Registration';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_doc_type'][] = 'City Business License';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_doc_type'][] = 'Agricultural License';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Lookup_doc_type'][] = 'Other type of document';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['doc_type']) && !empty($this->NM_ajax_info['select_html']['doc_type']))
          {
              $sOptComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['doc_type']);
          }
          $this->NM_ajax_info['fldList']['doc_type'] = array(
                       'row'    => '',
               'type'    => 'checkbox',
               'switch'  => false,
               ...
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-doc_type',
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['doc_type']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['doc_type']['valList'][$i] = form_clients_steps_appn_stripe_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['doc_type']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['doc_type']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['doc_type']['labList'] = $aLabel;
          }
   }

          //----- doc_file
   function ajax_return_values_doc_file($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("doc_file", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->doc_file);
              $aLookup = array();
              $sTmpExtension = pathinfo($this->doc_filename, PATHINFO_EXTENSION);
              $sTmpExtension = null == $sTmpExtension ? '' : '.' . $sTmpExtension;
              $sTmpFile      = 'sc_doc_file_' . md5(mt_rand(1, 1000) . microtime() . session_id()) . $sTmpExtension;
   if ($this->doc_file != "" && $this->doc_file != "none")   
   { 
       $out_doc_file = $this->Ini->path_imag_temp . "/" . $sTmpFile;
       $arq_doc_file = fopen($this->Ini->root . $out_doc_file, "w") ;  
       if (is_string($this->doc_file) && substr($this->doc_file, 0, 4) == "*nm*" && (strstr(strtoupper($this->Ini->nm_tpbanco),"MSSQL") || strstr(strtoupper($this->Ini->nm_tpbanco),"PDOSQLITE"))) 
       { 
           $this->doc_file = base64_decode($this->doc_file) ; 
       } 
       elseif (is_string($this->doc_file) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase)) 
       {
           $this->doc_file = str_replace("''", "'", $this->doc_file);
       }
       fwrite($arq_doc_file, (string)$this->doc_file) ;  
       fclose($arq_doc_file) ;  
       if (isset($this->NM_size_docs[$doc_filename]))
       {
           if ($this->NM_size_docs[$doc_filename] != filesize($this->Ini->root . $out_doc_file))
           {
           }
       }
       if (isset($this->NM_size_docs[$main_contact_img_file]))
       {
           if ($this->NM_size_docs[$main_contact_img_file] != filesize($this->Ini->root . $out_doc_file))
           {
           }
       }
   } 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['download_filenames'][$sTmpFile] = $this->doc_filename;
              $tmp_file_doc_file = trim(NM_charset_to_utf8($this->doc_filename));
              $tmp_icon_doc_file = '';
              if ('' != $tmp_file_doc_file)
              {
                  $tmp_icon_doc_file = $this->gera_icone($tmp_file_doc_file);
              }
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['doc_file'] = array(
                       'row'    => '',
               'type'    => 'documento',
               'valList' => array($tmp_file_doc_file),
               'docLink' => "<a href=\"javascript:nm_mostra_doc('documento_db', '" . substr($sTmpFile, 3) . "', 'form_clients_steps_appn_stripe_staff')\">" . $tmp_file_doc_file . "</a>",
               'docIcon' => $tmp_icon_doc_file,
               'docReadonly' => "N",
              );
          }
   }
   ...
   function ajax_return_values_memb_list($bForce = false)
   {
          ...
          //----- est_memb_cost
   function ajax_return_values_est_memb_cost($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("est_memb_cost", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->est_memb_cost);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['est_memb_cost'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
          ...
          //----- memb_qty
   function ajax_return_values_memb_qty($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("memb_qty", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->memb_qty);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['memb_qty'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_applicant_signature($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Field_no_validate'] = array();
...
//----------- 
   ...
   { 
      ...
      $NM_val_form['more_buyers_xlsx'] = $this->more_buyers_xlsx;
      $NM_val_form['buyers_excel_qty'] = $this->buyers_excel_qty;
      $NM_val_form['qb_id'] = $this->qb_id;
      $NM_val_form['synced'] = $this->synced;
      ...
      if ($this->buyers_excel_qty === "" || is_null($this->buyers_excel_qty))  
      { 
          $this->buyers_excel_qty = 0;
          $this->sc_force_zero[] = 'buyers_excel_qty';
      } 
      ...
      if ($this->synced === "" || is_null($this->synced))  
      { 
          $this->synced = 0;
          $this->sc_force_zero[] = 'synced';
      } 
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          { 
              if (substr($this->doc_file, 0, 4) != "*nm*" && $this->doc_file != 'null') 
              { 
                  $this->doc_file = "*nm*" . base64_encode($this->doc_file) ; 
              } 
          } 
          ...
          { 
              if ($this->Ini->nm_tpbanco != "pdo_sqlsrv" && substr($this->doc_file, 0, 4) != "*nm*" && $this->doc_file != 'null') 
              { 
                  $this->doc_file = "*nm*" . base64_encode($this->doc_file) ; 
              } 
          } 
          ...
          { 
              $this->doc_file =  substr($this->Db->qstr($this->doc_file), 1, -1);
          } 
          ...
          $this->more_buyers_xlsx_original_filename = $this->more_buyers_xlsx; 
          $this->more_buyers_xlsx_before_qstr = $this->more_buyers_xlsx;
          $this->more_buyers_xlsx = substr($this->Db->qstr($this->more_buyers_xlsx), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->more_buyers_xlsx = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->more_buyers_xlsx);
          }
          if ($this->more_buyers_xlsx == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->more_buyers_xlsx = "null"; 
              $this->NM_val_null[] = "more_buyers_xlsx";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "memb_status_id = $this->memb_status_id, co_name = '$this->co_name', mailing_address = '$this->mailing_address', city = '$this->city', state = '$this->state', zip_code = '$this->zip_code', acct_instagram = '$this->acct_instagram', acct_facebook = '$this->acct_facebook', website_url = '$this->website_url', bus_cat_id = $this->bus_cat_id, bus_subcat_id = $this->bus_subcat_id, bus_subcat_other = '$this->bus_subcat_other', appn_date = #$this->appn_date#, appn_note = '$this->appn_note', doc_type = '$this->doc_type', applicant_name = '$this->applicant_name', applicant_signature = '$this->applicant_signature', applicant_title = '$this->applicant_title', main_contact_name = '$this->main_contact_name', main_contact_phone = '$this->main_contact_phone', main_contact_email = '$this->main_contact_email', main_contact_title = '$this->main_contact_title', memb_qty = $this->memb_qty"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "memb_status_id = $this->memb_status_id, co_name = '$this->co_name', mailing_address = '$this->mailing_address', city = '$this->city', state = '$this->state', zip_code = '$this->zip_code', acct_instagram = '$this->acct_instagram', acct_facebook = '$this->acct_facebook', website_url = '$this->website_url', bus_cat_id = $this->bus_cat_id, bus_subcat_id = $this->bus_subcat_id, bus_subcat_other = '$this->bus_subcat_other', appn_date = " . $this->Ini->date_delim . $this->appn_date . $this->Ini->date_delim1 . ", appn_note = '$this->appn_note', doc_type = '$this->doc_type', applicant_name = '$this->applicant_name', applicant_signature = '$this->applicant_signature', applicant_title = '$this->applicant_title', main_contact_name = '$this->main_contact_name', main_contact_phone = '$this->main_contact_phone', main_contact_email = '$this->main_contact_email', main_contact_title = '$this->main_contact_title', memb_qty = $this->memb_qty"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "memb_status_id = $this->memb_status_id, co_name = '$this->co_name', mailing_address = '$this->mailing_address', city = '$this->city', state = '$this->state', zip_code = '$this->zip_code', acct_instagram = '$this->acct_instagram', acct_facebook = '$this->acct_facebook', website_url = '$this->website_url', bus_cat_id = $this->bus_cat_id, bus_subcat_id = $this->bus_subcat_id, bus_subcat_other = '$this->bus_subcat_other', appn_date = EXTEND('$this->appn_date', YEAR TO FRACTION), appn_note = '$this->appn_note', doc_type = '$this->doc_type', applicant_name = '$this->applicant_name', applicant_title = '$this->applicant_title', main_contact_name = '$this->main_contact_name', main_contact_phone = '$this->main_contact_phone', main_contact_email = '$this->main_contact_email', main_contact_title = '$this->main_contact_title', memb_qty = $this->memb_qty"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $Prep_Tst = (isset($NM_val_form['renewal_date']) && $NM_val_form['renewal_date'] == "null"  && $this->nmgp_dados_select['renewal_date'] == "") ? "null" : $this->nmgp_dados_select['renewal_date'];
              if (isset($NM_val_form['renewal_date']) && $NM_val_form['renewal_date'] != $Prep_Tst) 
              { 
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
                  { 
              ...
              $Prep_Tst = (isset($NM_val_form['pricing_level_id']) && $NM_val_form['pricing_level_id'] == "null"  && $this->nmgp_dados_select['pricing_level_id'] == "") ? "null" : $this->nmgp_dados_select['pricing_level_id'];
              if (isset($NM_val_form['pricing_level_id']) && $NM_val_form['pricing_level_id'] != $Prep_Tst) 
              { 
              ...
              $Prep_Tst = (isset($NM_val_form['permanent_member_date']) && $NM_val_form['permanent_member_date'] == "null"  && $this->nmgp_dados_select['permanent_member_date'] == "") ? "null" : $this->nmgp_dados_select['permanent_member_date'];
              if (isset($NM_val_form['permanent_member_date']) && $NM_val_form['permanent_member_date'] != $Prep_Tst) 
              { 
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
                  { 
              ...
              $Prep_Tst = (isset($NM_val_form['buyers_excel_qty']) && $NM_val_form['buyers_excel_qty'] == "null"  && $this->nmgp_dados_select['buyers_excel_qty'] == "") ? "null" : $this->nmgp_dados_select['buyers_excel_qty'];
              if (isset($NM_val_form['buyers_excel_qty']) && $NM_val_form['buyers_excel_qty'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "buyers_excel_qty = $this->buyers_excel_qty"; 
              } 
              ...
              $Prep_Tst = (isset($NM_val_form['synced']) && $NM_val_form['synced'] == "null"  && $this->nmgp_dados_select['synced'] == "") ? "null" : $this->nmgp_dados_select['synced'];
              if (isset($NM_val_form['synced']) && $NM_val_form['synced'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "synced = $this->synced"; 
              } 
              ...
              if ($this->doc_file_limpa == "S")
              {
                  ...
                  {
                      $temp_cmd_sql = "doc_file = '" . $this->doc_file . "'";
                  }
                  $this->doc_file = "";
              }
              else
              {
                  if ($this->doc_file != "none" && $this->doc_file != "")
                  {
                      $NM_conteudo =  $this->doc_file;
                      if (in_array(strtolower($this->Ini->nm_tpbanco), $nm_bases_lob_geral))
                      {
                      }
                      else
                      {
                          $temp_cmd_sql .= " doc_file = '$NM_conteudo'";
                      }
                  }
                  else
                  {
                      $aDoNotUpdate[] = "doc_file";
                  }
              }
              ...
              if ($this->doc_file_limpa == "S" || ($this->doc_file != "none" && $this->doc_file != "" && in_array(strtolower($this->Ini->nm_tpbanco), $nm_bases_lob_geral))) 
              { 
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) 
                  { 
                      $SC_fields_update[] = "doc_file = ''"; 
                  } 
                  elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql)) 
                  { 
                      $SC_fields_update[] = "doc_file = ''"; 
                  ...
                  elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix)) 
                  { 
                      $SC_fields_update[] = "doc_file = null"; 
                  } 
                  elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite)) 
                  { 
                      $SC_fields_update[] = "doc_file = ''"; 
                  ...
                  { 
                      $SC_fields_update[] = "doc_file = empty_blob()"; 
                  } 
              } 
              ...
              $this->more_buyers_xlsx = $this->more_buyers_xlsx_before_qstr;
              ...
              { 
                  ...
                  if ($this->doc_file_limpa == "S" && (!isset($this->Ini->nm_bases_oracle) || !in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle)) && (!isset($this->Ini->nm_bases_informix) || !in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))) 
                  { 
                      $_SESSION['scriptcase']['sc_sql_ult_comando'] = "UpdateBlob(" . $this->Ini->nm_tabela . ", \"doc_file\", \"\",  \"client_id = $this->client_id\")"; 
                      $rs = $this->Db->UpdateBlob($this->Ini->nm_tabela, "doc_file", "",  "client_id = $this->client_id"); 
                  } 
                  else 
                  { 
                      if ($this->doc_file != "none" && $this->doc_file != "") 
              ...
              if ($this->doc_file_limpa == "S")
              {
                  $this->NM_ajax_info['fldList']['doc_file_salva'] = array(
                      'row'     => '',
                      'type'    => 'text',
                      'valList' => array(''),
                  );
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Cache_wizard_form'] = array();
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['doc_file_salva'] = array(
                      'row'     => '',
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['doc_type'])) { $this->doc_type = $NM_val_form['doc_type']; }
              elseif (isset($this->doc_type)) { $this->nm_limpa_alfa($this->doc_type); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['memb_qty'])) { $this->memb_qty = $NM_val_form['memb_qty']; }
              elseif (isset($this->memb_qty)) { $this->nm_limpa_alfa($this->memb_qty); }
              ...
              $bChange_more_buyers_xlsx = false;
              if (isset($this->more_buyers_xlsx_original_filename) && '' != $this->more_buyers_xlsx_original_filename && $this->more_buyers_xlsx_original_filename != $this->more_buyers_xlsx)
              {
                  $sTmpOrig_more_buyers_xlsx = $this->more_buyers_xlsx;
                  $this->more_buyers_xlsx    = $this->more_buyers_xlsx_original_filename;
                  $bChange_more_buyers_xlsx  = true;
              }

              $aOldRefresh               = $this->nmgp_refresh_fields;
              $this->nmgp_refresh_fields = array_diff(array('dummy02', 'dummy03', 'co_name', 'client_id', 'mailing_address', 'memb_status_id', 'city', 'bus_cat_id', 'state', 'bus_subcat_id', 'zip_code', 'bus_subcat_other', 'appn_date', 'acct_instagram', 'website_url', 'acct_facebook', 'dummy07', 'dummy08', 'main_contact_name', 'main_contact_phone', 'main_contact_email', 'main_contact_title', 'main_contact_img_id', 'doc_type', 'doc_file', 'appn_note', 'memb_list', 'est_memb_cost', 'memb_qty', 'read_at_sign', 'applicant_name', 'applicant_title', 'applicant_signature'), $aDoNotUpdate);
              $this->ajax_return_values();
              $this->nmgp_refresh_fields = $aOldRefresh;

              if ($bChange_more_buyers_xlsx)
              {
                  $this->more_buyers_xlsx                   = $sTmpOrig_more_buyers_xlsx;
                  $this->more_buyers_xlsx_original_filename = '';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              $_test_file = $this->fetchUniqueUploadName($this->more_buyers_xlsx_scfile_name, $dir_file, "more_buyers_xlsx");
              if (trim($this->more_buyers_xlsx_scfile_name) != $_test_file)
              {
                  $this->more_buyers_xlsx_scfile_name = $_test_file;
                  $this->more_buyers_xlsx = $_test_file;
              }
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $compl_insert     = ""; 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "memb_status_id, co_name, ofa_contact, street_address, mailing_address, city, state, zip_code, phone_number, home_phone, fax_number, email, business_type, fresh_cut_allowed, business_license, nursery_license, federal_tax_id, temporary_pass, ofa_member, starting_date, renewal_date, expiration_date, cancel_date, canceled_by, reason_canceled, retire_date, verified_receipts, date_last_updated, restricted, committee_approval_required, type_company, archive, archive_date, pricing_level_id, store_front_address, store_front_city, store_front_zip, home_base_address, home_base_city, home_base_zip, store_front_state, home_base_state, record_created, permanent_member_date, acct_instagram, acct_facebook, website_url, bus_cat_id, bus_subcat_id, bus_subcat_other, appn_date, appn_note, doc_type, doc_file, doc_filename, doc_filesize, applicant_name, applicant_signature, applicant_title, main_contact_name, main_contact_phone, main_contact_email, main_contact_title, main_contact_img_id, more_buyers_xlsx, buyers_excel_qty, qb_id, memb_qty, synced, main_contact_img_file, main_contact_img_size $compl_insert) VALUES (" . $NM_seq_auto . "$this->memb_status_id, '$this->co_name', '$this->ofa_contact', '$this->street_address', '$this->mailing_address', '$this->city', '$this->state', '$this->zip_code', '$this->phone_number', '$this->home_phone', '$this->fax_number', '$this->email', '$this->business_type', $this->fresh_cut_allowed, '$this->business_license', '$this->nursery_license', '$this->federal_tax_id', $this->temporary_pass, $this->ofa_member, " . $this->Ini->date_delim . $this->starting_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->renewal_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->expiration_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->cancel_date . $this->Ini->date_delim1 . ", '$this->canceled_by', '$this->reason_canceled', " . $this->Ini->date_delim . $this->retire_date . $this->Ini->date_delim1 . ", '$this->verified_receipts', " . $this->Ini->date_delim . $this->date_last_updated . $this->Ini->date_delim1 . ", $this->restricted, $this->committee_approval_required, '$this->type_company', $this->archive, " . $this->Ini->date_delim . $this->archive_date . $this->Ini->date_delim1 . ", $this->pricing_level_id, '$this->store_front_address', '$this->store_front_city', '$this->store_front_zip', '$this->home_base_address', '$this->home_base_city', '$this->home_base_zip', '$this->store_front_state', '$this->home_base_state', " . $this->Ini->date_delim . $this->record_created . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->permanent_member_date . $this->Ini->date_delim1 . ", '$this->acct_instagram', '$this->acct_facebook', '$this->website_url', $this->bus_cat_id, $this->bus_subcat_id, '$this->bus_subcat_other', " . $this->Ini->date_delim . $this->appn_date . $this->Ini->date_delim1 . ", '$this->appn_note', '$this->doc_type', EMPTY_BLOB(), '$this->doc_filename', '$this->doc_filesize', '$this->applicant_name', EMPTY_BLOB(), '$this->applicant_title', '$this->main_contact_name', '$this->main_contact_phone', '$this->main_contact_email', '$this->main_contact_title', EMPTY_BLOB(), EMPTY_BLOB(), $this->buyers_excel_qty, $this->qb_id, $this->memb_qty, $this->synced, '$this->main_contact_img_file', '$this->main_contact_img_size' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
              {
                  $compl_insert     = ""; 
              ...
              { 
                  ...
                  if (trim($this->more_buyers_xlsx ) != "") 
                  { 
                      $_SESSION['scriptcase']['sc_sql_ult_comando'] = "UpdateBlob(" . $this->Ini->nm_tabela . ",  more_buyers_xlsx , $this->more_buyers_xlsx,  \"client_id = $this->client_id\")"; 
                      $rs = $this->Db->UpdateBlob($this->Ini->nm_tabela, "more_buyers_xlsx", $this->more_buyers_xlsx,  "client_id = $this->client_id"); 
                      if ($rs === false)  
                      { 
                          $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_inst'], $this->Db->ErrorMsg()); 
                          $this->NM_rollback_db(); 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['Cache_wizard_form'] = array();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_members_app_mob->ini_controle();
              if ($this->form_members_app_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['parms'] = "client_id?#?$this->client_id?@?"; 
      }
      $this->nmgp_dados_form['doc_file'] = ""; 
      $this->doc_file_limpa = ""; 
      $this->doc_file_salva = ""; 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['snp'] = $this->nmgp_botoes['snp'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['submit_app'] = $this->nmgp_botoes['submit_app'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['requests'] = $this->nmgp_botoes['requests'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['btn_back_reqs'] = $this->nmgp_botoes['btn_back_reqs'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['approve_appn'] = $this->nmgp_botoes['approve_appn'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->renewal_date = $rs->fields[21] ; 
              ...
              $this->expiration_date = $rs->fields[22] ; 
              ...
              $this->canceled = $rs->fields[23] ; 
              $this->nmgp_dados_select['canceled'] = $this->canceled;
              $this->cancel_date = $rs->fields[24] ; 
              ...
              $this->verified_receipts = $rs->fields[28] ; 
              $this->nmgp_dados_select['verified_receipts'] = $this->verified_receipts;
              $this->date_last_updated = $rs->fields[29] ; 
              ...
              $this->permanent_member_date = $rs->fields[45] ; 
              ...
              $this->appn_note = $rs->fields[53] ; 
              $this->nmgp_dados_select['appn_note'] = $this->appn_note;
              $this->doc_type = $rs->fields[54] ; 
              $this->nmgp_dados_select['doc_type'] = $this->doc_type;
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              { 
                  $this->doc_file = $this->Db->BlobDecode($rs->fields[55]) ; 
              } 
              ...
              { 
                  ...
                  { 
                     $this->doc_file = file_get_contents($rs->fields[55]);
                  }else 
                  { 
                     $this->doc_file = ''; 
                  } 
              ...
              { 
                  ...
                  { 
                     $this->applicant_signature = file_get_contents($rs->fields[59]);
                  }else 
                  { 
                     $this->applicant_signature = ''; 
                  } 
              ...
              { 
                  $this->applicant_signature = $rs->fields[59] ; 
              } 
              $this->nmgp_dados_select['applicant_signature'] = $this->applicant_signature;
              $this->applicant_title = $rs->fields[60] ; 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              { 
                  $this->more_buyers_xlsx = $this->Db->BlobDecode($rs->fields[66]) ; 
              } 
              elseif ($this->Ini->nm_tpbanco == 'pdo_oracle')
              { 
                  $this->more_buyers_xlsx = $this->Db->BlobDecode($rs->fields[66]) ; 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  if(isset($rs->fields[66]) && !empty($rs->fields[66]) && is_file($rs->fields[66])) 
                  { 
                     $this->more_buyers_xlsx = file_get_contents($rs->fields[66]);
                  }else 
                  { 
                     $this->more_buyers_xlsx = ''; 
                  } 
              ...
              { 
                  $this->more_buyers_xlsx = $rs->fields[66] ; 
              } 
              $this->nmgp_dados_select['more_buyers_xlsx'] = $this->more_buyers_xlsx;
              $this->buyers_excel_qty = $rs->fields[67] ; 
              $this->nmgp_dados_select['buyers_excel_qty'] = $this->buyers_excel_qty;
              $this->qb_id = $rs->fields[68] ; 
              $this->nmgp_dados_select['qb_id'] = $this->qb_id;
              $this->memb_qty = $rs->fields[69] ; 
              $this->nmgp_dados_select['memb_qty'] = $this->memb_qty;
              $this->synced = $rs->fields[70] ; 
              $this->nmgp_dados_select['synced'] = $this->synced;
              $this->main_contact_img_file = $rs->fields[71] ; 
              $this->nmgp_dados_select['main_contact_img_file'] = $this->main_contact_img_file;
              $this->main_contact_img_size = $rs->fields[72] ; 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $this->buyers_excel_qty = (string)$this->buyers_excel_qty; 
              $this->qb_id = (string)$this->qb_id; 
              $this->memb_qty = (string)$this->memb_qty; 
              $this->synced = (string)$this->synced; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['parms'] = "client_id?#?$this->client_id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['sub_dir'][0]  = "/" . $this->nm_tira_formatacao_client_id($this->client_id);
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['reg_start'] < $qt_geral_reg_form_clients_steps_appn_stripe_staff_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              $this->nmgp_dados_form["main_contact_img_id"] = $this->main_contact_img_id;
              $this->more_buyers_xlsx = "";  
              $this->more_buyers_xlsx_ul_name = "" ;  
              $this->more_buyers_xlsx_ul_type = "" ;  
              $this->nmgp_dados_form["more_buyers_xlsx"] = $this->more_buyers_xlsx;
              $this->buyers_excel_qty = "0";  
              $this->nmgp_dados_form["buyers_excel_qty"] = $this->buyers_excel_qty;
              $this->qb_id = "";  
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scoutlink_remove_background*scinok*scout";
  }
// 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dados_select'];
           ...
           $this->SC_log_arr['fields']['buyers_excel_qty']['0'] =  $nmgp_dados_select['buyers_excel_qty'];
           $this->SC_log_arr['fields']['qb_id']['0'] =  $nmgp_dados_select['qb_id'];
           $this->SC_log_arr['fields']['memb_qty']['0'] =  $nmgp_dados_select['memb_qty'];
           $this->SC_log_arr['fields']['synced']['0'] =  $nmgp_dados_select['synced'];
...
// 
   function NM_gera_log_new() 
   {
       ...
       $this->SC_log_arr['fields']['buyers_excel_qty']['1'] =  $this->buyers_excel_qty;
       $this->SC_log_arr['fields']['qb_id']['1'] =  $this->qb_id;
       $this->SC_log_arr['fields']['memb_qty']['1'] =  $this->memb_qty;
       $this->SC_log_arr['fields']['synced']['1'] =  $this->synced;
...
// 
   function NM_gera_log_output() 
   {
       ...
       $Log_labels['buyers_excel_qty'] =  "Please enter the number of buyers included in the attached Excel file:";
       $Log_labels['qb_id'] =  "Qb Id";
       $Log_labels['memb_qty'] =  "Memb Qty";
       $Log_labels['synced'] =  "Synced";
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$modificado_memb_qty = $this->memb_qty;
$modificado_bus_subcat_id = $this->bus_subcat_id;
$modificado_est_memb_cost = $this->est_memb_cost;
$this->nm_formatar_campos('bus_cat_id', 'client_id', 'memb_qty', 'bus_subcat_id', 'est_memb_cost');
...
if ($original_memb_qty !== $modificado_memb_qty || isset($this->nmgp_cmp_readonly['memb_qty']) || (isset($bFlagRead_memb_qty) && $bFlagRead_memb_qty))
{
    $this->ajax_return_values_memb_qty(true);
}
...
if ($original_est_memb_cost !== $modificado_est_memb_cost || isset($this->nmgp_cmp_readonly['est_memb_cost']) || (isset($bFlagRead_est_memb_cost) && $bFlagRead_est_memb_cost))
{
    $this->ajax_return_values_est_memb_cost(true);
}
...
$this->nm_formatar_campos('client_id', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost', 'bus_subcat_other');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
function copy_approved_client()
{
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_staff_mob']['contr_erro'] = 'on';
if (!isset($this->sc_temp_gv_last_memb_status_id)) {$this->sc_temp_gv_last_memb_status_id = (isset($_SESSION['gv_last_memb_status_id'])) ? $_SESSION['gv_last_memb_status_id'] : "";}
if (!isset($this->sc_temp_usr_login)) {$this->sc_temp_usr_login = (isset($_SESSION['usr_login'])) ? $_SESSION['usr_login'] : "";}
  
$sql_ins = "INSERT INTO clients (
				appn_id,
				co_name,
				ofa_contact,
				street_address,
				...
				memb_status_id,
				memb_qty,
				main_contact_img_file,
				main_contact_img_size,
				doc_type,
				doc_file
			)
			SELECT
				...
				ofa_member,
				starting_date,
				(SELECT DATE_ADD(NOW(), INTERVAL 1 YEAR)) AS renewal_date,
				expiration_date,
				canceled,
				cancel_date,
				canceled_by,
...
$last_client_id = $this->ds[0][0];


     $nm_select ="UPDATE client_docs SET client_id = $last_client_id WHERE appn_id = " . $this->client_id ; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$sql_ins_memb = "INSERT INTO members (member_name, client_id, email, phone1, main_contact, note, driver_lic_id) ".
				"SELECT ".
					"member_name, $last_client_id, email, phone1, main_contact, note, driver_lic_id ".
				"FROM members_app ".
				"WHERE client_id = ". $this->client_id ;

     $nm_select = $sql_ins_memb; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$insert_sql = "INSERT INTO sec_approvals (client_id, login, memb_status_id, ts) 
			   VALUES (" . $last_client_id . ", '" . $this->sc_temp_usr_login . "', 3, NOW())";
...
$sql_ins_notes = "INSERT INTO client_notes (client_id, note, note_date, user) ".
				 "VALUES ( $last_client_id, '".strip_tags($this->appn_note )."', '".$this->appn_date ."', '".$this->sc_temp_usr_login."' )";

     $nm_select = $sql_ins_notes; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="UPDATE clients_app SET memb_status_id = 3 WHERE client_id = " . $this->client_id ; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$sql_log_upd = "INSERT INTO sc_log (
    ...
    'form_clients_steps_appn_stripe_staff',  
    'User',
    '$ip_user',  
    'Update',
    '$descript'
...
$memb_ct = 0;
$sql = "SELECT COUNT(member_id) FROM members_app WHERE client_id = $this->client_id ";
...
if ( $memb_ct == 1 ) {
	$sql = "UPDATE members_app SET email = '$this->main_contact_email' WHERE client_id = $this->client_id ";
...
$modificado_bus_subcat_id = $this->bus_subcat_id;
$modificado_est_memb_cost = $this->est_memb_cost;
$this->nm_formatar_campos('client_id', 'main_contact_email', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
$original_applicant_name = $this->applicant_name;
$original_memb_qty = $this->memb_qty;
$original_bus_cat_id = $this->bus_cat_id;
$original_bus_subcat_id = $this->bus_subcat_id;
$original_est_memb_cost = $this->est_memb_cost;
...
if ( $memb_ct == 1 ) {
	$sql = "UPDATE members_app SET member_name = '$this->main_contact_name', main_contact = 1 WHERE client_id = $this->client_id ";
...
$modificado_applicant_name = $this->applicant_name;
$modificado_memb_qty = $this->memb_qty;
$modificado_bus_cat_id = $this->bus_cat_id;
$modificado_bus_subcat_id = $this->bus_subcat_id;
$modificado_est_memb_cost = $this->est_memb_cost;
$this->nm_formatar_campos('client_id', 'main_contact_name', 'applicant_name', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
if ($original_applicant_name !== $modificado_applicant_name || isset($this->nmgp_cmp_readonly['applicant_name']) || (isset($bFlagRead_applicant_name) && $bFlagRead_applicant_name))
{
...
if ( $memb_ct == 1 ) {
	$sql = "UPDATE members_app SET phone1 = '$this->main_contact_phone' WHERE client_id = $this->client_id ";
...
$modificado_bus_subcat_id = $this->bus_subcat_id;
$modificado_est_memb_cost = $this->est_memb_cost;
$this->nm_formatar_campos('client_id', 'main_contact_phone', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
$original_applicant_title = $this->applicant_title;
...
$modificado_applicant_title = $this->applicant_title;
...
$modificado_bus_subcat_id = $this->bus_subcat_id;
$modificado_est_memb_cost = $this->est_memb_cost;
$this->nm_formatar_campos('applicant_title', 'main_contact_title', 'client_id', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost');
if ($original_applicant_title !== $modificado_applicant_title || isset($this->nmgp_cmp_readonly['applicant_title']) || (isset($bFlagRead_applicant_title) && $bFlagRead_applicant_title))
{
...
$modificado_bus_subcat_id = $this->bus_subcat_id;
$modificado_est_memb_cost = $this->est_memb_cost;
$this->nm_formatar_campos('client_id', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
if ( $this->memb_status_id  == 3 ) { 
	$currentDateTime = new DateTime();
	$this->permanent_member_date  = $currentDateTime->format('Y-m-d H:i:s');
}
...
if (!isset($this->sc_temp_gv_memb_price)) {$this->sc_temp_gv_memb_price = (isset($_SESSION['gv_memb_price'])) ? $_SESSION['gv_memb_price'] : "";}
if (!isset($this->sc_temp_gv_cost_addtl_buyer)) {$this->sc_temp_gv_cost_addtl_buyer = (isset($_SESSION['gv_cost_addtl_buyer'])) ? $_SESSION['gv_cost_addtl_buyer'] : "";}
...
if (!isset($this->sc_temp_gv_members_ct)) {$this->sc_temp_gv_members_ct = (isset($_SESSION['gv_members_ct'])) ? $_SESSION['gv_members_ct'] : "";}
      ...
      $nm_select = "SELECT COUNT(client_id) FROM members_app WHERE client_id = $this->client_id "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds = array();
     if ($this->client_id != "")
...
$this->sc_temp_gv_cost_addtl_buyer	= $cost_adtl_buyer;
$this->sc_temp_gv_memb_price = $memb_cost;
...
switch ( $bus_cat ) {
	...
	case "Florist": case "Plant Sales":		
		...
		$sql = "SELECT
  					...
  					ML.num_of_buyers
				FROM bus_categories C
  					INNER JOIN members_level ML
    					ON C.memb_lev_id = ML.memb_lev_id
				WHERE C.bus_cat = 'Business Services'";
      ...
      { 
		...
		$memb_cost				= $this->ds[0][0];
		$cost_adtl_buyer		= $this->ds[0][1];
		$incl_buyers			= $this->ds[0][2];
		break;
}

if ( $this->memb_qty  <= 3 ) {
	$memb_est_cost = $memb_cost;
} else {
	$memb_est_cost = $memb_cost + ($cost_adtl_buyer * ($this->memb_qty  - 3));
}
$this->sc_temp_gv_membership_price = $memb_est_cost;



$est = "<p>Based on the accurate information provided, the annual membership fee<br> for the <b>" . $bus_cat ."</b> (" . $bus_subcat . ") category with <b>" . $this->memb_qty . "</b> member(s)<br>will be <b>$" . $memb_est_cost . " Per Year.</b><br><small>You will be notified if additional information is required. After the payment, you will receive confirmation along with further details.</small></p>";

$this->est_memb_cost  = $est;

$price_id = $strp_id; 	
$prod_price = $this->sc_temp_gv_membership_price;
$member_ct = $this->memb_qty ;
$cust_id = $this->client_id ;
$path_lib = "http://localhost/scriptcase/devel/conf/grp/PFM_Staff/libraries/stripe_qb/";
if ($this->localEnviron() !== 1) {
	$path_lib = "https://pfm-app.com/_lib/libraries/grp/stripe_qb/";
}
$redirect_url = $path_lib . "index.php?price_id=$price_id&prod_price=$prod_price&member_ct=$member_ct&cust_id=$cust_id&cost_byr=$cost_adtl_buyer&memb_price".$this->sc_temp_gv_memb_price;
...
if (isset($this->sc_temp_gv_cost_addtl_buyer)) { $_SESSION['gv_cost_addtl_buyer'] = $this->sc_temp_gv_cost_addtl_buyer;}
if (isset($this->sc_temp_gv_memb_price)) { $_SESSION['gv_memb_price'] = $this->sc_temp_gv_memb_price;}
...
$cost_adtl_buyer = $this->sc_temp_gv_cost_addtl_buyer;
$memb_price = $this->sc_temp_gv_memb_price;
$path_lib = "http://localhost/scriptcase/devel/conf/grp/PFM_Staff/libraries/stripe_qb/";
if ($this->localEnviron() !== 1) {
	$path_lib = "https://pfm-app.com/_lib/libraries/grp/stripe_qb/";
}
$redirect_url = $path_lib . "index.php?price_id=$price_id&prod_price=$prod_price&member_ct=$member_ct&cust_id=$cust_id&cost_byr=$cost_adtl_buyer&memb_price=$memb_price";
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['download_filenames'][$sTmpFile_main_contact_img_file] = $this->main_contact_img_file;
   ...
   { 
       $out_doc_file = $this->doc_file;  
   } 
   if ($this->doc_file != "" && $this->doc_file != "none")   
   { 
       $sTmpExtension = pathinfo($this->doc_filename, PATHINFO_EXTENSION);
       $sTmpExtension = null == $sTmpExtension ? '' : '.' . $sTmpExtension;
       $sTmpFile_doc_filename = 'sc_doc_file_' . md5(mt_rand(1, 1000) . microtime() . session_id()) . $sTmpExtension;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['download_filenames']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['download_filenames'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['download_filenames'][$sTmpFile_doc_filename] = $this->doc_filename;
       $out_doc_file = $this->Ini->path_imag_temp . "/" . $sTmpFile_doc_filename;
       $arq_doc_file = fopen($this->Ini->root . $out_doc_file, "w") ;  
       if (is_string($this->doc_file) && substr($this->doc_file, 0, 4) == "*nm*" && (strstr(strtoupper($this->Ini->nm_tpbanco),"MSSQL") || strstr(strtoupper($this->Ini->nm_tpbanco),"PDOSQLITE"))) 
       { 
           $this->doc_file = base64_decode($this->doc_file) ; 
       ...
       if (isset($this->NM_size_docs[$main_contact_img_file]))
       {
        ...
        $this->initFormPages();
        include_once("form_clients_steps_appn_stripe_staff_mob_form0.php");
        include_once("form_clients_steps_appn_stripe_staff_mob_form1.php");
        include_once("form_clients_steps_appn_stripe_staff_mob_form2.php");
        include_once("form_clients_steps_appn_stripe_staff_mob_form3.php");
        $this->hideFormPages();
 }
...
<?php
    ...
    function form_highlight_search_quicksearch(&$result, $field, $value)
    {
        ...
        elseif ($field == $this->nmgp_fast_search && in_array($field, array("co_name", "client_id", "mailing_address", "memb_status_id", "city", "bus_cat_id", "state", "bus_subcat_id", "zip_code", "bus_subcat_other", "appn_date", "acct_instagram", "website_url", "acct_facebook", "main_contact_name", "main_contact_phone", "main_contact_email", "main_contact_title", "main_contact_img_id", "doc_type", "doc_file", "appn_note", "memb_list", "memb_qty", "applicant_name", "applicant_title", "applicant_signature"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['csrf_token'];
    }
...
{ 
   ...
   function Form_lookup_doc_type()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "Active Secretary of State Registration?#?Active Secretary of State Registration?#??@?";
       $nmgp_def_dados .= "City Business License?#?City Business License?#??@?";
       $nmgp_def_dados .= "Agricultural License?#?Agricultural License?#??@?";
       $nmgp_def_dados .= "Other type of document?#?Other type of document?#??@?";
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "doc_type") 
          {
              $data_lookup = $this->SC_lookup_doc_type($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "doc_type", $arg_search, $data_lookup, "VARCHAR", false);
              }
          }
          if ($field == "doc_file") 
          {
              $this->SC_monta_condicao($comando, "doc_file", $arg_search, $data_search, "BLOB", false);
          }
          if ($field == "appn_note") 
          {
              $this->SC_monta_condicao($comando, "appn_note", $arg_search, $data_search, "TINYTEXT", false);
          }
          if ($field == "memb_qty") 
          {
              $this->SC_monta_condicao($comando, "memb_qty", $arg_search, str_replace(",", ".", $data_search), "INT", false);
          }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_clients_steps_appn_stripe_staff_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['total'] = $qt_geral_reg_form_clients_steps_appn_stripe_staff_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_clients_steps_appn_stripe_staff_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "client_id";$nm_numeric[] = "memb_status_id";$nm_numeric[] = "fresh_cut_allowed";$nm_numeric[] = "temporary_pass";$nm_numeric[] = "ofa_member";$nm_numeric[] = "restricted";$nm_numeric[] = "committee_approval_required";$nm_numeric[] = "archive";$nm_numeric[] = "pricing_level_id";$nm_numeric[] = "bus_cat_id";$nm_numeric[] = "bus_subcat_id";$nm_numeric[] = "buyers_excel_qty";$nm_numeric[] = "qb_id";$nm_numeric[] = "memb_qty";$nm_numeric[] = "synced";
      if (in_array($campo_join, $nm_numeric))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_doc_type($condicao, $campo)
   {
       $data_look = array();
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $data_look['Active Secretary of State Registration'] = "Active Secretary of State Registration";
       $data_look['City Business License'] = "City Business License";
       $data_look['Agricultural License'] = "Agricultural License";
       $data_look['Other type of document'] = "Other type of document";
       $result = array();
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values'] = array();
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['dummy02'] = $this->dummy02;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['dummy03'] = $this->dummy03;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['co_name'] = $this->co_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['client_id'] = $this->client_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['mailing_address'] = $this->mailing_address;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['memb_status_id'] = $this->memb_status_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['city'] = $this->city;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['bus_cat_id'] = $this->bus_cat_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['state'] = $this->state;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['bus_subcat_id'] = $this->bus_subcat_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['zip_code'] = $this->zip_code;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['bus_subcat_other'] = $this->bus_subcat_other;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['appn_date'] = $this->appn_date;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['acct_instagram'] = $this->acct_instagram;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['website_url'] = $this->website_url;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['acct_facebook'] = $this->acct_facebook;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['dummy07'] = $this->dummy07;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['dummy08'] = $this->dummy08;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['main_contact_name'] = $this->main_contact_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['main_contact_phone'] = $this->main_contact_phone;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['main_contact_email'] = $this->main_contact_email;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['main_contact_title'] = $this->main_contact_title;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['main_contact_img_id'] = $this->main_contact_img_id;
    }

    function wizard_loadFields_step_0()
    {
        $this->dummy02 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['dummy02'];
        $this->dummy03 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['dummy03'];
        $this->co_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['co_name'];
        $this->client_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['client_id'];
        $this->mailing_address = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['mailing_address'];
        $this->memb_status_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['memb_status_id'];
        $this->city = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['city'];
        $this->bus_cat_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['bus_cat_id'];
        $this->state = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['state'];
        $this->bus_subcat_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['bus_subcat_id'];
        $this->zip_code = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['zip_code'];
        $this->bus_subcat_other = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['bus_subcat_other'];
        $this->appn_date = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['appn_date'];
        $this->acct_instagram = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['acct_instagram'];
        $this->website_url = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['website_url'];
        $this->acct_facebook = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['acct_facebook'];
        $this->dummy07 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['dummy07'];
        $this->dummy08 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['dummy08'];
        $this->main_contact_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['main_contact_name'];
        $this->main_contact_phone = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['main_contact_phone'];
        $this->main_contact_email = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['main_contact_email'];
        $this->main_contact_title = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['main_contact_title'];
        $this->main_contact_img_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['main_contact_img_id'];
    }
    ...
    function wizard_returnValues_step_0()
    {
        ...
        $this->ajax_return_values_dummy07(true);
        $this->ajax_return_values_dummy08(true);
        $this->ajax_return_values_main_contact_name(true);
        $this->ajax_return_values_main_contact_phone(true);
        $this->ajax_return_values_main_contact_email(true);
        $this->ajax_return_values_main_contact_title(true);
        $this->ajax_return_values_main_contact_img_id(true);
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['doc_type'] = $this->doc_type;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['doc_file'] = $this->doc_file;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['appn_note'] = $this->appn_note;
    }

    function wizard_loadFields_step_1()
    {
        $this->doc_type = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['doc_type'];
        $this->doc_file = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['doc_file'];
        $this->appn_note = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['appn_note'];
    }

    function wizard_returnValues_step_1()
    {
        $this->ajax_return_values_doc_type(true);
        $this->ajax_return_values_doc_file(true);
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['memb_list'] = $this->memb_list;
    }

    function wizard_loadFields_step_2()
    {
        $this->memb_list = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['memb_list'];
    }

    function wizard_returnValues_step_2()
    {
        $this->ajax_return_values_memb_list(true);
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['est_memb_cost'] = $this->est_memb_cost;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['memb_qty'] = $this->memb_qty;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['read_at_sign'] = $this->read_at_sign;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['applicant_name'] = $this->applicant_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['applicant_title'] = $this->applicant_title;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['applicant_signature'] = $this->applicant_signature;
    }

    function wizard_loadFields_step_3()
    {
        $this->est_memb_cost = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['est_memb_cost'];
        $this->memb_qty = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['memb_qty'];
        $this->read_at_sign = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['read_at_sign'];
        $this->applicant_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['applicant_name'];
        $this->applicant_title = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['applicant_title'];
        $this->applicant_signature = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['field_values']['applicant_signature'];
    }
...
?>
    <li class="item sc-ui-form-step <?php echo $wizardStepClass; ?>" id="sc-ui-form-step-0">
        ...
        <div class="content">
            ...
            <span class="description">Company and Primary Contact Information</span>
        </div>
    </li>
<?php
...
?>
    <li class="item sc-ui-form-step <?php echo $wizardStepClass; ?>" id="sc-ui-form-step-1">
        ...
        <div class="content">
            ...
            <span class="description">Share documentation showing the business is actively registered</span>
        </div>
    </li>
<?php
...
?>
    <li class="item sc-ui-form-step <?php echo $wizardStepClass; ?>" id="sc-ui-form-step-2">
        ...
        <div class="content">
            ...
            <span class="description">Buyer names for flower market access</span>
        </div>
    </li>
<?php
...
?>
    <li class="item sc-ui-form-step <?php echo $wizardStepClass; ?>" id="sc-ui-form-step-3">
        ...
        <div class="content">
            <h4 class="title">Submit<br>After Payment</h4>
            <span class="description">Our team efficiently reviews payment and application eligibility</span>
        </div>
    </li>
<?php
    }
...
<?php
    ...
    {
        if ($stepNo < $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['actual_step']) {
            return 'sc-ui-form-step-done';
        } elseif ($stepNo == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['actual_step']) {
            return 'sc-ui-form-step-now';
        } elseif ($stepNo == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['form_wizard']['actual_step'] + 1) {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_clients_steps_appn_stripe_staff_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_clients_steps_appn_stripe_staff_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app_mob']['reg_start'] = "";
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app_mob']['total']);
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "update":
                ...
                break;
            case "approve_appn":
                return array("sc_approve_appn_bot");
                break;
            case "bstepretorna":
                return array("sc_b_stepret_b.sc-unique-btn-2");
                break;
            case "bstepavanca":
                return array("sc_b_stepavc_b.sc-unique-btn-3");
                break;
            case "help":
                return array("sc_b_hlp_b");
                break;
            case "exit":
                return array("sc_b_sai_b.sc-unique-btn-4", "sc_b_sai_b.sc-unique-btn-6", "sc_b_sai_b.sc-unique-btn-11", "sc_b_sai_b.sc-unique-btn-5");
                break;
            case "btn_back_reqs":
                return array("sc_btn_back_reqs_bot");
                break;
            case "first":
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['ordem_ord'] == " desc") {
