...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_clients_steps_appn_stripe_staff_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_pdf_download_ok()
{
    ...
    document.F1.action = "form_clients_steps_appn_stripe_staff_mob.php";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['where_detal']))
  {
?>  
...
function nm_mostra_doc(campo1, campo2, campo3)
{
    ...
    NovaJanela = window.open ("form_clients_steps_appn_stripe_staff_mob_doc.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nm_cod_doc=" + campo1 + "&nm_nome_doc=" + encodeURIComponent(campo2) + "&nm_cod_apl=" + campo3, "sc_name_download_iframe", "resizable, scrollbars");
}
...
{
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form0').style.width='1px';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form0').style.height='0px';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form0').style.display='none';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form0').style.overflow='scroll';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form1').style.width='1px';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form1').style.height='0px';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form1').style.display='none';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form1').style.overflow='scroll';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form2').style.width='1px';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form2').style.height='0px';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form2').style.display='none';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form2').style.overflow='scroll';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form3').style.width='1px';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form3').style.height='0px';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form3').style.display='none';
    document.getElementById('form_clients_steps_appn_stripe_staff_mob_form3').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff_mob']['pdf_view']) {
?>
...
?>
    ...
    displayChange_page(pag_ativa.substr(45), 'off');
    pag_ativa = N_pagina;
    sc_tab_pag(pag_ativa, 'scTabActive');
    displayChange_page(pag_ativa.substr(45), 'on');
   if ("form_clients_steps_appn_stripe_staff_mob_form2" == N_pagina) {
