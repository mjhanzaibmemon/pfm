  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clients_steps_appn_stripe_staff" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_clients_steps_appn_stripe_staff_form();
        }
...
?>
  ...
  // ---------- Validate dummy02
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy02()
  {
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy02

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy02_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy02_cb

  // ---------- Validate dummy03
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy03()
  {
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy03

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy03_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy03_cb

  // ---------- Validate co_name
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_co_name()
  {
    var nomeCampo_co_name = "co_name";
    var var_co_name = scAjaxGetFieldText(nomeCampo_co_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_co_name(var_co_name, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_co_name_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_co_name

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_co_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_co_name_cb

  // ---------- Validate client_id
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldHidden(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_client_id_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_client_id

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_client_id_cb

  // ---------- Validate mailing_address
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_mailing_address()
  {
    var nomeCampo_mailing_address = "mailing_address";
    var var_mailing_address = scAjaxGetFieldText(nomeCampo_mailing_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_mailing_address(var_mailing_address, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_mailing_address_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_mailing_address

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_mailing_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_mailing_address_cb

  // ---------- Validate memb_status_id
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_status_id()
  {
    var nomeCampo_memb_status_id = "memb_status_id";
    var var_memb_status_id = scAjaxGetFieldSelect(nomeCampo_memb_status_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_memb_status_id(var_memb_status_id, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_status_id_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_status_id

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_status_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_status_id_cb

  // ---------- Validate city
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_city(var_city, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_city_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_city

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_city_cb

  // ---------- Validate bus_cat_id
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldSelect(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_cat_id_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_cat_id

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_cat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_cat_id_cb

  // ---------- Validate state
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_state()
  {
    var nomeCampo_state = "state";
    var var_state = scAjaxGetFieldText(nomeCampo_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_state(var_state, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_state_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_state

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_state_cb

  // ---------- Validate bus_subcat_id
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_id()
  {
    var nomeCampo_bus_subcat_id = "bus_subcat_id";
    var var_bus_subcat_id = scAjaxGetFieldSelect(nomeCampo_bus_subcat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_id(var_bus_subcat_id, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_id_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_id

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_id_cb

  // ---------- Validate zip_code
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_zip_code()
  {
    var nomeCampo_zip_code = "zip_code";
    var var_zip_code = scAjaxGetFieldText(nomeCampo_zip_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_zip_code(var_zip_code, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_zip_code_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_zip_code

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_zip_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_zip_code_cb

  // ---------- Validate bus_subcat_other
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_other()
  {
    var nomeCampo_bus_subcat_other = "bus_subcat_other";
    var var_bus_subcat_other = scAjaxGetFieldText(nomeCampo_bus_subcat_other);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_other(var_bus_subcat_other, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_other_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_other

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_other_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_bus_subcat_other_cb

  // ---------- Validate appn_date
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_appn_date()
  {
    var nomeCampo_appn_date = "appn_date";
    var var_appn_date = scAjaxGetFieldHidden(nomeCampo_appn_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_appn_date(var_appn_date, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_appn_date_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_appn_date

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_appn_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_appn_date_cb

  // ---------- Validate acct_instagram
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_acct_instagram()
  {
    var nomeCampo_acct_instagram = "acct_instagram";
    var var_acct_instagram = scAjaxGetFieldText(nomeCampo_acct_instagram);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_acct_instagram(var_acct_instagram, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_acct_instagram_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_acct_instagram

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_acct_instagram_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_acct_instagram_cb

  // ---------- Validate website_url
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_website_url()
  {
    var nomeCampo_website_url = "website_url";
    var var_website_url = scAjaxGetFieldText(nomeCampo_website_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_website_url(var_website_url, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_website_url_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_website_url

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_website_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_website_url_cb

  // ---------- Validate acct_facebook
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_acct_facebook()
  {
    var nomeCampo_acct_facebook = "acct_facebook";
    var var_acct_facebook = scAjaxGetFieldText(nomeCampo_acct_facebook);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_acct_facebook(var_acct_facebook, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_acct_facebook_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_acct_facebook

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_acct_facebook_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_acct_facebook_cb

  // ---------- Validate dummy07
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy07()
  {
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy07

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy07_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy07_cb

  // ---------- Validate dummy08
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy08()
  {
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy08

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy08_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_dummy08_cb

  // ---------- Validate main_contact_name
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_name()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_name(var_main_contact_name, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_name_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_name

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_name_cb

  // ---------- Validate main_contact_phone
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_phone()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_phone(var_main_contact_phone, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_phone_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_phone

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_phone_cb

  // ---------- Validate main_contact_email
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_email()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_email(var_main_contact_email, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_email_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_email

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_email_cb

  // ---------- Validate main_contact_title
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_title()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_title(var_main_contact_title, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_title_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_title

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_title_cb

  // ---------- Validate main_contact_img_id
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_img_id()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_img_id(var_main_contact_img_id, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_img_id_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_img_id

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_img_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_main_contact_img_id_cb

  // ---------- Validate doc_type
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_doc_type()
  {
    var nomeCampo_doc_type = "doc_type";
    var var_doc_type = scAjaxGetFieldCheckbox(nomeCampo_doc_type, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_doc_type(var_doc_type, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_doc_type_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_doc_type

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_doc_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_doc_type_cb

  // ---------- Validate doc_file
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_doc_file()
  {
    var nomeCampo_doc_file = "doc_file";
    var var_doc_file = scAjaxGetFieldText(nomeCampo_doc_file);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_doc_file(var_doc_file, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_doc_file_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_doc_file

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_doc_file_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_doc_file_cb

  // ---------- Validate appn_note
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_appn_note()
  {
    var nomeCampo_appn_note = "appn_note";
    var var_appn_note = scAjaxGetFieldEditorHtml(nomeCampo_appn_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_appn_note(var_appn_note, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_appn_note_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_appn_note

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_appn_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_appn_note_cb

  // ---------- Validate memb_list
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_list()
  {
    var nomeCampo_memb_list = "memb_list";
    var var_memb_list = scAjaxGetFieldText(nomeCampo_memb_list);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_memb_list(var_memb_list, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_list_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_list

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_list_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_list_cb

  // ---------- Validate est_memb_cost
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_est_memb_cost()
  {
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_est_memb_cost

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_est_memb_cost_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_est_memb_cost_cb

  // ---------- Validate memb_qty
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_qty()
  {
    var nomeCampo_memb_qty = "memb_qty";
    var var_memb_qty = scAjaxGetFieldText(nomeCampo_memb_qty);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_memb_qty(var_memb_qty, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_qty_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_qty

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_qty_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_memb_qty_cb

  // ---------- Validate read_at_sign
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_read_at_sign()
  {
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_read_at_sign

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_read_at_sign_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_read_at_sign_cb

  // ---------- Validate applicant_name
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_name()
  {
    var nomeCampo_applicant_name = "applicant_name";
    var var_applicant_name = scAjaxGetFieldText(nomeCampo_applicant_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_name(var_applicant_name, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_name_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_name

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_name_cb

  // ---------- Validate applicant_title
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_title()
  {
    var nomeCampo_applicant_title = "applicant_title";
    var var_applicant_title = scAjaxGetFieldText(nomeCampo_applicant_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_title(var_applicant_title, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_title_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_title

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_title_cb

  // ---------- Validate applicant_signature
  function do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_signature()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_signature(var_applicant_signature, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_signature_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_signature

  function do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_signature_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_validate_applicant_signature_cb

  // ---------- Refresh bus_cat_id
  function do_ajax_form_clients_steps_appn_stripe_staff_refresh_bus_cat_id()
  {
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    var var_nmgp_refresh_fields = "bus_subcat_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_stripe_staff_refresh_bus_cat_id(var_bus_cat_id, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_refresh_bus_cat_id_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_refresh_bus_cat_id

  function do_ajax_form_clients_steps_appn_stripe_staff_refresh_bus_cat_id_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_steps_appn_stripe_staff_refresh_bus_cat_id_cb

  // ---------- Event onchange bus_cat_id
  function do_ajax_form_clients_steps_appn_stripe_staff_event_bus_cat_id_onchange()
  {
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_stripe_staff_event_bus_cat_id_onchange(var_bus_cat_id, var_client_id, var_memb_qty, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_event_bus_cat_id_onchange_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_bus_cat_id_onchange

  function do_ajax_form_clients_steps_appn_stripe_staff_event_bus_cat_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bus_cat_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_stripe_staff_event_bus_cat_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_bus_cat_id_onchange_cb
  function do_ajax_form_clients_steps_appn_stripe_staff_event_bus_cat_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_clients_steps_appn_stripe_staff_refresh_bus_cat_id();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_bus_cat_id_onchange_cb_after_alert

  // ---------- Event onchange bus_subcat_id
  function do_ajax_form_clients_steps_appn_stripe_staff_event_bus_subcat_id_onchange()
  {
    var var_client_id = scAjaxGetFieldHidden("client_id");
    var var_memb_qty = scAjaxGetFieldText("memb_qty");
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_stripe_staff_event_bus_subcat_id_onchange(var_client_id, var_memb_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_bus_subcat_other, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_event_bus_subcat_id_onchange_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_bus_subcat_id_onchange

  function do_ajax_form_clients_steps_appn_stripe_staff_event_bus_subcat_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bus_subcat_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_stripe_staff_event_bus_subcat_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_bus_subcat_id_onchange_cb
  function do_ajax_form_clients_steps_appn_stripe_staff_event_bus_subcat_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_bus_subcat_id_onchange_cb_after_alert

  // ---------- Event onchange main_contact_email
  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_email_onchange()
  {
    var var_client_id = scAjaxGetFieldHidden("client_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_email_onchange(var_client_id, var_main_contact_email, var_memb_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_email_onchange_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_email_onchange

  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_email_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_email";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_email_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_email_onchange_cb
  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_email_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_email_onchange_cb_after_alert

  // ---------- Event onchange main_contact_name
  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_name_onchange()
  {
    var var_client_id = scAjaxGetFieldHidden("client_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_name_onchange(var_client_id, var_main_contact_name, var_applicant_name, var_memb_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_name_onchange_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_name_onchange

  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_name_onchange_cb
  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_name_onchange_cb_after_alert

  // ---------- Event onchange main_contact_phone
  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_phone_onchange()
  {
    var var_client_id = scAjaxGetFieldHidden("client_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_phone_onchange(var_client_id, var_main_contact_phone, var_memb_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_phone_onchange_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_phone_onchange

  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_phone_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_phone";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_phone_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_phone_onchange_cb
  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_phone_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_phone_onchange_cb_after_alert

  // ---------- Event onchange main_contact_title
  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_title_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_title_onchange(var_applicant_title, var_main_contact_title, var_client_id, var_memb_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_title_onchange_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_title_onchange

  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_title_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_title";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_title_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_title_onchange_cb
  function do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_title_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_main_contact_title_onchange_cb_after_alert

  // ---------- Event onchange memb_qty
  function do_ajax_form_clients_steps_appn_stripe_staff_event_memb_qty_onchange()
  {
    var var_client_id = scAjaxGetFieldHidden("client_id");
    var var_memb_qty = scAjaxGetFieldText("memb_qty");
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_stripe_staff_event_memb_qty_onchange(var_client_id, var_memb_qty, var_bus_cat_id, var_bus_subcat_id, var_est_memb_cost, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_event_memb_qty_onchange_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_memb_qty_onchange

  function do_ajax_form_clients_steps_appn_stripe_staff_event_memb_qty_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "memb_qty";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_stripe_staff_event_memb_qty_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_memb_qty_onchange_cb
  function do_ajax_form_clients_steps_appn_stripe_staff_event_memb_qty_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_memb_qty_onchange_cb_after_alert

  // ---------- Event onchange memb_status_id
  function do_ajax_form_clients_steps_appn_stripe_staff_event_memb_status_id_onchange()
  {
    var var_memb_status_id = scAjaxGetFieldSelect("memb_status_id");
    var var_client_id = scAjaxGetFieldHidden("client_id");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_steps_appn_stripe_staff_event_memb_status_id_onchange(var_memb_status_id, var_client_id, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_event_memb_status_id_onchange_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_memb_status_id_onchange

  function do_ajax_form_clients_steps_appn_stripe_staff_event_memb_status_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "memb_status_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_steps_appn_stripe_staff_event_memb_status_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_memb_status_id_onchange_cb
  function do_ajax_form_clients_steps_appn_stripe_staff_event_memb_status_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_steps_appn_stripe_staff_event_memb_status_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clients_steps_appn_stripe_staff_submit_page_0(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_stripe_staff_submit_page_0(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      url: "form_clients_steps_appn_stripe_staff.php",
      method: "POST",
      dataType: "json",
      data: {
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_0(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_stripe_staff_submit_page_0

  function do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_0(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
  ...
  } // do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_0

  function do_ajax_form_clients_steps_appn_stripe_staff_submit_page_1(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_stripe_staff_submit_page_1(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_1(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_stripe_staff_submit_page_1

  function do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_1(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_1

  function do_ajax_form_clients_steps_appn_stripe_staff_submit_page_2(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_stripe_staff_submit_page_2(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_2(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_stripe_staff_submit_page_2

  function do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_2(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_2

  function do_ajax_form_clients_steps_appn_stripe_staff_submit_page_3(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_stripe_staff_submit_page_3(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_3(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_clients_steps_appn_stripe_staff_submit_page_3

  function do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_3(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_clients_steps_appn_stripe_staff_submit_page_cb_3

  function do_ajax_form_clients_steps_appn_stripe_staff_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_steps_appn_stripe_staff_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_clients_steps_appn_stripe_staff_submit_form(var_dummy02, var_dummy03, var_co_name, var_client_id, var_mailing_address, var_memb_status_id, var_city, var_bus_cat_id, var_state, var_bus_subcat_id, var_zip_code, var_bus_subcat_other, var_appn_date, var_acct_instagram, var_website_url, var_acct_facebook, var_dummy07, var_dummy08, var_main_contact_name, var_main_contact_phone, var_main_contact_email, var_main_contact_title, var_main_contact_img_id, var_doc_type, var_doc_file, var_appn_note, var_est_memb_cost, var_memb_qty, var_read_at_sign, var_applicant_name, var_applicant_title, var_applicant_signature, var_doc_file_ul_name, var_doc_file_ul_type, var_main_contact_img_id_ul_name, var_main_contact_img_id_ul_type, var_main_contact_img_id_limpa, var_doc_file_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clients_steps_appn_stripe_staff_submit_form_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_submit_form

  function do_ajax_form_clients_steps_appn_stripe_staff_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxUpdateErrors("valid");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clients_steps_appn_stripe_staff_submit_form_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_stripe_staff_submit_form_cb
  function do_ajax_form_clients_steps_appn_stripe_staff_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clients_steps_appn_stripe_staff_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_members_app"] = "off";

  function do_ajax_form_clients_steps_appn_stripe_staff_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clients_steps_appn_stripe_staff_navigate_form, function() {});
    } else {
      perform_ajax_form_clients_steps_appn_stripe_staff_navigate_form();
    }
  }

  function perform_ajax_form_clients_steps_appn_stripe_staff_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_clients_steps_appn_stripe_staff_navigate_form(var_client_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clients_steps_appn_stripe_staff_navigate_form_cb);
  } // do_ajax_form_clients_steps_appn_stripe_staff_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_staff']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clients_steps_appn_stripe_staff_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clients_steps_appn_stripe_staff_navigate_form_cb_after_alert);
  } // do_ajax_form_clients_steps_appn_stripe_staff_navigate_form_cb
  function do_ajax_form_clients_steps_appn_stripe_staff_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clients_steps_appn_stripe_staff_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_clients_steps_appn_stripe_staff_navigate_form_cb_after_alert

  function sc_hide_form_clients_steps_appn_stripe_staff_form()
  {
