...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_app_name_' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_app_form_sec_groups_apps_app_name__onblur('#id_sc_field_app_name_' + iSeqRow, iSeqRow);}, 300) })
  ...
  $('#id_sc_field_priv_access_' + iSeqRow).bind('blur', function() { sc_app_form_sec_groups_apps_priv_access__onblur('#id_sc_field_priv_access_' + iSeqRow, iSeqRow) })
  ...
  $('#id_sc_field_priv_insert_' + iSeqRow).bind('blur', function() { sc_app_form_sec_groups_apps_priv_insert__onblur('#id_sc_field_priv_insert_' + iSeqRow, iSeqRow) })
  ...
  $('#id_sc_field_priv_delete_' + iSeqRow).bind('blur', function() { sc_app_form_sec_groups_apps_priv_delete__onblur('#id_sc_field_priv_delete_' + iSeqRow, iSeqRow) })
  ...
  $('#id_sc_field_priv_update_' + iSeqRow).bind('blur', function() { sc_app_form_sec_groups_apps_priv_update__onblur('#id_sc_field_priv_update_' + iSeqRow, iSeqRow) })
  ...
  $('#id_sc_field_priv_export_' + iSeqRow).bind('blur', function() { sc_app_form_sec_groups_apps_priv_export__onblur('#id_sc_field_priv_export_' + iSeqRow, iSeqRow) })
  ...
  $('#id_sc_field_priv_print_' + iSeqRow).bind('blur', function() { sc_app_form_sec_groups_apps_priv_print__onblur('#id_sc_field_priv_print_' + iSeqRow, iSeqRow) })
