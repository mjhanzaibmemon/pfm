...
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off'; 
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Gera_log_access'] = false;
      }
      ...
      { 
         ...
         {
             if ($this->nmgp_opcao != "incluir" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_export_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['priv_export_']))
             { 
                 $this->priv_export_ = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_export_'];
             } 
             if ($this->nmgp_opcao != "incluir" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_print_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['priv_print_']))
             { 
                 $this->priv_print_ = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_print_'];
             } 
             if ($this->nmgp_opcao != "incluir" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_insert_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['priv_insert_']))
             { 
                 $this->priv_insert_ = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_insert_'];
             } 
             if ($this->nmgp_opcao != "incluir" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_delete_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['priv_delete_']))
             { 
                 $this->priv_delete_ = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_delete_'];
             } 
             if ($this->nmgp_opcao != "incluir" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dados_select'][$sc_seq_vert]['priv_update_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_disabled'][$sc_seq_vert]['priv_update_']))
             { 
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['dyn_search_cache']);
