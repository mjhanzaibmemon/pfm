<div id="form_clients_steps_appn_stripe_renew_form3" style='<?php echo (3 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $sStyleHidden_memb_qty_dumb = ('' == $sStyleHidden_memb_qty) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_memb_qty_dumb" style="<?php echo $sStyleHidden_memb_qty_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<span id="id_read_on_js_strp_price_id" class="sc-ui-readonly-js_strp_price_id css_js_strp_price_id_line" style="<?php echo $sStyleReadLab_js_strp_price_id; ?>"><?php echo $this->form_format_readonly("js_strp_price_id", $this->form_encode_input($this->js_strp_price_id)); ?></span><span id="id_read_off_js_strp_price_id" class="css_read_off_js_strp_price_id<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_js_strp_price_id; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> maxlength=150 alt="{datatype: 'text', maxLength: 150, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['bstepretorna']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['bstepretorna']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['bstepretorna']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['bstepretorna']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['bstepretorna'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['bstepavanca']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['bstepavanca']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['bstepavanca']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['bstepavanca']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['bstepavanca'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['pmt_js']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['pmt_js']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['pmt_js']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['pmt_js']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['pmt_js'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['btn_exit_app']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['btn_exit_app']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['btn_exit_app']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['btn_exit_app']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['btn_exit_app'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['btn_label']['exit'];
        }
?>
...
$(function() {
    if ('page' == wizardViewMode) {
        scJQWizardGoToPage(<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['form_wizard']['actual_step']; ?>);
        $(".sc-form-page").on("click", function() {
            var thisStepNo = $(this).attr("id").substr(16);
            scJQWizardPageClick(thisStepNo);
        });
    } else {
        scJQWizardGoToStep(<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['form_wizard']['actual_step']; ?>);
...
?>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_clients_steps_appn_stripe_renew");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_clients_steps_appn_stripe_renew");
 parent.scAjaxDetailHeight("form_clients_steps_appn_stripe_renew", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
