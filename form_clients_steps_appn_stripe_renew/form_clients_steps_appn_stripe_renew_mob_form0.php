...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_pdf']))
 {
 ?>
 <link rel="stylesheet" type="text/css" href="form_clients_steps_appn_stripe_renew_mob_wizard.css" />
<?php
if ($_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']) {
?>
 <link rel="stylesheet" type="text/css" href="form_clients_steps_appn_stripe_renew_mob_wizard_mobile.css" />
<?php
}
?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_clients_steps_appn_stripe_renew/form_clients_steps_appn_stripe_renew_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['btn_disabled']['last'] : 'off'); ?>";
...
function summary_atualiza(reg_ini, reg_qtd, reg_tot)
{
 ...
 function refresh_member_list() {
  ...
  document.getElementById('nmsc_iframe_liga_form_members_app').contentDocument.location.reload(true);
 } // refresh_member_list
<?php

include_once('form_clients_steps_appn_stripe_renew_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew']['error_buffer']) && '' != $_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew']['error_buffer'];
}
...
<?php
 include_once("form_clients_steps_appn_stripe_renew_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" enctype="multipart/form-data" 
               action="form_clients_steps_appn_stripe_renew_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_clients_steps_appn_stripe_renew_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_clients_steps_appn_stripe_renew_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<div id="form_clients_steps_appn_stripe_renew_mob_form0" style='<?php echo (0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<input type="hidden" name="doc_file_ul_name" id="id_sc_field_doc_file_ul_name" value="<?php echo $this->form_encode_input($this->doc_file_ul_name);?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dummy03_line" id="hidden_field_data_dummy03" style="<?php echo $sStyleHidden_dummy03; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dummy03_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_dummy03_label" style=""><span id="id_label_dummy03"><?php echo $this->nm_new_label['dummy03']; ?></span></span><br><span id="id_ajax_label_dummy03"><?php echo $dummy03?></span>
<input type="hidden" name="dummy03" value="<?php echo $this->form_encode_input($dummy03); ?>">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['client_id'] = "Membership #";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['appn_date'] = "Renewal Date";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
?> 
<?php  }?>
<span class="scFormDataTagOdd" style="display: block"><span style="color: darkorange; font-family: Arial, sans-serif; font-size: small;">(Find rates below)</span></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_pricing_level_id_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_pricing_level_id_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_dummy01_dumb = ('' == $sStyleHidden_dummy01) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dummy01_dumb" style="<?php echo $sStyleHidden_dummy01_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable scFormDataOdd<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont"><?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "<table style=\"border-collapse: collapse; height: 100%; width: 100%\"><tr><td style=\"vertical-align: middle; border-width: 0px; padding: 0px 2px 0px 0px\"><img id=\"SC_blk_pdf1\" src=\"" . $this->Ini->path_icones . "/" . $this->Ini->Block_img_exp . "\" style=\"border: 0px; float: left\" class=\"sc-ui-block-control\"></td><td style=\"border-width: 0px; padding: 0px; width: 100%;\" class=\"scFormBlockAlign\">"; } ?>MEMBERSHIP LEVELS<?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "</td></tr></table>"; } ?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_memb_levels_line" id="hidden_field_data_memb_levels" style="<?php echo $sStyleHidden_memb_levels; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_memb_levels_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_memb_levels css_memb_levels_line" style="<?php echo $sStyleReadLab_memb_levels; ?>"><?php echo $fieldContent; ?></span><span id="id_read_off_memb_levels" class="css_read_off_memb_levels" style="<?php echo $sStyleReadInp_memb_levels; ?>"><span id="id_ajax_label_memb_levels"><?php echo $memb_levels?></span>
...
<?php $sStyleHidden_memb_levels_dumb = ('' == $sStyleHidden_memb_levels) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_memb_levels_dumb" style="<?php echo $sStyleHidden_memb_levels_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
