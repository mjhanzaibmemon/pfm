<?php
//
class form_clients_steps_appn_stripe_renew_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['memb_levels']))
          {
              $this->memb_levels = $this->NM_ajax_info['param']['memb_levels'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['rules']))
          {
              $this->rules = $this->NM_ajax_info['param']['rules'];
          }
      ...
      $Sc_lig_md5 = false;
      $List_cmps = array('dummy02','dummy03','co_name','client_id','mailing_address','appn_date','city','pricing_level_id','state','bus_cat_id','zip_code','bus_subcat_id','website_url','bus_subcat_other','acct_instagram','acct_facebook','dummy01','memb_levels','dummy07','dummy08','main_contact_name','main_contact_title','main_contact_phone','main_contact_email','main_contact_img_id','doc_type','doc_file','appn_note','memb_list','est_memb_cost','rules','memb_qty','read_at_sign','applicant_name','applicant_title','applicant_signature','js_strp_price_id','js_prod_price','js_mbr_ct','js_client_id','memb_status_id','appn_id','ofa_contact','street_address','phone_number','home_phone','fax_number','email','business_type','fresh_cut_allowed','business_license','nursery_license','federal_tax_id','temporary_pass','ofa_member','starting_date','renewal_date','expiration_date','canceled','cancel_date','canceled_by','reason_canceled','retire_date','verified_receipts','date_last_updated','restricted','committee_approval_required','type_company','archive','archive_date','store_front_address','store_front_city','store_front_zip','home_base_address','home_base_city','home_base_zip','store_front_state','home_base_state','record_created','permanent_member_date','doc_sec_of_state','doc_city_bus_lic','doc_agric_lic','doc_last_year_tax','qb_id','main_contact_img_file','main_contact_img_size','main_contact_img_id_prev','doc_filename','doc_filesize','addtl_memb_mail','adtl_memb_name','adtl_memb_note','adtl_memb_phone','dummy04','dummy05','dummy06','dummy09','dummy10','dummy11','dummy12','dummy13','main_contact_title_lbl','memb_01','memb_02','memb_03','memb_04','memb_05','memb_06','memb_07','memb_08','memb_09','memb_10','memb_11','memb_12','memb_13','memb_email','memb_name','memb_note','memb_phone','paid','pay','rules_warn','xlsx_sample');
      if (!isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['Cache_wizard_form']) || (isset($_POST['rs']) && strpos($_POST['rs'], '_navigate_form'))) {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['Cache_wizard_form'] = array();
      }
      foreach ($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['Cache_wizard_form'] as $nmgp_var => $nmgp_val) {
          ...
          foreach ($_POST as $nmgp_var => $nmgp_val)
          {
              ...
              if ($nmgp_var == "nmgp_parms" && substr($nmgp_val, 0, 8) == "@SC_par@")
              {
               ...
               if (in_array($nmgp_var, $List_cmps)) {
                   $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['Cache_wizard_form'][$nmgp_var] = $nmgp_val;
               }
          }
      }
      if (!empty($_GET))
      ...
      if (isset($this->token) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_clients_steps_appn_stripe_renew_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['opc_ant']);
          }
          if (isset($this->gv_contact_pfm)) 
          {
              $_SESSION['gv_contact_pfm'] = $this->gv_contact_pfm;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_clients_steps_appn_stripe_renew_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['initialize'])
          {
              $_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew_mob']['contr_erro'] = 'on';
  ?>
<style>
...
<?php
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['upload_field_info']['main_contact_img_id'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_renew_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['upload_field_info']['doc_file'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_renew_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
          'upload_type'        => 'single',
          'upload_allowed_type'  => '/\.(pdf|doc|docx|odt|ods|odp|jpg|jpeg|gif|tiff|png|xls|xlsx|bmp|svg)$/i',
          'upload_max_size'  => null,
          'upload_file_height' => '',
          'upload_file_width'  => '',
          'upload_file_aspect' => '',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['upload_field_info']['doc_sec_of_state'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_renew_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['upload_field_info']['doc_city_bus_lic'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_renew_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['upload_field_info']['doc_agric_lic'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_renew_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['upload_field_info']['doc_last_year_tax'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_renew_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_renew_mob']['upload_field_info']['main_contact_img_id_prev'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_renew_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_steps_appn_stripe_renew_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_steps_appn_stripe_renew_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe_renew_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe_renew_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_clients_steps_appn_stripe_renew_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe_renew_mob']['label'] = "PFM - Buyers Pass App";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_clients_steps_appn_stripe_renew_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->arr_buttons['pay_now']['hint']             = "A secure payment window will open in a new tab";
      $this->arr_buttons['pay_now']['type']             = "button";
      $this->arr_buttons['pay_now']['value']            = "(1) Pay Membership";
      $this->arr_buttons['pay_now']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['pay_now']['display_position'] = "text_right";
      $this->arr_buttons['pay_now']['style']            = "paypal";
      $this->arr_buttons['pay_now']['image']            = "";
      $this->arr_buttons['pay_now']['has_fa']            = "true";
      $this->arr_buttons['pay_now']['fontawesomeicon']            = "far fa-credit-card";

      $this->arr_buttons['pmt_js']['hint']             = "";
      $this->arr_buttons['pmt_js']['type']             = "button";
      $this->arr_buttons['pmt_js']['value']            = "(1) Pay Membership";
      $this->arr_buttons['pmt_js']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['pmt_js']['display_position'] = "text_right";
      $this->arr_buttons['pmt_js']['style']            = "default";
      $this->arr_buttons['pmt_js']['image']            = "";
      $this->arr_buttons['pmt_js']['has_fa']            = "true";
      $this->arr_buttons['pmt_js']['fontawesomeicon']            = "far fa-credit-card";


      $_SESSION['scriptcase']['error_icon']['form_clients_steps_appn_stripe_renew_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_clients_steps_appn_stripe_renew_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['table_refresh'] = false;

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard'])) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard'] = array();
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['actual_step']) || $this->nmgp_opcao  == "novo" || $this->nmgp_opcao  == "incluir") {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['actual_step'] = 0;
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['total_steps'] = 4;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->NM_ajax_info['param']['main_contact_img_id_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      elseif (isset($this->main_contact_img_id_ul_name) && '' != $this->main_contact_img_id_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->main_contact_img_id_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_field_ul_name'][$this->doc_file_ul_name]))
          {
              $this->NM_ajax_info['param']['doc_file_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_field_ul_name'][$this->doc_file_ul_name];
          }
      ...
      elseif (isset($this->doc_file_ul_name) && '' != $this->doc_file_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_field_ul_name'][$this->doc_file_ul_name]))
          {
              $this->doc_file_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_field_ul_name'][$this->doc_file_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['goto']      = 'on';
          }
      }
      ...
      $this->nmgp_botoes['pay_now'] = "on";
      $this->nmgp_botoes['pmt_js'] = "on";
      if (isset($this->NM_btn_cancel) && 'N' == $this->NM_btn_cancel)
      {
          $this->nmgp_botoes['cancel'] = "off";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_renew_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_steps_appn_stripe_renew_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_steps_appn_stripe_renew_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form'];
          if (!isset($this->memb_status_id)){$this->memb_status_id = $this->nmgp_dados_form['memb_status_id'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_clients_steps_appn_stripe_renew_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_clients_steps_appn_stripe_renew_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_clients_steps_appn_stripe_renew_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_clients_steps_appn_stripe_renew/form_clients_steps_appn_stripe_renew_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_clients_steps_appn_stripe_renew_mob_erro.class.php"); 
      }
      $this->Erro      = new form_clients_steps_appn_stripe_renew_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opcao']))
         { 
             if ($this->client_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew_mob']['start']);
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_renew']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['btn_exit_app'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['botoes']['btn_exit_app'];
          $this->nmgp_botoes['pdf_download'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['botoes']['pdf_download'];
          $this->nmgp_botoes['pay_now'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['botoes']['pay_now'];
          $this->nmgp_botoes['pmt_js'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['botoes']['pmt_js'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['total']);
          $detailAppName = 'form_members_mob';
          $detailAppObject = "form_members_mob";
          ...
          $this->form_members_mob = new $detailAppObject;
      }
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- memb_status_id
      $this->field_config['memb_status_id']               = array();
      $this->field_config['memb_status_id']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['memb_status_id']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['memb_status_id']['symbol_dec'] = '';
      $this->field_config['memb_status_id']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['memb_status_id']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- appn_id
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Gera_log_access'] = false;
      }
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") {
          $this->pricing_level_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['pricing_level_id'];
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_clients_steps_appn_stripe_renew_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_select']['pricing_level_id']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pricing_level_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_select']['pricing_level_id'];
          } 
        ...
        if ($this->wizard_change_step) {
            ...
            if (!$this->wizard_go_forward) {
                ...
                $wizardData['action'] = 'change_step';
                $wizardData['next_step'] = $this->wizard_step_goto;
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['actual_step'] = $this->wizard_step_goto;
            }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_clients_steps_appn_stripe_renew_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="form_clients_steps_appn_stripe_renew_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_clients_steps_appn_stripe_renew_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_clients_steps_appn_stripe_renew_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe_renew_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe_renew_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe_renew_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
include_once("form_clients_steps_appn_stripe_renew_mob_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opc_ant'] == "incluir")
      {
          $nmgp_opc_ant_saida_php = "novo";
          $nmgp_opcao_saida_php   = "recarga";
      }
      $nm_f_saida = "form_clients_steps_appn_stripe_renew_mob.php";
...
<?php
      ...
      {
          if (!isset($this->client_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['client_id']))
          {
              $varloc_btn_php['client_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['client_id'];
          }
          if (!isset($this->memb_qty) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['memb_qty']))
          {
              $varloc_btn_php['memb_qty'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['memb_qty'];
          }
          if (!isset($this->client_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['client_id']))
          {
              $varloc_btn_php['client_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['client_id'];
          }
          if (!isset($this->bus_cat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['bus_cat_id']))
          {
              $varloc_btn_php['bus_cat_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['bus_cat_id'];
          }
          if (!isset($this->bus_subcat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['bus_subcat_id']))
          {
              $varloc_btn_php['bus_subcat_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['bus_subcat_id'];
          }
          if (!isset($this->bus_cat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['bus_cat_id']))
          {
              $varloc_btn_php['bus_cat_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['bus_cat_id'];
          ...
          if (!isset($this->est_memb_cost) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['est_memb_cost']))
          {
              $varloc_btn_php['est_memb_cost'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['est_memb_cost'];
          }
          if (!isset($this->client_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['client_id']))
          {
              $varloc_btn_php['client_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form']['client_id'];
...
$this->sc_temp_gv_members_ct = (isset($this->ds[0][0])) ? $this->ds[0][0] : 0;
$this->memb_qty  = $this->sc_temp_gv_members_ct;
...
if ( $this->sc_temp_gv_members_ct <= 3 ) {
...
echo "<script>
    var stripeWin = window.open('$redirect_url', 'stripeCheckout', 'width=800,height=700,resizable=yes,scrollbars=yes');
</script>";
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_renew_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_renew_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_renew_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_renew_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_doc_file = $this->doc_file;
    ...
    $original_pricing_level_id = $this->pricing_level_id;
}
  $this->members_ct();

if ( $this->doc_file  == 'add_new_doc.pdf' ) {    
    
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= 'Missing attachment file for the document supporting business operations.';
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_renew_mob';
  } elseif ('submit_form' == $this->NM_ajax_opcao) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_renew_mob';
  } else {
   $sErrorIndex = substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
  }
  $this->NM_ajax_info['errList'][$sErrorIndex][] = 'Missing attachment file for the document supporting business operations.';
 }
;
}
...
if ( $this->sc_evento == "alterar" || $this->sc_evento == "update" ) {	
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Please ensure the payment is completed before<br>submitting the membership application.";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_renew_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Please ensure the payment is completed before<br>submitting the membership application.";
 }
;
	} elseif ( $this->ds[0][0] != 'succeeded' ) {	
		
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "An error occurred during payment processing";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_renew_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "An error occurred during payment processing";
 }
;
	}
}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_doc_file != $this->doc_file || (isset($bFlagRead_doc_file) && $bFlagRead_doc_file)))
    {
    ...
    if (($original_pricing_level_id != $this->pricing_level_id || (isset($bFlagRead_pricing_level_id) && $bFlagRead_pricing_level_id)))
    {
        $this->ajax_return_values_pricing_level_id(true);
    }
}
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew_mob']['contr_erro'] = 'off'; 
      }
...
if (!isset($this->sc_temp_token)) {$this->sc_temp_token = (isset($_SESSION['token'])) ? $_SESSION['token'] : "";}
  if ( $this->sc_evento == "alterar" || $this->sc_evento == "update" ) {
	...
	$sql = "UPDATE sec_renewals SET applied = NOW() WHERE token = '".$this->sc_temp_token."'";
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_main_contact_email != $this->main_contact_email || (isset($bFlagRead_main_contact_email) && $bFlagRead_main_contact_email)))
    {
...
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_co_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['co_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['co_name'] == "on")) 
      { 
          if ($this->co_name == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_client_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Membership #: " . $this->Ini->Nm_lang['lang_errm_size']; 
    ...
    function ValidateField_mailing_address(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['mailing_address']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['mailing_address'] == "on")) 
      { 
    ...
    function ValidateField_city(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['city']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['city'] == "on")) 
      { 
          if ($this->city == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['pricing_level_id'])) {
       return;
               ...
               if (!empty($this->pricing_level_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_pricing_level_id']) && !in_array($this->pricing_level_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_pricing_level_id']))
               {
                   $hasError = true;
    ...
    function ValidateField_state(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['state']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['state'] == "on")) 
      { 
          if ($this->state == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['bus_cat_id'])) {
      ...
      if ($this->bus_cat_id == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['bus_cat_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['bus_cat_id'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->bus_cat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_cat_id']) && !in_array($this->bus_cat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_cat_id']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['bus_cat_id']))
    ...
    function ValidateField_zip_code(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      $this->nm_tira_mask($this->zip_code, "99999-9999", "(){}[].,;:-+/ "); 
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['zip_code']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['zip_code'] == "on")) 
      { 
          if ($this->zip_code == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['bus_subcat_id'])) {
      ...
      if ($this->bus_subcat_id == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['bus_subcat_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['bus_subcat_id'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->bus_subcat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_subcat_id']) && !in_array($this->bus_subcat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_subcat_id']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['bus_subcat_id']))
    ...
    function ValidateField_main_contact_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_name'] == "on")) 
      { 
    ...
    function ValidateField_main_contact_title(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_title']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_title'] == "on")) 
      { 
    ...
    function ValidateField_main_contact_phone(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      $this->nm_tira_mask($this->main_contact_phone, "(999) 999 - 9999", "(){}[].,;:-+/ "); 
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_phone']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_phone'] == "on")) 
      { 
    ...
    function ValidateField_main_contact_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_email'] == "on") 
          { 
              $hasError = true;
    ...
    function ValidateField_main_contact_img_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_img_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_img_id'] == "on")) 
      { 
          if (($this->main_contact_img_id == "" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_select']['main_contact_img_id'] == "") || "S" == $this->main_contact_img_id_limpa)
          { 
              $hasError = true;
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->main_contact_img_id && "S" != $this->main_contact_img_id_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_clients_steps_appn_stripe_renew_mob_doc_name.php';
                }
   ...
   if (isset($this->Field_no_validate['doc_type'])) {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['doc_type']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['doc_type'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_doc_file(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['doc_file']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['doc_file'] == "on")) 
      { 
          if (($this->doc_file == "" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_select']['doc_file'] == "") || "S" == $this->doc_file_limpa)
          { 
              $hasError = true;
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if ("" != $this->doc_file && "S" != $this->doc_file_limpa && !$teste_validade->ArqExtensao($this->doc_file, array('pdf', 'doc', 'docx', 'odt', 'ods', 'odp', 'jpg', 'jpeg', 'gif', 'tiff', 'png', 'xls', 'xlsx', 'bmp', 'svg')))
            {
                $hasError = true;
    ...
    function ValidateField_applicant_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['applicant_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['applicant_name'] == "on")) 
      { 
    ...
    function ValidateField_applicant_title(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['applicant_title']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['applicant_title'] == "on")) 
      { 
    ...
    function ValidateField_applicant_signature(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['applicant_signature']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['applicant_signature'] == "on") 
          { 
              $hasError = true;
    ...
    function ValidateField_js_strp_price_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->js_strp_price_id) > 150) 
          { 
              $hasError = true;
              $Campos_Crit .= "js_strp_price_id " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 150 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['js_strp_price_id']))
              {
                  $Campos_Erros['js_strp_price_id'] = array();
              }
              $Campos_Erros['js_strp_price_id'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 150 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['js_strp_price_id'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 150 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
...
//--------------------------------------------------------------------------------------
   function upload_img_doc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros, $filtro = '') 
   {
     ...
     if (!$this->wizard_go_forward || (is_array($filtro) && in_array('main_contact_img_id', $filtro))) {
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->nmgp_opcao == "incluir" && ($this->main_contact_img_id == "none" || ($this->main_contact_img_id == "" && $this->main_contact_img_id_salva == "")) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_img_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['main_contact_img_id'] == "on")) 
          { 
              $Campos_Falta[] = "Contact Driver<br>License or ID" ; 
              if (!isset($Campos_Erros['main_contact_img_id']))
              {
     ...
     if (!$this->wizard_go_forward || (is_array($filtro) && in_array('doc_file', $filtro))) {
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->nmgp_opcao == "incluir" && ($this->doc_file == "none" || ($this->doc_file == "" && $this->doc_file_salva == "")) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['doc_file']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['php_cmp_required']['doc_file'] == "on")) 
          { 
              $Campos_Falta[] = "Attachment:" ; 
              if (!isset($Campos_Erros['doc_file']))
              {
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_numero($this->memb_qty, $this->field_config['memb_qty']['symbol_grp']) ; 
      $this->Before_unformat['memb_status_id'] = $this->memb_status_id;
      nm_limpa_numero($this->memb_status_id, $this->field_config['memb_status_id']['symbol_grp']) ; 
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_memb_levels();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['client_id']['keyVal'] = form_clients_steps_appn_stripe_renew_mob_pack_protect_string($this->nmgp_dados_form['client_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['foreign_key']['client_id'] = $this->nmgp_dados_form['client_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['where_filter'] = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['where_detal']  = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_members_mob_script_case_init'] ]['form_members_mob']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_pricing_level_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_pricing_level_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_pricing_level_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_pricing_level_id'] = array(); 
}
$aLookup[] = array(form_clients_steps_appn_stripe_renew_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_renew_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_pricing_level_id'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_clients_steps_appn_stripe_renew_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_clients_steps_appn_stripe_renew_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_pricing_level_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pricing_level_id']['valList'][$i] = form_clients_steps_appn_stripe_renew_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_cat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_cat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_cat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_cat_id'] = array(); 
}
$aLookup[] = array(form_clients_steps_appn_stripe_renew_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_renew_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_cat_id'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_cat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_cat_id']['valList'][$i] = form_clients_steps_appn_stripe_renew_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_subcat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_subcat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_subcat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_subcat_id'] = array(); 
}
$aLookup[] = array(form_clients_steps_appn_stripe_renew_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_renew_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_subcat_id'][] = '';
if ($this->bus_cat_id != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_bus_subcat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_subcat_id']['valList'][$i] = form_clients_steps_appn_stripe_renew_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_dummy01($bForce = false)
   {
          ...
          //----- memb_levels
   function ajax_return_values_memb_levels($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("memb_levels", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->memb_levels);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['memb_levels'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$doc_filename]))
       {
           if ($this->NM_size_docs[$doc_filename] != filesize($this->Ini->root . $out_main_contact_img_id))
           {
              ...
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['download_filenames']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['download_filenames'] = array();
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['download_filenames'][$sTmpFile] = $this->main_contact_img_file;
          ...
          $this->NM_ajax_info['fldList']['main_contact_img_id'] = array(
               ...
               'docLink' => "<a href=\"javascript:nm_mostra_doc('documento_db', '" . substr($sTmpFile, 3) . "', 'form_clients_steps_appn_stripe_renew')\">" . $tmp_file_main_contact_img_id . "</a>",
...
$aLookup[] = array(form_clients_steps_appn_stripe_renew_mob_pack_protect_string('Active Secretary of State Registration') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_renew_mob_pack_protect_string("Active Secretary of State Registration")));
$aLookup[] = array(form_clients_steps_appn_stripe_renew_mob_pack_protect_string('City Business License') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_renew_mob_pack_protect_string("City Business License")));
$aLookup[] = array(form_clients_steps_appn_stripe_renew_mob_pack_protect_string('Agricultural License') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_renew_mob_pack_protect_string("Agricultural License")));
$aLookup[] = array(form_clients_steps_appn_stripe_renew_mob_pack_protect_string('Other type of document') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_renew_mob_pack_protect_string("Other type of document")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_doc_type'][] = 'Active Secretary of State Registration';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_doc_type'][] = 'City Business License';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_doc_type'][] = 'Agricultural License';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Lookup_doc_type'][] = 'Other type of document';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['doc_type']['valList'][$i] = form_clients_steps_appn_stripe_renew_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$doc_filename]))
       {
           if ($this->NM_size_docs[$doc_filename] != filesize($this->Ini->root . $out_doc_file))
           {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['download_filenames'][$sTmpFile] = $this->doc_filename;
          ...
          $this->NM_ajax_info['fldList']['doc_file'] = array(
               ...
               'docLink' => "<a href=\"javascript:nm_mostra_doc('documento_db', '" . substr($sTmpFile, 3) . "', 'form_clients_steps_appn_stripe_renew')\">" . $tmp_file_doc_file . "</a>",
   ...
   function ajax_return_values_est_memb_cost($bForce = false)
   {
          ...
          //----- rules
   function ajax_return_values_rules($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("rules", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->rules);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['rules'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_js_client_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Field_no_validate'] = array();
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew_mob']['contr_erro'] = 'on';
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_applicant_signature = $this->applicant_signature;
    $original_appn_date = $this->appn_date;
    $original_appn_note = $this->appn_note;
    $original_bus_cat_id = $this->bus_cat_id;
    $original_bus_subcat_id = $this->bus_subcat_id;
    $original_bus_subcat_other = $this->bus_subcat_other;
    $original_client_id = $this->client_id;
    $original_doc_file = $this->doc_file;
    $original_doc_type = $this->doc_type;
    $original_est_memb_cost = $this->est_memb_cost;
    $original_js_client_id = $this->js_client_id;
    $original_js_mbr_ct = $this->js_mbr_ct;
    $original_js_prod_price = $this->js_prod_price;
    $original_js_strp_price_id = $this->js_strp_price_id;
    $original_main_contact_img_id = $this->main_contact_img_id;
...
$this->main_contact_img_id_prev  = $this->main_contact_img_id ;	

$this->appn_date  = date('Y-m-d H:i:s');
$this->doc_type  = null;	
$this->doc_file  = 'add_new_doc.pdf';  
...
$sql = "SELECT Count(member_name) AS Ct " .
		"FROM members " .
		"WHERE client_id = " . $this->client_id  . " AND member_name = '" . trim($this->main_contact_name ) ."'";
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_applicant_signature != $this->applicant_signature || (isset($bFlagRead_applicant_signature) && $bFlagRead_applicant_signature)))
    {
        $this->ajax_return_values_applicant_signature(true);
    }
    if (($original_appn_date != $this->appn_date || (isset($bFlagRead_appn_date) && $bFlagRead_appn_date)))
    {
        $this->ajax_return_values_appn_date(true);
    }
    if (($original_appn_note != $this->appn_note || (isset($bFlagRead_appn_note) && $bFlagRead_appn_note)))
    {
    ...
    if (($original_doc_type != $this->doc_type || (isset($bFlagRead_doc_type) && $bFlagRead_doc_type)))
    {
    ...
    if (($original_main_contact_img_id != $this->main_contact_img_id || (isset($bFlagRead_main_contact_img_id) && $bFlagRead_main_contact_img_id)))
    {
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
  ...
  if ( $this->applicant_signature  == 'data:image/jsignature;base30,' ) {	
	
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= 'Signature Missing: Please complete the online application process by signing<br>with your mouse or input device.';
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_renew_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = 'Signature Missing: Please complete the online application process by signing<br>with your mouse or input device.';
 }
;
	if (isset($this->Campos_Mens_erro) && !empty($this->Campos_Mens_erro))
{
...
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "co_name = '$this->co_name', mailing_address = '$this->mailing_address', city = '$this->city', state = '$this->state', zip_code = '$this->zip_code', pricing_level_id = $this->pricing_level_id, acct_instagram = '$this->acct_instagram', acct_facebook = '$this->acct_facebook', website_url = '$this->website_url', bus_cat_id = $this->bus_cat_id, bus_subcat_id = $this->bus_subcat_id, bus_subcat_other = '$this->bus_subcat_other', appn_date = #$this->appn_date#, appn_note = '$this->appn_note', main_contact_name = '$this->main_contact_name', main_contact_phone = '$this->main_contact_phone', main_contact_email = '$this->main_contact_email', main_contact_title = '$this->main_contact_title', memb_qty = '$this->memb_qty', doc_type = '$this->doc_type', applicant_name = '$this->applicant_name', applicant_signature = '$this->applicant_signature', applicant_title = '$this->applicant_title'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "co_name = '$this->co_name', mailing_address = '$this->mailing_address', city = '$this->city', state = '$this->state', zip_code = '$this->zip_code', pricing_level_id = $this->pricing_level_id, acct_instagram = '$this->acct_instagram', acct_facebook = '$this->acct_facebook', website_url = '$this->website_url', bus_cat_id = $this->bus_cat_id, bus_subcat_id = $this->bus_subcat_id, bus_subcat_other = '$this->bus_subcat_other', appn_date = " . $this->Ini->date_delim . $this->appn_date . $this->Ini->date_delim1 . ", appn_note = '$this->appn_note', main_contact_name = '$this->main_contact_name', main_contact_phone = '$this->main_contact_phone', main_contact_email = '$this->main_contact_email', main_contact_title = '$this->main_contact_title', memb_qty = '$this->memb_qty', doc_type = '$this->doc_type', applicant_name = '$this->applicant_name', applicant_signature = '$this->applicant_signature', applicant_title = '$this->applicant_title'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "co_name = '$this->co_name', mailing_address = '$this->mailing_address', city = '$this->city', state = '$this->state', zip_code = '$this->zip_code', pricing_level_id = $this->pricing_level_id, acct_instagram = '$this->acct_instagram', acct_facebook = '$this->acct_facebook', website_url = '$this->website_url', bus_cat_id = $this->bus_cat_id, bus_subcat_id = $this->bus_subcat_id, bus_subcat_other = '$this->bus_subcat_other', appn_date = EXTEND('$this->appn_date', YEAR TO FRACTION), appn_note = '$this->appn_note', main_contact_name = '$this->main_contact_name', main_contact_phone = '$this->main_contact_phone', main_contact_email = '$this->main_contact_email', main_contact_title = '$this->main_contact_title', memb_qty = '$this->memb_qty', doc_type = '$this->doc_type', applicant_name = '$this->applicant_name', applicant_title = '$this->applicant_title'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $Prep_Tst = (isset($NM_val_form['memb_status_id']) && $NM_val_form['memb_status_id'] == "null"  && $this->nmgp_dados_select['memb_status_id'] == "") ? "null" : $this->nmgp_dados_select['memb_status_id'];
              if (isset($NM_val_form['memb_status_id']) && $NM_val_form['memb_status_id'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "memb_status_id = $this->memb_status_id"; 
              } 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Cache_wizard_form'] = array();
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['main_contact_img_id_salva'] = array(
                      'row'     => '',
              ...
              $this->nmgp_refresh_fields = array_diff(array('dummy02', 'dummy03', 'co_name', 'client_id', 'mailing_address', 'appn_date', 'city', 'pricing_level_id', 'state', 'bus_cat_id', 'zip_code', 'bus_subcat_id', 'website_url', 'bus_subcat_other', 'acct_instagram', 'acct_facebook', 'dummy01', 'memb_levels', 'dummy07', 'dummy08', 'main_contact_name', 'main_contact_title', 'main_contact_phone', 'main_contact_email', 'main_contact_img_id', 'doc_type', 'doc_file', 'appn_note', 'memb_list', 'est_memb_cost', 'rules', 'memb_qty', 'read_at_sign', 'applicant_name', 'applicant_title', 'applicant_signature', 'js_strp_price_id', 'js_prod_price', 'js_mbr_ct', 'js_client_id'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['Cache_wizard_form'] = array();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_members_mob->ini_controle();
              if ($this->form_members_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['reg_start'] = 0; 
              }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
  ...
  $sql = "INSERT INTO client_docs (doc_type, doc_file, doc_filename, doc_filesize, client_id) ".
		"SELECT doc_type, doc_file, doc_filename, doc_filesize, client_id ".
		"FROM clients ".
...
$sql = "INSERT INTO client_notes ( client_id, note, note_date, user ) " .
           "VALUES ( ". $this->client_id  . ", '" . $this->appn_note  . "', NOW(), 'Renewal')";
...
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_renew_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['parms'] = "client_id?#?$this->client_id?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['pay_now'] = $this->nmgp_botoes['pay_now'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['pmt_js'] = $this->nmgp_botoes['pmt_js'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->renewal_date = $rs->fields[22] ; 
              ...
              $this->expiration_date = $rs->fields[23] ; 
              ...
              $this->canceled = $rs->fields[24] ; 
              $this->nmgp_dados_select['canceled'] = $this->canceled;
              $this->cancel_date = $rs->fields[25] ; 
              ...
              $this->verified_receipts = $rs->fields[29] ; 
              $this->nmgp_dados_select['verified_receipts'] = $this->verified_receipts;
              $this->date_last_updated = $rs->fields[30] ; 
              ...
              $this->permanent_member_date = $rs->fields[46] ; 
              ...
              $this->appn_note = $rs->fields[54] ; 
              $this->nmgp_dados_select['appn_note'] = $this->appn_note;
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              { 
                  $this->doc_sec_of_state = $this->Db->BlobDecode($rs->fields[55]) ; 
              } 
              ...
              { 
                  ...
                  { 
                     $this->doc_sec_of_state = file_get_contents($rs->fields[55]);
                  }else 
                  { 
              ...
              { 
                  $this->doc_sec_of_state = $rs->fields[55] ; 
              } 
              $this->nmgp_dados_select['doc_sec_of_state'] = $this->doc_sec_of_state;
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              { 
                  $this->doc_city_bus_lic = $this->Db->BlobDecode($rs->fields[56]) ; 
              } 
              elseif ($this->Ini->nm_tpbanco == 'pdo_oracle')
              { 
                  $this->doc_city_bus_lic = $this->Db->BlobDecode($rs->fields[56]) ; 
              ...
              { 
                  ...
                  { 
                     $this->doc_city_bus_lic = file_get_contents($rs->fields[56]);
                  }else 
                  { 
              ...
              { 
                  $this->doc_city_bus_lic = $rs->fields[56] ; 
              } 
              $this->nmgp_dados_select['doc_city_bus_lic'] = $this->doc_city_bus_lic;
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              { 
                  $this->doc_agric_lic = $this->Db->BlobDecode($rs->fields[57]) ; 
              } 
              elseif ($this->Ini->nm_tpbanco == 'pdo_oracle')
              { 
                  $this->doc_agric_lic = $this->Db->BlobDecode($rs->fields[57]) ; 
              ...
              { 
                  ...
                  { 
                     $this->doc_agric_lic = file_get_contents($rs->fields[57]);
                  }else 
                  { 
                     $this->doc_agric_lic = ''; 
                  } 
              ...
              { 
                  $this->doc_agric_lic = $rs->fields[57] ; 
              } 
              $this->nmgp_dados_select['doc_agric_lic'] = $this->doc_agric_lic;
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              { 
                  $this->doc_last_year_tax = $this->Db->BlobDecode($rs->fields[58]) ; 
              } 
              elseif ($this->Ini->nm_tpbanco == 'pdo_oracle')
              { 
                  $this->doc_last_year_tax = $this->Db->BlobDecode($rs->fields[58]) ; 
              ...
              { 
                  ...
                  { 
                     $this->doc_last_year_tax = file_get_contents($rs->fields[58]);
                  }else 
                  { 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  if(isset($rs->fields[64]) && !empty($rs->fields[64]) && is_file($rs->fields[64])) 
                  { 
                     $this->main_contact_img_id = file_get_contents($rs->fields[64]);
                  }else 
                  { 
                     $this->main_contact_img_id = ''; 
                  } 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  if(isset($rs->fields[67]) && !empty($rs->fields[67]) && is_file($rs->fields[67])) 
                  { 
                     $this->main_contact_img_id_prev = file_get_contents($rs->fields[67]);
                  }else 
                  { 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  if(isset($rs->fields[70]) && !empty($rs->fields[70]) && is_file($rs->fields[70])) 
                  { 
                     $this->doc_file = file_get_contents($rs->fields[70]);
                  }else 
                  { 
                     $this->doc_file = ''; 
                  } 
              ...
              { 
                  ...
                  { 
                     $this->applicant_signature = file_get_contents($rs->fields[74]);
                  }else 
                  { 
                     $this->applicant_signature = ''; 
                  } 
              ...
              { 
                  $this->applicant_signature = $rs->fields[74] ; 
              } 
              $this->nmgp_dados_select['applicant_signature'] = $this->applicant_signature;
              $this->applicant_title = $rs->fields[75] ; 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['parms'] = "client_id?#?$this->client_id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['sub_dir'][0]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['sub_dir'][1]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['sub_dir'][2]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['sub_dir'][3]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['sub_dir'][4]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['reg_start'] < $qt_geral_reg_form_clients_steps_appn_stripe_renew_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_mob']['embutida_parms'] = "SC_glo_par_gv_members_ct*scingv_members_ct*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scout";
  }
// 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dados_select'];
...
// 
   function NM_gera_log_output() 
   {
       ...
       $prim_delim = "";
       $Log_labels = array();
       $Log_labels['memb_status_id'] =  "Memb Status Id";
       ...
       $Log_labels['appn_date'] =  "Renewal Date";
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$this->members_ct();
$this->sc_temp_gv_bus_cat = $this->bus_cat_id  ?? 0;
...
$modificado_pricing_level_id = $this->pricing_level_id;
...
$this->nm_formatar_campos('bus_cat_id', 'client_id', 'memb_qty', 'bus_subcat_id', 'est_memb_cost', 'pricing_level_id', 'js_prod_price', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id');
...
if ($original_pricing_level_id !== $modificado_pricing_level_id || isset($this->nmgp_cmp_readonly['pricing_level_id']) || (isset($bFlagRead_pricing_level_id) && $bFlagRead_pricing_level_id))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['dados_form']['pricing_level_id'] = $this->pricing_level_id;
    $this->ajax_return_values_pricing_level_id(true);
}
...
$this->nm_formatar_campos('client_id', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost', 'pricing_level_id', 'js_prod_price', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id', 'bus_subcat_other');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
$modificado_js_mbr_ct = $this->js_mbr_ct;
$modificado_js_client_id = $this->js_client_id;
$this->nm_formatar_campos('client_id', 'main_contact_email', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost', 'pricing_level_id', 'js_prod_price', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
$modificado_js_mbr_ct = $this->js_mbr_ct;
$modificado_js_client_id = $this->js_client_id;
$this->nm_formatar_campos('client_id', 'main_contact_name', 'applicant_name', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost', 'pricing_level_id', 'js_prod_price', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
$modificado_js_mbr_ct = $this->js_mbr_ct;
$modificado_js_client_id = $this->js_client_id;
$this->nm_formatar_campos('client_id', 'main_contact_phone', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost', 'pricing_level_id', 'js_prod_price', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
$modificado_js_mbr_ct = $this->js_mbr_ct;
$modificado_js_client_id = $this->js_client_id;
$this->nm_formatar_campos('applicant_title', 'main_contact_title', 'client_id', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost', 'pricing_level_id', 'js_prod_price', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id');
...
$modificado_js_mbr_ct = $this->js_mbr_ct;
$modificado_js_client_id = $this->js_client_id;
$this->nm_formatar_campos('client_id', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'est_memb_cost', 'pricing_level_id', 'js_prod_price', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
$est = "<p><span style='color:#727CF5; font-weight:bold;'>Thank you for renewing your Portland Flower Market Membership!</span><br><b>".$this->sc_temp_gv_descript.":</b> Based on the accurate information provided, the annual membership fee<br> for the <b>" . $bus_cat ."</b> (" . $bus_subcat . ") category with <span style='color:#8B0000; font-weight:bold;'>" . $this->sc_temp_gv_members_ct . "</span> member(s)<br>will be <b>$" . $memb_est_cost . " Per Year.</b><br><small>You will be notified if additional information is required. After the payment, you will receive confirmation along with further details.</small></p>";

$this->est_memb_cost  = $est;

$price_id = $this->sc_temp_gv_strp_id;	 
$this->js_strp_price_id  = $price_id;
$prod_price = $this->sc_temp_gv_membership_price;
$member_ct = $this->sc_temp_gv_members_ct;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['download_filenames'][$sTmpFile_main_contact_img_file] = $this->main_contact_img_file;
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['download_filenames'][$sTmpFile_doc_filename] = $this->doc_filename;
       ...
       if (isset($this->NM_size_docs[$doc_filename]))
       {
        ...
        $this->initFormPages();
        include_once("form_clients_steps_appn_stripe_renew_mob_form0.php");
        include_once("form_clients_steps_appn_stripe_renew_mob_form1.php");
        include_once("form_clients_steps_appn_stripe_renew_mob_form2.php");
        include_once("form_clients_steps_appn_stripe_renew_mob_form3.php");
        $this->hideFormPages();
 }
...
<?php
    ...
    function form_highlight_search_quicksearch(&$result, $field, $value)
    {
        ...
        elseif ($field == $this->nmgp_fast_search && in_array($field, array("co_name", "client_id", "mailing_address", "appn_date", "city", "pricing_level_id", "state", "bus_cat_id", "zip_code", "bus_subcat_id", "website_url", "bus_subcat_other", "acct_instagram", "acct_facebook", "main_contact_name", "main_contact_title", "main_contact_phone", "main_contact_email", "main_contact_img_id", "doc_type", "doc_file", "appn_note", "memb_list", "memb_qty", "applicant_name", "applicant_title", "applicant_signature"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "memb_qty") 
          {
              $this->SC_monta_condicao($comando, "memb_qty", $arg_search, $data_search, "VARCHAR", false);
          }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_clients_steps_appn_stripe_renew_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['total'] = $qt_geral_reg_form_clients_steps_appn_stripe_renew_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_clients_steps_appn_stripe_renew_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "client_id";$nm_numeric[] = "memb_status_id";$nm_numeric[] = "appn_id";$nm_numeric[] = "fresh_cut_allowed";$nm_numeric[] = "temporary_pass";$nm_numeric[] = "ofa_member";$nm_numeric[] = "restricted";$nm_numeric[] = "committee_approval_required";$nm_numeric[] = "archive";$nm_numeric[] = "pricing_level_id";$nm_numeric[] = "bus_cat_id";$nm_numeric[] = "bus_subcat_id";$nm_numeric[] = "qb_id";
      if (in_array($campo_join, $nm_numeric))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_doc_type($condicao, $campo)
   {
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values'] = array();
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['dummy02'] = $this->dummy02;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['dummy03'] = $this->dummy03;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['co_name'] = $this->co_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['client_id'] = $this->client_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['mailing_address'] = $this->mailing_address;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['appn_date'] = $this->appn_date;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['city'] = $this->city;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['pricing_level_id'] = $this->pricing_level_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['state'] = $this->state;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['bus_cat_id'] = $this->bus_cat_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['zip_code'] = $this->zip_code;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['bus_subcat_id'] = $this->bus_subcat_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['website_url'] = $this->website_url;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['bus_subcat_other'] = $this->bus_subcat_other;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['acct_instagram'] = $this->acct_instagram;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['acct_facebook'] = $this->acct_facebook;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['dummy01'] = $this->dummy01;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['memb_levels'] = $this->memb_levels;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['dummy07'] = $this->dummy07;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['dummy08'] = $this->dummy08;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['main_contact_name'] = $this->main_contact_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['main_contact_title'] = $this->main_contact_title;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['main_contact_phone'] = $this->main_contact_phone;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['main_contact_email'] = $this->main_contact_email;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['main_contact_img_id'] = $this->main_contact_img_id;
    }

    function wizard_loadFields_step_0()
    {
        $this->dummy02 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['dummy02'];
        $this->dummy03 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['dummy03'];
        $this->co_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['co_name'];
        $this->client_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['client_id'];
        $this->mailing_address = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['mailing_address'];
        $this->appn_date = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['appn_date'];
        $this->city = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['city'];
        $this->pricing_level_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['pricing_level_id'];
        $this->state = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['state'];
        $this->bus_cat_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['bus_cat_id'];
        $this->zip_code = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['zip_code'];
        $this->bus_subcat_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['bus_subcat_id'];
        $this->website_url = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['website_url'];
        $this->bus_subcat_other = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['bus_subcat_other'];
        $this->acct_instagram = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['acct_instagram'];
        $this->acct_facebook = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['acct_facebook'];
        $this->dummy01 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['dummy01'];
        $this->memb_levels = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['memb_levels'];
        $this->dummy07 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['dummy07'];
        $this->dummy08 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['dummy08'];
        $this->main_contact_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['main_contact_name'];
        $this->main_contact_title = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['main_contact_title'];
        $this->main_contact_phone = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['main_contact_phone'];
        $this->main_contact_email = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['main_contact_email'];
        $this->main_contact_img_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['main_contact_img_id'];
    }
    ...
    function wizard_returnValues_step_0()
    {
        ...
        $this->ajax_return_values_memb_levels(true);
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['doc_type'] = $this->doc_type;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['doc_file'] = $this->doc_file;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['appn_note'] = $this->appn_note;
    }

    function wizard_loadFields_step_1()
    {
        $this->doc_type = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['doc_type'];
        $this->doc_file = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['doc_file'];
        $this->appn_note = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['appn_note'];
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['memb_list'] = $this->memb_list;
    }

    function wizard_loadFields_step_2()
    {
        $this->memb_list = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['memb_list'];
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['est_memb_cost'] = $this->est_memb_cost;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['rules'] = $this->rules;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['memb_qty'] = $this->memb_qty;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['read_at_sign'] = $this->read_at_sign;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['applicant_name'] = $this->applicant_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['applicant_title'] = $this->applicant_title;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['applicant_signature'] = $this->applicant_signature;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['js_strp_price_id'] = $this->js_strp_price_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['js_prod_price'] = $this->js_prod_price;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['js_mbr_ct'] = $this->js_mbr_ct;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['js_client_id'] = $this->js_client_id;
    }

    function wizard_loadFields_step_3()
    {
        $this->est_memb_cost = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['est_memb_cost'];
        $this->rules = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['rules'];
        $this->memb_qty = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['memb_qty'];
        $this->read_at_sign = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['read_at_sign'];
        $this->applicant_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['applicant_name'];
        $this->applicant_title = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['applicant_title'];
        $this->applicant_signature = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['applicant_signature'];
        $this->js_strp_price_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['js_strp_price_id'];
        $this->js_prod_price = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['js_prod_price'];
        $this->js_mbr_ct = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['js_mbr_ct'];
        $this->js_client_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['field_values']['js_client_id'];
    }

    function wizard_returnValues_step_3()
    {
        $this->ajax_return_values_est_memb_cost(true);
        $this->ajax_return_values_rules(true);
        $this->ajax_return_values_memb_qty(true);
...
<?php
    ...
    {
        if ($stepNo < $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['actual_step']) {
            return 'sc-ui-form-step-done';
        } elseif ($stepNo == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['actual_step']) {
            return 'sc-ui-form-step-now';
        } elseif ($stepNo == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['form_wizard']['actual_step'] + 1) {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_clients_steps_appn_stripe_renew_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_clients_steps_appn_stripe_renew_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_mob']['reg_start'] = "";
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_mob']['total']);
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "bstepretorna":
                return array("sc_b_stepret_b.sc-unique-btn-1");
                break;
            case "bstepavanca":
                return array("sc_b_stepavc_b.sc-unique-btn-2");
                break;
            case "pmt_js":
                return array("sc_pmt_js_bot");
                break;
            case "update":
            ...
            case "btn_exit_app":
                ...
                break;
            case "exit":
                return array("sc_b_sai_b.sc-unique-btn-4", "sc_b_sai_b.sc-unique-btn-9");
                break;
            case "first":
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<table width="100%" height="67px" class="scFormHeader">
        ...
        <td width="67px" class="scFormHeaderFont"><?php if ($this->Ini->Export_img_zip) {$this->Ini->Img_export_zip[] = $this->Ini->root . $this->Ini->path_imag_cab . '/grp__NM__bg__NM__pfm_logo_small.png';echo '<IMG SRC="grp__NM__bg__NM__pfm_logo_small.png';}else{ echo '<IMG SRC="' . $this->Ini->path_imag_cab  . '/grp__NM__bg__NM__pfm_logo_small.png';}?>" BORDER="0"/></td>
               ...
               <td align="right" class="scFormHeaderFont"><span  id="lin1_col2"><?php echo "<b>Buyer's Pass Online Renewal Application</b>" ?></span><br /><span id="lin2_col2">
<?php
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_renew_mob']['ordem_ord'] == " desc") {
