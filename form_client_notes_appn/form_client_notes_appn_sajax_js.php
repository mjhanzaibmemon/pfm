  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_client_notes_appn" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_client_notes_appn_form();
        }
...
?>
  ...
  // ---------- Validate note_date_
  function do_ajax_form_client_notes_appn_validate_note_date_(iNumLinha)
  {
    var nomeCampo_note_date_ = "note_date_" + iNumLinha;
    var var_note_date_ = scAjaxGetFieldHidden(nomeCampo_note_date_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_notes_appn_validate_note_date_(var_note_date_, iNumLinha, var_script_case_init, do_ajax_form_client_notes_appn_validate_note_date__cb);
  } // do_ajax_form_client_notes_appn_validate_note_date_

  function do_ajax_form_client_notes_appn_validate_note_date__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "note_date_" + iLineNumber;
    }
    else
    {
      sFieldValid = "note_date_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "note_date_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "note_date_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_notes_appn_validate_note_date__cb

  // ---------- Validate note_
  function do_ajax_form_client_notes_appn_validate_note_(iNumLinha)
  {
    var nomeCampo_note_ = "note_" + iNumLinha;
    var var_note_ = scAjaxGetFieldText(nomeCampo_note_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_notes_appn_validate_note_(var_note_, iNumLinha, var_script_case_init, do_ajax_form_client_notes_appn_validate_note__cb);
  } // do_ajax_form_client_notes_appn_validate_note_

  function do_ajax_form_client_notes_appn_validate_note__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_notes_appn_validate_note__cb

  // ---------- Validate notes_id_
  function do_ajax_form_client_notes_appn_validate_notes_id_(iNumLinha)
  {
    var nomeCampo_notes_id_ = "notes_id_" + iNumLinha;
    var var_notes_id_ = scAjaxGetFieldHidden(nomeCampo_notes_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_notes_appn_validate_notes_id_(var_notes_id_, iNumLinha, var_script_case_init, do_ajax_form_client_notes_appn_validate_notes_id__cb);
  } // do_ajax_form_client_notes_appn_validate_notes_id_

  function do_ajax_form_client_notes_appn_validate_notes_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "notes_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "notes_id_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "notes_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "notes_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_notes_appn_validate_notes_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_client_notes_appn_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_client_notes_appn_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_client_notes_appn_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_client_notes_appn_add_new_line_cb);
  } // do_ajax_form_client_notes_appn_add_new_line

  function do_ajax_form_client_notes_appn_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_form_client_notes_appn_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_client_notes_appn_backup_line(iNumLinha)
  {
    var var_notes_id_ = scAjaxGetFieldHidden("notes_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_notes_appn_backup_line(var_notes_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_client_notes_appn_backup_line_cb);
  } // do_ajax_form_client_notes_appn_backup_line

  function do_ajax_form_client_notes_appn_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_client_notes_appn_backup_line_cb

  function do_ajax_form_client_notes_appn_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_client_notes_appn_cancel_insert

  function do_ajax_form_client_notes_appn_cancel_update(iSeqVert)
  {
    do_ajax_form_client_notes_appn_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_client_notes_appn_cancel_update

  function do_ajax_form_client_notes_appn_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_client_notes_appn_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_client_notes_appn_table_refresh()
  {
    var var_notes_id_ = document.F2.notes_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_client_notes_appn_table_refresh(var_notes_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_client_notes_appn_table_refresh_cb);
  } //  do_ajax_form_client_notes_appn_table_refresh

  function do_ajax_form_client_notes_appn_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.notes_id_.value = scAjaxGetKeyValue("notes_id_");
    ...
    scAjaxAlert(do_ajax_form_client_notes_appn_table_refresh_cb_after_alert);
  } // do_ajax_form_client_notes_appn_table_refresh_cb
  function do_ajax_form_client_notes_appn_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_client_notes_appn_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_client_notes_appn_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_client_notes_appn_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_note_date_ = scAjaxGetFieldHidden("note_date_" + iNumLinha);
...
?>
    x_ajax_form_client_notes_appn_submit_form(var_note_date_, var_note_, var_notes_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_client_notes_appn_submit_form_cb);
  } // do_ajax_form_client_notes_appn_submit_form

  function do_ajax_form_client_notes_appn_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("note_date_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("note_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("notes_id_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_client_notes_appn_submit_form_cb_after_alert);
  } // do_ajax_form_client_notes_appn_submit_form_cb
  function do_ajax_form_client_notes_appn_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_client_notes_appn_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_client_notes_appn_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_client_notes_appn_navigate_form, function() {});
    } else {
      perform_ajax_form_client_notes_appn_navigate_form();
    }
  }

  function perform_ajax_form_client_notes_appn_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_client_notes_appn_cancel_insert(sc_form_client_notes_appn_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("note_date_" + iNavForm);
      scAjaxHideErrorDisplay("note_" + iNavForm);
      scAjaxHideErrorDisplay("notes_id_" + iNavForm);
    }
    var var_notes_id_ = document.F2.notes_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_client_notes_appn_navigate_form(var_notes_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_client_notes_appn_navigate_form_cb);
  } // do_ajax_form_client_notes_appn_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_notes_appn']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_client_notes_appn_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.notes_id_.value = scAjaxGetKeyValue("notes_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_client_notes_appn_navigate_form_cb_after_alert);
  } // do_ajax_form_client_notes_appn_navigate_form_cb
  function do_ajax_form_client_notes_appn_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_client_notes_appn_navigate_form_cb_after_alert

    function sc_form_client_notes_appn_get_last_line_number()
    {
    ...
    } //sc_form_client_notes_appn_get_last_line_number

  function sc_hide_form_client_notes_appn_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "note_date_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "note_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "notes_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["note_date_" + iNumLinha] = {"label": "Date<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ...
    ajax_error_list["notes_id_" + iNumLinha] = {"label": "Notes Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["note_date_"][iNumLinha] = "note_date_" + iNumLinha;
    ajax_field_mult["note_"][iNumLinha] = "note_" + iNumLinha;
    ajax_field_mult["notes_id_"][iNumLinha] = "notes_id_" + iNumLinha;
    ajax_field_id["note_date_" + iNumLinha] = new Array("hidden_field_label_note_date_", "hidden_field_data_note_date_" + iNumLinha);
    ajax_field_id["note_" + iNumLinha] = new Array("hidden_field_label_note_", "hidden_field_data_note_" + iNumLinha);
    ajax_error_count["note_date_" + iNumLinha] = "off";
    ajax_error_count["note_" + iNumLinha] = "off";
    ajax_error_count["notes_id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["note_date_" + iNumLinha] = "off";
    ajax_read_only["note_" + iNumLinha] = "off";
    ajax_read_only["notes_id_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["note_date_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["note_date_" + iNumLinha] = null;
    ajax_error_list["note_" + iNumLinha] = null;
    ajax_error_list["notes_id_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["note_date_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["note_date_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["note_date_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["note_date_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["note_date_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["notes_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["notes_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["notes_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["notes_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["notes_id_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['note_date_'])) ? $this->nmgp_cmp_readonly['note_date_'] : 'off';
?>
    scAjaxFieldRead("note_date_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['notes_id_'])) ? $this->nmgp_cmp_readonly['notes_id_'] : 'on';
?>
    scAjaxFieldRead("notes_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("note_date_" + iSeq, "on");
    scAjaxFieldRead("note_" + iSeq, "on");
    scAjaxFieldRead("notes_id_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["note_date_" + iRow] || "on" == ajax_error_count["note_" + iRow] || "on" == ajax_error_count["notes_id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_note_date_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_note_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_notes_id_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["note_date_" + iRow] && "off" == ajax_error_count["note_" + iRow] && "off" == ajax_error_count["notes_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["note_date_" + iRow] = "off";
        ajax_error_count["note_" + iRow] = "off";
        ajax_error_count["notes_id_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_note_date_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_note_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_notes_id_" + iRow).removeClass("scFormErrorLine");
    }
  }
