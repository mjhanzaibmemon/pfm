...
function scEventControl_init(iSeqRow) {
  scEventControl_data["note_date_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["note_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["notes_id_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}

function scEventControl_active(iSeqRow) {
  if (scEventControl_data["note_date_" + iSeqRow] && scEventControl_data["note_date_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["note_date_" + iSeqRow] && scEventControl_data["note_date_" + iSeqRow]["change"]) {
    return true;
  }
  ...
  if (scEventControl_data["notes_id_" + iSeqRow] && scEventControl_data["notes_id_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["notes_id_" + iSeqRow] && scEventControl_data["notes_id_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_notes_id_' + iSeqRow).bind('blur', function() { sc_form_client_notes_appn_notes_id__onblur('#id_sc_field_notes_id_' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_client_notes_appn_notes_id__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_client_notes_appn_notes_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_client_id_' + iSeqRow).bind('change', function() { sc_form_client_notes_appn_client_id__onchange(this, iSeqRow) });
  $('#id_sc_field_note_' + iSeqRow).bind('blur', function() { sc_form_client_notes_appn_note__onblur('#id_sc_field_note_' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_form_client_notes_appn_note__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_client_notes_appn_note__onfocus(this, iSeqRow) });
  $('#id_sc_field_note_date_' + iSeqRow).bind('blur', function() { sc_form_client_notes_appn_note_date__onblur('#id_sc_field_note_date_' + iSeqRow, iSeqRow) })
                                        .bind('change', function() { sc_form_client_notes_appn_note_date__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_client_notes_appn_note_date__onfocus(this, iSeqRow) });
  $('#id_sc_field_user_' + iSeqRow).bind('change', function() { sc_form_client_notes_appn_user__onchange(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_client_notes_appn_notes_id__onblur(oThis, iSeqRow) {
  do_ajax_form_client_notes_appn_validate_notes_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_client_notes_appn_notes_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_client_notes_appn_notes_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_client_notes_appn_client_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_notes_appn_note__onblur(oThis, iSeqRow) {
  do_ajax_form_client_notes_appn_validate_note_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_client_notes_appn_note__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_client_notes_appn_note__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_client_notes_appn_note_date__onblur(oThis, iSeqRow) {
  do_ajax_form_client_notes_appn_validate_note_date_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_client_notes_appn_note_date__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_client_notes_appn_note_date__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_client_notes_appn_user__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_block_0(status) {
        displayChange_field("note_date_", "", status);
        displayChange_field("note_", "", status);
}

function displayChange_row(row, status) {
        displayChange_field_note_date_(row, status);
        displayChange_field_note_(row, status);
        displayChange_field_notes_id_(row, status);
}
...
function displayChange_field_note_date_(row, status) {
    var fieldId;
}
...
function displayChange_field_notes_id_(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
        $("#id_form_client_notes_appn_form" + pageNo).hide();
}
...
{
    $.ajax({
        url: "form_client_notes_appn.php",
        dataType: "json",
        method: "POST",
        data: {
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_client_notes_appn')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
