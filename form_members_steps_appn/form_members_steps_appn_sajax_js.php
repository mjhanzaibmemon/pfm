  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_members_steps_appn" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_members_steps_appn_form();
        }
...
?>
  ...
  // ---------- Validate member_name_
  function do_ajax_form_members_steps_appn_validate_member_name_(iNumLinha)
  {
    var nomeCampo_member_name_ = "member_name_" + iNumLinha;
    var var_member_name_ = scAjaxGetFieldText(nomeCampo_member_name_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_steps_appn_validate_member_name_(var_member_name_, iNumLinha, var_script_case_init, do_ajax_form_members_steps_appn_validate_member_name__cb);
  } // do_ajax_form_members_steps_appn_validate_member_name_

  function do_ajax_form_members_steps_appn_validate_member_name__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "member_name_" + iLineNumber;
    }
    else
    {
      sFieldValid = "member_name_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "member_name_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "member_name_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_steps_appn_validate_member_name__cb

  // ---------- Validate main_contact_
  function do_ajax_form_members_steps_appn_validate_main_contact_(iNumLinha)
  {
    var nomeCampo_main_contact_ = "main_contact_" + iNumLinha;
    var var_main_contact_ = scAjaxGetFieldSelect(nomeCampo_main_contact_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_steps_appn_validate_main_contact_(var_main_contact_, iNumLinha, var_script_case_init, do_ajax_form_members_steps_appn_validate_main_contact__cb);
  } // do_ajax_form_members_steps_appn_validate_main_contact_

  function do_ajax_form_members_steps_appn_validate_main_contact__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "main_contact_" + iLineNumber;
    }
    else
    {
      sFieldValid = "main_contact_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "main_contact_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "main_contact_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_steps_appn_validate_main_contact__cb

  // ---------- Validate phone1_
  function do_ajax_form_members_steps_appn_validate_phone1_(iNumLinha)
  {
    var nomeCampo_phone1_ = "phone1_" + iNumLinha;
    var var_phone1_ = scAjaxGetFieldText(nomeCampo_phone1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_steps_appn_validate_phone1_(var_phone1_, iNumLinha, var_script_case_init, do_ajax_form_members_steps_appn_validate_phone1__cb);
  } // do_ajax_form_members_steps_appn_validate_phone1_

  function do_ajax_form_members_steps_appn_validate_phone1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "phone1_" + iLineNumber;
    }
    else
    {
      sFieldValid = "phone1_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "phone1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "phone1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_steps_appn_validate_phone1__cb

  // ---------- Validate email_
  function do_ajax_form_members_steps_appn_validate_email_(iNumLinha)
  {
    var nomeCampo_email_ = "email_" + iNumLinha;
    var var_email_ = scAjaxGetFieldText(nomeCampo_email_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_steps_appn_validate_email_(var_email_, iNumLinha, var_script_case_init, do_ajax_form_members_steps_appn_validate_email__cb);
  } // do_ajax_form_members_steps_appn_validate_email_

  function do_ajax_form_members_steps_appn_validate_email__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_steps_appn_validate_email__cb

  // ---------- Validate driver_lic_id_
  function do_ajax_form_members_steps_appn_validate_driver_lic_id_(iNumLinha)
  {
    var nomeCampo_driver_lic_id_ = "driver_lic_id_" + iNumLinha;
    var var_driver_lic_id_ = scAjaxGetFieldText(nomeCampo_driver_lic_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_steps_appn_validate_driver_lic_id_(var_driver_lic_id_, iNumLinha, var_script_case_init, do_ajax_form_members_steps_appn_validate_driver_lic_id__cb);
  } // do_ajax_form_members_steps_appn_validate_driver_lic_id_

  function do_ajax_form_members_steps_appn_validate_driver_lic_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "driver_lic_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "driver_lic_id_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "driver_lic_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "driver_lic_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_steps_appn_validate_driver_lic_id__cb

  // ---------- Validate note_
  function do_ajax_form_members_steps_appn_validate_note_(iNumLinha)
  {
    var nomeCampo_note_ = "note_" + iNumLinha;
    var var_note_ = scAjaxGetFieldText(nomeCampo_note_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_steps_appn_validate_note_(var_note_, iNumLinha, var_script_case_init, do_ajax_form_members_steps_appn_validate_note__cb);
  } // do_ajax_form_members_steps_appn_validate_note_

  function do_ajax_form_members_steps_appn_validate_note__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "note_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "note_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_members_steps_appn_validate_note__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_members_steps_appn_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_members_steps_appn_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_members_steps_appn_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_members_steps_appn_add_new_line_cb);
  } // do_ajax_form_members_steps_appn_add_new_line

  function do_ajax_form_members_steps_appn_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    eval("var_ajax_img_driver_lic_id_" + iAjaxNewLine + " = '';");
    scFixCol_loadState();
  } // do_ajax_form_members_steps_appn_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_members_steps_appn_backup_line(iNumLinha)
  {
    var var_member_id_ = scAjaxGetFieldText("member_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_members_steps_appn_backup_line(var_member_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_members_steps_appn_backup_line_cb);
  } // do_ajax_form_members_steps_appn_backup_line

  function do_ajax_form_members_steps_appn_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_members_steps_appn_backup_line_cb

  function do_ajax_form_members_steps_appn_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_members_steps_appn_cancel_insert

  function do_ajax_form_members_steps_appn_cancel_update(iSeqVert)
  {
    do_ajax_form_members_steps_appn_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_members_steps_appn_cancel_update

  function do_ajax_form_members_steps_appn_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_members_steps_appn_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_members_steps_appn_table_refresh()
  {
    var var_member_id_ = document.F2.member_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_members_steps_appn_table_refresh(var_member_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_members_steps_appn_table_refresh_cb);
  } //  do_ajax_form_members_steps_appn_table_refresh

  function do_ajax_form_members_steps_appn_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.member_id_.value = scAjaxGetKeyValue("member_id_");
    ...
    scAjaxAlert(do_ajax_form_members_steps_appn_table_refresh_cb_after_alert);
  } // do_ajax_form_members_steps_appn_table_refresh_cb
  function do_ajax_form_members_steps_appn_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_members_steps_appn_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_members_steps_appn_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_members_steps_appn_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_member_name_ = scAjaxGetFieldText("member_name_" + iNumLinha);
    var var_main_contact_ = scAjaxGetFieldSelect("main_contact_" + iNumLinha);
    var var_phone1_ = scAjaxGetFieldText("phone1_" + iNumLinha);
    var var_email_ = scAjaxGetFieldText("email_" + iNumLinha);
    var var_driver_lic_id_ = scAjaxGetFieldText("driver_lic_id_" + iNumLinha);
    var var_note_ = scAjaxGetFieldText("note_" + iNumLinha);
    var var_driver_lic_id__ul_name = scAjaxSpecCharProtect(eval('document.F1.driver_lic_id__ul_name' + iNumLinha + '.value'));
    var var_driver_lic_id__ul_type = eval('document.F1.driver_lic_id__ul_type' + iNumLinha + '.value');
    var var_driver_lic_id__limpa = eval('document.F1.driver_lic_id__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_members_steps_appn_submit_form(var_member_name_, var_main_contact_, var_phone1_, var_email_, var_driver_lic_id_, var_note_, var_driver_lic_id__ul_name, var_driver_lic_id__ul_type, var_driver_lic_id__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_members_steps_appn_submit_form_cb);
  } // do_ajax_form_members_steps_appn_submit_form

  function do_ajax_form_members_steps_appn_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("member_name_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("main_contact_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("phone1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("email_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("driver_lic_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("note_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
<?php
        ...
        {
?>
          if (document.F1.elements["driver_lic_id__limpa" + sc_num_ult_line] && document.F1.elements["driver_lic_id__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldImage("driver_lic_id_" + sc_num_ult_line, oImgTemp, "", "", "", "N");
            document.F1.elements["driver_lic_id__limpa" + sc_num_ult_line].checked = false;
          }
<?php
        }
?>
      }
      eval("if (document.F1.driver_lic_id__ul_name" + sc_num_ult_line + ") document.F1.driver_lic_id__ul_name" + sc_num_ult_line + ".value = ''");
      eval("if (document.F1.driver_lic_id__ul_type" + sc_num_ult_line + ") document.F1.driver_lic_id__ul_type" + sc_num_ult_line + ".value = ''");
    }
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_members_steps_appn_submit_form_cb_after_alert);
  } // do_ajax_form_members_steps_appn_submit_form_cb
  function do_ajax_form_members_steps_appn_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_members_steps_appn_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_members_steps_appn_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_members_steps_appn_navigate_form, function() {});
    } else {
      perform_ajax_form_members_steps_appn_navigate_form();
    }
  }

  function perform_ajax_form_members_steps_appn_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_members_steps_appn_cancel_insert(sc_form_members_steps_appn_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("member_name_" + iNavForm);
      scAjaxHideErrorDisplay("main_contact_" + iNavForm);
      scAjaxHideErrorDisplay("phone1_" + iNavForm);
      scAjaxHideErrorDisplay("email_" + iNavForm);
      scAjaxHideErrorDisplay("driver_lic_id_" + iNavForm);
      scAjaxHideErrorDisplay("note_" + iNavForm);
    }
    var var_member_id_ = document.F2.member_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_members_steps_appn_navigate_form(var_member_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_members_steps_appn_navigate_form_cb);
  } // do_ajax_form_members_steps_appn_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_members_steps_appn_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.member_id_.value = scAjaxGetKeyValue("member_id_" + var_last_index);
    ...
    {
      eval("if (document.F1.driver_lic_id__ul_name" + iImg + ") document.F1.driver_lic_id__ul_name" + iImg + ".value = ''");
      eval("if (document.F1.driver_lic_id__ul_type" + iImg + ") document.F1.driver_lic_id__ul_type" + iImg + ".value = ''");
    }
    scAjaxSetBtnVars();
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_members_steps_appn_navigate_form_cb_after_alert);
  } // do_ajax_form_members_steps_appn_navigate_form_cb
  function do_ajax_form_members_steps_appn_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_members_steps_appn_navigate_form_cb_after_alert

    function sc_form_members_steps_appn_get_last_line_number()
    {
    ...
    } //sc_form_members_steps_appn_get_last_line_number

  function sc_hide_form_members_steps_appn_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "member_name_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "main_contact_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "phone1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "email_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "driver_lic_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "note_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["member_name_" + iNumLinha] = {"label": "Member Name<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["main_contact_" + iNumLinha] = {"label": "Main Contact<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["phone1_" + iNumLinha] = {"label": "Phone<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["email_" + iNumLinha] = {"label": "Email<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["driver_lic_id_" + iNumLinha] = {"label": "Driver Lic/ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["note_" + iNumLinha] = {"label": "Note<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["member_name_"][iNumLinha] = "member_name_" + iNumLinha;
    ajax_field_mult["main_contact_"][iNumLinha] = "main_contact_" + iNumLinha;
    ajax_field_mult["phone1_"][iNumLinha] = "phone1_" + iNumLinha;
    ajax_field_mult["email_"][iNumLinha] = "email_" + iNumLinha;
    ajax_field_mult["driver_lic_id_"][iNumLinha] = "driver_lic_id_" + iNumLinha;
    ajax_field_mult["note_"][iNumLinha] = "note_" + iNumLinha;
    ajax_field_id["member_name_" + iNumLinha] = new Array("hidden_field_label_member_name_", "hidden_field_data_member_name_" + iNumLinha);
    ajax_field_id["main_contact_" + iNumLinha] = new Array("hidden_field_label_main_contact_", "hidden_field_data_main_contact_" + iNumLinha);
    ajax_field_id["phone1_" + iNumLinha] = new Array("hidden_field_label_phone1_", "hidden_field_data_phone1_" + iNumLinha);
    ajax_field_id["email_" + iNumLinha] = new Array("hidden_field_label_email_", "hidden_field_data_email_" + iNumLinha);
    ajax_field_id["driver_lic_id_" + iNumLinha] = new Array("hidden_field_label_driver_lic_id_", "hidden_field_data_driver_lic_id_" + iNumLinha);
    ajax_field_id["note_" + iNumLinha] = new Array("hidden_field_label_note_", "hidden_field_data_note_" + iNumLinha);
    ajax_error_count["member_name_" + iNumLinha] = "off";
    ajax_error_count["main_contact_" + iNumLinha] = "off";
    ajax_error_count["phone1_" + iNumLinha] = "off";
    ajax_error_count["email_" + iNumLinha] = "off";
    ajax_error_count["driver_lic_id_" + iNumLinha] = "off";
    ajax_error_count["note_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["member_name_" + iNumLinha] = "off";
    ajax_read_only["main_contact_" + iNumLinha] = "off";
    ajax_read_only["phone1_" + iNumLinha] = "off";
    ajax_read_only["email_" + iNumLinha] = "off";
    ajax_read_only["driver_lic_id_" + iNumLinha] = "off";
    ajax_read_only["note_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["member_name_" + iNumLinha] = "on";
    ajax_read_only["main_contact_" + iNumLinha] = "on";
    ajax_read_only["phone1_" + iNumLinha] = "on";
    ajax_read_only["email_" + iNumLinha] = "on";
    ajax_read_only["driver_lic_id_" + iNumLinha] = "on";
    ajax_read_only["note_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["member_name_" + iNumLinha] = null;
    ajax_error_list["main_contact_" + iNumLinha] = null;
    ajax_error_list["phone1_" + iNumLinha] = null;
    ajax_error_list["email_" + iNumLinha] = null;
    ajax_error_list["driver_lic_id_" + iNumLinha] = null;
    ajax_error_list["note_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "member_name_": new Array(),
    "main_contact_": new Array(),
    "phone1_": new Array(),
    "email_": new Array(),
    "driver_lic_id_": new Array(),
    "note_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["member_name_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["member_name_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["member_name_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["member_name_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["member_name_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["main_contact_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["main_contact_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["main_contact_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["main_contact_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["main_contact_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["phone1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["phone1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["phone1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["phone1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["phone1_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["driver_lic_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["driver_lic_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["driver_lic_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["driver_lic_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["driver_lic_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["note_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["note_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["note_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["note_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["note_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['member_name_'])) ? $this->nmgp_cmp_readonly['member_name_'] : 'off';
?>
    scAjaxFieldRead("member_name_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['main_contact_'])) ? $this->nmgp_cmp_readonly['main_contact_'] : 'off';
?>
    scAjaxFieldRead("main_contact_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['phone1_'])) ? $this->nmgp_cmp_readonly['phone1_'] : 'off';
?>
    scAjaxFieldRead("phone1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['driver_lic_id_'])) ? $this->nmgp_cmp_readonly['driver_lic_id_'] : 'off';
?>
    scAjaxFieldRead("driver_lic_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['note_'])) ? $this->nmgp_cmp_readonly['note_'] : 'off';
?>
    scAjaxFieldRead("note_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("member_name_" + iSeq, "on");
    scAjaxFieldRead("main_contact_" + iSeq, "on");
    scAjaxFieldRead("phone1_" + iSeq, "on");
    scAjaxFieldRead("email_" + iSeq, "on");
    scAjaxFieldRead("driver_lic_id_" + iSeq, "on");
    scAjaxFieldRead("note_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["member_name_" + iRow] || "on" == ajax_error_count["main_contact_" + iRow] || "on" == ajax_error_count["phone1_" + iRow] || "on" == ajax_error_count["email_" + iRow] || "on" == ajax_error_count["driver_lic_id_" + iRow] || "on" == ajax_error_count["note_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_member_name_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_main_contact_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_phone1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_email_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_driver_lic_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_note_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["member_name_" + iRow] && "off" == ajax_error_count["main_contact_" + iRow] && "off" == ajax_error_count["phone1_" + iRow] && "off" == ajax_error_count["email_" + iRow] && "off" == ajax_error_count["driver_lic_id_" + iRow] && "off" == ajax_error_count["note_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["member_name_" + iRow] = "off";
        ajax_error_count["main_contact_" + iRow] = "off";
        ajax_error_count["phone1_" + iRow] = "off";
        ajax_error_count["email_" + iRow] = "off";
        ajax_error_count["driver_lic_id_" + iRow] = "off";
        ajax_error_count["note_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_member_name_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_main_contact_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_phone1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_email_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_driver_lic_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_note_" + iRow).removeClass("scFormErrorLine");
    }
  }
