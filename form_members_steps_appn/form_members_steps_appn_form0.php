<?php
class form_members_steps_appn_form extends form_members_steps_appn_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['sc_redir_atualiz'] == 'ok')
{
?>
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_members_steps_appn/form_members_steps_appn_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_members_steps_appn_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_members_steps_appn_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['link_info']['remove_border']) {
...
<?php
 include_once("form_members_steps_appn_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_members_steps_appn'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_members_steps_appn'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
?>
   ...
   <?php
    $sStyleHidden_driver_lic_id_ = '';
    if (isset($this->nmgp_cmp_hidden['driver_lic_id_']) && $this->nmgp_cmp_hidden['driver_lic_id_'] == 'off') {
        $sStyleHidden_driver_lic_id_ = 'display: none';
    }
    if (1 || !isset($this->nmgp_cmp_hidden['driver_lic_id_']) || $this->nmgp_cmp_hidden['driver_lic_id_'] == 'on') {
        if (!isset($this->nm_new_label['driver_lic_id_'])) {
            $this->nm_new_label['driver_lic_id_'] = "Driver Lic/ID";
        }
        $SC_Label = "" . $this->nm_new_label['driver_lic_id_']  . "";
        $label_fieldName = nl2br($SC_Label);

        // label & order
        $divLabelStyle = '; justify-content: left';
        $fieldSortRule = $this->scGetColumnOrderRule("driver_lic_id", $orderColName, $orderColOrient, $orderColRule);
        $fieldSortIcon = $this->scGetColumnOrderIcon("driver_lic_id", $fieldSortRule);
        ...
        $label_labelContent = "<a href=\"javascript:nm_move('ordem', 'driver_lic_id')\" class=\"scFormLabelLink scFormLabelLinkOddMult\">" . $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_driver_lic_id__label sc-col-title <?php echo $classColFld ?>" id="hidden_field_label_driver_lic_id_" style="<?php echo $sStyleHidden_driver_lic_id_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_members_steps_appn);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_members_steps_appn = $this->form_vert_form_members_steps_appn;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_members_steps_appn))
   {
       $sc_seq_vert = 0;
   }
   foreach ($this->form_vert_form_members_steps_appn as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       $this->loadRecordState($sc_seq_vert);
       $this->member_id_ = $this->form_vert_form_members_steps_appn[$sc_seq_vert]['member_id_'];
       $this->client_id_ = $this->form_vert_form_members_steps_appn[$sc_seq_vert]['client_id_'];
       $this->include_ = $this->form_vert_form_members_steps_appn[$sc_seq_vert]['include_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           ...
           $this->nmgp_cmp_readonly['driver_lic_id_'] = true;
       ...
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['driver_lic_id_']) || $this->nmgp_cmp_readonly['driver_lic_id_'] != "on") {$this->nmgp_cmp_readonly['driver_lic_id_'] = false;}
        ...
        $this->member_name_ = $this->form_vert_form_members_steps_appn[$sc_seq_vert]['member_name_']; 
       ...
       $this->main_contact_ = $this->form_vert_form_members_steps_appn[$sc_seq_vert]['main_contact_']; 
       ...
       $this->phone1_ = $this->form_vert_form_members_steps_appn[$sc_seq_vert]['phone1_']; 
       ...
       $this->email_ = $this->form_vert_form_members_steps_appn[$sc_seq_vert]['email_']; 
       $email_ = $this->email_; 
       $sStyleHidden_email_ = '';
       ...
       $this->driver_lic_id_ = $this->form_vert_form_members_steps_appn[$sc_seq_vert]['driver_lic_id_']; 
       $driver_lic_id_ = $this->driver_lic_id_; 
       $this->driver_lic_id__limpa = $this->form_vert_form_members_steps_appn[$sc_seq_vert]['driver_lic_id__limpa']; 
       $driver_lic_id__limpa = $this->driver_lic_id__limpa; 
       $sStyleHidden_driver_lic_id_ = '';
       if (isset($sCheckRead_driver_lic_id_))
       {
           unset($sCheckRead_driver_lic_id_);
       }
       if (isset($this->nmgp_cmp_readonly['driver_lic_id_']))
       {
           $sCheckRead_driver_lic_id_ = $this->nmgp_cmp_readonly['driver_lic_id_'];
       }
       if (isset($this->nmgp_cmp_hidden['driver_lic_id_']) && $this->nmgp_cmp_hidden['driver_lic_id_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['driver_lic_id_']);
           $sStyleHidden_driver_lic_id_ = 'display: none;';
       }
       $bTestReadOnly_driver_lic_id_ = true;
       $sStyleReadLab_driver_lic_id_ = 'display: none;';
       $sStyleReadInp_driver_lic_id_ = '';
       if (isset($this->nmgp_cmp_readonly['driver_lic_id_']) && $this->nmgp_cmp_readonly['driver_lic_id_'] == 'on')
       {
           $bTestReadOnly_driver_lic_id_ = false;
           unset($this->nmgp_cmp_readonly['driver_lic_id_']);
           $sStyleReadLab_driver_lic_id_ = '';
           $sStyleReadInp_driver_lic_id_ = 'display: none;';
       }
       $this->note_ = $this->form_vert_form_members_steps_appn[$sc_seq_vert]['note_']; 
       $note_ = $this->note_; 
       $sStyleHidden_note_ = '';
       ...
       { 
           $out_driver_lic_id_ = $this->driver_lic_id_;  
       } 
...
<input type="hidden" name="driver_lic_id__ul_name<?php echo $sc_seq_vert; ?>" id="id_sc_field_driver_lic_id__ul_name<?php echo $sc_seq_vert; ?>" value="<?php echo $this->form_encode_input($this->driver_lic_id__ul_name);?>">
<input type="hidden" name="driver_lic_id__ul_type<?php echo $sc_seq_vert; ?>" id="id_sc_field_driver_lic_id__ul_type<?php echo $sc_seq_vert; ?>" value="<?php echo $this->form_encode_input($this->driver_lic_id__ul_type);?>">
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_members_steps_appn_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_members_steps_appn_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_members_steps_appn_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_members_steps_appn_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_members_steps_appn_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_members_steps_appn_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
 </TD>
   <?php 
       $this->form_fixed_column_no++;
}?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['Lookup_main_contact_'][] = '1'; ?>
 <option  value="0" <?php  if ($this->main_contact_ == "0") { echo " selected" ;} ?><?php  if (empty($this->main_contact_)) { echo " selected" ;} ?>>--</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['Lookup_main_contact_'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php }?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['driver_lic_id_']) && $this->nmgp_cmp_hidden['driver_lic_id_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="driver_lic_id_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($driver_lic_id_) . "\">"; ?>
<?php } else { $sc_hidden_no++; 
       $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>

    <TD class="scFormDataOddMult css_driver_lic_id__line <?php echo $classColFld ?>" id="hidden_field_data_driver_lic_id_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_driver_lic_id_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_driver_lic_id__line" style="vertical-align: top;padding: 0px">
 <?php $this->NM_ajax_info['varList'][] = array("var_ajax_img_driver_lic_id_" . $sc_seq_vert . "" => $out1_driver_lic_id_); ?><script>var var_ajax_img_driver_lic_id_<?php echo $sc_seq_vert; ?> = '<?php echo $out1_driver_lic_id_; ?>';</script><input type="hidden" name="temp_out_driver_lic_id_" value="<?php echo $this->form_encode_input($out_driver_lic_id_); ?>" /><input type="hidden" name="temp_out1_driver_lic_id_" value="<?php echo $this->form_encode_input($out1_driver_lic_id_); ?>" /><?php if (!empty($out_driver_lic_id_)){ echo "<a id=\"id_ajax_link_driver_lic_id_" . $sc_seq_vert . "\" href=\"javascript:nm_mostra_img(var_ajax_img_driver_lic_id_" . $sc_seq_vert . ", '" . $this->nmgp_return_img['driver_lic_id_'][0] . "', '" . $this->nmgp_return_img['driver_lic_id_'][1] . "')\">" . $this->Ini->Nm_lang['lang_othr_show_imgg'] . "</a>"; if (!empty($driver_lic_id_)){ echo "<br>";} } ?><br>
<?php if ($bTestReadOnly_driver_lic_id_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["driver_lic_id_"]) &&  $this->nmgp_cmp_readonly["driver_lic_id_"] == "on") { 

 ?>
<img id=\"driver_lic_id_<?php echo $sc_seq_vert ?><?php echo $sc_seq_vert; ?>_img_uploading\" style=\"display: none\" border=\"0\" src=\"" . $this->Ini->path_icones . "/scriptcase__NM__ajax_load.gif\" align=\"absmiddle\" /><input type="hidden" name="driver_lic_id_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($driver_lic_id_) . "\">" . $driver_lic_id_ . ""; ?>
<?php } else { ?>
<span id="id_read_off_driver_lic_id_<?php echo $sc_seq_vert ?>" class="css_read_off_driver_lic_id_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_driver_lic_id_; ?>"><span style="display:inline-block"><span id="sc-id-upload-select-driver_lic_id_<?php echo $sc_seq_vert ?>" class="fileinput-button fileinput-button-padding scButton_default">
 <span><?php echo $this->Ini->Nm_lang['lang_select_file'] ?></span>

 <input class="sc-js-input scFormObjectOddMult css_driver_lic_id__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" type="file" name="driver_lic_id_<?php echo $sc_seq_vert ?>[]" id="id_sc_field_driver_lic_id_<?php echo $sc_seq_vert ?>" onchange="<?php if ($this->nmgp_opcao == "novo") {echo "if (document.F1.elements['sc_check_vert[" . $sc_seq_vert . "]']) { document.F1.elements['sc_check_vert[" . $sc_seq_vert . "]'].checked = true }"; }?>"></span></span>
<?php
   $sCheckInsert = "";
...
?>
<span id="chk_ajax_img_driver_lic_id_<?php echo $sc_seq_vert; ?>"<?php if ($this->nmgp_opcao == "novo" || empty($driver_lic_id_)) { echo " style=\"display: none\""; } ?>> <input type=checkbox name="driver_lic_id__limpa<?php echo $sc_seq_vert ?>" value="<?php echo $driver_lic_id__limpa . '" '; if ($driver_lic_id__limpa == "S"){echo "checked ";} ?> onclick="this.value = ''; if (this.checked){ this.value = 'S'};<?php echo $sCheckInsert ?>"><?php echo $this->Ini->Nm_lang['lang_btns_dele_hint']; ?> &nbsp;</span><img id="driver_lic_id_<?php echo $sc_seq_vert ?><?php echo $sc_seq_vert; ?>_img_uploading" style="display: none" border="0" src="<?php echo $this->Ini->path_icones; ?>/scriptcase__NM__ajax_load.gif" align="absmiddle" /><div id="id_img_loader_driver_lic_id_<?php echo $sc_seq_vert; ?>" class="progress progress-success progress-striped active scProgressBarStart" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" style="display: none"><div class="bar scProgressBarLoading">&nbsp;</div></div><img id="id_ajax_loader_driver_lic_id_<?php echo $sc_seq_vert; ?>" src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ajax_load.gif" style="display: none" /></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_driver_lic_id_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_driver_lic_id_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php $this->form_fixed_column_no++; ?>
<?php }?>
...
<?php   
       ...
       if (isset($sCheckRead_driver_lic_id_))
       {
           $this->nmgp_cmp_readonly['driver_lic_id_'] = $sCheckRead_driver_lic_id_;
       }
       if ('display: none;' == $sStyleHidden_driver_lic_id_)
       {
           $this->nmgp_cmp_hidden['driver_lic_id_'] = 'off';
       }
       if (isset($sCheckRead_note_))
       {
   ...
   { 
       ...
       $this->form_vert_form_members_steps_appn = $guarda_form_vert_form_members_steps_appn;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['last'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['btn_label']['exit'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_members_steps_appn");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_members_steps_appn");
 parent.scAjaxDetailHeight("form_members_steps_appn", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
        ...
        function scBtnFn_sys_format_inc() {
                if ($("#sc_b_new_b.sc-unique-btn-5").length && $("#sc_b_new_b.sc-unique-btn-5").is(":visible")) {
                    if ($("#sc_b_new_b.sc-unique-btn-5").hasClass("disabled")) {
                        ...
                        do_ajax_form_members_steps_appn_add_new_line(); return false;
                         return;
                }
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_members_steps_appn']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
