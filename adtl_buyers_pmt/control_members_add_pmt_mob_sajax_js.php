  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_members_add_pmt_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_control_members_add_pmt_mob_form();
        }
...
?>
  ...
  // ---------- Validate bus_name
  function do_ajax_control_members_add_pmt_mob_validate_bus_name()
  {
    var nomeCampo_bus_name = "bus_name";
    var var_bus_name = scAjaxGetFieldHidden(nomeCampo_bus_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_pmt_mob_validate_bus_name(var_bus_name, var_script_case_init, do_ajax_control_members_add_pmt_mob_validate_bus_name_cb);
  } // do_ajax_control_members_add_pmt_mob_validate_bus_name

  function do_ajax_control_members_add_pmt_mob_validate_bus_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_pmt_mob_validate_bus_name_cb

  // ---------- Validate cat
  function do_ajax_control_members_add_pmt_mob_validate_cat()
  {
    var nomeCampo_cat = "cat";
    var var_cat = scAjaxGetFieldHidden(nomeCampo_cat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_pmt_mob_validate_cat(var_cat, var_script_case_init, do_ajax_control_members_add_pmt_mob_validate_cat_cb);
  } // do_ajax_control_members_add_pmt_mob_validate_cat

  function do_ajax_control_members_add_pmt_mob_validate_cat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_pmt_mob_validate_cat_cb

  // ---------- Validate sub_cat
  function do_ajax_control_members_add_pmt_mob_validate_sub_cat()
  {
    var nomeCampo_sub_cat = "sub_cat";
    var var_sub_cat = scAjaxGetFieldHidden(nomeCampo_sub_cat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_pmt_mob_validate_sub_cat(var_sub_cat, var_script_case_init, do_ajax_control_members_add_pmt_mob_validate_sub_cat_cb);
  } // do_ajax_control_members_add_pmt_mob_validate_sub_cat

  function do_ajax_control_members_add_pmt_mob_validate_sub_cat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sub_cat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_pmt_mob_validate_sub_cat_cb

  // ---------- Validate dummy02
  function do_ajax_control_members_add_pmt_mob_validate_dummy02()
  {
  } // do_ajax_control_members_add_pmt_mob_validate_dummy02

  function do_ajax_control_members_add_pmt_mob_validate_dummy02_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy02";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_pmt_mob_validate_dummy02_cb

  // ---------- Validate membs_num
  function do_ajax_control_members_add_pmt_mob_validate_membs_num()
  {
    var nomeCampo_membs_num = "membs_num";
    var var_membs_num = scAjaxGetFieldHidden(nomeCampo_membs_num);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_pmt_mob_validate_membs_num(var_membs_num, var_script_case_init, do_ajax_control_members_add_pmt_mob_validate_membs_num_cb);
  } // do_ajax_control_members_add_pmt_mob_validate_membs_num

  function do_ajax_control_members_add_pmt_mob_validate_membs_num_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_pmt_mob_validate_membs_num_cb

  // ---------- Validate total
  function do_ajax_control_members_add_pmt_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_pmt_mob_validate_total(var_total, var_script_case_init, do_ajax_control_members_add_pmt_mob_validate_total_cb);
  } // do_ajax_control_members_add_pmt_mob_validate_total

  function do_ajax_control_members_add_pmt_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_pmt_mob_validate_total_cb

  // ---------- Validate dummy01
  function do_ajax_control_members_add_pmt_mob_validate_dummy01()
  {
  } // do_ajax_control_members_add_pmt_mob_validate_dummy01

  function do_ajax_control_members_add_pmt_mob_validate_dummy01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dummy01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_pmt_mob_validate_dummy01_cb

  // ---------- Event onchange membs_num
  function do_ajax_control_members_add_pmt_mob_event_membs_num_onchange()
  {
    var var_cat = scAjaxGetFieldHidden("cat");
    var var_membs_num = scAjaxGetFieldHidden("membs_num");
    var var_total = scAjaxGetFieldHidden("total");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_members_add_pmt_mob_event_membs_num_onchange(var_cat, var_membs_num, var_total, var_script_case_init, do_ajax_control_members_add_pmt_mob_event_membs_num_onchange_cb);
  } // do_ajax_control_members_add_pmt_mob_event_membs_num_onchange

  function do_ajax_control_members_add_pmt_mob_event_membs_num_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "membs_num";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_members_add_pmt_mob_event_membs_num_onchange_cb_after_alert);
  } // do_ajax_control_members_add_pmt_mob_event_membs_num_onchange_cb
  function do_ajax_control_members_add_pmt_mob_event_membs_num_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_members_add_pmt_mob_event_membs_num_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_members_add_pmt_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_members_add_pmt_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_members_add_pmt_mob_submit_form(var_bus_name, var_cat, var_sub_cat, var_dummy02, var_membs_num, var_total, var_dummy01, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_members_add_pmt_mob_submit_form_cb);
  } // do_ajax_control_members_add_pmt_mob_submit_form

  function do_ajax_control_members_add_pmt_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_members_add_pmt_mob_submit_form_cb_after_alert);
  } // do_ajax_control_members_add_pmt_mob_submit_form_cb
  function do_ajax_control_members_add_pmt_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_members_add_pmt_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_members_add_pmt_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_members_add_pmt_mob_navigate_form, function() {});
    } else {
      perform_ajax_control_members_add_pmt_mob_navigate_form();
    }
  }

  function perform_ajax_control_members_add_pmt_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_members_add_pmt_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_members_add_pmt_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_members_add_pmt_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_members_add_pmt_mob_navigate_form_cb
  function do_ajax_control_members_add_pmt_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_control_members_add_pmt_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_members_add_pmt_mob_navigate_form_cb_after_alert

  function sc_hide_control_members_add_pmt_mob_form()
  {
  ...
  ajax_field_list[0] = "bus_name";
  ajax_field_list[1] = "cat";
  ajax_field_list[2] = "sub_cat";
  ajax_field_list[3] = "dummy02";
  ajax_field_list[4] = "membs_num";
  ajax_field_list[5] = "total";
  ajax_field_list[6] = "dummy01";
  ...
  var ajax_error_list = {
    "bus_name": {"label": "Business name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cat": {"label": "Category", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sub_cat": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "dummy02": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "membs_num": {"label": "Additional buyers", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
