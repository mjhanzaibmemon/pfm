...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>adtl_buyers_pmt/control_members_add_pmt_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_members_add_pmt_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('control_members_add_pmt_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['link_info']['remove_border']) {
...
<?php
 include_once("control_members_add_pmt_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_members_add_pmt'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_members_add_pmt'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['empty_filter'] = true;
       }
  }
?>
<?php $sc_hidden_no = 1; $sc_hidden_yes = 0; ?>
   <a name="bloco_0"></a>
   <table width="100%" height="100%" cellpadding="0" cellspacing=0 class="scBlockRow scBlockRowFirst"><tr valign="top"><td width="50%" height="">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_membs_num_label" id="hidden_field_label_membs_num" style="<?php echo $sStyleHidden_membs_num; ?>"><span id="id_label_membs_num"><?php echo $this->nm_new_label['membs_num']; ?></span></TD>
    <TD class="scFormDataOdd css_membs_num_line" id="hidden_field_data_membs_num" style="<?php echo $sStyleHidden_membs_num; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_membs_num_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="membs_num" value="<?php echo $this->form_encode_input($membs_num); ?>"><span id="id_ajax_label_membs_num"><?php echo nl2br($membs_num); ?></span>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_members_add_pmt");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_members_add_pmt");
 parent.scAjaxDetailHeight("control_members_add_pmt", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_pmt']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
