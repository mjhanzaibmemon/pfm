<?php
//
class form_clients_steps_appn_stripe_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (!isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['Cache_wizard_form']) || (isset($_POST['rs']) && strpos($_POST['rs'], '_navigate_form'))) {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['Cache_wizard_form'] = array();
      }
      foreach ($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['Cache_wizard_form'] as $nmgp_var => $nmgp_val) {
          ...
          foreach ($_POST as $nmgp_var => $nmgp_val)
          {
              ...
              if ($nmgp_var == "nmgp_parms" && substr($nmgp_val, 0, 8) == "@SC_par@")
              {
               ...
               if (in_array($nmgp_var, $List_cmps)) {
                   $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['Cache_wizard_form'][$nmgp_var] = $nmgp_val;
               }
          }
      }
      if (!empty($_GET))
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_clients_steps_appn_stripe($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['opc_ant']);
          }
          if (isset($this->gv_contact_pfm)) 
          {
              $_SESSION['gv_contact_pfm'] = $this->gv_contact_pfm;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_clients_steps_appn_stripe_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['initialize'])
          {
              $_SESSION['scriptcase']['form_clients_steps_appn_stripe']['contr_erro'] = 'on';
  echo "<script>
...
$_SESSION['scriptcase']['form_clients_steps_appn_stripe']['contr_erro'] = 'off';
          }
          $this->Ini->init2();
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['upload_field_info']['main_contact_img_id'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['upload_field_info']['doc_file'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe']['upload_field_info']['more_buyers_xlsx'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_steps_appn_stripe']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_steps_appn_stripe'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_clients_steps_appn_stripe') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe']['label'] = "PFM - Buyers Pass App";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_clients_steps_appn_stripe")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_clients_steps_appn_stripe']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_clients_steps_appn_stripe'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['table_refresh'] = false;

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard'])) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard'] = array();
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['actual_step']) || $this->nmgp_opcao  == "novo" || $this->nmgp_opcao  == "incluir") {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['actual_step'] = 0;
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['total_steps'] = 4;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_field_ul_name'][$this->doc_file_ul_name]))
          {
              $this->NM_ajax_info['param']['doc_file_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_field_ul_name'][$this->doc_file_ul_name];
          }
      ...
      elseif (isset($this->doc_file_ul_name) && '' != $this->doc_file_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_field_ul_name'][$this->doc_file_ul_name]))
          {
              $this->doc_file_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_field_ul_name'][$this->doc_file_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->NM_ajax_info['param']['main_contact_img_id_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      elseif (isset($this->main_contact_img_id_ul_name) && '' != $this->main_contact_img_id_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->main_contact_img_id_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_steps_appn_stripe'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_steps_appn_stripe'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_clients_steps_appn_stripe", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_clients_steps_appn_stripe_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_clients_steps_appn_stripe_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'new_memb_app/form_clients_steps_appn_stripe_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_clients_steps_appn_stripe_erro.class.php"); 
      }
      $this->Erro      = new form_clients_steps_appn_stripe_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao']))
         { 
             if ($this->client_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'] = "novo";
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['pmt_js'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['botoes']['pmt_js'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['total']);
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_clients_steps_appn_stripe']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_clients_steps_appn_stripe']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Gera_log_access'] = false;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_clients_steps_appn_stripe_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
        ...
        if ($this->wizard_change_step) {
            ...
            if (!$this->wizard_go_forward) {
                ...
                $wizardData['action'] = 'change_step';
                $wizardData['next_step'] = $this->wizard_step_goto;
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['actual_step'] = $this->wizard_step_goto;
            }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_clients_steps_appn_stripe.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="form_clients_steps_appn_stripe_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_clients_steps_appn_stripe"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe']) || !is_array($this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe']))
              {
                  $this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
 ...
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe';
...
$_SESSION['scriptcase']['form_clients_steps_appn_stripe']['contr_erro'] = 'off'; 
   ...
   if (isset($this->Field_no_validate['pricing_level_id'])) {
       return;
               ...
               if (!empty($this->pricing_level_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_pricing_level_id']) && !in_array($this->pricing_level_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_pricing_level_id']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['bus_cat_id'])) {
       return;
               ...
               if (!empty($this->bus_cat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_cat_id']) && !in_array($this->bus_cat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_cat_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['bus_subcat_id'])) {
       return;
               ...
               if (!empty($this->bus_subcat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_subcat_id']) && !in_array($this->bus_subcat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_subcat_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->main_contact_img_id && "S" != $this->main_contact_img_id_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_clients_steps_appn_stripe_doc_name.php';
                }
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['client_id']['keyVal'] = form_clients_steps_appn_stripe_pack_protect_string($this->nmgp_dados_form['client_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['foreign_key']['client_id'] = $this->nmgp_dados_form['client_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['where_filter'] = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['where_detal']  = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_members_app_script_case_init'] ]['form_members_app']['total']);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_pricing_level_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_pricing_level_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_pricing_level_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_pricing_level_id'] = array(); 
}
$aLookup[] = array(form_clients_steps_appn_stripe_pack_protect_string('') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_pricing_level_id'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_clients_steps_appn_stripe_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_clients_steps_appn_stripe_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_pricing_level_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pricing_level_id']['valList'][$i] = form_clients_steps_appn_stripe_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_cat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_cat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_cat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_cat_id'] = array(); 
}
$aLookup[] = array(form_clients_steps_appn_stripe_pack_protect_string('') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_cat_id'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_cat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_cat_id']['valList'][$i] = form_clients_steps_appn_stripe_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_subcat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_subcat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_subcat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_subcat_id'] = array(); 
}
$aLookup[] = array(form_clients_steps_appn_stripe_pack_protect_string('') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_subcat_id'][] = '';
if ($this->bus_cat_id != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_bus_subcat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_subcat_id']['valList'][$i] = form_clients_steps_appn_stripe_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_clients_steps_appn_stripe_pack_protect_string('Active Secretary of State Registration') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_pack_protect_string("Active Secretary of State Registration")));
$aLookup[] = array(form_clients_steps_appn_stripe_pack_protect_string('City Business License') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_pack_protect_string("City Business License")));
$aLookup[] = array(form_clients_steps_appn_stripe_pack_protect_string('Agricultural License') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_pack_protect_string("Agricultural License")));
$aLookup[] = array(form_clients_steps_appn_stripe_pack_protect_string('Other type of document') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_pack_protect_string("Other type of document")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_doc_type'][] = 'Active Secretary of State Registration';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_doc_type'][] = 'City Business License';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_doc_type'][] = 'Agricultural License';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_doc_type'][] = 'Other type of document';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['doc_type']['valList'][$i] = form_clients_steps_appn_stripe_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_applicant_signature($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Field_no_validate'] = array();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->client_id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opcao'] = '';
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Cache_wizard_form'] = array();
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['doc_file_salva'] = array(
                      'row'     => '',
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total']);
              }
              ...
              $this->NM_gera_log_new();
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Cache_wizard_form'] = array();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
...
$_SESSION['scriptcase']['form_clients_steps_appn_stripe']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['parms'] = "client_id?#?$this->client_id?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dados_select'] = $this->nmgp_dados_select;
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$main_contact_img_file]))
       {
        ...
        $this->initFormPages();
        include_once("form_clients_steps_appn_stripe_form0.php");
        include_once("form_clients_steps_appn_stripe_form1.php");
        include_once("form_clients_steps_appn_stripe_form2.php");
        include_once("form_clients_steps_appn_stripe_form3.php");
        $this->hideFormPages();
 }
...
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_clients_steps_appn_stripe = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total'] = $qt_geral_reg_form_clients_steps_appn_stripe;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_clients_steps_appn_stripe_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_doc_type($condicao, $campo)
   {
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values'] = array();
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy02'] = $this->dummy02;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy03'] = $this->dummy03;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['co_name'] = $this->co_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['client_id'] = $this->client_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['mailing_address'] = $this->mailing_address;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['appn_date'] = $this->appn_date;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['city'] = $this->city;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['pricing_level_id'] = $this->pricing_level_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['state'] = $this->state;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['bus_cat_id'] = $this->bus_cat_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['zip_code'] = $this->zip_code;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['bus_subcat_id'] = $this->bus_subcat_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['website_url'] = $this->website_url;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['bus_subcat_other'] = $this->bus_subcat_other;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['acct_facebook'] = $this->acct_facebook;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['acct_instagram'] = $this->acct_instagram;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy04'] = $this->dummy04;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy05'] = $this->dummy05;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['memb_levels'] = $this->memb_levels;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy07'] = $this->dummy07;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy08'] = $this->dummy08;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['main_contact_name'] = $this->main_contact_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['main_contact_phone'] = $this->main_contact_phone;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['main_contact_email'] = $this->main_contact_email;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['main_contact_title'] = $this->main_contact_title;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['main_contact_img_id'] = $this->main_contact_img_id;
    }

    function wizard_loadFields_step_0()
    {
        $this->dummy02 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy02'];
        $this->dummy03 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy03'];
        $this->co_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['co_name'];
        $this->client_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['client_id'];
        $this->mailing_address = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['mailing_address'];
        $this->appn_date = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['appn_date'];
        $this->city = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['city'];
        $this->pricing_level_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['pricing_level_id'];
        $this->state = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['state'];
        $this->bus_cat_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['bus_cat_id'];
        $this->zip_code = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['zip_code'];
        $this->bus_subcat_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['bus_subcat_id'];
        $this->website_url = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['website_url'];
        $this->bus_subcat_other = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['bus_subcat_other'];
        $this->acct_facebook = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['acct_facebook'];
        $this->acct_instagram = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['acct_instagram'];
        $this->dummy04 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy04'];
        $this->dummy05 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy05'];
        $this->memb_levels = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['memb_levels'];
        $this->dummy07 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy07'];
        $this->dummy08 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['dummy08'];
        $this->main_contact_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['main_contact_name'];
        $this->main_contact_phone = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['main_contact_phone'];
        $this->main_contact_email = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['main_contact_email'];
        $this->main_contact_title = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['main_contact_title'];
        $this->main_contact_img_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['main_contact_img_id'];
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['doc_type'] = $this->doc_type;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['doc_file'] = $this->doc_file;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['appn_note'] = $this->appn_note;
    }

    function wizard_loadFields_step_1()
    {
        $this->doc_type = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['doc_type'];
        $this->doc_file = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['doc_file'];
        $this->appn_note = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['appn_note'];
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['memb_list'] = $this->memb_list;
    }

    function wizard_loadFields_step_2()
    {
        $this->memb_list = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['memb_list'];
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['est_memb_cost'] = $this->est_memb_cost;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['rules'] = $this->rules;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['memb_qty'] = $this->memb_qty;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['read_at_sign'] = $this->read_at_sign;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['applicant_name'] = $this->applicant_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['applicant_title'] = $this->applicant_title;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['js_strp_price_id'] = $this->js_strp_price_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['js_prod_price'] = $this->js_prod_price;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['js_mbr_ct'] = $this->js_mbr_ct;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['js_client_id'] = $this->js_client_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['applicant_signature'] = $this->applicant_signature;
    }

    function wizard_loadFields_step_3()
    {
        $this->est_memb_cost = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['est_memb_cost'];
        $this->rules = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['rules'];
        $this->memb_qty = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['memb_qty'];
        $this->read_at_sign = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['read_at_sign'];
        $this->applicant_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['applicant_name'];
        $this->applicant_title = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['applicant_title'];
        $this->js_strp_price_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['js_strp_price_id'];
        $this->js_prod_price = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['js_prod_price'];
        $this->js_mbr_ct = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['js_mbr_ct'];
        $this->js_client_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['js_client_id'];
        $this->applicant_signature = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['field_values']['applicant_signature'];
    }
...
<?php
    ...
    {
        if ($stepNo < $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['actual_step']) {
            return 'sc-ui-form-step-done';
        } elseif ($stepNo == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['actual_step']) {
            return 'sc-ui-form-step-now';
        } elseif ($stepNo == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['actual_step'] + 1) {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_clients_steps_appn_stripe_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_clients_steps_appn_stripe_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['masterValue']))
{
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['ordem_ord'] == " desc") {
