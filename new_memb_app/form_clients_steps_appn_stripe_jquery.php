...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_client_id' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_client_id_onblur('#id_sc_field_client_id' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_clients_steps_appn_stripe_client_id_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_clients_steps_appn_stripe_client_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_memb_status_id' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_status_id_onchange(this, iSeqRow) });
  $('#id_sc_field_co_name' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_co_name_onblur('#id_sc_field_co_name' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_clients_steps_appn_stripe_co_name_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_clients_steps_appn_stripe_co_name_onfocus(this, iSeqRow) });
  $('#id_sc_field_ofa_contact' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_ofa_contact_onchange(this, iSeqRow) });
  $('#id_sc_field_street_address' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_street_address_onchange(this, iSeqRow) });
  $('#id_sc_field_mailing_address' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_mailing_address_onblur('#id_sc_field_mailing_address' + iSeqRow, iSeqRow) })
                                             .bind('change', function() { sc_form_clients_steps_appn_stripe_mailing_address_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_city' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_city_onblur('#id_sc_field_city' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_clients_steps_appn_stripe_city_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_state' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_state_onblur('#id_sc_field_state' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_form_clients_steps_appn_stripe_state_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_zip_code' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_zip_code_onblur('#id_sc_field_zip_code' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_clients_steps_appn_stripe_zip_code_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_clients_steps_appn_stripe_zip_code_onfocus(this, iSeqRow) });
  $('#id_sc_field_phone_number' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_phone_number_onchange(this, iSeqRow) });
  $('#id_sc_field_home_phone' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_home_phone_onchange(this, iSeqRow) });
  $('#id_sc_field_fax_number' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_fax_number_onchange(this, iSeqRow) });
  $('#id_sc_field_email' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_email_onchange(this, iSeqRow) });
  $('#id_sc_field_business_type' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_business_type_onchange(this, iSeqRow) });
  $('#id_sc_field_fresh_cut_allowed' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_fresh_cut_allowed_onchange(this, iSeqRow) });
  $('#id_sc_field_business_license' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_business_license_onchange(this, iSeqRow) });
  $('#id_sc_field_nursery_license' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_nursery_license_onchange(this, iSeqRow) });
  $('#id_sc_field_federal_tax_id' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_federal_tax_id_onchange(this, iSeqRow) });
  $('#id_sc_field_temporary_pass' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_temporary_pass_onchange(this, iSeqRow) });
  $('#id_sc_field_ofa_member' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_ofa_member_onchange(this, iSeqRow) });
  $('#id_sc_field_starting_date' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_starting_date_onchange(this, iSeqRow) });
  $('#id_sc_field_renewal_date' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_renewal_date_onchange(this, iSeqRow) });
  $('#id_sc_field_expiration_date' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_expiration_date_onchange(this, iSeqRow) });
  $('#id_sc_field_canceled' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_canceled_onchange(this, iSeqRow) });
  $('#id_sc_field_cancel_date' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_cancel_date_onchange(this, iSeqRow) });
  $('#id_sc_field_canceled_by' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_canceled_by_onchange(this, iSeqRow) });
  $('#id_sc_field_reason_canceled' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_reason_canceled_onchange(this, iSeqRow) });
  $('#id_sc_field_retire_date' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_retire_date_onchange(this, iSeqRow) });
  $('#id_sc_field_verified_receipts' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_verified_receipts_onchange(this, iSeqRow) });
  $('#id_sc_field_date_last_updated' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_date_last_updated_onchange(this, iSeqRow) });
  $('#id_sc_field_restricted' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_restricted_onchange(this, iSeqRow) });
  $('#id_sc_field_committee_approval_required' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_committee_approval_required_onchange(this, iSeqRow) });
  $('#id_sc_field_type_company' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_type_company_onchange(this, iSeqRow) });
  $('#id_sc_field_archive' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_archive_onchange(this, iSeqRow) });
  $('#id_sc_field_archive_date' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_archive_date_onchange(this, iSeqRow) });
  $('#id_sc_field_pricing_level_id' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_pricing_level_id_onblur('#id_sc_field_pricing_level_id' + iSeqRow, iSeqRow) })
                                              .bind('change', function() { sc_form_clients_steps_appn_stripe_pricing_level_id_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_clients_steps_appn_stripe_pricing_level_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_store_front_address' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_store_front_address_onchange(this, iSeqRow) });
  $('#id_sc_field_store_front_city' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_store_front_city_onchange(this, iSeqRow) });
  $('#id_sc_field_store_front_zip' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_store_front_zip_onchange(this, iSeqRow) });
  $('#id_sc_field_home_base_address' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_home_base_address_onchange(this, iSeqRow) });
  $('#id_sc_field_home_base_city' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_home_base_city_onchange(this, iSeqRow) });
  $('#id_sc_field_home_base_zip' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_home_base_zip_onchange(this, iSeqRow) });
  $('#id_sc_field_store_front_state' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_store_front_state_onchange(this, iSeqRow) });
  $('#id_sc_field_home_base_state' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_home_base_state_onchange(this, iSeqRow) });
  $('#id_sc_field_record_created' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_record_created_onchange(this, iSeqRow) });
  $('#id_sc_field_record_created_hora' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_record_created_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_permanent_member_date' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_permanent_member_date_onchange(this, iSeqRow) });
  $('#id_sc_field_acct_instagram' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_acct_instagram_onblur('#id_sc_field_acct_instagram' + iSeqRow, iSeqRow) })
                                            .bind('change', function() { sc_form_clients_steps_appn_stripe_acct_instagram_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_acct_facebook' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_acct_facebook_onblur('#id_sc_field_acct_facebook' + iSeqRow, iSeqRow) })
                                           .bind('change', function() { sc_form_clients_steps_appn_stripe_acct_facebook_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_website_url' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_website_url_onblur('#id_sc_field_website_url' + iSeqRow, iSeqRow) })
                                         .bind('change', function() { sc_form_clients_steps_appn_stripe_website_url_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_bus_subcat_other' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_bus_subcat_other_onblur('#id_sc_field_bus_subcat_other' + iSeqRow, iSeqRow) })
                                              .bind('change', function() { sc_form_clients_steps_appn_stripe_bus_subcat_other_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_appn_date' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_appn_date_onblur('#id_sc_field_appn_date' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_clients_steps_appn_stripe_appn_date_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_appn_note' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_appn_note_onblur('#id_sc_field_appn_note' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_clients_steps_appn_stripe_appn_note_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_doc_type' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_doc_type_onblur('#id_sc_field_doc_type' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_clients_steps_appn_stripe_doc_type_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_doc_file' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_doc_file_onblur('#id_sc_field_doc_file' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_clients_steps_appn_stripe_doc_file_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_clients_steps_appn_stripe_doc_file_onfocus(this, iSeqRow) });
  $('#id_sc_field_doc_filename' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_doc_filename_onchange(this, iSeqRow) });
  $('#id_sc_field_doc_filesize' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_doc_filesize_onchange(this, iSeqRow) });
  $('#id_sc_field_applicant_name' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_applicant_name_onblur('#id_sc_field_applicant_name' + iSeqRow, iSeqRow) })
                                            .bind('change', function() { sc_form_clients_steps_appn_stripe_applicant_name_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_applicant_signature' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_applicant_signature_onblur('#id_sc_field_applicant_signature' + iSeqRow, iSeqRow) })
                                                 .bind('change', function() { sc_form_clients_steps_appn_stripe_applicant_signature_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_applicant_title' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_applicant_title_onblur('#id_sc_field_applicant_title' + iSeqRow, iSeqRow) })
                                             .bind('change', function() { sc_form_clients_steps_appn_stripe_applicant_title_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_main_contact_img_id' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_main_contact_img_id_onblur('#id_sc_field_main_contact_img_id' + iSeqRow, iSeqRow) })
                                                 .bind('change', function() { sc_form_clients_steps_appn_stripe_main_contact_img_id_onchange(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_clients_steps_appn_stripe_main_contact_img_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_more_buyers_xlsx' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_more_buyers_xlsx_onchange(this, iSeqRow) });
  $('#id_sc_field_buyers_excel_qty' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_buyers_excel_qty_onchange(this, iSeqRow) });
  $('#id_sc_field_qb_id' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_qb_id_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_synced' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_synced_onchange(this, iSeqRow) });
  $('#id_sc_field_main_contact_img_file' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_main_contact_img_file_onchange(this, iSeqRow) });
  $('#id_sc_field_main_contact_img_size' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_main_contact_img_size_onchange(this, iSeqRow) });
  $('#id_sc_field_addtl_memb_mail' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_addtl_memb_mail_onchange(this, iSeqRow) });
  $('#id_sc_field_adtl_memb_name' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_adtl_memb_name_onchange(this, iSeqRow) });
  $('#id_sc_field_adtl_memb_note' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_adtl_memb_note_onchange(this, iSeqRow) });
  $('#id_sc_field_adtl_memb_phone' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_adtl_memb_phone_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy01' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_dummy01_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy02' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_dummy02_onblur('#id_sc_field_dummy02' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_clients_steps_appn_stripe_dummy02_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dummy03' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_dummy03_onblur('#id_sc_field_dummy03' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_clients_steps_appn_stripe_dummy03_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dummy04' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_dummy04_onblur('#id_sc_field_dummy04' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_clients_steps_appn_stripe_dummy04_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dummy05' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_dummy05_onblur('#id_sc_field_dummy05' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_clients_steps_appn_stripe_dummy05_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_clients_steps_appn_stripe_dummy05_onfocus(this, iSeqRow) });
  $('#id_sc_field_dummy06' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_dummy06_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy07' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_dummy07_onblur('#id_sc_field_dummy07' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_clients_steps_appn_stripe_dummy07_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dummy08' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_dummy08_onblur('#id_sc_field_dummy08' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_clients_steps_appn_stripe_dummy08_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_clients_steps_appn_stripe_dummy08_onfocus(this, iSeqRow) });
  $('#id_sc_field_dummy09' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_dummy09_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy10' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_dummy10_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy11' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_dummy11_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy12' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_dummy12_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy13' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_dummy13_onchange(this, iSeqRow) });
  $('#id_sc_field_est_memb_cost' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_est_memb_cost_onblur('#id_sc_field_est_memb_cost' + iSeqRow, iSeqRow) })
                                           .bind('change', function() { sc_form_clients_steps_appn_stripe_est_memb_cost_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_clients_steps_appn_stripe_est_memb_cost_onfocus(this, iSeqRow) });
  $('#id_sc_field_main_contact_title_lbl' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_main_contact_title_lbl_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_01' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_01_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_02' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_02_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_03' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_03_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_04' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_04_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_05' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_05_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_06' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_06_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_07' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_07_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_08' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_08_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_09' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_09_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_10' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_10_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_11' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_11_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_12' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_12_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_13' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_13_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_email' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_email_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_levels' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_memb_levels_onblur('#id_sc_field_memb_levels' + iSeqRow, iSeqRow) })
                                         .bind('change', function() { sc_form_clients_steps_appn_stripe_memb_levels_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_memb_list' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_memb_list_onblur('#id_sc_field_memb_list' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_clients_steps_appn_stripe_memb_list_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_clients_steps_appn_stripe_memb_list_onfocus(this, iSeqRow) });
  $('#id_sc_field_memb_name' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_name_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_note' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_note_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_phone' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_memb_phone_onchange(this, iSeqRow) });
  $('#id_sc_field_paid' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_paid_onchange(this, iSeqRow) });
  $('#id_sc_field_pay' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_pay_onchange(this, iSeqRow) });
  $('#id_sc_field_read_at_sign' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_read_at_sign_onblur('#id_sc_field_read_at_sign' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_form_clients_steps_appn_stripe_read_at_sign_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_rules' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_rules_onblur('#id_sc_field_rules' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_form_clients_steps_appn_stripe_rules_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_clients_steps_appn_stripe_rules_onfocus(this, iSeqRow) });
  $('#id_sc_field_rules_warn' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_rules_warn_onchange(this, iSeqRow) });
  $('#id_sc_field_xlsx_sample' + iSeqRow).bind('change', function() { sc_form_clients_steps_appn_stripe_xlsx_sample_onchange(this, iSeqRow) });
  $('#id_sc_field_js_strp_price_id' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_js_strp_price_id_onblur('#id_sc_field_js_strp_price_id' + iSeqRow, iSeqRow) })
                                              .bind('change', function() { sc_form_clients_steps_appn_stripe_js_strp_price_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_js_prod_price' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_js_prod_price_onblur('#id_sc_field_js_prod_price' + iSeqRow, iSeqRow) })
                                           .bind('change', function() { sc_form_clients_steps_appn_stripe_js_prod_price_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_js_mbr_ct' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_js_mbr_ct_onblur('#id_sc_field_js_mbr_ct' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_clients_steps_appn_stripe_js_mbr_ct_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_js_client_id' + iSeqRow).bind('blur', function() { sc_form_clients_steps_appn_stripe_js_client_id_onblur('#id_sc_field_js_client_id' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_form_clients_steps_appn_stripe_js_client_id_onchange(this, iSeqRow) })
...
function sc_form_clients_steps_appn_stripe_client_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_memb_status_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_co_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_ofa_contact_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_street_address_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_mailing_address_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_city_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_state_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_zip_code_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_phone_number_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_home_phone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_fax_number_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_business_type_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_fresh_cut_allowed_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_business_license_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_nursery_license_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_federal_tax_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_temporary_pass_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_ofa_member_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_starting_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_renewal_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_expiration_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_canceled_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_cancel_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_canceled_by_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_reason_canceled_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_retire_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_verified_receipts_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_date_last_updated_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_restricted_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_committee_approval_required_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_type_company_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_archive_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_archive_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_pricing_level_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_store_front_address_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_store_front_city_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_store_front_zip_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_home_base_address_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_home_base_city_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_home_base_zip_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_store_front_state_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_home_base_state_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_record_created_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_record_created_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_permanent_member_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_acct_instagram_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_acct_facebook_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_website_url_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_bus_subcat_other_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_appn_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_appn_note_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_doc_type_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_doc_file_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_doc_filename_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_doc_filesize_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_applicant_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_applicant_signature_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_applicant_title_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_main_contact_img_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_more_buyers_xlsx_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_buyers_excel_qty_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_qb_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_synced_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_main_contact_img_file_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_main_contact_img_size_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_addtl_memb_mail_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_adtl_memb_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_adtl_memb_note_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_adtl_memb_phone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_dummy01_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_dummy02_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_dummy03_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_dummy04_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_dummy05_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_dummy06_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_dummy07_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_dummy08_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_dummy09_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_dummy10_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_dummy11_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_dummy12_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_dummy13_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_est_memb_cost_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_main_contact_title_lbl_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_01_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_02_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_03_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_04_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_05_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_06_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_07_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_08_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_09_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_10_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_11_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_12_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_13_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_memb_levels_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_memb_list_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_memb_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_note_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_memb_phone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_paid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_pay_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_read_at_sign_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_rules_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_rules_warn_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_steps_appn_stripe_xlsx_sample_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_js_strp_price_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_js_prod_price_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_js_mbr_ct_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_steps_appn_stripe_js_client_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
        $("#id_form_clients_steps_appn_stripe_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  ...
  $("#id_sc_field_starting_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_validate_starting_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_renewal_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_validate_renewal_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_expiration_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_validate_expiration_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_cancel_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_validate_cancel_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_retire_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_validate_retire_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_date_last_updated" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_validate_date_last_updated(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_archive_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_validate_archive_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_validate_record_created(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_permanent_member_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_validate_permanent_member_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_main_contact_img_id" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_clients_steps_appn_stripe_ul_save.php",
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_clients_steps_appn_stripe')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
...
var wizardActualStep = <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['actual_step']; ?>;
var wizardTotalSteps = <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['total_steps']; ?>;
...
function scJQWizardValidateStep(stepGoTo)
{
    if (0 == wizardActualStep) {
        do_ajax_form_clients_steps_appn_stripe_submit_page_0(stepGoTo);
    }
    if (1 == wizardActualStep) {
        do_ajax_form_clients_steps_appn_stripe_submit_page_1(stepGoTo);
    }
    if (2 == wizardActualStep) {
        do_ajax_form_clients_steps_appn_stripe_submit_page_2(stepGoTo);
    }
    if (3 == wizardActualStep) {
        do_ajax_form_clients_steps_appn_stripe_submit_page_3(stepGoTo);
    }
}
...
{
    $("#form_clients_steps_appn_stripe_form" + stepNo).css({
        "width": "1px",
        "height": "0",
        "display": "none",
        "overflow": "scroll",
