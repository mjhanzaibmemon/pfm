<div id="form_clients_steps_appn_stripe_form1" style='<?php echo (1 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_doc_type'][] = 'Active Secretary of State Registration'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_doc_type'][] = 'City Business License'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_doc_type'][] = 'Agricultural License'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['Lookup_doc_type'][] = 'Other type of document'; ?>
...
<?php echo "</div>\r\n"; ?></span><?php  }?>
   ...
   <?php
    ...
    {
        $this->nm_new_label['doc_file'] = "Attachment: (Click to upload or drop a file in the box below)";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php
   $sCheckInsert = "";
?>
<span id="chk_ajax_img_doc_file"<?php if ($this->nmgp_opcao == "novo" || empty($doc_file)) { echo " style=\"display: none\""; } ?>> <input type=checkbox name="doc_file_limpa" value="<?php echo $doc_file_limpa . '" '; if ($doc_file_limpa == "S"){echo "checked ";} ?> onclick="this.value = ''; if (this.checked){ this.value = 'S'};<?php echo $sCheckInsert ?>"><?php echo $this->Ini->Nm_lang['lang_btns_dele_hint']; ?> &nbsp;</span>
<?php 
