<?php
//
class form_clients_steps_appn_stripe_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      $Sc_lig_md5 = false;
      $List_cmps = array('dummy02','dummy03','co_name','client_id','mailing_address','appn_date','city','pricing_level_id','state','bus_cat_id','zip_code','bus_subcat_id','website_url','bus_subcat_other','acct_facebook','acct_instagram','dummy04','dummy05','memb_levels','dummy07','dummy08','main_contact_name','main_contact_phone','main_contact_email','main_contact_title','main_contact_img_id','doc_type','doc_file','appn_note','memb_list','est_memb_cost','rules','memb_qty','read_at_sign','applicant_name','applicant_title','js_strp_price_id','js_prod_price','js_mbr_ct','js_client_id','applicant_signature','memb_status_id','ofa_contact','street_address','phone_number','home_phone','fax_number','email','business_type','fresh_cut_allowed','business_license','nursery_license','federal_tax_id','temporary_pass','ofa_member','starting_date','renewal_date','expiration_date','canceled','cancel_date','canceled_by','reason_canceled','retire_date','verified_receipts','date_last_updated','restricted','committee_approval_required','type_company','archive','archive_date','store_front_address','store_front_city','store_front_zip','home_base_address','home_base_city','home_base_zip','store_front_state','home_base_state','record_created','permanent_member_date','doc_filename','doc_filesize','more_buyers_xlsx','buyers_excel_qty','qb_id','synced','main_contact_img_file','main_contact_img_size','addtl_memb_mail','adtl_memb_name','adtl_memb_note','adtl_memb_phone','dummy01','dummy06','dummy09','dummy10','dummy11','dummy12','dummy13','main_contact_title_lbl','memb_01','memb_02','memb_03','memb_04','memb_05','memb_06','memb_07','memb_08','memb_09','memb_10','memb_11','memb_12','memb_13','memb_email','memb_name','memb_note','memb_phone','paid','pay','rules_warn','xlsx_sample');
      if (!isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['Cache_wizard_form']) || (isset($_POST['rs']) && strpos($_POST['rs'], '_navigate_form'))) {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['Cache_wizard_form'] = array();
      }
      foreach ($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['Cache_wizard_form'] as $nmgp_var => $nmgp_val) {
          ...
          foreach ($_POST as $nmgp_var => $nmgp_val)
          {
              ...
              if ($nmgp_var == "nmgp_parms" && substr($nmgp_val, 0, 8) == "@SC_par@")
              {
               ...
               if (in_array($nmgp_var, $List_cmps)) {
                   $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['Cache_wizard_form'][$nmgp_var] = $nmgp_val;
               }
          }
      }
      if (!empty($_GET))
      ...
      if (isset($this->gv_pricing_lev_id) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['gv_pricing_lev_id'] = $this->gv_pricing_lev_id;
      }
      ...
      if (isset($_POST["gv_pricing_lev_id"]) && isset($this->gv_pricing_lev_id)) 
      {
          $_SESSION['gv_pricing_lev_id'] = $this->gv_pricing_lev_id;
      }
      ...
      if (isset($_GET["gv_pricing_lev_id"]) && isset($this->gv_pricing_lev_id)) 
      {
          $_SESSION['gv_pricing_lev_id'] = $this->gv_pricing_lev_id;
      }
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_clients_steps_appn_stripe_mob($cadapar[1]);
          ...
          if (isset($this->gv_pricing_lev_id)) 
          {
              $_SESSION['gv_pricing_lev_id'] = $this->gv_pricing_lev_id;
          }
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['opc_ant']);
          }
          if (isset($this->gv_contact_pfm)) 
          {
              $_SESSION['gv_contact_pfm'] = $this->gv_contact_pfm;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_clients_steps_appn_stripe_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['initialize'])
          {
              $_SESSION['scriptcase']['form_clients_steps_appn_stripe_mob']['contr_erro'] = 'on';
  echo "<script>
document.addEventListener('DOMContentLoaded', function() {
    function isNextButtonVisible() {
        var nextButton = document.getElementById('sc_b_stepavc_b');
        if (nextButton) {
            var isVisible = !!(nextButton.offsetWidth || nextButton.offsetHeight || nextButton.getClientRects().length);
            return isVisible;
        }
    ...
    function toggleSaveButtonVisibility() {
        var saveButton = document.getElementById('sc_b_upd_b');
...
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['upload_field_info']['main_contact_img_id'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['upload_field_info']['doc_file'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
          'upload_type'        => 'single',
          'upload_allowed_type'  => '/\.(pdf|jpg|jpeg|png|bmp|gif|tiff|svg|doc|docx|odt|ods|odp|xls|xlsx)$/i',
          'upload_max_size'  => null,
          'upload_file_height' => '',
          'upload_file_width'  => '',
          'upload_file_aspect' => '',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_steps_appn_stripe_mob']['upload_field_info']['more_buyers_xlsx'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_steps_appn_stripe_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_steps_appn_stripe_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_steps_appn_stripe_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_clients_steps_appn_stripe_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_steps_appn_stripe_mob']['label'] = "PFM - Buyers Pass App";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_clients_steps_appn_stripe_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->arr_buttons['pmt_js']['style']            = "paypal";
      ...
      $_SESSION['scriptcase']['error_icon']['form_clients_steps_appn_stripe_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_clients_steps_appn_stripe_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['table_refresh'] = false;

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard'])) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard'] = array();
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['actual_step']) || $this->nmgp_opcao  == "novo" || $this->nmgp_opcao  == "incluir") {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['actual_step'] = 0;
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['total_steps'] = 4;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_field_ul_name'][$this->doc_file_ul_name]))
          {
              $this->NM_ajax_info['param']['doc_file_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_field_ul_name'][$this->doc_file_ul_name];
          }
      ...
      elseif (isset($this->doc_file_ul_name) && '' != $this->doc_file_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_field_ul_name'][$this->doc_file_ul_name]))
          {
              $this->doc_file_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_field_ul_name'][$this->doc_file_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->NM_ajax_info['param']['main_contact_img_id_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      elseif (isset($this->main_contact_img_id_ul_name) && '' != $this->main_contact_img_id_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->main_contact_img_id_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_steps_appn_stripe_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_steps_appn_stripe_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_steps_appn_stripe_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_clients_steps_appn_stripe_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_clients_steps_appn_stripe_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_clients_steps_appn_stripe_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'new_memb_app/form_clients_steps_appn_stripe_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_clients_steps_appn_stripe_mob_erro.class.php"); 
      }
      $this->Erro      = new form_clients_steps_appn_stripe_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opcao']))
         { 
             if ($this->client_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe_mob']['start']);
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_steps_appn_stripe']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "novo")  
      {
          $this->nmgp_botoes['pmt_js'] = "off";
      }
      elseif ($this->nmgp_opcao == "incluir")  
      {
          $this->nmgp_botoes['pmt_js'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['botoes']['pmt_js'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['total']);
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_clients_steps_appn_stripe_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_clients_steps_appn_stripe_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['appn_date']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'];
      $this->field_config['appn_date']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['appn_date']['date_display'] = "ddmmaaaa";
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Gera_log_access'] = false;
      }
...
<body>
    <table id=\"memb_lev\">
        <tr id=\"memb_lev\">
            ...
            <th id=\"memb_lev\">Cost per Year<br><span style='font-size: 14px; color: orange; font-family: Arial, sans-serif;'>(up to 3 buyers)</span></th>
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_clients_steps_appn_stripe_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
        ...
        if ($this->wizard_change_step) {
            ...
            if (!$this->wizard_go_forward) {
                ...
                $wizardData['action'] = 'change_step';
                $wizardData['next_step'] = $this->wizard_step_goto;
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['actual_step'] = $this->wizard_step_goto;
            }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_clients_steps_appn_stripe_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="form_clients_steps_appn_stripe_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_clients_steps_appn_stripe_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_clients_steps_appn_stripe_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_steps_appn_stripe_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'doc_type':
               ...
               break;
           case 'doc_file':
               return "Attachment: (Click to upload or drop a file in the box below)";
               break;
           case 'appn_note':
               return "Appn Note";
               break;
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_clients_steps_appn_stripe_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_mailing_address = $this->mailing_address;
    ...
    $original_zip_code = $this->zip_code;
}
  if ( $this->sc_evento == "alterar" || $this->sc_evento == "update" ) {
  	if ( empty($this->co_name ) ) {
	    
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: Company Name";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  } elseif ('submit_form' == $this->NM_ajax_opcao) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  } else {
   $sErrorIndex = substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
  }
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: Company Name";
 }
;
	}
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: Mailing Address";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: Mailing Address";
 }
;
	}
	if ( empty($this->city ) ) {
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: City";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: City";
 }
;
	}
	if ( empty($this->state ) ) {
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: State";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: State";
 }
;
	}
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: Zip code";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: Zip code";
 }
;
	}
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: Membership Level";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: Membership Level";
 }
;
	}
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: Business Category";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: Business Category";
 }
;
	}
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: Business Subcategory";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: Business Subcategory";
 }
;
	}
	if ( empty($this->main_contact_name ) ) {
	    
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: Contact Name";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: Contact Name";
 }
;
	}
	if ( empty($this->main_contact_email ) ) {
	    
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: Contact Email";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: Contact Email";
 }
;
	}	
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: Contact Phone";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: Contact Phone";
 }
;
	}
	if ( empty($this->main_contact_title ) ) {
	    
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: Contact Title";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: Contact Title";
 }
;
	}
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Organization details: Contact Picture ID";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Organization details: Contact Picture ID";
 }
;
	}
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Supporting Document(s): Document type";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Supporting Document(s): Document type";
 }
;
	}
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Supporting Document(s): Attachment";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_steps_appn_stripe_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Supporting Document(s): Attachment";
 }
;
	}
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_city != $this->city || (isset($bFlagRead_city) && $bFlagRead_city)))
    {
    ...
    if (($original_mailing_address != $this->mailing_address || (isset($bFlagRead_mailing_address) && $bFlagRead_mailing_address)))
    {
    ...
    if (($original_main_contact_phone != $this->main_contact_phone || (isset($bFlagRead_main_contact_phone) && $bFlagRead_main_contact_phone)))
    {
        $this->ajax_return_values_main_contact_phone(true);
    }
    if (($original_main_contact_title != $this->main_contact_title || (isset($bFlagRead_main_contact_title) && $bFlagRead_main_contact_title)))
    {
    ...
    if (($original_state != $this->state || (isset($bFlagRead_state) && $bFlagRead_state)))
    {
        $this->ajax_return_values_state(true);
    }
    if (($original_zip_code != $this->zip_code || (isset($bFlagRead_zip_code) && $bFlagRead_zip_code)))
    {
...
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_mob']['contr_erro'] = 'off'; 
   ...
   if (isset($this->Field_no_validate['pricing_level_id'])) {
       return;
               ...
               if (!empty($this->pricing_level_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_pricing_level_id']) && !in_array($this->pricing_level_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_pricing_level_id']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['bus_cat_id'])) {
       return;
               ...
               if (!empty($this->bus_cat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_cat_id']) && !in_array($this->bus_cat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_cat_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['bus_subcat_id'])) {
       return;
               ...
               if (!empty($this->bus_subcat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_subcat_id']) && !in_array($this->bus_subcat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_subcat_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->main_contact_img_id && "S" != $this->main_contact_img_id_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_clients_steps_appn_stripe_mob_doc_name.php';
                }
   ...
   if (isset($this->Field_no_validate['doc_type'])) {
    ...
    function ValidateField_doc_file(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (isset($this->Field_no_validate['doc_file'])) {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if ("" != $this->doc_file && "S" != $this->doc_file_limpa && !$teste_validade->ArqExtensao($this->doc_file, array('pdf', 'jpg', 'jpeg', 'png', 'bmp', 'gif', 'tiff', 'svg', 'doc', 'docx', 'odt', 'ods', 'odp', 'xls', 'xlsx')))
            {
                $hasError = true;
                $Campos_Crit .= "Attachment: (Click to upload or drop a file in the box below): " . $this->Ini->Nm_lang['lang_errm_file_invl']; 
            ...
            if (!$hasError && "" != $this->doc_file && "S" != $this->doc_file_limpa) {
                ...
                if ($hasError) {
                    $Campos_Crit .= "Attachment: (Click to upload or drop a file in the box below): " . $this->Ini->Nm_lang['lang_errm_file_size'] . $sizeErrorSuffix;
                    if (!isset($Campos_Erros['doc_file']))
                    {
                        $Campos_Erros['doc_file'] = array();
                    }
    ...
    function ValidateField_js_strp_price_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->js_strp_price_id) > 100) 
          { 
              $hasError = true;
              $Campos_Crit .= "js_strp_price_id " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['js_strp_price_id']))
              {
                  $Campos_Erros['js_strp_price_id'] = array();
              }
              $Campos_Erros['js_strp_price_id'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['js_strp_price_id'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
...
//--------------------------------------------------------------------------------------
     ...
     if (!$this->wizard_go_forward || (is_array($filtro) && in_array('doc_file', $filtro))) {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Attachment: (Click to upload or drop a file in the box below) " . $this->Ini->Nm_lang['lang_errm_upld']; 
                  $this->doc_file = "";
                  if (!isset($Campos_Erros['doc_file']))
                  {
                      $Campos_Erros['doc_file'] = array();
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['client_id']['keyVal'] = form_clients_steps_appn_stripe_mob_pack_protect_string($this->nmgp_dados_form['client_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['foreign_key']['client_id'] = $this->nmgp_dados_form['client_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['where_filter'] = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['where_detal']  = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_members_app_mob_script_case_init'] ]['form_members_app_mob']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_pricing_level_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_pricing_level_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_pricing_level_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_pricing_level_id'] = array(); 
}
$aLookup[] = array(form_clients_steps_appn_stripe_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_pricing_level_id'][] = '';
   ...
   $nm_comando = "SELECT memb_lev_id, descript  FROM members_level  WHERE active and show_new_mbr  ORDER BY sort_by";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_clients_steps_appn_stripe_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_clients_steps_appn_stripe_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_pricing_level_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pricing_level_id']['valList'][$i] = form_clients_steps_appn_stripe_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_cat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_cat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_cat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_cat_id'] = array(); 
}
$aLookup[] = array(form_clients_steps_appn_stripe_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_cat_id'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_cat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_cat_id']['valList'][$i] = form_clients_steps_appn_stripe_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_subcat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_subcat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_subcat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_subcat_id'] = array(); 
}
$aLookup[] = array(form_clients_steps_appn_stripe_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_subcat_id'][] = '';
if ($this->bus_cat_id != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_bus_subcat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_subcat_id']['valList'][$i] = form_clients_steps_appn_stripe_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$main_contact_img_file]))
       {
           if ($this->NM_size_docs[$main_contact_img_file] != filesize($this->Ini->root . $out_main_contact_img_id))
           {
              ...
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['download_filenames']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['download_filenames'] = array();
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['download_filenames'][$sTmpFile] = $this->main_contact_img_file;
          ...
          $this->NM_ajax_info['fldList']['main_contact_img_id'] = array(
               ...
               'docLink' => "<a href=\"javascript:nm_mostra_doc('documento_db', '" . substr($sTmpFile, 3) . "', 'form_clients_steps_appn_stripe')\">" . $tmp_file_main_contact_img_id . "</a>",
...
$aLookup[] = array(form_clients_steps_appn_stripe_mob_pack_protect_string('Active Secretary of State Registration') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_mob_pack_protect_string("Active Secretary of State Registration")));
$aLookup[] = array(form_clients_steps_appn_stripe_mob_pack_protect_string('City Business License') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_mob_pack_protect_string("City Business License")));
$aLookup[] = array(form_clients_steps_appn_stripe_mob_pack_protect_string('Agricultural License') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_mob_pack_protect_string("Agricultural License")));
$aLookup[] = array(form_clients_steps_appn_stripe_mob_pack_protect_string('Other type of document') => str_replace('<', '&lt;',form_clients_steps_appn_stripe_mob_pack_protect_string("Other type of document")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_doc_type'][] = 'Active Secretary of State Registration';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_doc_type'][] = 'City Business License';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_doc_type'][] = 'Agricultural License';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Lookup_doc_type'][] = 'Other type of document';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['doc_type']['valList'][$i] = form_clients_steps_appn_stripe_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$main_contact_img_file]))
       {
           if ($this->NM_size_docs[$main_contact_img_file] != filesize($this->Ini->root . $out_doc_file))
           {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['download_filenames'][$sTmpFile] = $this->doc_filename;
          ...
          $this->NM_ajax_info['fldList']['doc_file'] = array(
               ...
               'docLink' => "<a href=\"javascript:nm_mostra_doc('documento_db', '" . substr($sTmpFile, 3) . "', 'form_clients_steps_appn_stripe')\">" . $tmp_file_doc_file . "</a>",
   ...
   function ajax_return_values_applicant_signature($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Field_no_validate'] = array();
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Cache_wizard_form'] = array();
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['doc_file_salva'] = array(
                      'row'     => '',
              ...
              $this->nmgp_refresh_fields = array_diff(array('dummy02', 'dummy03', 'co_name', 'client_id', 'mailing_address', 'appn_date', 'city', 'pricing_level_id', 'state', 'bus_cat_id', 'zip_code', 'bus_subcat_id', 'website_url', 'bus_subcat_other', 'acct_facebook', 'acct_instagram', 'dummy04', 'dummy05', 'memb_levels', 'dummy07', 'dummy08', 'main_contact_name', 'main_contact_phone', 'main_contact_email', 'main_contact_title', 'main_contact_img_id', 'doc_type', 'doc_file', 'appn_note', 'memb_list', 'est_memb_cost', 'rules', 'memb_qty', 'read_at_sign', 'applicant_name', 'applicant_title', 'js_strp_price_id', 'js_prod_price', 'js_mbr_ct', 'js_client_id', 'applicant_signature'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['Cache_wizard_form'] = array();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['reg_start'] = 0; 
              }
...
$sql = "SELECT msg_subject, msg_body 
		FROM notifications
		WHERE descript = 'appn_submitted_msg'";
...
$sql = "INSERT INTO client_docs (doc_type, doc_file, doc_filename, doc_filesize, appn_id) ".
...
$_SESSION['scriptcase']['form_clients_steps_appn_stripe_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['parms'] = "client_id?#?$this->client_id?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['parms'] = "client_id?#?$this->client_id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['sub_dir'][0]  = "/" . $this->nm_tira_formatacao_client_id($this->client_id);
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['reg_start'] < $qt_geral_reg_form_clients_steps_appn_stripe_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opcao']   = '';
          }
      } 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dados_select'];
   ...
   function NM_gera_log_output() 
   {
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$this->nm_formatar_campos('client_id', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'pricing_level_id', 'js_prod_price', 'est_memb_cost', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id');
...
$this->nm_formatar_campos('client_id', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'pricing_level_id', 'js_prod_price', 'est_memb_cost', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id', 'bus_subcat_other');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
$modificado_js_mbr_ct = $this->js_mbr_ct;
$modificado_js_client_id = $this->js_client_id;
$this->nm_formatar_campos('client_id', 'main_contact_email', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'pricing_level_id', 'js_prod_price', 'est_memb_cost', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
$modificado_js_mbr_ct = $this->js_mbr_ct;
$modificado_js_client_id = $this->js_client_id;
$this->nm_formatar_campos('client_id', 'main_contact_name', 'applicant_name', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'pricing_level_id', 'js_prod_price', 'est_memb_cost', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
$modificado_js_mbr_ct = $this->js_mbr_ct;
$modificado_js_client_id = $this->js_client_id;
$this->nm_formatar_campos('client_id', 'main_contact_phone', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'pricing_level_id', 'js_prod_price', 'est_memb_cost', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id');
if ($original_client_id !== $modificado_client_id || isset($this->nmgp_cmp_readonly['client_id']) || (isset($bFlagRead_client_id) && $bFlagRead_client_id))
{
    $this->ajax_return_values_client_id(true);
}
...
$modificado_js_mbr_ct = $this->js_mbr_ct;
$modificado_js_client_id = $this->js_client_id;
$this->nm_formatar_campos('applicant_title', 'main_contact_title', 'client_id', 'memb_qty', 'bus_cat_id', 'bus_subcat_id', 'pricing_level_id', 'js_prod_price', 'est_memb_cost', 'js_strp_price_id', 'js_mbr_ct', 'js_client_id');
...
if (!isset($this->sc_temp_gv_pricing_lev_id)) {$this->sc_temp_gv_pricing_lev_id = (isset($_SESSION['gv_pricing_lev_id'])) ? $_SESSION['gv_pricing_lev_id'] : "";}
...
$memb_est_cost = 0;
if ( $this->pricing_level_id  == 14 ) {	
	$this->sc_temp_gv_pricing_lev_id = 13; }
else {
	$this->sc_temp_gv_pricing_lev_id = $this->pricing_level_id ;
}
$sql = "SELECT curr_price, price_after, stripe_price_id, descript " .
		"FROM members_level " .
		"WHERE active AND memb_lev_id = " . $this->sc_temp_gv_pricing_lev_id . " " .  
		"ORDER BY sort_by";
...
if (isset($this->sc_temp_gv_pricing_lev_id)) { $_SESSION['gv_pricing_lev_id'] = $this->sc_temp_gv_pricing_lev_id;}
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['download_filenames'][$sTmpFile_main_contact_img_file] = $this->main_contact_img_file;
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['download_filenames'][$sTmpFile_doc_filename] = $this->doc_filename;
       ...
       if (isset($this->NM_size_docs[$main_contact_img_file]))
       {
        ...
        $this->initFormPages();
        include_once("form_clients_steps_appn_stripe_mob_form0.php");
        include_once("form_clients_steps_appn_stripe_mob_form1.php");
        include_once("form_clients_steps_appn_stripe_mob_form2.php");
        include_once("form_clients_steps_appn_stripe_mob_form3.php");
        $this->hideFormPages();
 }
...
<?php
    ...
    function form_highlight_search_quicksearch(&$result, $field, $value)
    {
        ...
        elseif ($field == $this->nmgp_fast_search && in_array($field, array("co_name", "client_id", "mailing_address", "appn_date", "city", "pricing_level_id", "state", "bus_cat_id", "zip_code", "bus_subcat_id", "website_url", "bus_subcat_other", "acct_facebook", "acct_instagram", "main_contact_name", "main_contact_phone", "main_contact_email", "main_contact_title", "main_contact_img_id", "doc_type", "doc_file", "appn_note", "memb_list", "memb_qty", "applicant_name", "applicant_title", "applicant_signature"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_clients_steps_appn_stripe_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['total'] = $qt_geral_reg_form_clients_steps_appn_stripe_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_clients_steps_appn_stripe_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_pricing_level_id($condicao, $campo)
   {
       ...
       {
           $nm_comando = "SELECT descript, memb_lev_id FROM members_level WHERE (CAST (memb_lev_id AS TEXT) LIKE '%$campo%') AND (active) AND (show_new_mbr)" ; 
       }
       else
       {
           $nm_comando = "SELECT descript, memb_lev_id FROM members_level WHERE (#cmp_idescript#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos) AND (active) AND (show_new_mbr)" ; 
       }
       if ($condicao == "ii")
       {
   ...
   function SC_lookup_doc_type($condicao, $campo)
   {
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values'] = array();
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy02'] = $this->dummy02;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy03'] = $this->dummy03;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['co_name'] = $this->co_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['client_id'] = $this->client_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['mailing_address'] = $this->mailing_address;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['appn_date'] = $this->appn_date;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['city'] = $this->city;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['pricing_level_id'] = $this->pricing_level_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['state'] = $this->state;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['bus_cat_id'] = $this->bus_cat_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['zip_code'] = $this->zip_code;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['bus_subcat_id'] = $this->bus_subcat_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['website_url'] = $this->website_url;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['bus_subcat_other'] = $this->bus_subcat_other;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['acct_facebook'] = $this->acct_facebook;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['acct_instagram'] = $this->acct_instagram;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy04'] = $this->dummy04;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy05'] = $this->dummy05;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['memb_levels'] = $this->memb_levels;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy07'] = $this->dummy07;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy08'] = $this->dummy08;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['main_contact_name'] = $this->main_contact_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['main_contact_phone'] = $this->main_contact_phone;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['main_contact_email'] = $this->main_contact_email;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['main_contact_title'] = $this->main_contact_title;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['main_contact_img_id'] = $this->main_contact_img_id;
    }

    function wizard_loadFields_step_0()
    {
        $this->dummy02 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy02'];
        $this->dummy03 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy03'];
        $this->co_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['co_name'];
        $this->client_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['client_id'];
        $this->mailing_address = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['mailing_address'];
        $this->appn_date = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['appn_date'];
        $this->city = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['city'];
        $this->pricing_level_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['pricing_level_id'];
        $this->state = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['state'];
        $this->bus_cat_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['bus_cat_id'];
        $this->zip_code = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['zip_code'];
        $this->bus_subcat_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['bus_subcat_id'];
        $this->website_url = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['website_url'];
        $this->bus_subcat_other = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['bus_subcat_other'];
        $this->acct_facebook = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['acct_facebook'];
        $this->acct_instagram = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['acct_instagram'];
        $this->dummy04 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy04'];
        $this->dummy05 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy05'];
        $this->memb_levels = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['memb_levels'];
        $this->dummy07 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy07'];
        $this->dummy08 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['dummy08'];
        $this->main_contact_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['main_contact_name'];
        $this->main_contact_phone = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['main_contact_phone'];
        $this->main_contact_email = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['main_contact_email'];
        $this->main_contact_title = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['main_contact_title'];
        $this->main_contact_img_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['main_contact_img_id'];
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['doc_type'] = $this->doc_type;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['doc_file'] = $this->doc_file;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['appn_note'] = $this->appn_note;
    }

    function wizard_loadFields_step_1()
    {
        $this->doc_type = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['doc_type'];
        $this->doc_file = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['doc_file'];
        $this->appn_note = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['appn_note'];
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['memb_list'] = $this->memb_list;
    }

    function wizard_loadFields_step_2()
    {
        $this->memb_list = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['memb_list'];
    }
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['est_memb_cost'] = $this->est_memb_cost;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['rules'] = $this->rules;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['memb_qty'] = $this->memb_qty;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['read_at_sign'] = $this->read_at_sign;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['applicant_name'] = $this->applicant_name;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['applicant_title'] = $this->applicant_title;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['js_strp_price_id'] = $this->js_strp_price_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['js_prod_price'] = $this->js_prod_price;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['js_mbr_ct'] = $this->js_mbr_ct;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['js_client_id'] = $this->js_client_id;
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['applicant_signature'] = $this->applicant_signature;
    }

    function wizard_loadFields_step_3()
    {
        $this->est_memb_cost = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['est_memb_cost'];
        $this->rules = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['rules'];
        $this->memb_qty = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['memb_qty'];
        $this->read_at_sign = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['read_at_sign'];
        $this->applicant_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['applicant_name'];
        $this->applicant_title = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['applicant_title'];
        $this->js_strp_price_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['js_strp_price_id'];
        $this->js_prod_price = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['js_prod_price'];
        $this->js_mbr_ct = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['js_mbr_ct'];
        $this->js_client_id = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['js_client_id'];
        $this->applicant_signature = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['field_values']['applicant_signature'];
    }
...
<?php
    ...
    {
        if ($stepNo < $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['actual_step']) {
            return 'sc-ui-form-step-done';
        } elseif ($stepNo == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['actual_step']) {
            return 'sc-ui-form-step-now';
        } elseif ($stepNo == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['form_wizard']['actual_step'] + 1) {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_clients_steps_appn_stripe_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_clients_steps_appn_stripe_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_mob']['ordem_ord'] == " desc") {
