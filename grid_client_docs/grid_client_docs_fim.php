...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PFM_Staff_____grid_client_docs"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PFM_Staff_____grid_client_docs"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_client_docs']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_client_docs']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_client_docs']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_client_docs']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_client_docs']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_client_docs']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_client_docs']['embutida_filho'] as $ind => $sc_init)
          {
