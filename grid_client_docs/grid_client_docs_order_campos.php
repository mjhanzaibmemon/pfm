...
<?php
   ...
   $Ord_Cmp = new grid_client_docs_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_client_docs_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['ts'] = "ts";
   $tab_labels["ts"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_client_docs']['labels']["ts"])) ? $_SESSION['sc_session'][$sc_init]['grid_client_docs']['labels']["ts"] : "Date";
   $tab_ger_campos['doc_type'] = "on";
   $tab_def_campos['doc_type'] = "doc_type";
   $tab_labels["doc_type"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_client_docs']['labels']["doc_type"])) ? $_SESSION['sc_session'][$sc_init]['grid_client_docs']['labels']["doc_type"] : "Type";
   $tab_ger_campos['doc_file'] = "on";
   $tab_def_campos['doc_file'] = "doc_file";
   $tab_labels["doc_file"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_client_docs']['labels']["doc_file"])) ? $_SESSION['sc_session'][$sc_init]['grid_client_docs']['labels']["doc_file"] : "Document";
   $tab_ger_campos['user'] = "on";
   $tab_def_campos['user'] = "user";
   $tab_labels["user"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_client_docs']['labels']["user"])) ? $_SESSION['sc_session'][$sc_init]['grid_client_docs']['labels']["user"] : "User";
   $tab_ger_campos['doc_file'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_client_docs']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_client_docs']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_client_docs']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_client_docs_order_campos.php",
    data: {
...
<div class="sc_ui_sortable-wrapper" id="sorting_list_ord_campos">
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_client_docs']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
