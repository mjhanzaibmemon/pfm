<?php
@session_start() ;
$_SESSION['scriptcase']['grid_client_docs']['sc_process_barr'] = true;
require_once('../grid_client_docs/index.php');
unset($_SESSION['scriptcase']['grid_client_docs']['sc_process_barr']);
$ExportCtrl = new grid_client_docs_export_control;
$ExportCtrl->Export_barr();

class grid_client_docs_export_control
{
