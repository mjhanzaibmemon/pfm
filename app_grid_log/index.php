...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_nome_apl     = "Application to check the log: pfm_log"; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20241010"; 
      $this->nm_hr_criacao   = "061342"; 
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['remove_background'] = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_background'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['remove_background'] = 1 == $_GET['remove_background'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_background)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['remove_background'] = 1 == $remove_background;
              }
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_remove_background) && 'ok' == $link_remove_background) {
            ...
            $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info']['remove_background'] = true;
        }
        if (isset($link_margin_top) && '' != $link_margin_top) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_grid_log']['link_info']['margin_top'] = $link_margin_top;
        }
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_log']['glo_nm_conexao'], $this->root . $this->path_prod, 'PFM_Staff', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'app_grid_log', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'app_grid_log', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'app_grid_log', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//----- 
   function controle($linhas = 0)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_orig'])))
      {
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "grid")  
          { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opc_liga']['inicial']))
          {
              ...
              $_SESSION['sc_session'][$script_case_init]['app_grid_log']['orig_pesq'] = "grid";
          }
      }
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_log_res_xls.class.php"); 
          } 
          $this->xls  = new app_grid_log_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_log_res_xml.class.php"); 
          } 
          $this->xml  = new app_grid_log_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_log_res_csv.class.php"); 
          } 
          $this->csv  = new app_grid_log_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_grid_log/app_grid_log_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_grid_log_res_rtf.class.php"); 
          } 
          $this->rtf  = new app_grid_log_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          ...
          { 
              if (isset($_POST['summary_chart_data']) && 'Y' == $_POST['summary_chart_data'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_data($_POST['chart_md5']);
              }
              elseif (isset($_POST['summary_chart']) && 'Y' == $_POST['summary_chart'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['chart_info'][$_POST['chart_md5']])) {
              ...
              elseif (isset($_POST['chart_inline_update']) && 'Y' == $_POST['chart_inline_update'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_inline_updateAjaxResponse($_POST['chart_md5']);
              }
              elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['dashboard_refresh_after_chart'])) {
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['app_grid_log']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp'] . "/sc_apl_default_PFM_Staff.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp'] . "/sc_apl_default_PFM_Staff.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_PFM_Staff'])) {
               $_SESSION['scriptcase']['app_grid_log']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_PFM_Staff'];
           }
       }
   }
   ...
   if (isset($_SESSION['scriptcase']['app_grid_log']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['app_grid_log']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetBlue/Sc9_SweetBlue";
   ...
   { 
       ...
       elseif (substr($_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] != "pdf" ) 
       {
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['opcao'] != "pdf" ) 
       { 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['app_grid_log']['opc_psq'] && !isset($_SESSION['scriptcase']['app_grid_log']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_log']) || $_SESSION['scriptcase']['sc_apl_seg']['app_grid_log'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['app_grid_log']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida']) && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['app_grid_log']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
