<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['app_grid_log']['glo_nm_path_imag_temp'] . "/sc_apl_default_PFM_Staff.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['creator'] = "creator";
   $tab_labels["creator"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["creator"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["creator"] : "" . $this->Nm_lang['lang_log_creator'] . "";
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['log_ok'] = "log_ok";
   }
   else
   {
       $tab_def_campos['log_ok'] = "";
   }
   $tab_labels["log_ok"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["log_ok"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_log']['labels']["log_ok"] : "" . $this->Nm_lang['lang_log_updates'] . "";
   $tab_ger_campos['log_ok'] = "none";
