...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ip_user')
      {
          $ip_user = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ip_user($ip_user);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_ip_user($ip_user)
   {
      $ip_user = substr($this->Db->qstr($ip_user), 1, -1);
            $ip_user_look = (is_string($ip_user) ? substr($this->Db->qstr($ip_user), 1, -1) : $ip_user); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ip_user from " . $this->Ini->nm_tabela . " where  ip_user like '%" . $ip_user . "%' order by ip_user"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_log_title'] ?></TITLE>
...
<script type="text/javascript"> 
 ...
 //----------------------
 function nm_add_sel(event, sOrig, sDest, Saida, Order)
 {
  // Recupera objetos
  ...
  for (i = 0; i < oOrig.length; i++)
  {
   ...
   if ((event == 'Click' && oOrig.options[i].selected && !oOrig.options[i].disabled) || (event != 'Click' && oOrig.options[i] == event.target && !oOrig.options[i].disabled))
   {
 ...
 // Remove um elemento
 //--------------------
 function nm_del_sel(event, sOrig, sDest, Saida, Order)
 {
  // Recupera objetos
  oOrig = document.F1.elements[sOrig];
  oDest = document.F1.elements[sDest];
  ...
  for (i = oOrig.length - 1; i >= 0; i--)
  {
   ...
   if ((event == 'Click' && oOrig.options[i].selected) || (event != 'Click' && oOrig.options[i] == event.target))
   {
   if (Order == 'S')
   {
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_username#NMF#' + search_get_Dselelect('SC_username_dest') + '@NMF@';
  str_out += 'SC_ip_user_cond#NMF#' + search_get_sel_txt('SC_ip_user_cond') + '@NMF@';
  str_out += 'SC_ip_user#NMF#' + search_get_text('SC_ip_user') + '@NMF@';
  str_out += 'id_ac_ip_user#NMF#' + search_get_text('id_ac_ip_user') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_ip_user").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_ip_user").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ip_user",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ip_user").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_application").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_log_title'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $ip_user_cond, $ip_user, $ip_user_autocomp,
      ...
      {
         $tmp_pos = (is_string($application)) ? strpos($application, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
...
?>
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_application_cond" name="application_cond" onChange="nm_campos_between(document.getElementById('id_vis_application'), this, 'application')">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_application" name="application_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_username_cond" name="username_cond" onChange="nm_campos_between(document.getElementById('id_vis_username'), this, 'username')">
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "select distinct username from sc_log"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px; border-spacing: 0px;"><tr><td style='vertical-align: top;padding: 0px;'>
    <SELECT class="scFilterObjectOdd" id="SC_username_orig" name="username_orig" size=7 multiple onDblClick="nm_add_sel(event, 'username_orig', 'username_dest', 'N' , '')">
<?php
         ...
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($username) && !empty($username))
            {
               ...
               foreach ($username as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $username_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                       break;
                   }
               }
            }
            ...
            {
               $username_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $username_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('username_orig', 'username_dest', 'N', '');", "nm_add_all('username_orig', 'username_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('Click', 'username_orig', 'username_dest', 'N', '');", "nm_add_sel('Click', 'username_orig', 'username_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('Click', 'username_dest', 'username_orig', 'N', '');", "nm_del_sel('Click', 'username_dest', 'username_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('username_dest', 'username_orig', 'N', '');", "nm_del_all('username_dest', 'username_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td style='vertical-align: top;padding: 0px;'>
    <SELECT class="scFilterObjectOdd" id="SC_username_dest" name="username_dest" size=7 multiple  onDblClick="nm_del_sel(event, 'username_dest', 'username_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_username" name="username" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.username_dest.selectedIndex = -1;</script>
<?php
?>
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_ip_user_cond" name="ip_user_cond" onChange="nm_campos_between(document.getElementById('id_vis_ip_user'), this, 'ip_user')">
       <OPTION value="qp" <?php if ("qp" == $ip_user_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ip_user_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ip_user_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ip_user_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $ip_user_look = (is_string($ip_user) ? substr($this->Db->qstr($ip_user), 1, -1) : $ip_user); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ip_user from " . $this->Ini->nm_tabela . " where ip_user = '$ip_user_look' order by ip_user"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$ip_user]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ip_user];
      }
      else
      {
          $sAutocompValue = $ip_user;
      }
?>
<INPUT  type="text" id="SC_ip_user" name="ip_user" value="<?php echo NM_encode_input($ip_user) ?>"  size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_ip_user" name="ip_user_autocomp" size="32"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "select distinct action from sc_log"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_grid_log']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app_grid_log']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_grid_log']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app_grid_log']['start'] == 'filter')
   {
?>
...
?>
 ...
 {
   nm_pack('username_dest', 'username');
    document.F1.submit();
 }
 function limpa_form()
 {
 ...
 function SC_carga_evt_jquery()
 {
    ...
    $('#SC_inserted_date_hor').bind('change', function() {sc_app_grid_log_valida_hora(this)});
    $('#SC_inserted_date_input_2_dia').bind('change', function() {sc_app_grid_log_valida_dia(this)});
    $('#SC_inserted_date_input_2_hor').bind('change', function() {sc_app_grid_log_valida_hora(this)});
    $('#SC_inserted_date_input_2_mes').bind('change', function() {sc_app_grid_log_valida_mes(this)});
    $('#SC_inserted_date_input_2_min').bind('change', function() {sc_app_grid_log_valida_min(this)});
    $('#SC_inserted_date_input_2_seg').bind('change', function() {sc_app_grid_log_valida_seg(this)});
    $('#SC_inserted_date_mes').bind('change', function() {sc_app_grid_log_valida_mes(this)});
    $('#SC_inserted_date_min').bind('change', function() {sc_app_grid_log_valida_min(this)});
    $('#SC_inserted_date_seg').bind('change', function() {sc_app_grid_log_valida_seg(this)});
 }
 ...
 function sc_app_grid_log_valida_hora(obj)
 {
 ...
 function sc_app_grid_log_valida_min(obj)
 {
 ...
 function sc_app_grid_log_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "PFM_Staff/app_grid_log";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_username'] = 'dselect';
      $tp_fields['SC_ip_user_cond'] = 'cond';
      $tp_fields['SC_ip_user'] = 'text_aut';
      $tp_fields['id_ac_ip_user'] = 'text_aut';
   ...
   function trata_campos()
   {
      ...
      if (!empty($ip_user_autocomp) && empty($ip_user))
      {
          $ip_user = $ip_user_autocomp;
      }
      if (!empty($username))
      {
          $username = explode("@?@", $username);
      ...
      $this->cmp_formatado['inserted_date'] = "'" . $this->cmp_formatado['inserted_date'] . "'";
      if (isset($this->cmp_formatado['inserted_date_input_2'])  && !empty($this->cmp_formatado['inserted_date_input_2'])) {
          $this->cmp_formatado['inserted_date_input_2'] = "'" . $this->cmp_formatado['inserted_date_input_2'] . "'";
      }
      $nmgp_def_dados = array();
    if ($application != '') {
      $application_look = (is_string($application) ? substr($this->Db->qstr($application), 1, -1) : $application); 
      ...
      $this->cmp_formatado['application'] = "'" . $this->cmp_formatado['application'] . "'";
      if (isset($this->cmp_formatado['application_input_2'])  && !empty($this->cmp_formatado['application_input_2'])) {
          $this->cmp_formatado['application_input_2'] = "'" . $this->cmp_formatado['application_input_2'] . "'";
      }
      ...
      $this->cmp_formatado['username'] = "'" . $this->cmp_formatado['username'] . "'";
      if (isset($this->cmp_formatado['username_input_2'])  && !empty($this->cmp_formatado['username_input_2'])) {
          $this->cmp_formatado['username_input_2'] = "'" . $this->cmp_formatado['username_input_2'] . "'";
      }
      $nmgp_def_dados = array();
    if ($ip_user != '') {
      $ip_user_look = (is_string($ip_user) ? substr($this->Db->qstr($ip_user), 1, -1) : $ip_user); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ip_user'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['ip_user'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ip_user'] = $ip_user;
      }
      $this->cmp_formatado['ip_user'] = "'" . $this->cmp_formatado['ip_user'] . "'";
      if (isset($this->cmp_formatado['ip_user_input_2'])  && !empty($this->cmp_formatado['ip_user_input_2'])) {
          $this->cmp_formatado['ip_user_input_2'] = "'" . $this->cmp_formatado['ip_user_input_2'] . "'";
      }
      ...
      $this->cmp_formatado['sc_field_0'] = "'" . $this->cmp_formatado['sc_field_0'] . "'";
      if (isset($this->cmp_formatado['sc_field_0_input_2'])  && !empty($this->cmp_formatado['sc_field_0_input_2'])) {
          $this->cmp_formatado['sc_field_0_input_2'] = "'" . $this->cmp_formatado['sc_field_0_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if ($inserted_date_cond != "bi_TP" && $Res_comp != 'calend')
      {
      ...
      {
         $this->monta_condicao("application", $application_cond, $application, "", "application", "VARCHAR", false);
      }
      ...
      if (is_array($username) && count($username) != 0)
      {
         ...
         if ($username_cond == "df" || $username_cond == "np")
         {
             ...
             $this->comando_sum    .= " sc_log.username not in (";
             $this->comando_filtro .= " username not in (";
         }
         else
         {
             $this->comando        .= " username in (";
             $this->comando_sum    .= " sc_log.username in (";
             $this->comando_filtro .= " username in (";
         }
         $x                     = count($username);
         $xx                    = 0;
         $nm_cond               = "";
         $Lang_concat = ($username_cond == "df" || $username_cond == "np") ? $this->Ini->Nm_lang['lang_srch_and_cond'] : $this->Ini->Nm_lang['lang_srch_orr_cond'];
         foreach ($username as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if ($tmp_pos === false)
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= $nmgp_tab_label['username'] . " " . $Lang_descr_final . " " . $nm_cond . "##*@@";
      }
      ...
      if (is_array($sc_field_0) && count($sc_field_0) != 0)
      {
         ...
         if ($sc_field_0_cond == "df" || $sc_field_0_cond == "np")
         {
             ...
             $this->comando_sum    .= " sc_log.`action` not in (";
             $this->comando_filtro .= " `action` not in (";
         }
         else
         {
             $this->comando        .= " `action` in (";
             $this->comando_sum    .= " sc_log.`action` in (";
             $this->comando_filtro .= " `action` in (";
         }
         $x                     = count($sc_field_0);
         $xx                    = 0;
         $nm_cond               = "";
         $Lang_concat = ($sc_field_0_cond == "df" || $sc_field_0_cond == "np") ? $this->Ini->Nm_lang['lang_srch_and_cond'] : $this->Ini->Nm_lang['lang_srch_orr_cond'];
         foreach ($sc_field_0 as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if ($tmp_pos === false)
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['cond_pesq'] .= $nmgp_tab_label['sc_field_0'] . " " . $Lang_descr_final . " " . $nm_cond . "##*@@";
      }
   ...
   function finaliza_resultado()
   {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_log']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
