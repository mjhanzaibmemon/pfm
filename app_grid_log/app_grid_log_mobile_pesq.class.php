...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_application_cond" name="application_cond" onChange="nm_campos_between(document.getElementById('id_vis_application'), this, 'application')">
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_username_cond" name="username_cond" onChange="nm_campos_between(document.getElementById('id_vis_username'), this, 'username')">
      ...
      <br><span id="id_hide_username"  <?php echo $str_hide_username?>>
<?php
...
?>
   <span id="idAjaxSelect_username">
      <SELECT class="scFilterObjectOdd" id="SC_username" name="username[]"  size="7" multiple>
<?php
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ip_user_cond" name="ip_user_cond" onChange="nm_campos_between(document.getElementById('id_vis_ip_user'), this, 'ip_user')">
      ...
      <br><span id="id_hide_ip_user"  <?php echo $str_hide_ip_user?>><?php
      if ($ip_user != "")
      {
      $ip_user_look = (is_string($ip_user) ? substr($this->Db->qstr($ip_user), 1, -1) : $ip_user); 
      $nmgp_def_dados = array(); 
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'username[]')
      {
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "username" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
