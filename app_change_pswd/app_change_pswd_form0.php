...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
else
{
    ...
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['link_info']['remove_background']) {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_old_pswd_line" id="hidden_field_data_old_pswd" style="<?php echo $sStyleHidden_old_pswd; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_old_pswd_label" style=""><span id="id_label_old_pswd"><?php echo $this->nm_new_label['old_pswd']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pswd_line" id="hidden_field_data_pswd" style="<?php echo $sStyleHidden_pswd; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_pswd_label" style=""><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_confirm_pswd_line" id="hidden_field_data_confirm_pswd" style="<?php echo $sStyleHidden_confirm_pswd; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_confirm_pswd_label" style=""><span id="id_label_confirm_pswd"><?php echo $this->nm_new_label['confirm_pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['php_cmp_required']['confirm_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_change_pswd']['php_cmp_required']['confirm_pswd'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></span><br>
