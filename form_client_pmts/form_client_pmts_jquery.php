...
function scEventControl_onCalculator_amt_received_() {
  if (!_scCalculatorControl["id_sc_field_amt_received_"]) {
    ...
    do_ajax_form_client_pmts_event_amt_received__onblur();
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_client_pmt_id_' + iSeqRow).bind('blur', function() { sc_form_client_pmts_client_pmt_id__onblur('#id_sc_field_client_pmt_id_' + iSeqRow, iSeqRow) })
                                            .bind('change', function() { sc_form_client_pmts_client_pmt_id__onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_client_pmts_client_pmt_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_client_id_' + iSeqRow).bind('change', function() { sc_form_client_pmts_client_id__onchange(this, iSeqRow) });
  $('#id_sc_field_pmt_mode_' + iSeqRow).bind('blur', function() { sc_form_client_pmts_pmt_mode__onblur('#id_sc_field_pmt_mode_' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_client_pmts_pmt_mode__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_client_pmts_pmt_mode__onfocus(this, iSeqRow) });
  $('#id_sc_field_reference_' + iSeqRow).bind('blur', function() { sc_form_client_pmts_reference__onblur('#id_sc_field_reference_' + iSeqRow, iSeqRow) })
                                        .bind('change', function() { sc_form_client_pmts_reference__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_client_pmts_reference__onfocus(this, iSeqRow) });
  $('#id_sc_field_pmt_date_' + iSeqRow).bind('blur', function() { sc_form_client_pmts_pmt_date__onblur('#id_sc_field_pmt_date_' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_client_pmts_pmt_date__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_client_pmts_pmt_date__onfocus(this, iSeqRow) });
  $('#id_sc_field_amt_received_' + iSeqRow).bind('blur', function() { sc_form_client_pmts_amt_received__onblur('#id_sc_field_amt_received_' + iSeqRow, iSeqRow) })
                                           .bind('change', function() { sc_form_client_pmts_amt_received__onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_client_pmts_amt_received__onfocus(this, iSeqRow) });
  $('#id_sc_field_remarks_' + iSeqRow).bind('blur', function() { sc_form_client_pmts_remarks__onblur('#id_sc_field_remarks_' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_client_pmts_remarks__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_client_pmts_remarks__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_client_pmts_client_pmt_id__onblur(oThis, iSeqRow) {
  do_ajax_form_client_pmts_validate_client_pmt_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_client_pmts_client_pmt_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_client_pmts_client_pmt_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_client_pmts_client_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_pmts_pmt_mode__onblur(oThis, iSeqRow) {
  do_ajax_form_client_pmts_validate_pmt_mode_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_client_pmts_pmt_mode__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_client_pmts_pmt_mode__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_client_pmts_reference__onblur(oThis, iSeqRow) {
  do_ajax_form_client_pmts_validate_reference_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_client_pmts_reference__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_client_pmts_reference__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_client_pmts_pmt_date__onblur(oThis, iSeqRow) {
  do_ajax_form_client_pmts_validate_pmt_date_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_client_pmts_pmt_date__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_client_pmts_pmt_date__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_client_pmts_amt_received__onblur(oThis, iSeqRow) {
  do_ajax_form_client_pmts_validate_amt_received_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_client_pmts_amt_received__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_client_pmts_amt_received__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_client_pmts_remarks__onblur(oThis, iSeqRow) {
  do_ajax_form_client_pmts_validate_remarks_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_client_pmts_remarks__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_client_pmts_remarks__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
        $("#id_form_client_pmts_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_client_pmts')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
