<?php
   ...
   include_once 'form_clients_steps_appn_stripe_test_embd_doc_name.php';
   ...
   if ($nm_cod_doc == "documento_db")
   {
       ...
       $trab_doc = $root . $_SESSION['scriptcase']['form_clients_steps_appn_stripe_test_embd']['glo_nm_path_imag_temp'] . "/" . $index_file;
