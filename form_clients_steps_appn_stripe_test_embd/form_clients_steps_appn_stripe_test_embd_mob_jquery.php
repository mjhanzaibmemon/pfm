...
function scHidePage(pageNo) {
        $("#id_form_clients_steps_appn_stripe_test_embd_mob_form" + pageNo).hide();
}
...
function scCheckNoPageSelected() {
        if (!$(".sc-form-page").filter(".scTabActive").filter(":visible").length) {
                ...
                if (inactiveTabs.length) {
                        var tabNo = $(inactiveTabs[0]).attr("id").substr(52);
                }
        }
}
...
function scJQCalendarAdd(iSeqRow) {
  ...
  $("#id_sc_field_starting_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_test_embd_mob_validate_starting_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_renewal_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_test_embd_mob_validate_renewal_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_expiration_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_test_embd_mob_validate_expiration_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_cancel_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_test_embd_mob_validate_cancel_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_retire_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_test_embd_mob_validate_retire_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_date_last_updated" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_test_embd_mob_validate_date_last_updated(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_archive_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_test_embd_mob_validate_archive_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_test_embd_mob_validate_record_created(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_permanent_member_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_steps_appn_stripe_test_embd_mob_validate_permanent_member_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_main_contact_img_id" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_clients_steps_appn_stripe_test_embd_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_clients_steps_appn_stripe_test_embd_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
...
var wizardActualStep = <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_test_embd_mob']['form_wizard']['actual_step']; ?>;
var wizardTotalSteps = <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_test_embd_mob']['form_wizard']['total_steps']; ?>;
...
function scJQWizardValidateStep(stepGoTo)
{
    if (0 == wizardActualStep) {
        do_ajax_form_clients_steps_appn_stripe_test_embd_mob_submit_page_0(stepGoTo);
    }
    if (1 == wizardActualStep) {
        do_ajax_form_clients_steps_appn_stripe_test_embd_mob_submit_page_1(stepGoTo);
    }
    if (2 == wizardActualStep) {
        do_ajax_form_clients_steps_appn_stripe_test_embd_mob_submit_page_2(stepGoTo);
    }
    if (3 == wizardActualStep) {
        do_ajax_form_clients_steps_appn_stripe_test_embd_mob_submit_page_3(stepGoTo);
    }
}
...
{
    $("#form_clients_steps_appn_stripe_test_embd_mob_form" + stepNo).css({
        "width": "1px",
        "height": "0",
        "display": "none",
        "overflow": "scroll",
