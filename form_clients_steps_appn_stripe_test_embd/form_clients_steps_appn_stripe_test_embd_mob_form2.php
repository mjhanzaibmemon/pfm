<div id="form_clients_steps_appn_stripe_test_embd_mob_form2" style='<?php echo (2 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_test_embd_mob']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
?> 
<img id="more_buyers_xlsx_img_uploading" style="display: none" border="0" src="<?php echo $this->Ini->path_icones; ?>/scriptcase__NM__ajax_load.gif" align="absmiddle" /><span id="id_ajax_doc_more_buyers_xlsx"><a href="javascript:nm_mostra_doc('2', '<?php echo str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_more_buyers_xlsx, 3)); ?>', 'form_clients_steps_appn_stripe_test_embd')"><?php echo $more_buyers_xlsx ?></a></span><div id="id_img_loader_more_buyers_xlsx" class="progress progress-success progress-striped active scProgressBarStart" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" style="display: none"><div class="bar scProgressBarLoading">&nbsp;</div></div><img id="id_ajax_loader_more_buyers_xlsx" src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ajax_load.gif" style="display: none" /></span><?php } ?>
