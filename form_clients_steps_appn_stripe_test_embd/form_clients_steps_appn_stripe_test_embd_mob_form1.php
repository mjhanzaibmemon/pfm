<div id="form_clients_steps_appn_stripe_test_embd_mob_form1" style='<?php echo (1 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_test_embd_mob']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
?> 
    ...
    <TD class="scFormDataOdd css_doc_type_line" id="hidden_field_data_doc_type" style="<?php echo $sStyleHidden_doc_type; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_doc_type_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_doc_type_label" style=""><span id="id_label_doc_type"><?php echo $this->nm_new_label['doc_type']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_test_embd_mob']['php_cmp_required']['doc_type']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_test_embd_mob']['php_cmp_required']['doc_type'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_test_embd_mob']['Lookup_doc_type'][] = 'Active Secretary of State Registration'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_test_embd_mob']['Lookup_doc_type'][] = 'City Business License'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_test_embd_mob']['Lookup_doc_type'][] = 'Agricultural License'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_steps_appn_stripe_test_embd_mob']['Lookup_doc_type'][] = 'Other type of document'; ?>
