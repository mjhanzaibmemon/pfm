...
class grid_vw_client_active_resumo
{
   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    function info_initializeInfo()
    {
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'ts' => [
                    'label' => sprintf("Approval date", "Approval"),
                    'datatype' => 'datetime',
                    'lowercase' => 'ts',
                    'summary_values_array' => 'array_total_ts',
                    'summary_line_values_array' => 'array_line_ts',
            ...
            'metric' => [
                'ts-C' => [
                    ...
                    'is_rating' => '' != '',
                    'rating_function' => '',
                    'format_function' => 'aux_format_ts_C',
                    'css_class' => "css_ts_cnt_field",
            ...
            'options' => [
                ...
                'order_initial_rule' => '',
                'order_metric_apply_to_dimensions' => ['ts'],
    ...
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_group_by'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_order'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_x_axys'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_y_axys'] = [];

        $dimensionCount = 0;

        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_x_axys'] [] = $dimensionCount;
        ...
        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['y'] as $dimensionName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_y_axys'] [] = $dimensionCount;

            $dimensionCount++;
        }

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['dimension_order'] = [];
        foreach ($this->SC_APP_info['dimension'] as $dimensionName => $dimensionInfo) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['dimension_order'] [$dimensionName] = $dimensionInfo['order_by_direction'];
        }
    }

    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['last_displayed_group_by'] = 'byDate';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('byDate' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['last_displayed_group_by'] = 'byDate';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        ...
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_using'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_using'] = false;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_name'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_rule'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_parameters'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pagination_length'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pagination_length'] = $this->SC_APP_data['pagination'] ['length'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pagination_first'] = $this->SC_APP_data['pagination'] ['first'];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['chart_info'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['chart_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_tabular'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_tabular'] = $this->SC_APP_info['options'] ['tabular'];
        }
        ...
        if ($this->SC_APP_info['options'] ['starting_group_by']) {
            if ('' != $this->SC_APP_info['options'] ['order_initial_metric'] && '' != $this->SC_APP_info['options'] ['order_initial_rule'] && !$this->aux_hasXAxysDimensionField()) {
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_name'] = $this->SC_APP_info['options'] ['order_initial_metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_rule'] = $this->SC_APP_info['options'] ['order_initial_rule'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_parameters'] = [];
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['has_limit_chart_items'] = $this->SC_APP_info['options'] ['has_limit_chart_items'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['limit_chart_items'] = '0';
        }
    }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_group_by'] as $dimensionIndex => $dimensionLabel) {
            $dimensionName = $this->SC_APP_info['group_by'] ['dimension'] ['order'] [$dimensionIndex];

            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] = 'label' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_order'] [$dimensionIndex] ? self::TOTAL_ARRAY_LABEL_INDEX : self::TOTAL_ARRAY_VALUE_INDEX;

            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_x_axys'])) {
                $this->SC_APP_info['group_by'] ['dimension'] ['x'] [] = $dimensionName;
            }
            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_y_axys'])) {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['summarizing_fields_order'] ['byDate'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['summarizing_fields_display'] ['byDate'] [$metricIndex] ['display']) {
                $this->SC_APP_info['group_by'] ['metric'] [] = $this->SC_APP_info['metric_by_index'] [$metricIndex];
            }
        }

        $this->SC_APP_info['options'] ['tabular'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pivot_tabular'];

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['dimension_order'] as $dimensionName => $dimensionOrder) {
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $dimensionOrder;
        }

        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['contr_array_resumo']) && 'NAO' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['contr_array_resumo']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pagination_first'] = 1;
        }
        $this->SC_APP_data['pagination'] ['length'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pagination_length'];
        $this->SC_APP_data['pagination'] ['first'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pagination_first'];

        $this->SC_APP_data['metric_order'] ['using'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_using'];
        $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_name'];
        $this->SC_APP_data['metric_order'] ['rule'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_rule'];
        $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_parameters'];
    }
    ...
    function info_changeSort_dimension()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['dimension_order'] [$sortDimension] = $sortRule;
    ...
    function info_changeSort_metric()
    {
        ...
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_info'] [$sortMetricMd5])) {
            if ('' != $sortRule) {
                $this->SC_APP_data['metric_order'] ['using'] = true;
                $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $this->SC_APP_data['metric_order'] ['rule'] = $sortRule;
                $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];

                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_rule'] = $sortRule;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];
            } else {
                $this->info_clearSort_metric();
            }
        }
    ...
    function info_changePagination_length()
    {
        if ('all' == strtolower($this->SC_APP_data['process'] ['parameters'] ['length'])) {
            $paginationLength = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pagination_record_count']; 
        } else {
            $paginationLength = (int)$this->SC_APP_data['process'] ['parameters'] ['length']; 
        }

        $this->SC_APP_data['pagination'] ['length'] = $paginationLength;
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pagination_length'] = $paginationLength;
    ...
    function info_changePagination_page()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pagination_first'] = $paginationFirst;
    }
    ...
    function info_changePagination_record()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pagination_first'] = $paginationRecord;
    }
    ...
    function info_setPagination()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['pagination_record_count'] = $this->SC_APP_data['pagination'] ['record_count'];
    ...
    function info_setComparisonLabels()
    {
        if ($this->aux_isComparison()) {
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_ORIGINAL] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['cond_pesq_compara'] [self::GROUPBY_ORIGINAL];
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_COMPARISON] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['cond_pesq_compara'] [self::GROUPBY_COMPARISON];
    ...
    {
        return isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['using_summary_cache']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['using_summary_cache'];
    }

    function info_saveSummaryCache()
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['using_summary_cache'] = true;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['summary_cache'] = [
    ...
    {
        $this->SC_APP_data['dimension_value_labels'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['summary_cache'] ['dimension_value_labels'];
        $this->SC_APP_data['ordered_x_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['summary_cache'] ['ordered_x_axys'];
        $this->SC_APP_data['ordered_y_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['summary_cache'] ['ordered_y_axys'];
        $this->SC_APP_data['ordered_x_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['summary_cache'] ['ordered_x_matrix'];
        $this->SC_APP_data['ordered_y_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['summary_cache'] ['ordered_y_matrix'];
    }

    function info_deleteSummaryCache()
    {
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['using_summary_cache'])) {
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['using_summary_cache']);
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['summary_cache']);
        }
    }
    ...
    function info_exportData()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['export_data'] = $exportData;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['export_info'] = [
            'dimension_count' => [
...
SCEOT;
    ...
    function display_js_chart()
    {
        ...
        $ajaxUrl = "{$this->Ini->path_link}grid_vw_client_active/index.php";
...
SCEOT;
    ...
    let windowName = "grid_vw_client_active_chart_window" + (Math.floor(Math.random() * 100) + 1);
...
SCEOT;
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if ($this->progress_fp) {
                grid_vw_client_active_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $chartLang . " " . $chartCount . "/" . $chartTotal . "...\n", $this->Ini->Nm_lang, true);
...
SCEOT;
        ...
        if ($chartFP) {
            ...
            grid_vw_client_active_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $pdfGenerateLang . "...
", $this->Ini->Nm_lang);
...
SCEOT;
    ...
    function aux_addChart($dimensionName, $metricName, $colDimensionValues, $rowDimensionValues, $isComparisonRow)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['chart_info'] [$chartMd5] = $chartInfo;
...
SCEOT;
    ...
    function aux_addOrderToMetric($metricLabel, $metricName, $parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['metric_order_info'] [$metricOrderMd5] = $orderInfo;
...
SCEOT;
    ...
    function aux_createLinkInfo($parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['LigR_Md5'] [$linkMd5] = $linkInfo;

        return '@SC_par@' . NM_encode_input($this->Ini->sc_page) . '@SC_par@grid_vw_client_active@SC_par@' . $linkMd5;
    }
...
SCEOT;
    ...
    function aux_displayPdfCharts()
    {
        if (!$this->aux_isPdf()) {
            return false;
        } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['skip_charts']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['skip_charts']) {
            return false;
    ...
    function aux_format_ts_C($value)
    {
        $isNegative = 0 > $value;
        $suffix = '';
    ...
    function aux_generatePhantomImage($chartMd5)
    {
        ...
        $imageUrlDir = "{$_SESSION['scriptcase'] ['grid_vw_client_active'] ['glo_nm_path_imag_temp']}/";
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_vw_client_active'] ['glo_nm_path_imag_temp']}/sc_pjs_js_{$phantomId}.js", $jsCode);
    }
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_vw_client_active'] ['glo_nm_path_imag_temp']}/sc_pjs_php_{$phantomId}.html", $htmlCode);
    }
    ...
    {
        if ('doc_word' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('doc_word_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('csv' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('csv_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('json' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('json_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        }

        if ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        }

        if ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        }
    ...
    function aux_isPdf()
    {
        if ('pdf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('print' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_client_active'] ['opcao']) {
            return true;
        }
...
SCEOT;
    ...
    function getChartInstance() {
        ...
        function generateChartImages() {
            $this->getChartInstance();
                ...
                $chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_charts'];
                $chartFiles = array();

                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['phantomjs_export_process'] = true;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_step']     = 'image';
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_count']    = 0;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_total']    = 0;
                ...
                foreach ($chartList as $chartKey => $chartData) {
                        ...
                        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_total']++;
                }
                ...
                foreach ($chartList as $chartKey => $chartData) {
                        ...
                        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['phantomjs_export_file'] = '';
                        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_count']++;

                        $this->writeProgressFile();

                        $this->Graf->generateChartImage($chartKey);

                        if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['phantomjs_export_file']) {
                                $chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['phantomjs_export_file'];
                        }
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['phantomjs_export_process'] = false;
        ...
        function zipChartImages($password = '') {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_step'] = 'zip';

                $this->writeProgressFile();

                $zipFile = $this->zipFileList($chartImages, $password);

                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_step'] = 'end';
        ...
        function zipFileList($fileList, $password = '') {
                $tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_vw_client_active']['glo_nm_path_imag_temp'] . '/';
        ...
        function writeProgressFile() {
                if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_step']) {
                        $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_total'] + 1));
                        $content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_total']}###$progress";

                        $content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
                }
                elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_step']) {
                        $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_total'] + 1));
                        $content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

                        $content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
                }
                elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_step']) {
                        $content = "ok###100";
                }
                else {
                        $content = "init###0";
                ...
                $f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_vw_client_active']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['export_progress_file']}", 'w');
                fwrite($f, $content);
                fclose($f);
        }
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_resumo'] = "";
      }
      $this->inicializa_vars();
        $this->info_initializeSummary();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_ts = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['arr_total_line']['ts'];
            }
          $this->array_total_ts = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['arr_total']['ts'];
          $this->array_total_geral = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['tot_geral_res'];
          $this->NM_res_sem_reg    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['res_sem_reg'];
          $this->Tem_Res_Compara   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['res_compara'];
      }
      else
      {
            $this->info_deleteSummaryCache();
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['SC_force_fiels_gb'] = $forceFields;
                $this->array_total_ts = array();
                $this->totaliza();
                ...
                $this->array_line_ts = $this->array_total_ts;
                $forceFields = [];
                foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                    $forceFields[] = $this->SC_APP_info['dimension'] [$dimensionName] ['lowercase'];
                }
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['SC_force_fiels_gb'] = $forceFields;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['SC_clear_total'] = true;
            }
          $this->array_total_ts = array();
          $this->totaliza('main');
          if ($this->Tem_Res_Compara) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['arr_total']['ts'] = $this->array_total_ts;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['arr_total_line']['ts'] = $this->array_line_ts;
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['SC_force_fiels_gb']);
            }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['contr_array_resumo'] = "OK";
      }
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          if ($this->aux_useNewSummary()) {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['json_use_label'])
       {
          $Lab_ts = "ts";
       }
       else
       {
       $Lab_ts = "Approval";
       $Lab_ts =  sprintf("Approval date", $Lab_ts);
       }
       $this->comp_field = array(
           $Lab_ts,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['client_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['client_id'] = "ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['co_name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['co_name'] = "Company"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['street_address']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['street_address'] = "Street Address"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['city']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['city'] = "City"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['renewal_date']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['renewal_date'] = "Renewal Date"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['status'] = "Status"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['ts']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['labels']['ts'] = "Approved"; 
       }
       //-----
       $this->comp_field_nm = array(
           'ts' => 0,
       ...
       //-----
       $this->comp_sum = array(
           2 => "Ts (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['summarizing_fields_order']['byDate']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['summarizing_fields_order']['byDate'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['summarizing_fields_order']['byDate'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['summarizing_fields_display']['byDate'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['summarizing_fields_display']['byDate'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['summarizing_fields_display']['byDate'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['summarizing_fields_display']['byDate'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['summarizing_fields_display']['byDate'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['summarizing_fields_display']['byDate'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['summarizing_fields_display']['byDate'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_ts as $i_ts => $d_ts) {
           if (!isset($i_ts, $this->comp_label[0]) || !in_array($i_ts, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_ts[3] ] = $d_ts[2];
               $this->comp_label[0][ $d_ts[3] ] = $d_ts[2];
           }
       }
       ...
       //-----
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_ts => $l_ts) {
           if (isset($this->array_total_ts[$i_ts])) {
               $this->comp_group[$i_ts] = array();
           }
       }
     }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_vw_client_active@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
          require_once($this->Ini->path_aplicacao . "grid_vw_client_active_total.class.php"); 
      }
      ...
      $this->Total   = new grid_vw_client_active_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['LigR_Md5'] = array();
   }
   ...
   function totaliza($tipo='')
   {
      ...
      $save_where_pesq = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq'];
      $where_compara   = "";
      $this->Total->Calc_resumo_byDate("res", $this->NM_export, 1, $tipo);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_dyn_compara'])) )
       {
          $tmp_cmd = "";
          ...
          if  (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq_compara']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq_compara'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq_compara'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq_compara'] . ")"; 
              }
          }
          elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq_filtro'])) {
              if (!empty($tmp_cmd)) {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq_fast'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq_fast'] . ")";
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq_fast'] . ")";
              }
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_resumo_search_2']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_resumo_search_2'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_resumo_search_2'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_resumo_search_2'] . ")"; 
               }
          }
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_resumo_search'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_resumo_search'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_resumo_search'] . ")"; 
               }
          }
          $where_compara = $tmp_cmd;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq'] = $tmp_cmd;
          $this->Total->Calc_resumo_byDate("res", $this->NM_export, 2, $tipo);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq'] = $save_where_pesq;
          $this->Tem_Res_Compara = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['res_compara'] = $this->Tem_Res_Compara;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_ts)) {
          ksort($this->array_total_ts);
      }
      $this->NM_res_sem_reg = true;
      $Sv_tot_ger  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['tot_geral'];
      $Sv_flag_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['contr_total_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      $this->array_total_geral = array();
      $this->array_total_geral[1][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['tot_geral'][2];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['tot_geral'][1] > 0) {
          $this->NM_res_sem_reg = false;
      }
      if ($this->Tem_Res_Compara) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq'] = $where_compara;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['contr_total_geral'] = "N";
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['SC_Ind_Groupby'];
          $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['Res_search_metric_use'])) ? true : false;
          $this->Total->$Gb_geral($tp_tot, $this->NM_export);
          $this->array_total_geral[2][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['tot_geral'][2];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['tot_geral_res']     = $this->array_total_geral;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['tot_geral']         = $Sv_tot_ger;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['contr_total_geral'] = $Sv_flag_tot;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['res_sem_reg']       = $this->NM_res_sem_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['where_pesq']        = $save_where_pesq;
      if ("out" == $this->NM_tipo)
      {
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE html>\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['ajax_nav']) {  
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_vw_client_active_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_vw_client_active_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_vw_client_active_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
      ...
      $nm_saida->saida("<TD style=\"padding: 0px; vertical-align: initial\" class='sc-mobile-inner-control'>\r\n");
       $tableHeight = "";
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['dashboard_info']['under_dashboard'])
       {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=en_us&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_vw_client_active&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_vw_client_active&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=en_us&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume&nm_all_modules=grid,resume&nm_json_format=N&nm_json_label=S&language=en_us&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=en_us&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['opc_psq'] && !$this->grid_emb_form)
      {
         ...
         if (is_file("grid_vw_client_active_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=en_us&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_vw_client_active&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=en_us&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rjson_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['json'][] = "Rjson_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume&nm_all_modules=grid,resume&nm_json_format=N&nm_json_label=S&language=en_us&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=en_us&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rprinttop\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['print'][] = "Rprint_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_vw_client_active']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_vw_client_active']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_vw_client_active_config_pivot.php?nome_apl=grid_vw_client_active&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_vw_client_active_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_vw_client_active_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_vw_client_active/grid_vw_client_active_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $client_id = (isset($Busca_temp['client_id'])) ? $Busca_temp['client_id'] : ""; 
          $tmp_pos = (is_string($client_id)) ? strpos($client_id, "##@@") : false;
          if ($tmp_pos !== false && !is_array($client_id))
          {
              $client_id = substr($client_id, 0, $tmp_pos);
          }
          $co_name = (isset($Busca_temp['co_name'])) ? $Busca_temp['co_name'] : ""; 
          $tmp_pos = (is_string($co_name)) ? strpos($co_name, "##@@") : false;
          if ($tmp_pos !== false && !is_array($co_name))
          {
              $co_name = substr($co_name, 0, $tmp_pos);
          }
          $street_address = (isset($Busca_temp['street_address'])) ? $Busca_temp['street_address'] : ""; 
          $tmp_pos = (is_string($street_address)) ? strpos($street_address, "##@@") : false;
          if ($tmp_pos !== false && !is_array($street_address))
          {
              $street_address = substr($street_address, 0, $tmp_pos);
          }
          $city = (isset($Busca_temp['city'])) ? $Busca_temp['city'] : ""; 
          $tmp_pos = (is_string($city)) ? strpos($city, "##@@") : false;
          if ($tmp_pos !== false && !is_array($city))
          {
              $city = substr($city, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_client_active']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " vw_client_active</div>\r\n");
   ...
   //---- 
   function adiciona_registro($cnt_ts, $quebra_ts, $quebra_ts_orig)
   {
      //----- Approval date
      if (!isset($this->array_total_ts[$quebra_ts_orig]))
      {
         $this->array_total_ts[$quebra_ts_orig][0] = 1;
         $this->array_total_ts[$quebra_ts_orig][1] = 1;
         $this->array_total_ts[$quebra_ts_orig][2] = $quebra_ts;
         $this->array_total_ts[$quebra_ts_orig][3] = $quebra_ts_orig;
      }
      else
      {
         $this->array_total_ts[$quebra_ts_orig][0]++;
         $this->array_total_ts[$quebra_ts_orig][1] ++;
      }
   }
   ...
   {
      if (isset($this->array_total_ts))
      {
         $arr_temp_0 = $this->array_total_ts;
         foreach ($this->array_total_ts as $campo_ts => $dados_ts)
         {
            $ind_exists  = "";
            $ind_missing = "";
            if (!isset($this->array_total_ts[$campo_ts][1])) {
                $ind_exists  = 2;
                $ind_missing = 1;
            }
            if (!isset($this->array_total_ts[$campo_ts][2])) {
                $ind_exists  = 1;
                $ind_missing = 2;
            }
            if (!empty($ind_missing)) {
                $arr_temp_0[$campo_ts][$ind_missing][0] = 0;
                $arr_temp_0[$campo_ts][$ind_missing][1] = 0;
                $arr_temp_0[$campo_ts][$ind_missing][2] = $dados_ts[$ind_exists][2];
                $arr_temp_0[$campo_ts][$ind_missing][3] = $dados_ts[$ind_exists][3];
            }
            ksort($arr_temp_0[$campo_ts]);
            $this->array_total_ts[$campo_ts] = $arr_temp_0[$campo_ts];
         } 
      } 
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->co_name = $Busca_temp['co_name']; 
       $this->co_name = (isset($Busca_temp['co_name'])) ? $Busca_temp['co_name'] : ""; 
       $tmp_pos = (is_string($this->co_name)) ? strpos($this->co_name, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->co_name))
       {
       ...
       $this->street_address = $Busca_temp['street_address']; 
       $this->street_address = (isset($Busca_temp['street_address'])) ? $Busca_temp['street_address'] : ""; 
       $tmp_pos = (is_string($this->street_address)) ? strpos($this->street_address, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->street_address))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('byDate', 'ts');
     $campos_order = $this->Ini->Get_date_order_groupby("ts", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->client_id = $rs_res->fields[0] ;  
            $this->co_name = $rs_res->fields[1] ;  
            $this->street_address = $rs_res->fields[2] ;  
            $this->city = $rs_res->fields[3] ;  
            $this->renewal_date = $rs_res->fields[4] ;  
            $this->status = $rs_res->fields[5] ;  
            $this->ts = $rs_res->fields[6] ;  
            ...
            $this->ts_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->ts, $Format_tst);
            $this->ts = $this->Ini->GB_date_format($TP_Time . $this->ts, $Format_tst, $Prefix_dat, "N", "M-d-Y");
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->ts, $this->ts, $this->ts_orig);
            }
   }
//
