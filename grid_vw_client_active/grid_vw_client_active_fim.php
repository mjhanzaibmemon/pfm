...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PFM_Staff_____grid_vw_client_active"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PFM_Staff_____grid_vw_client_active"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vw_client_active']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_vw_client_active']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vw_client_active']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_vw_client_active']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_vw_client_active']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_vw_client_active</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_vw_client_active']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_vw_client_active']['embutida_filho'] as $ind => $sc_init)
          {
