<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vw_client_active']['sc_process_barr'] = true;
require_once('../grid_vw_client_active/index.php');
unset($_SESSION['scriptcase']['grid_vw_client_active']['sc_process_barr']);
$ExportCtrl = new grid_vw_client_active_export_control;
$ExportCtrl->Export_barr();

class grid_vw_client_active_export_control
{
