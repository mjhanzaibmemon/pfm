...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_client_id' + iSeqRow).bind('blur', function() { sc_form_clients_staff_client_id_onblur('#id_sc_field_client_id' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_clients_staff_client_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_membershipid' + iSeqRow).bind('blur', function() { sc_form_clients_staff_membershipid_onblur('#id_sc_field_membershipid' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_form_clients_staff_membershipid_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_appn_id' + iSeqRow).bind('change', function() { sc_form_clients_staff_appn_id_onchange(this, iSeqRow) });
  $('#id_sc_field_co_name' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_clients_staff_co_name_onblur('#id_sc_field_co_name' + iSeqRow, iSeqRow);}, 300) })
                                     .bind('change', function() { sc_form_clients_staff_co_name_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_clients_staff_co_name_onfocus(this, iSeqRow) });
  $('#id_sc_field_ofa_contact' + iSeqRow).bind('change', function() { sc_form_clients_staff_ofa_contact_onchange(this, iSeqRow) });
  $('#id_sc_field_street_address' + iSeqRow).bind('change', function() { sc_form_clients_staff_street_address_onchange(this, iSeqRow) });
  $('#id_sc_field_mailing_address' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_clients_staff_mailing_address_onblur('#id_sc_field_mailing_address' + iSeqRow, iSeqRow);}, 300) })
                                             .bind('change', function() { sc_form_clients_staff_mailing_address_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_city' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_clients_staff_city_onblur('#id_sc_field_city' + iSeqRow, iSeqRow);}, 300) })
                                  .bind('change', function() { sc_form_clients_staff_city_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_state' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_clients_staff_state_onblur('#id_sc_field_state' + iSeqRow, iSeqRow);}, 300) })
                                   .bind('change', function() { sc_form_clients_staff_state_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_zip_code' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_clients_staff_zip_code_onblur('#id_sc_field_zip_code' + iSeqRow, iSeqRow);}, 300) })
                                      .bind('change', function() { sc_form_clients_staff_zip_code_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_clients_staff_zip_code_onfocus(this, iSeqRow) });
  $('#id_sc_field_phone_number' + iSeqRow).bind('change', function() { sc_form_clients_staff_phone_number_onchange(this, iSeqRow) });
  $('#id_sc_field_home_phone' + iSeqRow).bind('change', function() { sc_form_clients_staff_home_phone_onchange(this, iSeqRow) });
  $('#id_sc_field_fax_number' + iSeqRow).bind('change', function() { sc_form_clients_staff_fax_number_onchange(this, iSeqRow) });
  $('#id_sc_field_email' + iSeqRow).bind('change', function() { sc_form_clients_staff_email_onchange(this, iSeqRow) });
  $('#id_sc_field_business_type' + iSeqRow).bind('change', function() { sc_form_clients_staff_business_type_onchange(this, iSeqRow) });
  $('#id_sc_field_fresh_cut_allowed' + iSeqRow).bind('change', function() { sc_form_clients_staff_fresh_cut_allowed_onchange(this, iSeqRow) });
  $('#id_sc_field_business_license' + iSeqRow).bind('change', function() { sc_form_clients_staff_business_license_onchange(this, iSeqRow) });
  $('#id_sc_field_nursery_license' + iSeqRow).bind('change', function() { sc_form_clients_staff_nursery_license_onchange(this, iSeqRow) });
  $('#id_sc_field_federal_tax_id' + iSeqRow).bind('change', function() { sc_form_clients_staff_federal_tax_id_onchange(this, iSeqRow) });
  $('#id_sc_field_temporary_pass' + iSeqRow).bind('change', function() { sc_form_clients_staff_temporary_pass_onchange(this, iSeqRow) });
  $('#id_sc_field_ofa_member' + iSeqRow).bind('change', function() { sc_form_clients_staff_ofa_member_onchange(this, iSeqRow) });
  $('#id_sc_field_starting_date' + iSeqRow).bind('change', function() { sc_form_clients_staff_starting_date_onchange(this, iSeqRow) });
  $('#id_sc_field_renewal_date' + iSeqRow).bind('blur', function() { sc_form_clients_staff_renewal_date_onblur('#id_sc_field_renewal_date' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_form_clients_staff_renewal_date_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_clients_staff_renewal_date_onfocus(this, iSeqRow) });
  $('#id_sc_field_expiration_date' + iSeqRow).bind('change', function() { sc_form_clients_staff_expiration_date_onchange(this, iSeqRow) });
  $('#id_sc_field_canceled' + iSeqRow).bind('change', function() { sc_form_clients_staff_canceled_onchange(this, iSeqRow) });
  $('#id_sc_field_cancel_date' + iSeqRow).bind('change', function() { sc_form_clients_staff_cancel_date_onchange(this, iSeqRow) });
  $('#id_sc_field_canceled_by' + iSeqRow).bind('change', function() { sc_form_clients_staff_canceled_by_onchange(this, iSeqRow) });
  $('#id_sc_field_reason_canceled' + iSeqRow).bind('change', function() { sc_form_clients_staff_reason_canceled_onchange(this, iSeqRow) });
  $('#id_sc_field_retire_date' + iSeqRow).bind('change', function() { sc_form_clients_staff_retire_date_onchange(this, iSeqRow) });
  $('#id_sc_field_verified_receipts' + iSeqRow).bind('change', function() { sc_form_clients_staff_verified_receipts_onchange(this, iSeqRow) });
  $('#id_sc_field_date_last_updated' + iSeqRow).bind('change', function() { sc_form_clients_staff_date_last_updated_onchange(this, iSeqRow) });
  $('#id_sc_field_restricted' + iSeqRow).bind('change', function() { sc_form_clients_staff_restricted_onchange(this, iSeqRow) });
  $('#id_sc_field_committee_approval_required' + iSeqRow).bind('change', function() { sc_form_clients_staff_committee_approval_required_onchange(this, iSeqRow) });
  $('#id_sc_field_type_company' + iSeqRow).bind('change', function() { sc_form_clients_staff_type_company_onchange(this, iSeqRow) });
  $('#id_sc_field_archive' + iSeqRow).bind('change', function() { sc_form_clients_staff_archive_onchange(this, iSeqRow) });
  $('#id_sc_field_archive_date' + iSeqRow).bind('change', function() { sc_form_clients_staff_archive_date_onchange(this, iSeqRow) });
  $('#id_sc_field_pricing_level_id' + iSeqRow).bind('blur', function() { sc_form_clients_staff_pricing_level_id_onblur('#id_sc_field_pricing_level_id' + iSeqRow, iSeqRow) })
                                              .bind('change', function() { sc_form_clients_staff_pricing_level_id_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_clients_staff_pricing_level_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_store_front_address' + iSeqRow).bind('change', function() { sc_form_clients_staff_store_front_address_onchange(this, iSeqRow) });
  $('#id_sc_field_store_front_city' + iSeqRow).bind('change', function() { sc_form_clients_staff_store_front_city_onchange(this, iSeqRow) });
  $('#id_sc_field_store_front_zip' + iSeqRow).bind('change', function() { sc_form_clients_staff_store_front_zip_onchange(this, iSeqRow) });
  $('#id_sc_field_home_base_address' + iSeqRow).bind('change', function() { sc_form_clients_staff_home_base_address_onchange(this, iSeqRow) });
  $('#id_sc_field_home_base_city' + iSeqRow).bind('change', function() { sc_form_clients_staff_home_base_city_onchange(this, iSeqRow) });
  $('#id_sc_field_home_base_zip' + iSeqRow).bind('change', function() { sc_form_clients_staff_home_base_zip_onchange(this, iSeqRow) });
  $('#id_sc_field_store_front_state' + iSeqRow).bind('change', function() { sc_form_clients_staff_store_front_state_onchange(this, iSeqRow) });
  $('#id_sc_field_home_base_state' + iSeqRow).bind('change', function() { sc_form_clients_staff_home_base_state_onchange(this, iSeqRow) });
  $('#id_sc_field_record_created' + iSeqRow).bind('change', function() { sc_form_clients_staff_record_created_onchange(this, iSeqRow) });
  $('#id_sc_field_record_created_hora' + iSeqRow).bind('change', function() { sc_form_clients_staff_record_created_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_permanent_member_date' + iSeqRow).bind('blur', function() { sc_form_clients_staff_permanent_member_date_onblur('#id_sc_field_permanent_member_date' + iSeqRow, iSeqRow) })
                                                   .bind('change', function() { sc_form_clients_staff_permanent_member_date_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_acct_instagram' + iSeqRow).bind('blur', function() { sc_form_clients_staff_acct_instagram_onblur('#id_sc_field_acct_instagram' + iSeqRow, iSeqRow) })
                                            .bind('change', function() { sc_form_clients_staff_acct_instagram_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_acct_facebook' + iSeqRow).bind('blur', function() { sc_form_clients_staff_acct_facebook_onblur('#id_sc_field_acct_facebook' + iSeqRow, iSeqRow) })
                                           .bind('change', function() { sc_form_clients_staff_acct_facebook_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_website_url' + iSeqRow).bind('blur', function() { sc_form_clients_staff_website_url_onblur('#id_sc_field_website_url' + iSeqRow, iSeqRow) })
                                         .bind('change', function() { sc_form_clients_staff_website_url_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_bus_subcat_other' + iSeqRow).bind('blur', function() { sc_form_clients_staff_bus_subcat_other_onblur('#id_sc_field_bus_subcat_other' + iSeqRow, iSeqRow) })
                                              .bind('change', function() { sc_form_clients_staff_bus_subcat_other_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_clients_staff_bus_subcat_other_onfocus(this, iSeqRow) });
  $('#id_sc_field_appn_date' + iSeqRow).bind('change', function() { sc_form_clients_staff_appn_date_onchange(this, iSeqRow) });
  $('#id_sc_field_appn_note' + iSeqRow).bind('change', function() { sc_form_clients_staff_appn_note_onchange(this, iSeqRow) });
  $('#id_sc_field_doc_sec_of_state' + iSeqRow).bind('change', function() { sc_form_clients_staff_doc_sec_of_state_onchange(this, iSeqRow) });
  $('#id_sc_field_doc_city_bus_lic' + iSeqRow).bind('change', function() { sc_form_clients_staff_doc_city_bus_lic_onchange(this, iSeqRow) });
  $('#id_sc_field_doc_agric_lic' + iSeqRow).bind('change', function() { sc_form_clients_staff_doc_agric_lic_onchange(this, iSeqRow) });
  $('#id_sc_field_doc_last_year_tax' + iSeqRow).bind('change', function() { sc_form_clients_staff_doc_last_year_tax_onchange(this, iSeqRow) });
  $('#id_sc_field_qb_id' + iSeqRow).bind('change', function() { sc_form_clients_staff_qb_id_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_main_contact_img_id' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_clients_staff_main_contact_img_id_onblur('#id_sc_field_main_contact_img_id' + iSeqRow, iSeqRow);}, 300) })
                                                 .bind('change', function() { sc_form_clients_staff_main_contact_img_id_onchange(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_clients_staff_main_contact_img_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_main_contact_img_file' + iSeqRow).bind('change', function() { sc_form_clients_staff_main_contact_img_file_onchange(this, iSeqRow) });
  $('#id_sc_field_main_contact_img_size' + iSeqRow).bind('change', function() { sc_form_clients_staff_main_contact_img_size_onchange(this, iSeqRow) });
  $('#id_sc_field_main_contact_img_id_prev' + iSeqRow).bind('change', function() { sc_form_clients_staff_main_contact_img_id_prev_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_qty' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_qty_onchange(this, iSeqRow) });
  $('#id_sc_field_doc_type' + iSeqRow).bind('change', function() { sc_form_clients_staff_doc_type_onchange(this, iSeqRow) });
  $('#id_sc_field_doc_file' + iSeqRow).bind('change', function() { sc_form_clients_staff_doc_file_onchange(this, iSeqRow) });
  $('#id_sc_field_doc_filename' + iSeqRow).bind('change', function() { sc_form_clients_staff_doc_filename_onchange(this, iSeqRow) });
  $('#id_sc_field_doc_filesize' + iSeqRow).bind('change', function() { sc_form_clients_staff_doc_filesize_onchange(this, iSeqRow) });
  $('#id_sc_field_applicant_name' + iSeqRow).bind('change', function() { sc_form_clients_staff_applicant_name_onchange(this, iSeqRow) });
  $('#id_sc_field_applicant_signature' + iSeqRow).bind('change', function() { sc_form_clients_staff_applicant_signature_onchange(this, iSeqRow) });
  $('#id_sc_field_applicant_title' + iSeqRow).bind('change', function() { sc_form_clients_staff_applicant_title_onchange(this, iSeqRow) });
  $('#id_sc_field_addtl_memb_mail' + iSeqRow).bind('change', function() { sc_form_clients_staff_addtl_memb_mail_onchange(this, iSeqRow) });
  $('#id_sc_field_adtl_memb_name' + iSeqRow).bind('change', function() { sc_form_clients_staff_adtl_memb_name_onchange(this, iSeqRow) });
  $('#id_sc_field_adtl_memb_note' + iSeqRow).bind('change', function() { sc_form_clients_staff_adtl_memb_note_onchange(this, iSeqRow) });
  $('#id_sc_field_adtl_memb_phone' + iSeqRow).bind('change', function() { sc_form_clients_staff_adtl_memb_phone_onchange(this, iSeqRow) });
  $('#id_sc_field_client_pmts' + iSeqRow).bind('blur', function() { sc_form_clients_staff_client_pmts_onblur('#id_sc_field_client_pmts' + iSeqRow, iSeqRow) })
                                         .bind('change', function() { sc_form_clients_staff_client_pmts_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_docs' + iSeqRow).bind('blur', function() { sc_form_clients_staff_docs_onblur('#id_sc_field_docs' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_clients_staff_docs_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_clients_staff_docs_onfocus(this, iSeqRow) });
  $('#id_sc_field_dummy01' + iSeqRow).bind('change', function() { sc_form_clients_staff_dummy01_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy02' + iSeqRow).bind('blur', function() { sc_form_clients_staff_dummy02_onblur('#id_sc_field_dummy02' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_clients_staff_dummy02_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_clients_staff_dummy02_onfocus(this, iSeqRow) });
  $('#id_sc_field_dummy03' + iSeqRow).bind('change', function() { sc_form_clients_staff_dummy03_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy04' + iSeqRow).bind('change', function() { sc_form_clients_staff_dummy04_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy05' + iSeqRow).bind('change', function() { sc_form_clients_staff_dummy05_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy06' + iSeqRow).bind('change', function() { sc_form_clients_staff_dummy06_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy07' + iSeqRow).bind('blur', function() { sc_form_clients_staff_dummy07_onblur('#id_sc_field_dummy07' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_clients_staff_dummy07_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dummy08' + iSeqRow).bind('blur', function() { sc_form_clients_staff_dummy08_onblur('#id_sc_field_dummy08' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_clients_staff_dummy08_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_clients_staff_dummy08_onfocus(this, iSeqRow) });
  $('#id_sc_field_dummy09' + iSeqRow).bind('change', function() { sc_form_clients_staff_dummy09_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy10' + iSeqRow).bind('change', function() { sc_form_clients_staff_dummy10_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy11' + iSeqRow).bind('change', function() { sc_form_clients_staff_dummy11_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy12' + iSeqRow).bind('change', function() { sc_form_clients_staff_dummy12_onchange(this, iSeqRow) });
  $('#id_sc_field_dummy13' + iSeqRow).bind('change', function() { sc_form_clients_staff_dummy13_onchange(this, iSeqRow) });
  $('#id_sc_field_est_memb_cost' + iSeqRow).bind('change', function() { sc_form_clients_staff_est_memb_cost_onchange(this, iSeqRow) });
  $('#id_sc_field_main_contact_title_lbl' + iSeqRow).bind('change', function() { sc_form_clients_staff_main_contact_title_lbl_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_01' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_01_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_02' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_02_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_03' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_03_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_04' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_04_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_05' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_05_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_06' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_06_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_07' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_07_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_08' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_08_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_09' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_09_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_10' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_10_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_11' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_11_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_12' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_12_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_13' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_13_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_email' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_email_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_levels' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_levels_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_list' + iSeqRow).bind('blur', function() { sc_form_clients_staff_memb_list_onblur('#id_sc_field_memb_list' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_clients_staff_memb_list_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_clients_staff_memb_list_onfocus(this, iSeqRow) });
  $('#id_sc_field_memb_name' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_name_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_note' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_note_onchange(this, iSeqRow) });
  $('#id_sc_field_memb_phone' + iSeqRow).bind('change', function() { sc_form_clients_staff_memb_phone_onchange(this, iSeqRow) });
  $('#id_sc_field_notes' + iSeqRow).bind('blur', function() { sc_form_clients_staff_notes_onblur('#id_sc_field_notes' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_form_clients_staff_notes_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_clients_staff_notes_onfocus(this, iSeqRow) });
  $('#id_sc_field_paid' + iSeqRow).bind('change', function() { sc_form_clients_staff_paid_onchange(this, iSeqRow) });
  $('#id_sc_field_pay' + iSeqRow).bind('change', function() { sc_form_clients_staff_pay_onchange(this, iSeqRow) });
  $('#id_sc_field_read_at_sign' + iSeqRow).bind('change', function() { sc_form_clients_staff_read_at_sign_onchange(this, iSeqRow) });
  $('#id_sc_field_rules' + iSeqRow).bind('change', function() { sc_form_clients_staff_rules_onchange(this, iSeqRow) });
  $('#id_sc_field_rules_warn' + iSeqRow).bind('change', function() { sc_form_clients_staff_rules_warn_onchange(this, iSeqRow) });
  $('#id_sc_field_submitted' + iSeqRow).bind('change', function() { sc_form_clients_staff_submitted_onchange(this, iSeqRow) });
  $('#id_sc_field_transaction' + iSeqRow).bind('change', function() { sc_form_clients_staff_transaction_onchange(this, iSeqRow) });
  $('#id_sc_field_xlsx_sample' + iSeqRow).bind('change', function() { sc_form_clients_staff_xlsx_sample_onchange(this, iSeqRow) });
  $('#id_sc_field_js_prod_price' + iSeqRow).bind('blur', function() { sc_form_clients_staff_js_prod_price_onblur('#id_sc_field_js_prod_price' + iSeqRow, iSeqRow) })
                                           .bind('change', function() { sc_form_clients_staff_js_prod_price_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_js_strp_price_id' + iSeqRow).bind('blur', function() { sc_form_clients_staff_js_strp_price_id_onblur('#id_sc_field_js_strp_price_id' + iSeqRow, iSeqRow) })
                                              .bind('change', function() { sc_form_clients_staff_js_strp_price_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_js_mbr_ct' + iSeqRow).bind('blur', function() { sc_form_clients_staff_js_mbr_ct_onblur('#id_sc_field_js_mbr_ct' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_clients_staff_js_mbr_ct_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_js_client_id' + iSeqRow).bind('blur', function() { sc_form_clients_staff_js_client_id_onblur('#id_sc_field_js_client_id' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_form_clients_staff_js_client_id_onchange(this, iSeqRow) })
...
function sc_form_clients_staff_client_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_membershipid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_appn_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_co_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_ofa_contact_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_street_address_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_mailing_address_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_city_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_state_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_zip_code_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_phone_number_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_home_phone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_fax_number_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_business_type_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_fresh_cut_allowed_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_business_license_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_nursery_license_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_federal_tax_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_temporary_pass_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_ofa_member_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_starting_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_renewal_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_expiration_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_canceled_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_cancel_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_canceled_by_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_reason_canceled_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_retire_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_verified_receipts_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_date_last_updated_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_restricted_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_committee_approval_required_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_type_company_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_archive_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_archive_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_pricing_level_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_store_front_address_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_store_front_city_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_store_front_zip_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_home_base_address_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_home_base_city_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_home_base_zip_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_store_front_state_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_home_base_state_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_record_created_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_record_created_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_permanent_member_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_acct_instagram_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_acct_facebook_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_website_url_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_bus_subcat_other_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_appn_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_appn_note_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_doc_sec_of_state_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_doc_city_bus_lic_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_doc_agric_lic_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_doc_last_year_tax_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_qb_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_main_contact_img_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_main_contact_img_file_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_main_contact_img_size_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_main_contact_img_id_prev_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_qty_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_doc_type_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_doc_file_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_doc_filename_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_doc_filesize_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_applicant_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_applicant_signature_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_applicant_title_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_addtl_memb_mail_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_adtl_memb_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_adtl_memb_note_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_adtl_memb_phone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_client_pmts_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_docs_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_dummy01_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_dummy02_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_dummy03_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_dummy04_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_dummy05_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_dummy06_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_dummy07_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_dummy08_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_dummy09_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_dummy10_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_dummy11_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_dummy12_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_dummy13_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_est_memb_cost_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_main_contact_title_lbl_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_01_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_02_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_03_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_04_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_05_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_06_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_07_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_08_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_09_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_10_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_11_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_12_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_13_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_levels_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_memb_list_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_memb_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_note_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_memb_phone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_notes_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_paid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_pay_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_read_at_sign_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_rules_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_rules_warn_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_submitted_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_transaction_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_clients_staff_xlsx_sample_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_js_prod_price_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_js_strp_price_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_js_mbr_ct_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_clients_staff_js_client_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_memb_list(row, status) {
    var fieldId;
        if ("on" == status && typeof $("#nmsc_iframe_liga_form_members_staff")[0].contentWindow.scRecreateSelect2 === "function") {
                $("#nmsc_iframe_liga_form_members_staff")[0].contentWindow.scRecreateSelect2();
        }
}
...
function scHidePage(pageNo) {
        $("#id_form_clients_staff_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  ...
  $("#id_sc_field_permanent_member_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_staff_validate_permanent_member_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_renewal_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_staff_validate_renewal_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_starting_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_staff_validate_starting_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_expiration_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_staff_validate_expiration_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_cancel_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_staff_validate_cancel_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_retire_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_staff_validate_retire_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_date_last_updated" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_staff_validate_date_last_updated(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_archive_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_staff_validate_archive_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clients_staff_validate_record_created(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_main_contact_img_id" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_clients_staff_ul_save.php",
  ...
  $("#id_sc_field_applicant_signature" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_clients_staff_ul_save.php",
    dropZone: $("#hidden_field_data_applicant_signature" + iSeqRow),
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_clients_staff')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
