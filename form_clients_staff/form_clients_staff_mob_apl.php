<?php
//
class form_clients_staff_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['opc_ant']);
          }
          if (isset($this->gv_contact_pfm)) 
          {
              $_SESSION['gv_contact_pfm'] = $this->gv_contact_pfm;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_clients_staff_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['initialize'])
          {
              $_SESSION['scriptcase']['form_clients_staff_mob']['contr_erro'] = 'on';
  ?>
<style>
...
$_SESSION['scriptcase']['form_clients_staff_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['upload_field_info']['main_contact_img_id'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_staff_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['upload_field_info']['doc_sec_of_state'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_staff_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['upload_field_info']['doc_city_bus_lic'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_staff_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['upload_field_info']['doc_agric_lic'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_staff_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['upload_field_info']['doc_last_year_tax'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_staff_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['upload_field_info']['main_contact_img_id_prev'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_staff_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['upload_field_info']['doc_file'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_staff_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clients_staff_mob']['upload_field_info']['applicant_signature'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clients_staff_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_staff_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clients_staff_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_staff_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_staff_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_clients_staff_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clients_staff_mob']['label'] = "PFM - Buyers Pass App";
      ...
      $_SESSION['scriptcase']['error_icon']['form_clients_staff_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_clients_staff_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->NM_ajax_info['param']['main_contact_img_id_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      elseif (isset($this->main_contact_img_id_ul_name) && '' != $this->main_contact_img_id_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name]))
          {
              $this->main_contact_img_id_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['upload_field_ul_name'][$this->main_contact_img_id_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clients_staff_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_staff_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clients_staff_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_clients_staff/form_clients_staff_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_clients_staff_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_clients_staff_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_clients_staff_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_clients_staff/form_clients_staff_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_clients_staff_mob_erro.class.php"); 
      }
      $this->Erro      = new form_clients_staff_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opcao']))
         { 
             if ($this->client_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_clients_staff_mob']['start']);
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['btn_exit_app'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['botoes']['btn_exit_app'];
          $this->nmgp_botoes['pdf_download'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['botoes']['pdf_download'];
          $this->nmgp_botoes['btn_back_reqs'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['botoes']['btn_back_reqs'];
          $this->nmgp_botoes['btn_back_renewals'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['botoes']['btn_back_renewals'];
          $this->nmgp_botoes['email_client_if_active'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['botoes']['email_client_if_active'];
          $this->nmgp_botoes['back_clients'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['botoes']['back_clients'];
          $this->nmgp_botoes['close_tab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['botoes']['close_tab'];
          $this->nmgp_botoes['btn_delete_backend'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['botoes']['btn_delete_backend'];
          $this->nmgp_botoes['coll_pmt_js'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['botoes']['coll_pmt_js'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['total']);
          $detailAppName = 'form_members_staff_mob';
          $detailAppObject = "form_members_staff_mob";
          ...
          $this->form_members_staff_mob = new $detailAppObject;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['total']);
...
$_SESSION['scriptcase']['form_clients_staff_mob']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_clients_staff_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_clients_staff_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_clients_staff_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="form_clients_staff_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_clients_staff_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_clients_staff_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_staff_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_clients_staff_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clients_staff_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
include_once("form_clients_staff_mob_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opc_ant'] == "incluir")
      {
          $nmgp_opc_ant_saida_php = "novo";
          $nmgp_opcao_saida_php   = "recarga";
      }
      $nm_f_saida = "form_clients_staff_mob.php";
...
<?php
      ...
      {
          if (!isset($this->client_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form']['client_id']))
          {
              $varloc_btn_php['client_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form']['client_id'];
          }
          if (!isset($this->client_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form']['client_id']))
          {
              $varloc_btn_php['client_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form']['client_id'];
          ...
          if (!isset($this->co_name) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form']['co_name']))
          {
              $varloc_btn_php['co_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form']['co_name'];
          }
          if (!isset($this->main_contact_email) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form']['main_contact_email']))
          {
              $varloc_btn_php['main_contact_email'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form']['main_contact_email'];
          }
          if (!isset($this->client_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form']['client_id']))
          {
              $varloc_btn_php['client_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form']['client_id'];
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_clients_staff_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_clients_staff_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_clients_staff_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_clients_staff_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if ($this->nmgp_dados_form['membershipid'] != $this->membershipid ) {
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clients_staff_mob';
...
$_SESSION['scriptcase']['form_clients_staff_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_membershipid(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->membershipid, 10, 0, -0, 9999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_co_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['co_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['co_name'] == "on")) 
      { 
          if ($this->co_name == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_mailing_address(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['mailing_address']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['mailing_address'] == "on")) 
      { 
   ...
   if (isset($this->Field_no_validate['memb_status_id'])) {
       return;
               ...
               if (!empty($this->memb_status_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_memb_status_id']) && !in_array($this->memb_status_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_memb_status_id']))
               {
                   $hasError = true;
    ...
    function ValidateField_city(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['city']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['city'] == "on")) 
      { 
          if ($this->city == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['pricing_level_id'])) {
       return;
               ...
               if (!empty($this->pricing_level_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_pricing_level_id']) && !in_array($this->pricing_level_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_pricing_level_id']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_state(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['state']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['state'] == "on")) 
      { 
          if ($this->state == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['bus_cat_id'])) {
      ...
      if ($this->bus_cat_id == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['bus_cat_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['bus_cat_id'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->bus_cat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_cat_id']) && !in_array($this->bus_cat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_cat_id']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['bus_cat_id']))
    ...
    function ValidateField_zip_code(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      $this->nm_tira_mask($this->zip_code, "99999-9999", "(){}[].,;:-+/ "); 
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['zip_code']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['zip_code'] == "on")) 
      { 
          if ($this->zip_code == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['bus_subcat_id'])) {
      ...
      if ($this->bus_subcat_id == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['bus_subcat_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['bus_subcat_id'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->bus_subcat_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_subcat_id']) && !in_array($this->bus_subcat_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_subcat_id']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['bus_subcat_id']))
    ...
    function ValidateField_main_contact_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_name'] == "on")) 
      { 
    ...
    function ValidateField_main_contact_phone(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      $this->nm_tira_mask($this->main_contact_phone, "(999) 999 - 9999", "(){}[].,;:-+/ "); 
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_phone']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_phone'] == "on")) 
      { 
    ...
    function ValidateField_main_contact_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_email'] == "on") 
          { 
              $hasError = true;
    ...
    function ValidateField_main_contact_title(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_title']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_title'] == "on")) 
      { 
    ...
    function ValidateField_main_contact_img_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_img_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_img_id'] == "on")) 
      { 
          if (($this->main_contact_img_id == "" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_select']['main_contact_img_id'] == "") || "S" == $this->main_contact_img_id_limpa)
          { 
              $hasError = true;
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->main_contact_img_id && "S" != $this->main_contact_img_id_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_clients_staff_mob_doc_name.php';
                }
...
//--------------------------------------------------------------------------------------
   function upload_img_doc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros, $filtro = '') 
   {
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->nmgp_opcao == "incluir" && ($this->main_contact_img_id == "none" || ($this->main_contact_img_id == "" && $this->main_contact_img_id_salva == "")) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_img_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['php_cmp_required']['main_contact_img_id'] == "on")) 
          { 
              $Campos_Falta[] = "Contact Driver<br>License or ID" ; 
              if (!isset($Campos_Erros['main_contact_img_id']))
              {
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['client_id']['keyVal'] = form_clients_staff_mob_pack_protect_string($this->nmgp_dados_form['client_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['foreign_key']['client_id'] = $this->nmgp_dados_form['client_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['where_filter'] = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['where_detal']  = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_client_pmts_mob_script_case_init'] ]['form_client_pmts_mob']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_docs_2_script_case_init'] ]['grid_client_docs_2']['embutida_form_full'] = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_docs_2_script_case_init'] ]['grid_client_docs_2']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_docs_2_script_case_init'] ]['grid_client_docs_2']['embutida_pai']        = "form_clients_staff_mob";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_docs_2_script_case_init'] ]['grid_client_docs_2']['embutida_form_parms'] = "gv_client_id*scin" . $this->nmgp_dados_form['client_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_rows*scin5*scoutNMSC_paginacao*scinPARCIAL*scoutNMSC_cab*scinN*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scoutlink_remove_background*scinok*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_docs_2_script_case_init'] ]['grid_client_docs_2']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_docs_2_script_case_init'] ]['grid_client_docs_2']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_docs_2_script_case_init'] ]['grid_client_docs_2'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_docs_2_script_case_init'] ]['grid_client_docs_2'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_docs_2_script_case_init'] ]['grid_client_docs_2']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_docs_2_script_case_init'] ]['grid_client_docs_2']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['foreign_key']['client_id'] = $this->nmgp_dados_form['client_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['where_filter'] = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['where_detal']  = "client_id = " . $this->nmgp_dados_form['client_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['form_members_staff_mob_script_case_init'] ]['form_members_staff_mob']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_notes_script_case_init'] ]['grid_client_notes']['embutida_form_full'] = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_notes_script_case_init'] ]['grid_client_notes']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_notes_script_case_init'] ]['grid_client_notes']['embutida_pai']        = "form_clients_staff_mob";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_notes_script_case_init'] ]['grid_client_notes']['embutida_form_parms'] = "gv_client_id*scin" . $this->nmgp_dados_form['client_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_rows*scin5*scoutNMSC_paginacao*scinPARCIAL*scoutNMSC_cab*scinN*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scoutlink_remove_background*scinok*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_notes_script_case_init'] ]['grid_client_notes']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_notes_script_case_init'] ]['grid_client_notes']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_notes_script_case_init'] ]['grid_client_notes'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_notes_script_case_init'] ]['grid_client_notes'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_notes_script_case_init'] ]['grid_client_notes']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['grid_client_notes_script_case_init'] ]['grid_client_notes']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_memb_status_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_memb_status_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_memb_status_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_memb_status_id'] = array(); 
}
$aLookup[] = array(form_clients_staff_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_staff_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_memb_status_id'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_clients_staff_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_clients_staff_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_memb_status_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['memb_status_id']['valList'][$i] = form_clients_staff_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_pricing_level_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_pricing_level_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_pricing_level_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_pricing_level_id'] = array(); 
}
$aLookup[] = array(form_clients_staff_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_staff_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_pricing_level_id'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_pricing_level_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pricing_level_id']['valList'][$i] = form_clients_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_cat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_cat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_cat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_cat_id'] = array(); 
}
$aLookup[] = array(form_clients_staff_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_staff_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_cat_id'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_cat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_cat_id']['valList'][$i] = form_clients_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_subcat_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_subcat_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_subcat_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_subcat_id'] = array(); 
}
$aLookup[] = array(form_clients_staff_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clients_staff_mob_pack_protect_string('Choose')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_subcat_id'][] = '';
if ($this->bus_cat_id != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Lookup_bus_subcat_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['bus_subcat_id']['valList'][$i] = form_clients_staff_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_notes($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['Field_no_validate'] = array();
...
$_SESSION['scriptcase']['form_clients_staff_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['main_contact_img_id_salva'] = array(
                      'row'     => '',
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          {
              $sDetailWhere = "client_id = " . $this->client_id . "";
              $this->form_members_staff_mob->ini_controle();
              if ($this->form_members_staff_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
                  $sMsgErro   = $this->Ini->Nm_lang['lang_errm_fkvi'];
              }
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_clients_staff_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['parms'] = "client_id?#?$this->client_id?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['reg_start'] < $qt_geral_reg_form_clients_staff_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_staff_mob']['embutida_parms'] = "SC_glo_par_gv_members_ct*scingv_members_ct*scoutgv_client_id*scin" . $this->nmgp_dados_form['client_id'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scoutlink_remove_background*scinok*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_client_docs_2']['embutida_parms'] = "gv_client_id*scin" . $this->nmgp_dados_form['client_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_rows*scin5*scoutNMSC_paginacao*scinPARCIAL*scoutNMSC_cab*scinN*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scoutlink_remove_background*scinok*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scoutlink_remove_background*scinok*scout";
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       if (isset($this->NM_size_docs[$doc_filename]))
       {
        ...
        $this->initFormPages();
    include_once("form_clients_staff_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_clients_staff_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['total'] = $qt_geral_reg_form_clients_staff_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_clients_staff_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_clients_staff_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_clients_staff_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function sc_btn_label($buttonName, $buttonLabel)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['btn_label'][$buttonName] = $buttonLabel;
    } // sc_btn_label

    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "update":
                return array("sc_b_upd_t.sc-unique-btn-1", "sc_b_upd_b.sc-unique-btn-3", "sc_b_upd_t.sc-unique-btn-6");
                break;
            ...
            case "email_client_if_active":
                return array("sc_email_client_if_active_top", "sc_email_client_if_active_top");
                break;
            case "breload":
                return array("sc_b_reload_t.sc-unique-btn-2", "sc_b_reload_b.sc-unique-btn-4", "sc_b_reload_t.sc-unique-btn-8");
                break;
            case "btn_back_reqs":
                return array("sc_btn_back_reqs_top", "sc_btn_back_reqs_bot", "sc_btn_back_reqs_top");
                break;
            case "btn_back_renewals":
                return array("sc_btn_back_renewals_top", "sc_btn_back_renewals_bot", "sc_btn_back_renewals_top");
                break;
            case "back_clients":
                return array("sc_back_clients_top", "sc_back_clients_bot", "sc_back_clients_top");
                break;
            case "close_tab":
                return array("sc_close_tab_top");
                break;
            case "exit":
                return array("sc_b_sai_b.sc-unique-btn-5", "sc_b_sai_b.sc-unique-btn-13");
                break;
            case "delete":
                return array("sc_b_del_t.sc-unique-btn-7");
                break;
            case "first":
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['ordem_ord'] == " desc") {
