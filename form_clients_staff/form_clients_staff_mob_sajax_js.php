  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clients_staff_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_clients_staff_mob_form();
        }
...
?>
  ...
  // ---------- Validate dummy02
  function do_ajax_form_clients_staff_mob_validate_dummy02()
  {
  } // do_ajax_form_clients_staff_mob_validate_dummy02

  function do_ajax_form_clients_staff_mob_validate_dummy02_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_dummy02_cb

  // ---------- Validate membershipid
  function do_ajax_form_clients_staff_mob_validate_membershipid()
  {
    var nomeCampo_membershipid = "membershipid";
    var var_membershipid = scAjaxGetFieldText(nomeCampo_membershipid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_membershipid(var_membershipid, var_script_case_init, do_ajax_form_clients_staff_mob_validate_membershipid_cb);
  } // do_ajax_form_clients_staff_mob_validate_membershipid

  function do_ajax_form_clients_staff_mob_validate_membershipid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_membershipid_cb

  // ---------- Validate co_name
  function do_ajax_form_clients_staff_mob_validate_co_name()
  {
    var nomeCampo_co_name = "co_name";
    var var_co_name = scAjaxGetFieldText(nomeCampo_co_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_co_name(var_co_name, var_script_case_init, do_ajax_form_clients_staff_mob_validate_co_name_cb);
  } // do_ajax_form_clients_staff_mob_validate_co_name

  function do_ajax_form_clients_staff_mob_validate_co_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_co_name_cb

  // ---------- Validate client_id
  function do_ajax_form_clients_staff_mob_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldHidden(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_clients_staff_mob_validate_client_id_cb);
  } // do_ajax_form_clients_staff_mob_validate_client_id

  function do_ajax_form_clients_staff_mob_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_client_id_cb

  // ---------- Validate mailing_address
  function do_ajax_form_clients_staff_mob_validate_mailing_address()
  {
    var nomeCampo_mailing_address = "mailing_address";
    var var_mailing_address = scAjaxGetFieldText(nomeCampo_mailing_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_mailing_address(var_mailing_address, var_script_case_init, do_ajax_form_clients_staff_mob_validate_mailing_address_cb);
  } // do_ajax_form_clients_staff_mob_validate_mailing_address

  function do_ajax_form_clients_staff_mob_validate_mailing_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_mailing_address_cb

  // ---------- Validate memb_status_id
  function do_ajax_form_clients_staff_mob_validate_memb_status_id()
  {
    var nomeCampo_memb_status_id = "memb_status_id";
    var var_memb_status_id = scAjaxGetFieldSelect(nomeCampo_memb_status_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_memb_status_id(var_memb_status_id, var_script_case_init, do_ajax_form_clients_staff_mob_validate_memb_status_id_cb);
  } // do_ajax_form_clients_staff_mob_validate_memb_status_id

  function do_ajax_form_clients_staff_mob_validate_memb_status_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_memb_status_id_cb

  // ---------- Validate city
  function do_ajax_form_clients_staff_mob_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_city(var_city, var_script_case_init, do_ajax_form_clients_staff_mob_validate_city_cb);
  } // do_ajax_form_clients_staff_mob_validate_city

  function do_ajax_form_clients_staff_mob_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_city_cb

  // ---------- Validate pricing_level_id
  function do_ajax_form_clients_staff_mob_validate_pricing_level_id()
  {
    var nomeCampo_pricing_level_id = "pricing_level_id";
    var var_pricing_level_id = scAjaxGetFieldSelect(nomeCampo_pricing_level_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_pricing_level_id(var_pricing_level_id, var_script_case_init, do_ajax_form_clients_staff_mob_validate_pricing_level_id_cb);
  } // do_ajax_form_clients_staff_mob_validate_pricing_level_id

  function do_ajax_form_clients_staff_mob_validate_pricing_level_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_pricing_level_id_cb

  // ---------- Validate state
  function do_ajax_form_clients_staff_mob_validate_state()
  {
    var nomeCampo_state = "state";
    var var_state = scAjaxGetFieldText(nomeCampo_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_state(var_state, var_script_case_init, do_ajax_form_clients_staff_mob_validate_state_cb);
  } // do_ajax_form_clients_staff_mob_validate_state

  function do_ajax_form_clients_staff_mob_validate_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_state_cb

  // ---------- Validate bus_cat_id
  function do_ajax_form_clients_staff_mob_validate_bus_cat_id()
  {
    var nomeCampo_bus_cat_id = "bus_cat_id";
    var var_bus_cat_id = scAjaxGetFieldSelect(nomeCampo_bus_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_bus_cat_id(var_bus_cat_id, var_script_case_init, do_ajax_form_clients_staff_mob_validate_bus_cat_id_cb);
  } // do_ajax_form_clients_staff_mob_validate_bus_cat_id

  function do_ajax_form_clients_staff_mob_validate_bus_cat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_bus_cat_id_cb

  // ---------- Validate zip_code
  function do_ajax_form_clients_staff_mob_validate_zip_code()
  {
    var nomeCampo_zip_code = "zip_code";
    var var_zip_code = scAjaxGetFieldText(nomeCampo_zip_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_zip_code(var_zip_code, var_script_case_init, do_ajax_form_clients_staff_mob_validate_zip_code_cb);
  } // do_ajax_form_clients_staff_mob_validate_zip_code

  function do_ajax_form_clients_staff_mob_validate_zip_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_zip_code_cb

  // ---------- Validate bus_subcat_id
  function do_ajax_form_clients_staff_mob_validate_bus_subcat_id()
  {
    var nomeCampo_bus_subcat_id = "bus_subcat_id";
    var var_bus_subcat_id = scAjaxGetFieldSelect(nomeCampo_bus_subcat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_bus_subcat_id(var_bus_subcat_id, var_script_case_init, do_ajax_form_clients_staff_mob_validate_bus_subcat_id_cb);
  } // do_ajax_form_clients_staff_mob_validate_bus_subcat_id

  function do_ajax_form_clients_staff_mob_validate_bus_subcat_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_bus_subcat_id_cb

  // ---------- Validate permanent_member_date
  function do_ajax_form_clients_staff_mob_validate_permanent_member_date()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_permanent_member_date(var_permanent_member_date, var_script_case_init, do_ajax_form_clients_staff_mob_validate_permanent_member_date_cb);
  } // do_ajax_form_clients_staff_mob_validate_permanent_member_date

  function do_ajax_form_clients_staff_mob_validate_permanent_member_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_permanent_member_date_cb

  // ---------- Validate bus_subcat_other
  function do_ajax_form_clients_staff_mob_validate_bus_subcat_other()
  {
    var nomeCampo_bus_subcat_other = "bus_subcat_other";
    var var_bus_subcat_other = scAjaxGetFieldText(nomeCampo_bus_subcat_other);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_bus_subcat_other(var_bus_subcat_other, var_script_case_init, do_ajax_form_clients_staff_mob_validate_bus_subcat_other_cb);
  } // do_ajax_form_clients_staff_mob_validate_bus_subcat_other

  function do_ajax_form_clients_staff_mob_validate_bus_subcat_other_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_bus_subcat_other_cb

  // ---------- Validate renewal_date
  function do_ajax_form_clients_staff_mob_validate_renewal_date()
  {
    var nomeCampo_renewal_date = "renewal_date";
    var var_renewal_date = scAjaxGetFieldText(nomeCampo_renewal_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_renewal_date(var_renewal_date, var_script_case_init, do_ajax_form_clients_staff_mob_validate_renewal_date_cb);
  } // do_ajax_form_clients_staff_mob_validate_renewal_date

  function do_ajax_form_clients_staff_mob_validate_renewal_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_renewal_date_cb

  // ---------- Validate acct_instagram
  function do_ajax_form_clients_staff_mob_validate_acct_instagram()
  {
    var nomeCampo_acct_instagram = "acct_instagram";
    var var_acct_instagram = scAjaxGetFieldText(nomeCampo_acct_instagram);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_acct_instagram(var_acct_instagram, var_script_case_init, do_ajax_form_clients_staff_mob_validate_acct_instagram_cb);
  } // do_ajax_form_clients_staff_mob_validate_acct_instagram

  function do_ajax_form_clients_staff_mob_validate_acct_instagram_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_acct_instagram_cb

  // ---------- Validate website_url
  function do_ajax_form_clients_staff_mob_validate_website_url()
  {
    var nomeCampo_website_url = "website_url";
    var var_website_url = scAjaxGetFieldText(nomeCampo_website_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_website_url(var_website_url, var_script_case_init, do_ajax_form_clients_staff_mob_validate_website_url_cb);
  } // do_ajax_form_clients_staff_mob_validate_website_url

  function do_ajax_form_clients_staff_mob_validate_website_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_website_url_cb

  // ---------- Validate acct_facebook
  function do_ajax_form_clients_staff_mob_validate_acct_facebook()
  {
    var nomeCampo_acct_facebook = "acct_facebook";
    var var_acct_facebook = scAjaxGetFieldText(nomeCampo_acct_facebook);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_acct_facebook(var_acct_facebook, var_script_case_init, do_ajax_form_clients_staff_mob_validate_acct_facebook_cb);
  } // do_ajax_form_clients_staff_mob_validate_acct_facebook

  function do_ajax_form_clients_staff_mob_validate_acct_facebook_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_acct_facebook_cb

  // ---------- Validate js_prod_price
  function do_ajax_form_clients_staff_mob_validate_js_prod_price()
  {
    var nomeCampo_js_prod_price = "js_prod_price";
    var var_js_prod_price = scAjaxGetFieldText(nomeCampo_js_prod_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_js_prod_price(var_js_prod_price, var_script_case_init, do_ajax_form_clients_staff_mob_validate_js_prod_price_cb);
  } // do_ajax_form_clients_staff_mob_validate_js_prod_price

  function do_ajax_form_clients_staff_mob_validate_js_prod_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_js_prod_price_cb

  // ---------- Validate js_strp_price_id
  function do_ajax_form_clients_staff_mob_validate_js_strp_price_id()
  {
    var nomeCampo_js_strp_price_id = "js_strp_price_id";
    var var_js_strp_price_id = scAjaxGetFieldText(nomeCampo_js_strp_price_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_js_strp_price_id(var_js_strp_price_id, var_script_case_init, do_ajax_form_clients_staff_mob_validate_js_strp_price_id_cb);
  } // do_ajax_form_clients_staff_mob_validate_js_strp_price_id

  function do_ajax_form_clients_staff_mob_validate_js_strp_price_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_js_strp_price_id_cb

  // ---------- Validate js_mbr_ct
  function do_ajax_form_clients_staff_mob_validate_js_mbr_ct()
  {
    var nomeCampo_js_mbr_ct = "js_mbr_ct";
    var var_js_mbr_ct = scAjaxGetFieldText(nomeCampo_js_mbr_ct);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_js_mbr_ct(var_js_mbr_ct, var_script_case_init, do_ajax_form_clients_staff_mob_validate_js_mbr_ct_cb);
  } // do_ajax_form_clients_staff_mob_validate_js_mbr_ct

  function do_ajax_form_clients_staff_mob_validate_js_mbr_ct_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_js_mbr_ct_cb

  // ---------- Validate js_client_id
  function do_ajax_form_clients_staff_mob_validate_js_client_id()
  {
    var nomeCampo_js_client_id = "js_client_id";
    var var_js_client_id = scAjaxGetFieldText(nomeCampo_js_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_js_client_id(var_js_client_id, var_script_case_init, do_ajax_form_clients_staff_mob_validate_js_client_id_cb);
  } // do_ajax_form_clients_staff_mob_validate_js_client_id

  function do_ajax_form_clients_staff_mob_validate_js_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_js_client_id_cb

  // ---------- Validate dummy07
  function do_ajax_form_clients_staff_mob_validate_dummy07()
  {
  } // do_ajax_form_clients_staff_mob_validate_dummy07

  function do_ajax_form_clients_staff_mob_validate_dummy07_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_dummy07_cb

  // ---------- Validate dummy08
  function do_ajax_form_clients_staff_mob_validate_dummy08()
  {
  } // do_ajax_form_clients_staff_mob_validate_dummy08

  function do_ajax_form_clients_staff_mob_validate_dummy08_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_dummy08_cb

  // ---------- Validate main_contact_name
  function do_ajax_form_clients_staff_mob_validate_main_contact_name()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_main_contact_name(var_main_contact_name, var_script_case_init, do_ajax_form_clients_staff_mob_validate_main_contact_name_cb);
  } // do_ajax_form_clients_staff_mob_validate_main_contact_name

  function do_ajax_form_clients_staff_mob_validate_main_contact_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_main_contact_name_cb

  // ---------- Validate main_contact_phone
  function do_ajax_form_clients_staff_mob_validate_main_contact_phone()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_main_contact_phone(var_main_contact_phone, var_script_case_init, do_ajax_form_clients_staff_mob_validate_main_contact_phone_cb);
  } // do_ajax_form_clients_staff_mob_validate_main_contact_phone

  function do_ajax_form_clients_staff_mob_validate_main_contact_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_main_contact_phone_cb

  // ---------- Validate main_contact_email
  function do_ajax_form_clients_staff_mob_validate_main_contact_email()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_main_contact_email(var_main_contact_email, var_script_case_init, do_ajax_form_clients_staff_mob_validate_main_contact_email_cb);
  } // do_ajax_form_clients_staff_mob_validate_main_contact_email

  function do_ajax_form_clients_staff_mob_validate_main_contact_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_main_contact_email_cb

  // ---------- Validate main_contact_title
  function do_ajax_form_clients_staff_mob_validate_main_contact_title()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_main_contact_title(var_main_contact_title, var_script_case_init, do_ajax_form_clients_staff_mob_validate_main_contact_title_cb);
  } // do_ajax_form_clients_staff_mob_validate_main_contact_title

  function do_ajax_form_clients_staff_mob_validate_main_contact_title_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_main_contact_title_cb

  // ---------- Validate main_contact_img_id
  function do_ajax_form_clients_staff_mob_validate_main_contact_img_id()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_main_contact_img_id(var_main_contact_img_id, var_script_case_init, do_ajax_form_clients_staff_mob_validate_main_contact_img_id_cb);
  } // do_ajax_form_clients_staff_mob_validate_main_contact_img_id

  function do_ajax_form_clients_staff_mob_validate_main_contact_img_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_main_contact_img_id_cb

  // ---------- Validate memb_list
  function do_ajax_form_clients_staff_mob_validate_memb_list()
  {
    var nomeCampo_memb_list = "memb_list";
    var var_memb_list = scAjaxGetFieldText(nomeCampo_memb_list);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_memb_list(var_memb_list, var_script_case_init, do_ajax_form_clients_staff_mob_validate_memb_list_cb);
  } // do_ajax_form_clients_staff_mob_validate_memb_list

  function do_ajax_form_clients_staff_mob_validate_memb_list_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_memb_list_cb

  // ---------- Validate docs
  function do_ajax_form_clients_staff_mob_validate_docs()
  {
    var nomeCampo_docs = "docs";
    var var_docs = scAjaxGetFieldText(nomeCampo_docs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_docs(var_docs, var_script_case_init, do_ajax_form_clients_staff_mob_validate_docs_cb);
  } // do_ajax_form_clients_staff_mob_validate_docs

  function do_ajax_form_clients_staff_mob_validate_docs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_docs_cb

  // ---------- Validate client_pmts
  function do_ajax_form_clients_staff_mob_validate_client_pmts()
  {
    var nomeCampo_client_pmts = "client_pmts";
    var var_client_pmts = scAjaxGetFieldText(nomeCampo_client_pmts);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_client_pmts(var_client_pmts, var_script_case_init, do_ajax_form_clients_staff_mob_validate_client_pmts_cb);
  } // do_ajax_form_clients_staff_mob_validate_client_pmts

  function do_ajax_form_clients_staff_mob_validate_client_pmts_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_client_pmts_cb

  // ---------- Validate notes
  function do_ajax_form_clients_staff_mob_validate_notes()
  {
    var nomeCampo_notes = "notes";
    var var_notes = scAjaxGetFieldText(nomeCampo_notes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clients_staff_mob_validate_notes(var_notes, var_script_case_init, do_ajax_form_clients_staff_mob_validate_notes_cb);
  } // do_ajax_form_clients_staff_mob_validate_notes

  function do_ajax_form_clients_staff_mob_validate_notes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_validate_notes_cb

  // ---------- Refresh bus_cat_id
  function do_ajax_form_clients_staff_mob_refresh_bus_cat_id()
  {
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    var var_nmgp_refresh_fields = "bus_subcat_id";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_staff_mob_refresh_bus_cat_id(var_bus_cat_id, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_clients_staff_mob_refresh_bus_cat_id_cb);
  } // do_ajax_form_clients_staff_mob_refresh_bus_cat_id

  function do_ajax_form_clients_staff_mob_refresh_bus_cat_id_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clients_staff_mob_refresh_bus_cat_id_cb

  // ---------- Event onchange bus_cat_id
  function do_ajax_form_clients_staff_mob_event_bus_cat_id_onchange()
  {
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_staff_mob_event_bus_cat_id_onchange(var_bus_cat_id, var_client_id, var_bus_subcat_id, var_js_prod_price, var_js_strp_price_id, var_js_mbr_ct, var_js_client_id, var_script_case_init, do_ajax_form_clients_staff_mob_event_bus_cat_id_onchange_cb);
  } // do_ajax_form_clients_staff_mob_event_bus_cat_id_onchange

  function do_ajax_form_clients_staff_mob_event_bus_cat_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bus_cat_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_staff_mob_event_bus_cat_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_staff_mob_event_bus_cat_id_onchange_cb
  function do_ajax_form_clients_staff_mob_event_bus_cat_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_clients_staff_mob_refresh_bus_cat_id();
    scAjaxRedir();
  } // do_ajax_form_clients_staff_mob_event_bus_cat_id_onchange_cb_after_alert

  // ---------- Event onchange bus_subcat_id
  function do_ajax_form_clients_staff_mob_event_bus_subcat_id_onchange()
  {
    var var_client_id = scAjaxGetFieldHidden("client_id");
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    var var_bus_subcat_id = scAjaxGetFieldSelect("bus_subcat_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_staff_mob_event_bus_subcat_id_onchange(var_client_id, var_bus_cat_id, var_bus_subcat_id, var_js_prod_price, var_js_strp_price_id, var_js_mbr_ct, var_js_client_id, var_bus_subcat_other, var_script_case_init, do_ajax_form_clients_staff_mob_event_bus_subcat_id_onchange_cb);
  } // do_ajax_form_clients_staff_mob_event_bus_subcat_id_onchange

  function do_ajax_form_clients_staff_mob_event_bus_subcat_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bus_subcat_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_staff_mob_event_bus_subcat_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_staff_mob_event_bus_subcat_id_onchange_cb
  function do_ajax_form_clients_staff_mob_event_bus_subcat_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_staff_mob_event_bus_subcat_id_onchange_cb_after_alert

  // ---------- Event onchange main_contact_email
  function do_ajax_form_clients_staff_mob_event_main_contact_email_onchange()
  {
    var var_client_id = scAjaxGetFieldHidden("client_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_staff_mob_event_main_contact_email_onchange(var_client_id, var_main_contact_email, var_bus_cat_id, var_bus_subcat_id, var_js_prod_price, var_js_strp_price_id, var_js_mbr_ct, var_js_client_id, var_script_case_init, do_ajax_form_clients_staff_mob_event_main_contact_email_onchange_cb);
  } // do_ajax_form_clients_staff_mob_event_main_contact_email_onchange

  function do_ajax_form_clients_staff_mob_event_main_contact_email_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_email";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_staff_mob_event_main_contact_email_onchange_cb_after_alert);
  } // do_ajax_form_clients_staff_mob_event_main_contact_email_onchange_cb
  function do_ajax_form_clients_staff_mob_event_main_contact_email_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_staff_mob_event_main_contact_email_onchange_cb_after_alert

  // ---------- Event onchange main_contact_name
  function do_ajax_form_clients_staff_mob_event_main_contact_name_onchange()
  {
    var var_client_id = scAjaxGetFieldHidden("client_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_staff_mob_event_main_contact_name_onchange(var_client_id, var_main_contact_name, var_bus_cat_id, var_bus_subcat_id, var_js_prod_price, var_js_strp_price_id, var_js_mbr_ct, var_js_client_id, var_script_case_init, do_ajax_form_clients_staff_mob_event_main_contact_name_onchange_cb);
  } // do_ajax_form_clients_staff_mob_event_main_contact_name_onchange

  function do_ajax_form_clients_staff_mob_event_main_contact_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_staff_mob_event_main_contact_name_onchange_cb_after_alert);
  } // do_ajax_form_clients_staff_mob_event_main_contact_name_onchange_cb
  function do_ajax_form_clients_staff_mob_event_main_contact_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_staff_mob_event_main_contact_name_onchange_cb_after_alert

  // ---------- Event onchange main_contact_phone
  function do_ajax_form_clients_staff_mob_event_main_contact_phone_onchange()
  {
    var var_client_id = scAjaxGetFieldHidden("client_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_staff_mob_event_main_contact_phone_onchange(var_client_id, var_main_contact_phone, var_bus_cat_id, var_bus_subcat_id, var_js_prod_price, var_js_strp_price_id, var_js_mbr_ct, var_js_client_id, var_script_case_init, do_ajax_form_clients_staff_mob_event_main_contact_phone_onchange_cb);
  } // do_ajax_form_clients_staff_mob_event_main_contact_phone_onchange

  function do_ajax_form_clients_staff_mob_event_main_contact_phone_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_phone";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_staff_mob_event_main_contact_phone_onchange_cb_after_alert);
  } // do_ajax_form_clients_staff_mob_event_main_contact_phone_onchange_cb
  function do_ajax_form_clients_staff_mob_event_main_contact_phone_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_staff_mob_event_main_contact_phone_onchange_cb_after_alert

  // ---------- Event onchange main_contact_title
  function do_ajax_form_clients_staff_mob_event_main_contact_title_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_staff_mob_event_main_contact_title_onchange(var_main_contact_title, var_client_id, var_bus_cat_id, var_bus_subcat_id, var_js_prod_price, var_js_strp_price_id, var_js_mbr_ct, var_js_client_id, var_script_case_init, do_ajax_form_clients_staff_mob_event_main_contact_title_onchange_cb);
  } // do_ajax_form_clients_staff_mob_event_main_contact_title_onchange

  function do_ajax_form_clients_staff_mob_event_main_contact_title_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "main_contact_title";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_staff_mob_event_main_contact_title_onchange_cb_after_alert);
  } // do_ajax_form_clients_staff_mob_event_main_contact_title_onchange_cb
  function do_ajax_form_clients_staff_mob_event_main_contact_title_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_staff_mob_event_main_contact_title_onchange_cb_after_alert

  // ---------- Event onchange memb_qty
  function do_ajax_form_clients_staff_mob_event_memb_qty_onchange()
  {
    var var_client_id = scAjaxGetFieldHidden("client_id");
    var var_bus_cat_id = scAjaxGetFieldSelect("bus_cat_id");
    var var_bus_subcat_id = scAjaxGetFieldSelect("bus_subcat_id");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_staff_mob_event_memb_qty_onchange(var_client_id, var_bus_cat_id, var_bus_subcat_id, var_js_prod_price, var_js_strp_price_id, var_js_mbr_ct, var_js_client_id, var_script_case_init, do_ajax_form_clients_staff_mob_event_memb_qty_onchange_cb);
  } // do_ajax_form_clients_staff_mob_event_memb_qty_onchange

  function do_ajax_form_clients_staff_mob_event_memb_qty_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_staff_mob_event_memb_qty_onchange_cb_after_alert);
  } // do_ajax_form_clients_staff_mob_event_memb_qty_onchange_cb
  function do_ajax_form_clients_staff_mob_event_memb_qty_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_staff_mob_event_memb_qty_onchange_cb_after_alert

  // ---------- Event onchange memb_status_id
  function do_ajax_form_clients_staff_mob_event_memb_status_id_onchange()
  {
    var var_memb_status_id = scAjaxGetFieldSelect("memb_status_id");
    var var_client_id = scAjaxGetFieldHidden("client_id");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_staff_mob_event_memb_status_id_onchange(var_memb_status_id, var_client_id, var_script_case_init, do_ajax_form_clients_staff_mob_event_memb_status_id_onchange_cb);
  } // do_ajax_form_clients_staff_mob_event_memb_status_id_onchange

  function do_ajax_form_clients_staff_mob_event_memb_status_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "memb_status_id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_staff_mob_event_memb_status_id_onchange_cb_after_alert);
  } // do_ajax_form_clients_staff_mob_event_memb_status_id_onchange_cb
  function do_ajax_form_clients_staff_mob_event_memb_status_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_staff_mob_event_memb_status_id_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_btn_delete_backend
  function do_ajax_form_clients_staff_mob_event_scajaxbutton_btn_delete_backend_onclick()
  {
    var var_client_id = scAjaxGetFieldHidden("client_id");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clients_staff_mob_event_scajaxbutton_btn_delete_backend_onclick(var_client_id, var_script_case_init, do_ajax_form_clients_staff_mob_event_scajaxbutton_btn_delete_backend_onclick_cb);
  } // do_ajax_form_clients_staff_mob_event_scajaxbutton_btn_delete_backend_onclick

  function do_ajax_form_clients_staff_mob_event_scajaxbutton_btn_delete_backend_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clients_staff_mob_event_scajaxbutton_btn_delete_backend_onclick_cb_after_alert);
  } // do_ajax_form_clients_staff_mob_event_scajaxbutton_btn_delete_backend_onclick_cb
  function do_ajax_form_clients_staff_mob_event_scajaxbutton_btn_delete_backend_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clients_staff_mob_event_scajaxbutton_btn_delete_backend_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clients_staff_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clients_staff_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_clients_staff_mob_submit_form(var_dummy02, var_membershipid, var_co_name, var_client_id, var_mailing_address, var_memb_status_id, var_city, var_pricing_level_id, var_state, var_bus_cat_id, var_zip_code, var_bus_subcat_id, var_permanent_member_date, var_bus_subcat_other, var_renewal_date, var_acct_instagram, var_website_url, var_acct_facebook, var_js_prod_price, var_js_strp_price_id, var_js_mbr_ct, var_js_client_id, var_dummy07, var_dummy08, var_main_contact_name, var_main_contact_phone, var_main_contact_email, var_main_contact_title, var_main_contact_img_id, var_main_contact_img_id_ul_name, var_main_contact_img_id_ul_type, var_main_contact_img_id_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clients_staff_mob_submit_form_cb);
  } // do_ajax_form_clients_staff_mob_submit_form

  function do_ajax_form_clients_staff_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clients_staff_mob_submit_form_cb_after_alert);
  } // do_ajax_form_clients_staff_mob_submit_form_cb
  function do_ajax_form_clients_staff_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clients_staff_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_members_staff_mob"] = "off";
  scStatusDetail["grid_client_docs_2"] = "off";
  scStatusDetail["form_client_pmts_mob"] = "off";
  scStatusDetail["grid_client_notes"] = "off";

  function do_ajax_form_clients_staff_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_clients_staff_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_clients_staff_mob_navigate_form();
    }
  }

  function perform_ajax_form_clients_staff_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_members_staff_mob"] = "on";
    scStatusDetail["grid_client_docs_2"] = "on";
    scStatusDetail["form_client_pmts_mob"] = "on";
    scStatusDetail["grid_client_notes"] = "on";
    x_ajax_form_clients_staff_mob_navigate_form(var_client_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clients_staff_mob_navigate_form_cb);
  } // do_ajax_form_clients_staff_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clients_staff_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_members_staff_mob"] && "nmsc_iframe_liga_form_members_staff_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_members_staff_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_members_staff_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_members_staff_mob').contentWindow.nm_move('apl_detalhe', true, '600');
        document.getElementById('nmsc_iframe_liga_form_members_staff_mob').style.height = "600";
        document.getElementById('nmsc_iframe_liga_form_members_staff_mob').style.display = "none";
    }
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_client_pmts_mob"] && "nmsc_iframe_liga_form_client_pmts_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_client_pmts_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_client_pmts_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_client_pmts_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_client_pmts_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_client_pmts_mob').style.display = "none";
    }
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clients_staff_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_clients_staff_mob_navigate_form_cb
  function do_ajax_form_clients_staff_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clients_staff_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_clients_staff_mob_navigate_form_cb_after_alert

  function sc_hide_form_clients_staff_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_members_staff_mob"] && "off" == scStatusDetail["grid_client_docs_2"] && "off" == scStatusDetail["form_client_pmts_mob"] && "off" == scStatusDetail["grid_client_notes"])
    {
      return true;
    }
    return false;
