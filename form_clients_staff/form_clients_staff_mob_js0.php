...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_clients_staff_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_pdf_download_ok()
{
    ...
    document.F1.action = "form_clients_staff_mob.php";
...
function sc_btn_btn_back_renewals() 
{ 
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_btn_back_renewals(); }, 500);
      return;
    }
    window.location.href = '../grid_vw_clients_main_member_renew/';
} 
function sc_btn_btn_back_renewals_cancel()
{
}
function sc_btn_btn_back_renewals_ok()
{
    window.location.href = '../grid_vw_clients_main_member_renew/';
}
var Crtl_btn_email_client_if_active = false;
function sc_btn_email_client_if_active()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_email_client_if_active(); }, 500);
      return;
    }
    if (Crtl_btn_email_client_if_active) {return;}
    scJs_confirm("<?php echo html_entity_decode('Email notification? Status changes to Active; renewal date is updated.', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_email_client_if_active_ok, sc_btn_email_client_if_active_cancel)
}
function sc_btn_email_client_if_active_cancel()
{
}
function sc_btn_email_client_if_active_ok()
{
    Crtl_btn_email_client_if_active = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?email_client_if_active?@?";
    document.F1.action = "form_clients_staff_mob.php";
    document.F1.target = "_self";
    document.F1.submit();
}
function sc_btn_back_clients() 
{ 
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_back_clients(); }, 500);
      return;
    }
    window.location.href = '../grid_vw_clients/';
} 
function sc_btn_back_clients_cancel()
{
}
function sc_btn_back_clients_ok()
{
    window.location.href = '../grid_vw_clients/';
}
function sc_btn_close_tab() 
{ 
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_close_tab(); }, 500);
      return;
    }
    parent.del_aba_td('form_clients_staff');

} 
function sc_btn_close_tab_cancel()
{
}
function sc_btn_close_tab_ok()
{
    parent.del_aba_td('form_clients_staff');

}
function sc_btn_btn_delete_backend()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_btn_delete_backend(); }, 500);
      return;
    }
    sc_btn_btn_delete_backend_ok();
}
function sc_btn_btn_delete_backend_cancel()
{
}
function sc_btn_btn_delete_backend_ok()
{
    do_ajax_form_clients_staff_mob_event_scajaxbutton_btn_delete_backend_onclick();
}
function sc_btn_coll_pmt_js() 
{ 
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_coll_pmt_js(); }, 500);
      return;
    }
    scJs_confirm("<?php echo html_entity_decode('Please save the record first. Do you want to proceed with collecting payment?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_coll_pmt_js_ok, sc_btn_coll_pmt_js_cancel);
} 
function sc_btn_coll_pmt_js_cancel()
{
}
function sc_btn_coll_pmt_js_ok()
{
    /*
...
var priceId   = document.getElementById('id_sc_field_js_strp_price_id').value;	//"price_1OqccXHUv8No9pWb9A2cniWQ-B2B-DEV"; "price_1OmesEHUv8No9pWbA62f1Ams-H&FTM-DEV";
...
//var stripeUrl = 'http://localhost/scriptcase/devel/conf/grp/PFM_Staff/libraries/stripe_qb/index2.php'
var stripeUrl = 'https://pfm-app.com/_lib/libraries/grp/stripe_qb/index2.php'
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clients_staff_mob']['where_detal']))
  {
?>  
...
function nm_mostra_doc(campo1, campo2, campo3)
{
    ...
    NovaJanela = window.open ("form_clients_staff_mob_doc.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nm_cod_doc=" + campo1 + "&nm_nome_doc=" + encodeURIComponent(campo2) + "&nm_cod_apl=" + campo3, "sc_name_download_iframe", "resizable, scrollbars");
}
...
function sc_memb_status_id_onchange()
{
