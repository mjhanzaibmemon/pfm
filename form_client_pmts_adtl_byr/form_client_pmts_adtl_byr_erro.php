...
$old_error_handler = set_error_handler("form_client_pmts_adtl_byr_scriptcase_error_handler");

function form_client_pmts_adtl_byr_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_client_pmts_adtl_byr']['contr_erro']) && $_SESSION['scriptcase']['form_client_pmts_adtl_byr']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_client_pmts_adtl_byr->contr_form_client_pmts_adtl_byr->Apl_com_erro = true;
            if ($inicial_form_client_pmts_adtl_byr->contr_form_client_pmts_adtl_byr->NM_ajax_flag)
            {
                $inicial_form_client_pmts_adtl_byr->contr_form_client_pmts_adtl_byr->NM_ajax_info['errList']['geral_form_client_pmts_adtl_byr'][] = $msg;
                return;
            }
            form_client_pmts_adtl_byr_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_client_pmts_adtl_byr_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_client_pmts_adtl_byr'])  && '' != $_SESSION['scriptcase']['error_icon']['form_client_pmts_adtl_byr'])  ? $_SESSION['scriptcase']['error_icon']['form_client_pmts_adtl_byr']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_client_pmts_adtl_byr']) && '' != $_SESSION['scriptcase']['error_span_title']['form_client_pmts_adtl_byr']) ? $_SESSION['scriptcase']['error_span_title']['form_client_pmts_adtl_byr'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_client_pmts_adtl_byr']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_client_pmts_adtl_byr']) ? $_SESSION['scriptcase']['error_icon_title']['form_client_pmts_adtl_byr'] : '';
?>
