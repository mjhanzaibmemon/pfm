...
function scHidePage(pageNo) {
        $("#id_form_client_pmts_adtl_byr_mob_form" + pageNo).hide();
}
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_client_pmts_adtl_byr_mob_validate_token_exp(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_client_pmts_adtl_byr_mob_validate_ts(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_client_pmts_adtl_byr_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
