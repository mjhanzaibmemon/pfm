  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_client_pmts_adtl_byr_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_client_pmts_adtl_byr_mob_form();
        }
...
?>
  ...
  // ---------- Validate notif_name
  function do_ajax_form_client_pmts_adtl_byr_mob_validate_notif_name()
  {
    var nomeCampo_notif_name = "notif_name";
    var var_notif_name = scAjaxGetFieldText(nomeCampo_notif_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_mob_validate_notif_name(var_notif_name, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_mob_validate_notif_name_cb);
  } // do_ajax_form_client_pmts_adtl_byr_mob_validate_notif_name

  function do_ajax_form_client_pmts_adtl_byr_mob_validate_notif_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_mob_validate_notif_name_cb

  // ---------- Validate notif_email
  function do_ajax_form_client_pmts_adtl_byr_mob_validate_notif_email()
  {
    var nomeCampo_notif_email = "notif_email";
    var var_notif_email = scAjaxGetFieldText(nomeCampo_notif_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_mob_validate_notif_email(var_notif_email, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_mob_validate_notif_email_cb);
  } // do_ajax_form_client_pmts_adtl_byr_mob_validate_notif_email

  function do_ajax_form_client_pmts_adtl_byr_mob_validate_notif_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_mob_validate_notif_email_cb

  // ---------- Validate adtl_buyers
  function do_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_buyers()
  {
    var nomeCampo_adtl_buyers = "adtl_buyers";
    var var_adtl_buyers = scAjaxGetFieldText(nomeCampo_adtl_buyers);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_buyers(var_adtl_buyers, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_buyers_cb);
  } // do_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_buyers

  function do_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_buyers_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_buyers_cb

  // ---------- Validate total
  function do_ajax_form_client_pmts_adtl_byr_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_mob_validate_total(var_total, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_mob_validate_total_cb);
  } // do_ajax_form_client_pmts_adtl_byr_mob_validate_total

  function do_ajax_form_client_pmts_adtl_byr_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_mob_validate_total_cb

  // ---------- Validate adtl_byr_id
  function do_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_byr_id()
  {
    var nomeCampo_adtl_byr_id = "adtl_byr_id";
    var var_adtl_byr_id = scAjaxGetFieldHidden(nomeCampo_adtl_byr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_byr_id(var_adtl_byr_id, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_byr_id_cb);
  } // do_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_byr_id

  function do_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_byr_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_pmts_adtl_byr_mob_validate_adtl_byr_id_cb

  // ---------- Event onchange adtl_buyers
  function do_ajax_form_client_pmts_adtl_byr_mob_event_adtl_buyers_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_client_pmts_adtl_byr_mob_event_adtl_buyers_onchange(var_script_case_init, do_ajax_form_client_pmts_adtl_byr_mob_event_adtl_buyers_onchange_cb);
  } // do_ajax_form_client_pmts_adtl_byr_mob_event_adtl_buyers_onchange

  function do_ajax_form_client_pmts_adtl_byr_mob_event_adtl_buyers_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "adtl_buyers";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_client_pmts_adtl_byr_mob_event_adtl_buyers_onchange_cb_after_alert);
  } // do_ajax_form_client_pmts_adtl_byr_mob_event_adtl_buyers_onchange_cb
  function do_ajax_form_client_pmts_adtl_byr_mob_event_adtl_buyers_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_client_pmts_adtl_byr_mob_event_adtl_buyers_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_client_pmts_adtl_byr_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_client_pmts_adtl_byr_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_client_pmts_adtl_byr_mob_submit_form(var_notif_name, var_notif_email, var_adtl_buyers, var_total, var_adtl_byr_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_client_pmts_adtl_byr_mob_submit_form_cb);
  } // do_ajax_form_client_pmts_adtl_byr_mob_submit_form

  function do_ajax_form_client_pmts_adtl_byr_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_client_pmts_adtl_byr_mob_submit_form_cb_after_alert);
  } // do_ajax_form_client_pmts_adtl_byr_mob_submit_form_cb
  function do_ajax_form_client_pmts_adtl_byr_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_client_pmts_adtl_byr_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_client_pmts_adtl_byr_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_client_pmts_adtl_byr_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_client_pmts_adtl_byr_mob_navigate_form();
    }
  }

  function perform_ajax_form_client_pmts_adtl_byr_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_client_pmts_adtl_byr_mob_navigate_form(var_adtl_byr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_client_pmts_adtl_byr_mob_navigate_form_cb);
  } // do_ajax_form_client_pmts_adtl_byr_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_pmts_adtl_byr_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_client_pmts_adtl_byr_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_client_pmts_adtl_byr_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_client_pmts_adtl_byr_mob_navigate_form_cb
  function do_ajax_form_client_pmts_adtl_byr_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_client_pmts_adtl_byr_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_client_pmts_adtl_byr_mob_navigate_form_cb_after_alert

  function sc_hide_form_client_pmts_adtl_byr_mob_form()
  {
  ...
  ajax_field_list[0] = "notif_name";
  ajax_field_list[1] = "notif_email";
  ajax_field_list[2] = "adtl_buyers";
  ajax_field_list[3] = "total";
  ajax_field_list[4] = "adtl_byr_id";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "notif_name": {"label": "Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "notif_email": {"label": "Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "adtl_buyers": {"label": "Additional Buyers", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
