...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "permanent_member_date";$Nm_datas[] = "renewal_date";$Nm_numeric[] = "client_id";$Nm_numeric[] = "membershipid";$Nm_numeric[] = "appn_id";$Nm_numeric[] = "day_count";
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="requiredMark">*</span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_renewal_date_cond" name="renewal_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_renewal_date'), this, 'renewal_date')">
...
<SPAN id="Nm_bi_dados_renewal_date" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_renewal_date"  style="display:''">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_renewal_date_ano" name="renewal_date_ano" value="<?php echo NM_encode_input($renewal_date_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_renewal_date_jq">
         ...
         <br />
        <SPAN id="id_vis_renewal_date"  <?php echo $str_display_renewal_date; ?> class="scFilterFieldFontOdd">
