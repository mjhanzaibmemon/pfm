...
class grid_vw_clients_main_member_renew_res_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_csv()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['csv_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['csv_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['pivot_tabular'];
      if (1 >= sizeof($this->comp_y_axys))
      {
        ...
        if ('S' == $this->Label_CSV) {
            foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_clients_main_member_renew'] ['export_info'] ['ordered_x_matrix'] as $rowNumber => $rowInfo) {
            }
        }
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_clients_main_member_renew'] ['export_data'] as $exportRowInfo) {
            ...
            for ($i = $dimensionCount; $i < $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_clients_main_member_renew'] ['export_info'] ['dimension_count'] ['y']; $i++) {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['csv_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_clients_main_member_renew']['csv_res_file'] = $this->Csv_f;
      }
