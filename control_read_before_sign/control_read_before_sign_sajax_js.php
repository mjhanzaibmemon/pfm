  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_read_before_sign" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_control_read_before_sign_form();
        }
...
?>
  ...
  function do_ajax_control_read_before_sign_validate_rules_and_regulations()
  {
  } // do_ajax_control_read_before_sign_validate_rules_and_regulations

  function do_ajax_control_read_before_sign_validate_rules_and_regulations_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_read_before_sign_validate_rules_and_regulations_cb

  // ---------- Validate main_cat
  function do_ajax_control_read_before_sign_validate_main_cat()
  {
    var nomeCampo_main_cat = "main_cat";
    var var_main_cat = scAjaxGetFieldText(nomeCampo_main_cat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_read_before_sign_validate_main_cat(var_main_cat, var_script_case_init, do_ajax_control_read_before_sign_validate_main_cat_cb);
  } // do_ajax_control_read_before_sign_validate_main_cat

  function do_ajax_control_read_before_sign_validate_main_cat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_read_before_sign_validate_main_cat_cb

  // ---------- Validate sub_cat
  function do_ajax_control_read_before_sign_validate_sub_cat()
  {
    var nomeCampo_sub_cat = "sub_cat";
    var var_sub_cat = scAjaxGetFieldText(nomeCampo_sub_cat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_read_before_sign_validate_sub_cat(var_sub_cat, var_script_case_init, do_ajax_control_read_before_sign_validate_sub_cat_cb);
  } // do_ajax_control_read_before_sign_validate_sub_cat

  function do_ajax_control_read_before_sign_validate_sub_cat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sub_cat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_read_before_sign_validate_sub_cat_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_read_before_sign_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_read_before_sign_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_read_before_sign_submit_form(var_rules_and_regulations, var_main_cat, var_sub_cat, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_read_before_sign_submit_form_cb);
  } // do_ajax_control_read_before_sign_submit_form

  function do_ajax_control_read_before_sign_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_read_before_sign_submit_form_cb_after_alert);
  } // do_ajax_control_read_before_sign_submit_form_cb
  function do_ajax_control_read_before_sign_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_read_before_sign_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_read_before_sign_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_read_before_sign_navigate_form, function() {});
    } else {
      perform_ajax_control_read_before_sign_navigate_form();
    }
  }

  function perform_ajax_control_read_before_sign_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_read_before_sign_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_read_before_sign']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_read_before_sign_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_read_before_sign_navigate_form_cb_after_alert);
  } // do_ajax_control_read_before_sign_navigate_form_cb
  function do_ajax_control_read_before_sign_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_read_before_sign_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_read_before_sign_navigate_form_cb_after_alert

  function sc_hide_control_read_before_sign_form()
  {
