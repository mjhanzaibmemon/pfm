...
<?php
   ...
   $Ord_Cmp = new grid_vw_requests_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_vw_requests_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['open_lft'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['open_lft'] = "open_lft";
   }
   else
   {
       $tab_def_campos['open_lft'] = "";
   }
   $tab_labels["open_lft"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["open_lft"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["open_lft"] : "Open";
   $tab_ger_campos['client_id'] = "on";
   $tab_def_campos['client_id'] = "client_id";
   $tab_labels["client_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["client_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["client_id"] : "ID";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["status"] : "Status";
   $tab_ger_campos['co_name'] = "on";
   $tab_def_campos['co_name'] = "co_name";
   $tab_labels["co_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["co_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["co_name"] : "Name";
   $tab_ger_campos['main_contact_name'] = "on";
   $tab_def_campos['main_contact_name'] = "main_contact_name";
   $tab_labels["main_contact_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["main_contact_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["main_contact_name"] : "Main Contact";
   $tab_ger_campos['main_contact_phone'] = "on";
   $tab_def_campos['main_contact_phone'] = "main_contact_phone";
   $tab_labels["main_contact_phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["main_contact_phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["main_contact_phone"] : "Main Cont. Phone";
   $tab_ger_campos['main_contact_email'] = "on";
   $tab_def_campos['main_contact_email'] = "main_contact_email";
   $tab_labels["main_contact_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["main_contact_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["main_contact_email"] : "Main Cont. Email";
   $tab_ger_campos['main_contact_title'] = "on";
   $tab_def_campos['main_contact_title'] = "main_contact_title";
   $tab_labels["main_contact_title"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["main_contact_title"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["main_contact_title"] : "Main Cont. Title";
   $tab_ger_campos['payment_status'] = "on";
   $tab_def_campos['payment_status'] = "payment_status";
   $tab_labels["payment_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["payment_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["payment_status"] : "Payment";
   $tab_ger_campos['payment_created'] = "on";
   $tab_def_campos['payment_created'] = "payment_created";
   $tab_labels["payment_created"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["payment_created"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["payment_created"] : "Payment Issued";
   $tab_ger_campos['open'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['open'] = "open";
   }
   else
   {
       $tab_def_campos['open'] = "";
   }
   $tab_labels["open"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["open"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["open"] : "Open";
   $tab_ger_campos['table_name'] = "on";
   $tab_def_campos['table_name'] = "table_name";
   $tab_labels["table_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["table_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['labels']["table_name"] : "Table Name";
   $tab_ger_campos['open_lft'] = "none";
   $tab_ger_campos['open'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_vw_requests_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_vw_requests']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
