...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_vw_requests/grid_vw_requests_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_vw_requests_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_vw_requests.zip";
          $this->Arquivo   .= "_grid_vw_requests" . $this->Xls_tp;
          $this->Tit_doc    = "grid_vw_requests" . $this->Xls_tp;
          $this->Tit_zip    = "grid_vw_requests.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->main_contact_name = $rs->fields[3] ;  
         $this->main_contact_phone = $rs->fields[4] ;  
         $this->main_contact_email = $rs->fields[5] ;  
         $this->main_contact_title = $rs->fields[6] ;  
         $this->payment_status = $rs->fields[7] ;  
         $this->payment_created = $rs->fields[8] ;  
         $this->memb_status_id = $rs->fields[9] ;  
         $this->memb_status_id = (string)$this->memb_status_id;
         $this->co_address = $rs->fields[10] ;  
         $this->street_address = $rs->fields[11] ;  
         $this->city = $rs->fields[12] ;  
         $this->state = $rs->fields[13] ;  
         $this->zip_code = $rs->fields[14] ;  
         $this->phone_number = $rs->fields[15] ;  
         $this->email = $rs->fields[16] ;  
         $this->appn_note = $rs->fields[17] ;  
         $this->applicant_name = $rs->fields[18] ;  
         $this->applicant_title = $rs->fields[19] ;  
         $this->memb_qty = $rs->fields[20] ;  
         $this->appn_date = $rs->fields[21] ;  
         $this->bus_cat = $rs->fields[22] ;  
         $this->bus_subcategory = $rs->fields[23] ;  
         $this->table_name = $rs->fields[24] ;  
         ...
         $this->arg_sum_payment_status = " = " . $this->Db->qstr($this->payment_status);
          ...
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
...
$_SESSION['scriptcase']['grid_vw_requests']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
          $nm_grid_sem_reg = "There are no current membership requests to review."; 
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "open_lft" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
          ...
          if ($Cada_col == "payment_status" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "payment_created" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "memb_status_id" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "co_address" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "appn_note" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "applicant_name" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "applicant_title" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "memb_qty" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "appn_date" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "table_name" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   function NM_export_open_lft()
   {
         ...
         $this->open_lft = NM_charset_to_utf8($this->open_lft);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->open_lft, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->open_lft, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- client_id
   ...
   function NM_export_main_contact_phone()
   {
      ...
      if (!empty($this->main_contact_phone))
      {
             ...
             { 
                 $this->nm_gera_mask($this->main_contact_phone, "(zzz) zzz - zzzz"); 
             } 
      }
   ...
   //----- payment_status
   function NM_export_payment_status()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->payment_status = html_entity_decode($this->payment_status, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->payment_status = strip_tags($this->payment_status);
         $this->payment_status = NM_charset_to_utf8($this->payment_status);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->payment_status, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->payment_status, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- payment_created
   function NM_export_payment_created()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
      ...
      {
             if (substr($this->payment_created, 10, 1) == "-") 
             { 
                 $this->payment_created = substr($this->payment_created, 0, 10) . " " . substr($this->payment_created, 11);
             } 
             if (substr($this->payment_created, 13, 1) == ".") 
             { 
                $this->payment_created = substr($this->payment_created, 0, 13) . ":" . substr($this->payment_created, 14, 2) . ":" . substr($this->payment_created, 17);
             } 
             $conteudo_x =  $this->payment_created;
             nm_conv_limpa_dado($conteudo_x, "YYYY-MM-DD HH:II:SS");
             if (is_numeric($conteudo_x) && strlen($conteudo_x) > 0) 
             { 
                 $this->nm_data->SetaData($this->payment_created, "YYYY-MM-DD HH:II:SS  ");
                 $this->payment_created = $this->nm_data->FormataSaida("m-d-y h:i A");
             } 
      }
         $this->payment_created = NM_charset_to_utf8($this->payment_created);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->payment_created, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->payment_created, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- open
   function NM_export_open()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->open, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->open, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- memb_status_id
   function NM_export_memb_status_id()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->memb_status_id = NM_charset_to_utf8($this->memb_status_id);
         if (is_numeric($this->memb_status_id))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->memb_status_id);
         $this->Xls_col++;
   }
   //----- co_address
   function NM_export_co_address()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->co_address = html_entity_decode($this->co_address, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->co_address = strip_tags($this->co_address);
         $this->co_address = NM_charset_to_utf8($this->co_address);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->co_address, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->co_address, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- street_address
   ...
   function NM_export_phone_number()
   {
      ...
      if (!empty($this->phone_number))
      {
             ...
             { 
                 $this->nm_gera_mask($this->phone_number, "(zzz) zzz - zzzz"); 
             } 
      }
   ...
   function NM_export_appn_note()
   {
         ...
         $this->appn_note = html_entity_decode($this->appn_note, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->appn_note = strip_tags($this->appn_note);
         $this->appn_note = NM_charset_to_utf8($this->appn_note);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->appn_note, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->appn_note, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- applicant_name
   function NM_export_applicant_name()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->applicant_name = html_entity_decode($this->applicant_name, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->applicant_name = strip_tags($this->applicant_name);
         $this->applicant_name = NM_charset_to_utf8($this->applicant_name);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->applicant_name, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->applicant_name, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- applicant_title
   function NM_export_applicant_title()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->applicant_title = html_entity_decode($this->applicant_title, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->applicant_title = strip_tags($this->applicant_title);
         $this->applicant_title = NM_charset_to_utf8($this->applicant_title);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->applicant_title, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->applicant_title, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- memb_qty
   function NM_export_memb_qty()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->memb_qty = NM_charset_to_utf8($this->memb_qty);
         if (is_numeric($this->memb_qty))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->memb_qty);
         $this->Xls_col++;
   }
   //----- appn_date
   function NM_export_appn_date()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
      ...
      if (!empty($this->appn_date))
      {
             ...
             $conteudo_x =  $this->appn_date;
             nm_conv_limpa_dado($conteudo_x, "YYYY-MM-DD HH:II:SS");
             if (is_numeric($conteudo_x) && strlen($conteudo_x) > 0) 
             { 
                 $this->nm_data->SetaData($this->appn_date, "YYYY-MM-DD HH:II:SS  ");
                 $this->appn_date = $this->nm_data->FormataSaida("m-d-Y H:i");
             } 
      }
         $this->appn_date = NM_charset_to_utf8($this->appn_date);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->appn_date, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->appn_date, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- bus_cat
   ...
   function NM_export_table_name()
   {
         ...
         $this->table_name = html_entity_decode($this->table_name, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->table_name = strip_tags($this->table_name);
         $this->table_name = NM_charset_to_utf8($this->table_name);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->table_name, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->table_name, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- open_lft
   function NM_sub_cons_open_lft()
   {
         $this->open_lft = NM_charset_to_utf8($this->open_lft);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->open_lft;
   ...
   //----- payment_status
   function NM_sub_cons_payment_status()
   {
         $this->payment_status = html_entity_decode($this->payment_status, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->payment_status = strip_tags($this->payment_status);
         $this->payment_status = NM_charset_to_utf8($this->payment_status);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->payment_status;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- payment_created
   function NM_sub_cons_payment_created()
   {
      if (!empty($this->payment_created))
      {
         if (substr($this->payment_created, 10, 1) == "-") 
         ...
         $this->payment_created = NM_charset_to_utf8($this->payment_created);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->payment_created;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- open
   function NM_sub_cons_open()
   {
         $this->open = NM_charset_to_utf8($this->open);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->open;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- memb_status_id
   function NM_sub_cons_memb_status_id()
   {
         $this->memb_status_id = NM_charset_to_utf8($this->memb_status_id);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->memb_status_id;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- co_address
   function NM_sub_cons_co_address()
   {
         $this->co_address = html_entity_decode($this->co_address, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->co_address = strip_tags($this->co_address);
         $this->co_address = NM_charset_to_utf8($this->co_address);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->co_address;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- appn_note
   function NM_sub_cons_appn_note()
   {
         $this->appn_note = html_entity_decode($this->appn_note, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->appn_note = strip_tags($this->appn_note);
         $this->appn_note = NM_charset_to_utf8($this->appn_note);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->appn_note;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- applicant_name
   function NM_sub_cons_applicant_name()
   {
         $this->applicant_name = html_entity_decode($this->applicant_name, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->applicant_name = strip_tags($this->applicant_name);
         $this->applicant_name = NM_charset_to_utf8($this->applicant_name);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->applicant_name;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- applicant_title
   function NM_sub_cons_applicant_title()
   {
         $this->applicant_title = html_entity_decode($this->applicant_title, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->applicant_title = strip_tags($this->applicant_title);
         $this->applicant_title = NM_charset_to_utf8($this->applicant_title);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->applicant_title;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- memb_qty
   function NM_sub_cons_memb_qty()
   {
         $this->memb_qty = NM_charset_to_utf8($this->memb_qty);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->memb_qty;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- appn_date
   function NM_sub_cons_appn_date()
   {
      if (!empty($this->appn_date))
      {
         if (substr($this->appn_date, 10, 1) == "-") 
         ...
         $this->appn_date = NM_charset_to_utf8($this->appn_date);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->appn_date;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- table_name
   function NM_sub_cons_table_name()
   {
         $this->table_name = html_entity_decode($this->table_name, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->table_name = strip_tags($this->table_name);
         $this->table_name = NM_charset_to_utf8($this->table_name);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->table_name;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['nolabel'])
       {
 ...
 function quebra_payment_status_by_pmt_status($payment_status) 
 {
   ...
   function quebra_status_by_status_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['field_order'] as $Cada_cmp)
       {
           if (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_payment_status_by_pmt_status_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> vw_client_appns :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
