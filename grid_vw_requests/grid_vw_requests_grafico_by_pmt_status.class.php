...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "Payment";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['contr_label_graf']['payment_status']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['contr_label_graf']['payment_status']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['contr_label_graf']['payment_status'];
      }
   }
