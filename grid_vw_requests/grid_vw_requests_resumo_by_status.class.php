   ...
   if ($this->Ini->Embutida_iframe) {
        ...
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'status' => [
                    ...
                    'datatype' => 'varchar',
                    'lowercase' => 'status',
                    'summary_values_array' => 'array_total_status',
                    'summary_line_values_array' => 'array_line_status',
            ...
            'options' => [
                ...
                'order_initial_rule' => '',
                'order_metric_apply_to_dimensions' => ['status'],
    ...
    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_requests'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_requests'] ['last_displayed_group_by'] = 'by_status';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('by_status' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_requests'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_requests'] ['last_displayed_group_by'] = 'by_status';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($this->SC_APP_info['metric_by_index'] as $metricIndex => $metricName) {
            if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_requests'] ['summarizing_fields_display'] ['by_status'] [$metricIndex])) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_requests'] ['summarizing_fields_display'] ['by_status'] [$metricIndex] = ['display' => false];
            }
        }
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_requests'] ['summarizing_fields_order'] ['by_status'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_vw_requests'] ['summarizing_fields_display'] ['by_status'] [$metricIndex] ['display']) {
...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['arr_total_line']['status'];
            }
          $this->array_total_status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['arr_total']['status'];
      ...
      else
      {
            ...
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $this->array_line_status = $this->array_total_status;
                $forceFields = [];
                foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                    $forceFields[] = $this->SC_APP_info['dimension'] [$dimensionName] ['lowercase'];
                }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['arr_total']['status'] = $this->array_total_status;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['arr_total_line']['status'] = $this->array_line_status;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['summarizing_fields_order']['by_status']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['summarizing_fields_order']['by_status'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['summarizing_fields_order']['by_status'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['summarizing_fields_display']['by_status'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['summarizing_fields_display']['by_status'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['summarizing_fields_display']['by_status'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['summarizing_fields_display']['by_status'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['summarizing_fields_display']['by_status'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['summarizing_fields_display']['by_status'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['summarizing_fields_display']['by_status'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_status as $i_status => $d_status) {
           if (!isset($i_status, $this->comp_label[0]) || !in_array($i_status, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_status[2] ] = $d_status[1];
               $this->comp_label[0][ $d_status[2] ] = $d_status[1];
           }
       }
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_status => $l_status) {
           if (isset($this->array_total_status[$i_status])) {
               $this->comp_group[$i_status] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_status;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['proc_pdf_vert']){ 
   ...
   function totaliza($tipo='')
   {
      ...
      $where_compara   = "";
      $this->Total->Calc_resumo_by_status("res", $this->NM_export, 1, $tipo);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vw_requests']['where_dyn_compara'])) )
       {
          ...
          $this->Total->Calc_resumo_by_status("res", $this->NM_export, 2, $tipo);
      ...
      if (is_array($this->array_total_status)) {
          ksort($this->array_total_status);
      }
...
{ 
   ...
   //---- 
   function adiciona_registro($quebra_status, $quebra_status_orig)
   {
      //----- Status
      if (!isset($this->array_total_status[$quebra_status_orig]))
      {
         $this->array_total_status[$quebra_status_orig][0] = 1;
         $this->array_total_status[$quebra_status_orig][1] = $quebra_status;
         $this->array_total_status[$quebra_status_orig][2] = $quebra_status_orig;
      }
      else
      {
         $this->array_total_status[$quebra_status_orig][0]++;
      }
   }
   ...
   {
      if (isset($this->array_total_status))
      {
         $arr_temp_0 = $this->array_total_status;
         foreach ($this->array_total_status as $campo_status => $dados_status)
         {
            $ind_exists  = "";
            $ind_missing = "";
            if (!isset($this->array_total_status[$campo_status][1])) {
                $ind_exists  = 2;
                $ind_missing = 1;
            }
            if (!isset($this->array_total_status[$campo_status][2])) {
                $ind_exists  = 1;
                $ind_missing = 2;
            }
            if (!empty($ind_missing)) {
                $arr_temp_0[$campo_status][$ind_missing][0] = 0;
                $arr_temp_0[$campo_status][$ind_missing][1] = $dados_status[$ind_exists][1];
                $arr_temp_0[$campo_status][$ind_missing][2] = $dados_status[$ind_exists][2];
            }
            ksort($arr_temp_0[$campo_status]);
            $this->array_total_status[$campo_status] = $arr_temp_0[$campo_status];
         } 
      } 
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('by_status', 'status');
     $campos_order = $this->Ini->Get_date_order_groupby("status", 'asc', $format, $campos_order);
...
$_SESSION['scriptcase']['grid_vw_requests']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->status, $this->status_orig);
            }
   }
//
