  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_notifications_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_notifications_mob_form();
        }
...
?>
  ...
  function do_ajax_form_notifications_mob_validate_msg_subject()
  {
    var nomeCampo_msg_subject = "msg_subject";
    var var_msg_subject = scAjaxGetFieldText(nomeCampo_msg_subject);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notifications_mob_validate_msg_subject(var_msg_subject, var_script_case_init, do_ajax_form_notifications_mob_validate_msg_subject_cb);
  } // do_ajax_form_notifications_mob_validate_msg_subject

  function do_ajax_form_notifications_mob_validate_msg_subject_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notifications_mob_validate_msg_subject_cb

  // ---------- Validate msg_body
  function do_ajax_form_notifications_mob_validate_msg_body()
  {
    var nomeCampo_msg_body = "msg_body";
    var var_msg_body = scAjaxGetFieldEditorHtml(nomeCampo_msg_body);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notifications_mob_validate_msg_body(var_msg_body, var_script_case_init, do_ajax_form_notifications_mob_validate_msg_body_cb);
  } // do_ajax_form_notifications_mob_validate_msg_body

  function do_ajax_form_notifications_mob_validate_msg_body_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notifications_mob_validate_msg_body_cb

  // ---------- Validate active
  function do_ajax_form_notifications_mob_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldSelect(nomeCampo_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notifications_mob_validate_active(var_active, var_script_case_init, do_ajax_form_notifications_mob_validate_active_cb);
  } // do_ajax_form_notifications_mob_validate_active

  function do_ajax_form_notifications_mob_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notifications_mob_validate_active_cb

  // ---------- Validate descript
  function do_ajax_form_notifications_mob_validate_descript()
  {
    var nomeCampo_descript = "descript";
    var var_descript = scAjaxGetFieldHidden(nomeCampo_descript);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notifications_mob_validate_descript(var_descript, var_script_case_init, do_ajax_form_notifications_mob_validate_descript_cb);
  } // do_ajax_form_notifications_mob_validate_descript

  function do_ajax_form_notifications_mob_validate_descript_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notifications_mob_validate_descript_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_notifications_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_notifications_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_descript = scAjaxGetFieldHidden("descript");
    var var_notif_id = scAjaxGetFieldText("notif_id");
    ...
    scAjaxProcOn();
    x_ajax_form_notifications_mob_submit_form(var_msg_subject, var_msg_body, var_active, var_descript, var_notif_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_notifications_mob_submit_form_cb);
  } // do_ajax_form_notifications_mob_submit_form

  function do_ajax_form_notifications_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_notifications_mob_submit_form_cb_after_alert);
  } // do_ajax_form_notifications_mob_submit_form_cb
  function do_ajax_form_notifications_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_notifications_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_notifications_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_notifications_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_notifications_mob_navigate_form();
    }
  }

  function perform_ajax_form_notifications_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("active");
    scAjaxHideErrorDisplay("descript");
    var var_notif_id = document.F2.notif_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_notifications_mob_navigate_form(var_notif_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_notifications_mob_navigate_form_cb);
  } // do_ajax_form_notifications_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_notifications_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_notifications_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.notif_id.value = scAjaxGetKeyValue("notif_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_notifications_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_notifications_mob_navigate_form_cb
  function do_ajax_form_notifications_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_notifications_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_notifications_mob_navigate_form_cb_after_alert

  function sc_hide_form_notifications_mob_form()
  {
  ...
  ajax_field_list[0] = "msg_subject";
  ajax_field_list[1] = "msg_body";
  ajax_field_list[2] = "active";
  ajax_field_list[3] = "descript";
  ...
  var ajax_error_list = {
    ...
    "descript": {"label": "Tag", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
