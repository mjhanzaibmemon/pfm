<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="member_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['member_id_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_members_staff"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_chg_adtl_buyers = false;
function sc_btn_chg_adtl_buyers()
{
    if (scEventControl_active_all()) {
      setTimeout(function() { sc_btn_chg_adtl_buyers(); }, 500);
      return;
    }
    if (Crtl_btn_chg_adtl_buyers) {return;}
    sc_btn_chg_adtl_buyers_ok();
}
function sc_btn_chg_adtl_buyers_cancel()
{
}
function sc_btn_chg_adtl_buyers_ok()
{
    Crtl_btn_chg_adtl_buyers = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?chg_adtl_buyers?@?";
    document.F1.action = "./";
...
function scForm_inline_submit(y, z) {
        Nm_Proc_Atualiz = true;
        do_ajax_form_members_staff_submit_form(y, z);
