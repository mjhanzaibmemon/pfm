...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_ts_hora' + iSeqRow).bind('blur', function() { sc_form_client_docs_ts_onblur('#id_sc_field_ts' + iSeqRow, iSeqRow) })
                                     .bind('focus', function() { sc_form_client_docs_ts_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
        $("#id_form_client_docs_mob_form" + pageNo).hide();
}
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_client_docs_mob_validate_ts(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_doc_file" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_client_docs_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_client_docs_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
