...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_doc_id' + iSeqRow).bind('change', function() { sc_form_client_docs_doc_id_onchange(this, iSeqRow) });
  $('#id_sc_field_client_id' + iSeqRow).bind('change', function() { sc_form_client_docs_client_id_onchange(this, iSeqRow) });
  $('#id_sc_field_appn_id' + iSeqRow).bind('change', function() { sc_form_client_docs_appn_id_onchange(this, iSeqRow) });
  $('#id_sc_field_doc_type' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_client_docs_doc_type_onblur('#id_sc_field_doc_type' + iSeqRow, iSeqRow);}, 300) })
                                      .bind('change', function() { sc_form_client_docs_doc_type_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_client_docs_doc_type_onfocus(this, iSeqRow) });
  $('#id_sc_field_doc_file' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_client_docs_doc_file_onblur('#id_sc_field_doc_file' + iSeqRow, iSeqRow);}, 300) })
                                      .bind('change', function() { sc_form_client_docs_doc_file_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_client_docs_doc_file_onfocus(this, iSeqRow) });
  $('#id_sc_field_doc_filename' + iSeqRow).bind('change', function() { sc_form_client_docs_doc_filename_onchange(this, iSeqRow) });
  $('#id_sc_field_doc_filesize' + iSeqRow).bind('change', function() { sc_form_client_docs_doc_filesize_onchange(this, iSeqRow) });
  $('#id_sc_field_ts' + iSeqRow).bind('blur', function() { sc_form_client_docs_ts_onblur('#id_sc_field_ts' + iSeqRow, iSeqRow) })
                                .bind('change', function() { sc_form_client_docs_ts_onchange(this, iSeqRow) })
                                .bind('focus', function() { sc_form_client_docs_ts_onfocus(this, iSeqRow) });
  $('#id_sc_field_ts_hora' + iSeqRow).bind('blur', function() { sc_form_client_docs_ts_hora_onblur('#id_sc_field_ts' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_client_docs_ts_hora_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_client_docs_ts_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_user' + iSeqRow).bind('blur', function() { sc_form_client_docs_user_onblur('#id_sc_field_user' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_client_docs_user_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_client_docs_user_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_client_docs_doc_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_docs_client_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_docs_appn_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_docs_doc_type_onblur(oThis, iSeqRow) {
  do_ajax_form_client_docs_validate_doc_type();
  scCssBlur(oThis);
}

function sc_form_client_docs_doc_type_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_docs_doc_type_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_client_docs_doc_file_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_client_docs_doc_file_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_docs_doc_file_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_client_docs_doc_filename_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_docs_doc_filesize_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_docs_ts_onblur(oThis, iSeqRow) {
  do_ajax_form_client_docs_validate_ts();
  scCssBlur(oThis);
}

function sc_form_client_docs_ts_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_client_docs_validate_ts();
  scCssBlur(oThis);
}

function sc_form_client_docs_ts_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_docs_ts_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_docs_ts_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_client_docs_ts_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_client_docs_user_onblur(oThis, iSeqRow) {
  do_ajax_form_client_docs_validate_user();
  scCssBlur(oThis);
}

function sc_form_client_docs_user_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_client_docs_user_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
        $("#id_form_client_docs_form" + pageNo).hide();
}
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_client_docs_validate_ts(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_doc_file" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_client_docs_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_client_docs')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
