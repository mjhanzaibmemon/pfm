  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_client_docs_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_client_docs_mob_form();
        }
...
?>
  ...
  // ---------- Validate ts
  function do_ajax_form_client_docs_mob_validate_ts()
  {
    var nomeCampo_ts = "ts";
    var var_ts = scAjaxGetFieldText(nomeCampo_ts);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_docs_mob_validate_ts(var_ts, var_script_case_init, do_ajax_form_client_docs_mob_validate_ts_cb);
  } // do_ajax_form_client_docs_mob_validate_ts

  function do_ajax_form_client_docs_mob_validate_ts_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_docs_mob_validate_ts_cb

  // ---------- Validate doc_type
  function do_ajax_form_client_docs_mob_validate_doc_type()
  {
    var nomeCampo_doc_type = "doc_type";
    var var_doc_type = scAjaxGetFieldSelectMult(nomeCampo_doc_type, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_docs_mob_validate_doc_type(var_doc_type, var_script_case_init, do_ajax_form_client_docs_mob_validate_doc_type_cb);
  } // do_ajax_form_client_docs_mob_validate_doc_type

  function do_ajax_form_client_docs_mob_validate_doc_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_docs_mob_validate_doc_type_cb

  // ---------- Validate doc_file
  function do_ajax_form_client_docs_mob_validate_doc_file()
  {
    var nomeCampo_doc_file = "doc_file";
    var var_doc_file = scAjaxGetFieldText(nomeCampo_doc_file);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_docs_mob_validate_doc_file(var_doc_file, var_script_case_init, do_ajax_form_client_docs_mob_validate_doc_file_cb);
  } // do_ajax_form_client_docs_mob_validate_doc_file

  function do_ajax_form_client_docs_mob_validate_doc_file_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_docs_mob_validate_doc_file_cb

  // ---------- Validate user
  function do_ajax_form_client_docs_mob_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldHidden(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_client_docs_mob_validate_user(var_user, var_script_case_init, do_ajax_form_client_docs_mob_validate_user_cb);
  } // do_ajax_form_client_docs_mob_validate_user

  function do_ajax_form_client_docs_mob_validate_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_client_docs_mob_validate_user_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_client_docs_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_client_docs_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_client_docs_mob_submit_form(var_ts, var_doc_type, var_doc_file, var_user, var_doc_id, var_doc_file_ul_name, var_doc_file_ul_type, var_doc_file_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_client_docs_mob_submit_form_cb);
  } // do_ajax_form_client_docs_mob_submit_form

  function do_ajax_form_client_docs_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_client_docs_mob_submit_form_cb_after_alert);
  } // do_ajax_form_client_docs_mob_submit_form_cb
  function do_ajax_form_client_docs_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_client_docs_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_client_docs_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_client_docs_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_client_docs_mob_navigate_form();
    }
  }

  function perform_ajax_form_client_docs_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_client_docs_mob_navigate_form(var_doc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_client_docs_mob_navigate_form_cb);
  } // do_ajax_form_client_docs_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_client_docs_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_client_docs_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_client_docs_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_client_docs_mob_navigate_form_cb
  function do_ajax_form_client_docs_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_client_docs_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_client_docs_mob_navigate_form_cb_after_alert

  function sc_hide_form_client_docs_mob_form()
  {
