...
function scEventControl_onCalculator_membs_num() {
  if (!_scCalculatorControl["id_sc_field_membs_num"]) {
    ...
    do_ajax_control_members_add_charge_event_membs_num_onblur();
  }
...
function scEventControl_onCalculator_total() {
  if (!_scCalculatorControl["id_sc_field_total"]) {
    ...
    do_ajax_control_members_add_charge_event_total_onblur();
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_client_id' + iSeqRow).bind('blur', function() { sc_control_members_add_charge_client_id_onblur('#id_sc_field_client_id' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_control_members_add_charge_client_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_control_members_add_charge_total_onblur('#id_sc_field_total' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_control_members_add_charge_total_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cat' + iSeqRow).bind('blur', function() { sc_control_members_add_charge_cat_onblur('#id_sc_field_cat' + iSeqRow, iSeqRow) })
                                 .bind('change', function() { sc_control_members_add_charge_cat_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sub_cat' + iSeqRow).bind('blur', function() { sc_control_members_add_charge_sub_cat_onblur('#id_sc_field_sub_cat' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_control_members_add_charge_sub_cat_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_bus_name' + iSeqRow).bind('blur', function() { sc_control_members_add_charge_bus_name_onblur('#id_sc_field_bus_name' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_control_members_add_charge_bus_name_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_control_members_add_charge_email_onblur('#id_sc_field_email' + iSeqRow, iSeqRow);}, 300) })
                                   .bind('change', function() { sc_control_members_add_charge_email_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_main_contact' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_control_members_add_charge_main_contact_onblur('#id_sc_field_main_contact' + iSeqRow, iSeqRow);}, 300) })
                                          .bind('change', function() { sc_control_members_add_charge_main_contact_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_status' + iSeqRow).bind('blur', function() { sc_control_members_add_charge_status_onblur('#id_sc_field_status' + iSeqRow, iSeqRow) })
                                    .bind('change', function() { sc_control_members_add_charge_status_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_control_members_add_charge_status_onfocus(this, iSeqRow) });
  $('#id_sc_field_strp_price_id' + iSeqRow).bind('change', function() { sc_control_members_add_charge_strp_price_id_onchange(this, iSeqRow) });
  $('#id_sc_field_cost_per_buyer' + iSeqRow).bind('blur', function() { sc_control_members_add_charge_cost_per_buyer_onblur('#id_sc_field_cost_per_buyer' + iSeqRow, iSeqRow) })
                                            .bind('change', function() { sc_control_members_add_charge_cost_per_buyer_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_control_members_add_charge_cost_per_buyer_onfocus(this, iSeqRow) });
  $('#id_sc_field_bus_cat_id' + iSeqRow).bind('change', function() { sc_control_members_add_charge_bus_cat_id_onchange(this, iSeqRow) });
  $('#id_sc_field_bus_subcat_id' + iSeqRow).bind('change', function() { sc_control_members_add_charge_bus_subcat_id_onchange(this, iSeqRow) });
  $('#id_sc_field_token' + iSeqRow).bind('change', function() { sc_control_members_add_charge_token_onchange(this, iSeqRow) });
  $('#id_sc_field_token_exp' + iSeqRow).bind('change', function() { sc_control_members_add_charge_token_exp_onchange(this, iSeqRow) });
  $('#id_sc_field_token_exp_hora' + iSeqRow).bind('change', function() { sc_control_members_add_charge_token_exp_hora_onchange(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_control_members_add_charge_client_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_members_add_charge_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_members_add_charge_cat_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_members_add_charge_sub_cat_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_members_add_charge_bus_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_members_add_charge_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_members_add_charge_main_contact_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_members_add_charge_status_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_members_add_charge_strp_price_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_members_add_charge_cost_per_buyer_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_members_add_charge_bus_cat_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_control_members_add_charge_bus_subcat_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_control_members_add_charge_token_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_control_members_add_charge_token_exp_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_control_members_add_charge_token_exp_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
        $("#id_control_members_add_charge_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'control_members_add_charge')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
