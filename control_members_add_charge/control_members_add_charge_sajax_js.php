  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_members_add_charge" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_control_members_add_charge_form();
        }
...
?>
  ...
  // ---------- Validate client_id
  function do_ajax_control_members_add_charge_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldHidden(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_validate_client_id(var_client_id, var_script_case_init, do_ajax_control_members_add_charge_validate_client_id_cb);
  } // do_ajax_control_members_add_charge_validate_client_id

  function do_ajax_control_members_add_charge_validate_client_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_validate_client_id_cb

  // ---------- Validate bus_name
  function do_ajax_control_members_add_charge_validate_bus_name()
  {
    var nomeCampo_bus_name = "bus_name";
    var var_bus_name = scAjaxGetFieldHidden(nomeCampo_bus_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_validate_bus_name(var_bus_name, var_script_case_init, do_ajax_control_members_add_charge_validate_bus_name_cb);
  } // do_ajax_control_members_add_charge_validate_bus_name

  function do_ajax_control_members_add_charge_validate_bus_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_validate_bus_name_cb

  // ---------- Validate cat
  function do_ajax_control_members_add_charge_validate_cat()
  {
    var nomeCampo_cat = "cat";
    var var_cat = scAjaxGetFieldHidden(nomeCampo_cat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_validate_cat(var_cat, var_script_case_init, do_ajax_control_members_add_charge_validate_cat_cb);
  } // do_ajax_control_members_add_charge_validate_cat

  function do_ajax_control_members_add_charge_validate_cat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_validate_cat_cb

  // ---------- Validate sub_cat
  function do_ajax_control_members_add_charge_validate_sub_cat()
  {
    var nomeCampo_sub_cat = "sub_cat";
    var var_sub_cat = scAjaxGetFieldHidden(nomeCampo_sub_cat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_validate_sub_cat(var_sub_cat, var_script_case_init, do_ajax_control_members_add_charge_validate_sub_cat_cb);
  } // do_ajax_control_members_add_charge_validate_sub_cat

  function do_ajax_control_members_add_charge_validate_sub_cat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sub_cat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_validate_sub_cat_cb

  // ---------- Validate main_contact
  function do_ajax_control_members_add_charge_validate_main_contact()
  {
    var nomeCampo_main_contact = "main_contact";
    var var_main_contact = scAjaxGetFieldText(nomeCampo_main_contact);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_validate_main_contact(var_main_contact, var_script_case_init, do_ajax_control_members_add_charge_validate_main_contact_cb);
  } // do_ajax_control_members_add_charge_validate_main_contact

  function do_ajax_control_members_add_charge_validate_main_contact_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_validate_main_contact_cb

  // ---------- Validate email
  function do_ajax_control_members_add_charge_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_validate_email(var_email, var_script_case_init, do_ajax_control_members_add_charge_validate_email_cb);
  } // do_ajax_control_members_add_charge_validate_email

  function do_ajax_control_members_add_charge_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_validate_email_cb

  // ---------- Validate membs_num
  function do_ajax_control_members_add_charge_validate_membs_num()
  {
    var nomeCampo_membs_num = "membs_num";
    var var_membs_num = scAjaxGetFieldText(nomeCampo_membs_num);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_validate_membs_num(var_membs_num, var_script_case_init, do_ajax_control_members_add_charge_validate_membs_num_cb);
  } // do_ajax_control_members_add_charge_validate_membs_num

  function do_ajax_control_members_add_charge_validate_membs_num_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_validate_membs_num_cb

  // ---------- Validate status
  function do_ajax_control_members_add_charge_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldHidden(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_validate_status(var_status, var_script_case_init, do_ajax_control_members_add_charge_validate_status_cb);
  } // do_ajax_control_members_add_charge_validate_status

  function do_ajax_control_members_add_charge_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_validate_status_cb

  // ---------- Validate total
  function do_ajax_control_members_add_charge_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_validate_total(var_total, var_script_case_init, do_ajax_control_members_add_charge_validate_total_cb);
  } // do_ajax_control_members_add_charge_validate_total

  function do_ajax_control_members_add_charge_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_validate_total_cb

  // ---------- Validate cost_per_buyer
  function do_ajax_control_members_add_charge_validate_cost_per_buyer()
  {
    var nomeCampo_cost_per_buyer = "cost_per_buyer";
    var var_cost_per_buyer = scAjaxGetFieldHidden(nomeCampo_cost_per_buyer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_validate_cost_per_buyer(var_cost_per_buyer, var_script_case_init, do_ajax_control_members_add_charge_validate_cost_per_buyer_cb);
  } // do_ajax_control_members_add_charge_validate_cost_per_buyer

  function do_ajax_control_members_add_charge_validate_cost_per_buyer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_validate_cost_per_buyer_cb

  // ---------- Event onchange membs_num
  function do_ajax_control_members_add_charge_event_membs_num_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_control_members_add_charge_event_membs_num_onchange(var_cat, var_membs_num, var_total, var_cost_per_buyer, var_script_case_init, do_ajax_control_members_add_charge_event_membs_num_onchange_cb);
  } // do_ajax_control_members_add_charge_event_membs_num_onchange

  function do_ajax_control_members_add_charge_event_membs_num_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "membs_num";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_members_add_charge_event_membs_num_onchange_cb_after_alert);
  } // do_ajax_control_members_add_charge_event_membs_num_onchange_cb
  function do_ajax_control_members_add_charge_event_membs_num_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_members_add_charge_event_membs_num_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_members_add_charge_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_members_add_charge_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_members_add_charge_submit_form(var_client_id, var_bus_name, var_cat, var_sub_cat, var_main_contact, var_email, var_membs_num, var_status, var_total, var_cost_per_buyer, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_members_add_charge_submit_form_cb);
  } // do_ajax_control_members_add_charge_submit_form

  function do_ajax_control_members_add_charge_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_members_add_charge_submit_form_cb_after_alert);
  } // do_ajax_control_members_add_charge_submit_form_cb
  function do_ajax_control_members_add_charge_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_members_add_charge_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_members_add_charge_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_members_add_charge_navigate_form, function() {});
    } else {
      perform_ajax_control_members_add_charge_navigate_form();
    }
  }

  function perform_ajax_control_members_add_charge_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_members_add_charge_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_charge']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_members_add_charge_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_members_add_charge_navigate_form_cb_after_alert);
  } // do_ajax_control_members_add_charge_navigate_form_cb
  function do_ajax_control_members_add_charge_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_control_members_add_charge_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_members_add_charge_navigate_form_cb_after_alert

  function sc_hide_control_members_add_charge_form()
  {
