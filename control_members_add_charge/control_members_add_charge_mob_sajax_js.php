  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_members_add_charge_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_control_members_add_charge_mob_form();
        }
...
?>
  ...
  // ---------- Validate client_id
  function do_ajax_control_members_add_charge_mob_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldHidden(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_mob_validate_client_id(var_client_id, var_script_case_init, do_ajax_control_members_add_charge_mob_validate_client_id_cb);
  } // do_ajax_control_members_add_charge_mob_validate_client_id

  function do_ajax_control_members_add_charge_mob_validate_client_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_mob_validate_client_id_cb

  // ---------- Validate bus_name
  function do_ajax_control_members_add_charge_mob_validate_bus_name()
  {
    var nomeCampo_bus_name = "bus_name";
    var var_bus_name = scAjaxGetFieldHidden(nomeCampo_bus_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_mob_validate_bus_name(var_bus_name, var_script_case_init, do_ajax_control_members_add_charge_mob_validate_bus_name_cb);
  } // do_ajax_control_members_add_charge_mob_validate_bus_name

  function do_ajax_control_members_add_charge_mob_validate_bus_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bus_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_mob_validate_bus_name_cb

  // ---------- Validate cat
  function do_ajax_control_members_add_charge_mob_validate_cat()
  {
    var nomeCampo_cat = "cat";
    var var_cat = scAjaxGetFieldHidden(nomeCampo_cat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_mob_validate_cat(var_cat, var_script_case_init, do_ajax_control_members_add_charge_mob_validate_cat_cb);
  } // do_ajax_control_members_add_charge_mob_validate_cat

  function do_ajax_control_members_add_charge_mob_validate_cat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_mob_validate_cat_cb

  // ---------- Validate sub_cat
  function do_ajax_control_members_add_charge_mob_validate_sub_cat()
  {
    var nomeCampo_sub_cat = "sub_cat";
    var var_sub_cat = scAjaxGetFieldHidden(nomeCampo_sub_cat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_mob_validate_sub_cat(var_sub_cat, var_script_case_init, do_ajax_control_members_add_charge_mob_validate_sub_cat_cb);
  } // do_ajax_control_members_add_charge_mob_validate_sub_cat

  function do_ajax_control_members_add_charge_mob_validate_sub_cat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sub_cat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_mob_validate_sub_cat_cb

  // ---------- Validate main_contact
  function do_ajax_control_members_add_charge_mob_validate_main_contact()
  {
    var nomeCampo_main_contact = "main_contact";
    var var_main_contact = scAjaxGetFieldText(nomeCampo_main_contact);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_mob_validate_main_contact(var_main_contact, var_script_case_init, do_ajax_control_members_add_charge_mob_validate_main_contact_cb);
  } // do_ajax_control_members_add_charge_mob_validate_main_contact

  function do_ajax_control_members_add_charge_mob_validate_main_contact_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "main_contact";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_mob_validate_main_contact_cb

  // ---------- Validate email
  function do_ajax_control_members_add_charge_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_mob_validate_email(var_email, var_script_case_init, do_ajax_control_members_add_charge_mob_validate_email_cb);
  } // do_ajax_control_members_add_charge_mob_validate_email

  function do_ajax_control_members_add_charge_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_mob_validate_email_cb

  // ---------- Validate membs_num
  function do_ajax_control_members_add_charge_mob_validate_membs_num()
  {
    var nomeCampo_membs_num = "membs_num";
    var var_membs_num = scAjaxGetFieldText(nomeCampo_membs_num);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_mob_validate_membs_num(var_membs_num, var_script_case_init, do_ajax_control_members_add_charge_mob_validate_membs_num_cb);
  } // do_ajax_control_members_add_charge_mob_validate_membs_num

  function do_ajax_control_members_add_charge_mob_validate_membs_num_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "membs_num";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_mob_validate_membs_num_cb

  // ---------- Validate status
  function do_ajax_control_members_add_charge_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldHidden(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_mob_validate_status(var_status, var_script_case_init, do_ajax_control_members_add_charge_mob_validate_status_cb);
  } // do_ajax_control_members_add_charge_mob_validate_status

  function do_ajax_control_members_add_charge_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_mob_validate_status_cb

  // ---------- Validate total
  function do_ajax_control_members_add_charge_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_mob_validate_total(var_total, var_script_case_init, do_ajax_control_members_add_charge_mob_validate_total_cb);
  } // do_ajax_control_members_add_charge_mob_validate_total

  function do_ajax_control_members_add_charge_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_mob_validate_total_cb

  // ---------- Validate cost_per_buyer
  function do_ajax_control_members_add_charge_mob_validate_cost_per_buyer()
  {
    var nomeCampo_cost_per_buyer = "cost_per_buyer";
    var var_cost_per_buyer = scAjaxGetFieldHidden(nomeCampo_cost_per_buyer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_members_add_charge_mob_validate_cost_per_buyer(var_cost_per_buyer, var_script_case_init, do_ajax_control_members_add_charge_mob_validate_cost_per_buyer_cb);
  } // do_ajax_control_members_add_charge_mob_validate_cost_per_buyer

  function do_ajax_control_members_add_charge_mob_validate_cost_per_buyer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cost_per_buyer";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_members_add_charge_mob_validate_cost_per_buyer_cb

  // ---------- Event onchange membs_num
  function do_ajax_control_members_add_charge_mob_event_membs_num_onchange()
  {
    var var_cat = scAjaxGetFieldHidden("cat");
    var var_membs_num = scAjaxGetFieldText("membs_num");
    var var_total = scAjaxGetFieldHidden("total");
    var var_cost_per_buyer = scAjaxGetFieldHidden("cost_per_buyer");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_members_add_charge_mob_event_membs_num_onchange(var_cat, var_membs_num, var_total, var_cost_per_buyer, var_script_case_init, do_ajax_control_members_add_charge_mob_event_membs_num_onchange_cb);
  } // do_ajax_control_members_add_charge_mob_event_membs_num_onchange

  function do_ajax_control_members_add_charge_mob_event_membs_num_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "membs_num";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_members_add_charge_mob_event_membs_num_onchange_cb_after_alert);
  } // do_ajax_control_members_add_charge_mob_event_membs_num_onchange_cb
  function do_ajax_control_members_add_charge_mob_event_membs_num_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_members_add_charge_mob_event_membs_num_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_members_add_charge_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_members_add_charge_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_client_id = scAjaxGetFieldHidden("client_id");
    var var_bus_name = scAjaxGetFieldHidden("bus_name");
    var var_cat = scAjaxGetFieldHidden("cat");
    var var_sub_cat = scAjaxGetFieldHidden("sub_cat");
    var var_main_contact = scAjaxGetFieldText("main_contact");
    var var_email = scAjaxGetFieldText("email");
    var var_membs_num = scAjaxGetFieldText("membs_num");
    var var_status = scAjaxGetFieldHidden("status");
    var var_total = scAjaxGetFieldHidden("total");
    var var_cost_per_buyer = scAjaxGetFieldHidden("cost_per_buyer");
    ...
    scAjaxProcOn();
    x_ajax_control_members_add_charge_mob_submit_form(var_client_id, var_bus_name, var_cat, var_sub_cat, var_main_contact, var_email, var_membs_num, var_status, var_total, var_cost_per_buyer, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_members_add_charge_mob_submit_form_cb);
  } // do_ajax_control_members_add_charge_mob_submit_form

  function do_ajax_control_members_add_charge_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("bus_name");
      scAjaxHideErrorDisplay("cat");
      scAjaxHideErrorDisplay("sub_cat");
      scAjaxHideErrorDisplay("main_contact");
      scAjaxHideErrorDisplay("email");
      scAjaxHideErrorDisplay("membs_num");
      scAjaxHideErrorDisplay("status");
      scAjaxHideErrorDisplay("total");
      scAjaxHideErrorDisplay("cost_per_buyer");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_members_add_charge_mob_submit_form_cb_after_alert);
  } // do_ajax_control_members_add_charge_mob_submit_form_cb
  function do_ajax_control_members_add_charge_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_members_add_charge_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_members_add_charge_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_members_add_charge_mob_navigate_form, function() {});
    } else {
      perform_ajax_control_members_add_charge_mob_navigate_form();
    }
  }

  function perform_ajax_control_members_add_charge_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_members_add_charge_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_members_add_charge_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_members_add_charge_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_members_add_charge_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_members_add_charge_mob_navigate_form_cb
  function do_ajax_control_members_add_charge_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_control_members_add_charge_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_members_add_charge_mob_navigate_form_cb_after_alert

  function sc_hide_control_members_add_charge_mob_form()
  {
  ...
  ajax_field_list[1] = "bus_name";
  ajax_field_list[2] = "cat";
  ajax_field_list[3] = "sub_cat";
  ajax_field_list[4] = "main_contact";
  ajax_field_list[5] = "email";
  ajax_field_list[6] = "membs_num";
  ajax_field_list[7] = "status";
  ajax_field_list[8] = "total";
  ajax_field_list[9] = "cost_per_buyer";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "client_id": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "bus_name": {"label": "Client", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cat": {"label": "Business Category", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sub_cat": {"label": "Subcategory", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "main_contact": {"label": "Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "email": {"label": "Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "membs_num": {"label": "Additional members", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "status": {"label": "Membership", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "total": {"label": "Total", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cost_per_buyer": {"label": "Cost per additional buyer", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "cat": new Array(),
    "sub_cat": new Array(),
    "main_contact": new Array(),
    "email": new Array(),
    "membs_num": new Array(),
    "status": new Array(),
    "total": new Array(),
    "cost_per_buyer": new Array()
  };
  ajax_field_mult["client_id"][1] = "client_id";
  ajax_field_mult["bus_name"][1] = "bus_name";
  ajax_field_mult["cat"][1] = "cat";
  ajax_field_mult["sub_cat"][1] = "sub_cat";
  ajax_field_mult["main_contact"][1] = "main_contact";
  ajax_field_mult["email"][1] = "email";
  ajax_field_mult["membs_num"][1] = "membs_num";
  ajax_field_mult["status"][1] = "status";
  ajax_field_mult["total"][1] = "total";
  ajax_field_mult["cost_per_buyer"][1] = "cost_per_buyer";

  var ajax_field_id = {
    "client_id": new Array("hidden_field_label_client_id", "hidden_field_data_client_id"),
    "bus_name": new Array("hidden_field_label_bus_name", "hidden_field_data_bus_name"),
    "cat": new Array("hidden_field_label_cat", "hidden_field_data_cat"),
    "sub_cat": new Array("hidden_field_label_sub_cat", "hidden_field_data_sub_cat"),
    "main_contact": new Array("hidden_field_label_main_contact", "hidden_field_data_main_contact"),
    "email": new Array("hidden_field_label_email", "hidden_field_data_email"),
    "membs_num": new Array("hidden_field_label_membs_num", "hidden_field_data_membs_num"),
    ...
    "cost_per_buyer": new Array("hidden_field_label_cost_per_buyer", "hidden_field_data_cost_per_buyer")
  };
