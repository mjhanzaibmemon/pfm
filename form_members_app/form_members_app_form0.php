<?php
class form_members_app_form extends form_members_app_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['sc_redir_atualiz'] == 'ok')
{
?>
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_members_app/form_members_app_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_members_app_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['last'] : 'off'); ?>";
...
function navpage_atualiza(str_navpage)
{
 ...
 function nm_field_disabled(Fields, Opt, Seq, Opcao) {
  ...
  for (i=0; i < Field.length; i++)
  {
     ...
     if (F_name == "main_contact_")
     {
        for (ii=ini; ii < xx; ii++)
        {
            cmp_name = "main_contact_" + ii;
 ...
 function nm_field_disabled_reset() {
  for (var i = 0; i <= iAjaxNewLine; i++) {
    nm_field_disabled("main_contact_=enabled", "", i);
  }
 } // nm_field_disabled_reset
<?php

include_once('form_members_app_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['link_info']['remove_border']) {
...
<?php
 include_once("form_members_app_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_members_app'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_members_app'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_members_app);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_members_app = $this->form_vert_form_members_app;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_members_app))
   {
       $sc_seq_vert = 0;
   }
   foreach ($this->form_vert_form_members_app as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       $this->loadRecordState($sc_seq_vert);
       $this->member_id_ = $this->form_vert_form_members_app[$sc_seq_vert]['member_id_'];
       $this->client_id_ = $this->form_vert_form_members_app[$sc_seq_vert]['client_id_'];
       $this->include_ = $this->form_vert_form_members_app[$sc_seq_vert]['include_'];
       $this->driver_lic_id_ = $this->form_vert_form_members_app[$sc_seq_vert]['driver_lic_id_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->member_name_ = $this->form_vert_form_members_app[$sc_seq_vert]['member_name_']; 
       ...
       $this->main_contact_ = $this->form_vert_form_members_app[$sc_seq_vert]['main_contact_']; 
       ...
       $this->phone1_ = $this->form_vert_form_members_app[$sc_seq_vert]['phone1_']; 
       ...
       $this->email_ = $this->form_vert_form_members_app[$sc_seq_vert]['email_']; 
       $email_ = $this->email_; 
       $sStyleHidden_email_ = '';
       ...
       $this->note_ = $this->form_vert_form_members_app[$sc_seq_vert]['note_']; 
       $note_ = $this->note_; 
       $sStyleHidden_note_ = '';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_members_app_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_members_app_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_members_app_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_members_app_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_members_app_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_members_app_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_member_name__line" id="hidden_field_data_member_name_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_member_name_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_member_name__line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['Lookup_main_contact_'][] = '0'; ?>
 <option value="0">--</option>
 <option  value="1" <?php  if ($this->main_contact_ == "1") { echo " selected" ;} ?>>Yes</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['Lookup_main_contact_'][] = '1'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_phone1__line" id="hidden_field_data_phone1_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_phone1_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_phone1__line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_phone1_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-phone1_<?php echo $sc_seq_vert ?> css_phone1__line" style="<?php echo $sStyleReadLab_phone1_; ?>"><?php echo $this->form_format_readonly("phone1_", $this->form_encode_input($this->phone1_)); ?></span><span id="id_read_off_phone1_<?php echo $sc_seq_vert ?>" class="css_read_off_phone1_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_phone1_; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=14"; } ?> maxlength=114 alt="{datatype: 'mask', maxLength: 100, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', maskList: '(999) 999-9999', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_note__line" id="hidden_field_data_note_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_note_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_note__line" style="vertical-align: top;padding: 0px">
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_members_app = $guarda_form_vert_form_members_app;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        $buttonMacroLabel = "Add a New Buyer";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['new'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bnovo", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_new_b", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "Add a New buyer to the list (Ctrl + Enter)", "" . $buttonMacroDisabled . "", "", "", '', '', '', '', '', '', '', '', "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['insert'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_b", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "Add a New buyer to the list (Ctrl + Enter)", "" . $buttonMacroDisabled . "", "", "", '', '', '', '', '', '', '', '', "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['update'];
        }
?>
...
<?php
        ...
        $buttonMacroLabel = "Refresh List";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['breload'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "breload", "scBtnFn_sys_format_reload()", "scBtnFn_sys_format_reload()", "sc_b_reload_b", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "Reload member list", "" . $buttonMacroDisabled . "", "", "", '', '', '', '', '', '', '', '', "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['last'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['btn_label']['exit'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_members_app");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_members_app");
 parent.scAjaxDetailHeight("form_members_app", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
        ...
        function scBtnFn_sys_format_inc() {
                if ($("#sc_b_new_b.sc-unique-btn-1").length && $("#sc_b_new_b.sc-unique-btn-1").is(":visible")) {
                    if ($("#sc_b_new_b.sc-unique-btn-1").hasClass("disabled")) {
                        ...
                        do_ajax_form_members_app_add_new_line(); return false;
                         return;
                }
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_members_app']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
